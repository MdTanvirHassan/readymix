           ...
           if(!empty($postData)){
                ...
                if($priority=="All"){
                    if(!empty($postData['bank_id'])){
                        ...
                        where $where and dr.bank_id=".$postData['bank_id']." order by dr.deposit_date DESC";
                    ...
                    if(!empty($postData['bank_id'])){
                        ...
                        where $where and dr.priority='".$priority."' and dr.bank_id='".$postData['bank_id']."' order by dr.deposit_date DESC";     
                        ...
                        where $where and dr.priority='".$priority."' order by dr.deposit_date DESC";
