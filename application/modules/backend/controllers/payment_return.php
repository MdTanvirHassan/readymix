...
class Payment_return extends Site_Controller {
    ...
    function index() {
       ...
       // $where = "dr.unit_id=$branch_id";
        ...
        if (!empty($postData)) {
             ...
             if(!empty($f_date) & !empty($to_date)){
              ...
              //  $sql = "select dr.*,pc.collection_method,pc.collection_method,pc.amount,pc.no,b.b_name,b.b_short_name,b.branch_name,tc.c_name,c_short_name from tbl_deposit_realization dr left join tbl_payment_collections pc on dr.collection_id=pc.id left join tbl_banks b on dr.bank_id=b.id left join tbl_sales_orders tso on pc.o_id=tso.o_id left join tbl_customers tc on pc.customer_id=tc.id where $where and dr.deposit_date>='" . $f_date . "' and dr.deposit_date<='" . $to_date . "' and dr.is_active=1 and dr.realization_status='Deposited' order by dr.deposit_date DESC";
                if($user_category==2){
                    ...
                    where $where and dr.deposit_date>='" . $prev_date . "' and dr.deposit_date<='" . $currentDate . "' and dr.realization_status='Returned' order by dr.deposit_date DESC";
                }else{
                    $sql = "select dr.*,pc.check_date,pc.bg_issue_date,pc.po_date,pc.lc_date,pc.mrr_no,pc.remark as c_remark,pc.collection_method,pc.collection_method,pc.amount,pc.no,b.b_name,b.b_short_name,b.branch_name,tc.c_name,c_short_name,tpc.category_name from tbl_deposit_realization dr left join tbl_payment_collections pc on dr.collection_id=pc.id left join tbl_banks b on dr.bank_id=b.id left join tbl_sales_orders tso on pc.o_id=tso.o_id left join tbl_customers tc on pc.customer_id=tc.id left join tbl_product_categories tpc on pc.payment_for_id=tpc.category_id where $where and dr.deposit_date>='" . $f_date . "' and dr.deposit_date<='" . $to_date . "' and dr.realization_status='Returned' order by dr.deposit_date DESC";
                } 
              ...
              //  $sql = "select dr.*,pc.collection_method,pc.collection_method,pc.amount,pc.no,b.b_name,b.b_short_name,b.branch_name,tc.c_name,c_short_name from tbl_deposit_realization dr left join tbl_payment_collections pc on dr.collection_id=pc.id left join tbl_banks b on dr.bank_id=b.id left join tbl_sales_orders tso on pc.o_id=tso.o_id left join tbl_customers tc on pc.customer_id=tc.id where $where and dr.deposit_date>='".$f_date."' and dr.is_active=1 and dr.realization_status='Deposited' order by dr.deposit_date DESC";
                $sql = "select dr.*,pc.check_date,pc.bg_issue_date,pc.po_date,pc.lc_date,pc.mrr_no,pc.remark as c_remark,pc.collection_method,pc.collection_method,pc.amount,pc.no,b.b_name,b.b_short_name,b.branch_name,tc.c_name,c_short_name,tpc.category_name from tbl_deposit_realization dr left join tbl_payment_collections pc on dr.collection_id=pc.id left join tbl_banks b on dr.bank_id=b.id left join tbl_sales_orders tso on pc.o_id=tso.o_id left join tbl_customers tc on pc.customer_id=tc.id left join tbl_product_categories tpc on pc.payment_for_id=tpc.category_id where $where and dr.deposit_date='".$f_date."' and dr.realization_status='Returned' order by dr.deposit_date DESC";
             }else if (!empty($to_date)) {
               // $sql = "select dr.*,pc.collection_method,pc.collection_method,pc.amount,pc.no,b.b_name,b.b_short_name,b.branch_name,tc.c_name,c_short_name from tbl_deposit_realization dr left join tbl_payment_collections pc on dr.collection_id=pc.id left join tbl_banks b on dr.bank_id=b.id left join tbl_sales_orders tso on pc.o_id=tso.o_id left join tbl_customers tc on pc.customer_id=tc.id where $where and dr.deposit_date<='" . $to_date . "' and dr.is_active=1 and dr.realization_status='Deposited' order by dr.deposit_date DESC";
                $sql = "select dr.*,pc.check_date,pc.bg_issue_date,pc.po_date,pc.lc_date,pc.mrr_no,pc.remark as c_remark,pc.collection_method,pc.collection_method,pc.amount,pc.no,b.b_name,b.b_short_name,b.branch_name,tc.c_name,c_short_name,tpc.category_name from tbl_deposit_realization dr left join tbl_payment_collections pc on dr.collection_id=pc.id left join tbl_banks b on dr.bank_id=b.id left join tbl_sales_orders tso on pc.o_id=tso.o_id left join tbl_customers tc on pc.customer_id=tc.id left join tbl_product_categories tpc on pc.payment_for_id=tpc.category_id where $where and dr.deposit_date='" . $to_date . "' and dr.realization_status='Returned' order by dr.deposit_date DESC";
             }else{
                ...
                if($user_category==2){
                    ...
                    pc.po_date,pc.lc_date,pc.mrr_no,pc.remark as c_remark,
                    pc.collection_method,pc.collection_method,pc.amount,
                    pc.no,b.b_name,b.b_short_name,b.branch_name,
                    ...
                    left join tbl_customers tc on pc.customer_id=tc.id 
                    left join tbl_product_categories tpc on pc.payment_for_id=tpc.category_id 
                    where (dr.deposit_date>='$prev_date' and dr.deposit_date<='$currentDate') and $where and dr.realization_status='Returned' order by dr.deposit_date DESC";
                }else{
                    $sql = "select dr.*,pc.check_date,pc.bg_issue_date,pc.po_date,pc.lc_date,pc.mrr_no,pc.remark as c_remark,pc.collection_method,pc.collection_method,pc.amount,pc.no,b.b_name,b.b_short_name,b.branch_name,tc.c_name,c_short_name,tpc.category_name from tbl_deposit_realization dr left join tbl_payment_collections pc on dr.collection_id=pc.id left join tbl_banks b on dr.bank_id=b.id left join tbl_sales_orders tso on pc.o_id=tso.o_id left join tbl_customers tc on pc.customer_id=tc.id left join tbl_product_categories tpc on pc.payment_for_id=tpc.category_id where $where and dr.realization_status='Returned' order by dr.deposit_date DESC";
                } 
             }   
        }else{
          //  $sql = "select dr.*,pc.collection_method,pc.collection_method,pc.amount,pc.no,b.b_name,b.b_short_name,b.branch_name,tc.c_name,c_short_name from tbl_deposit_realization dr left join tbl_payment_collections pc on dr.collection_id=pc.id left join tbl_banks b on dr.bank_id=b.id left join tbl_sales_orders tso on pc.o_id=tso.o_id left join tbl_customers tc on pc.customer_id=tc.id where dr.is_active=1 and dr.realization_status='Deposited' and dr.unit_id=" . $branch_id." order by dr.deposit_date DESC";
            if($user_category==2){ 
                ...
                left join tbl_customers tc on pc.customer_id=tc.id 
                left join tbl_product_categories tpc on pc.payment_for_id=tpc.category_id 
                where (dr.deposit_date>='$prev_date' and dr.deposit_date<='$currentDate') and dr.is_active=1 and dr.realization_status='Returned' order by dr.deposit_date DESC";
            }else{
                $sql = "select dr.*,pc.check_date,pc.bg_issue_date,pc.po_date,pc.lc_date,pc.mrr_no,pc.remark as c_remark,pc.collection_method,pc.collection_method,pc.amount,pc.no,b.b_name,b.b_short_name,b.branch_name,tc.c_name,c_short_name,tpc.category_name from tbl_deposit_realization dr left join tbl_payment_collections pc on dr.collection_id=pc.id left join tbl_banks b on dr.bank_id=b.id left join tbl_sales_orders tso on pc.o_id=tso.o_id left join tbl_customers tc on pc.customer_id=tc.id left join tbl_product_categories tpc on pc.payment_for_id=tpc.category_id where dr.is_active=1 and dr.realization_status='Returned' order by dr.deposit_date DESC";
            }
        ...
        $this->load->view('payment_return/v_payment_return', $data);
    }
    // function index() {
    //     $branch_id = $this->session->userdata('companyId');
    //     $this->menu = 'sales';
    ...
    //     $sql = "select dr.*,pc.collection_method,pc.collection_method,pc.amount,pc.no,tc.c_name,c_short_name from tbl_payment_return dr left join tbl_payment_collections pc on dr.collection_id=pc.id  left join tbl_sales_orders tso on pc.o_id=tso.o_id left join tbl_customers tc on pc.customer_id=tc.id where dr.is_active=1";
    ...
    function add_payment_return() {
        ...
        $data['customers']=$this->m_common->get_row_array('tbl_customers',array('is_active'=>1),'*','','','c_name'); 
        $sql = "select pc.*,c.c_name,c_short_name,tpc.category_name from tbl_payment_collections pc left join tbl_customers c on pc.customer_id=c.id left join tbl_product_categories tpc on pc.payment_for_id=tpc.category_id where pc.is_active=1 and (pc.collection_method='Pdc' || pc.collection_method='Bg' || pc.collection_method='Lc' || pc.collection_method='Po') and pc.payment_status='Collected' order by pc.receive_date desc";  
        
        $data['collections'] = $this->m_common->customeQuery($sql);
        $this->load->view('payment_return/v_add_payment_return',$data);
    }

     function collection_info() {
        $this->setOutputMode(NORMAL);
        $customer_id = $this->input->post('customer_id');
        $sql = "select tpc.*,tc.c_name,c_short_name from tbl_payment_collections tpc left join tbl_sales_orders tso on tpc.o_id=tso.o_id left join tbl_customers tc on tso.customer_id=tc.id where tpc.is_active=1 and tso.customer_id=".$customer_id;
        $data['collections'] = $this->m_common->customeQuery($sql);
        ...
        if (!empty($postData)) {
            ...
            if (!empty($postData['collection_id'])) {
                ...
                if(!empty($pre_deposit)){
                   redirect_with_msg('payment_return/add_return_collection', 'This collection already returned');
                } 
            }
...
//            }
            ...
            redirect_with_msg('payment_return/add_payment_return', 'Please fill the form and submit');
        }
    }
    ...
    function edit_payment_return($id) {
        ...
        $this->titlebackend("Deposit");
        $data['customers']=$this->m_common->get_row_array('tbl_customers',array('is_active'=>1),'*','','','c_name');    
        $sql = "select dr.*,pc.collection_method,pc.collection_method,pc.collection_method,pc.amount,pc.no from tbl_payment_return dr left join tbl_payment_collections pc on dr.collection_id=pc.id  where dr.is_active=1 and dr.id=" . $id;
        $data['return_info'] = $this->m_common->customeQuery($sql);
      
        $sql = "select pc.*,c.c_name,c_short_name,tpc.category_name from tbl_payment_collections pc left join tbl_customers c on pc.customer_id=c.id left join tbl_product_categories tpc on pc.payment_for_id=tpc.category_id where pc.is_active=1 and (pc.collection_method='Pdc' || pc.collection_method='Bg' || pc.collection_method='Lc' || pc.collection_method='Po') and pc.payment_status='Collected' order by pc.receive_date desc";        
        $data['collections'] = $this->m_common->customeQuery($sql);
        
        $this->load->view('payment_return/v_edit_payment_return', $data);
    }
...
//            }
            ...
            redirect_with_msg('payment_return/edit_payment_return/' . $id, 'Please fill the form and submit');
        }
    }
    ...
    function delete_payment_return($id) {
        if(!empty($id)){
            ...
            if(!empty($id)){
                redirect_with_msg('payment_return/index', 'Successfully Deleted');
            } else {
                redirect_with_msg('payment_return/index', 'Data not deleted for an unexpected error');
            }
        }else{
            redirect_with_msg('payment_return/index', 'Please click on delete button');
        }
    }
