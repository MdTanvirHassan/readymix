    ...
    function add_purchase_order_action() {
         ...
         if(!empty($postData)){
             ...
             if(!empty($postData['sub_total_amount'])){
                    $insertData['sub_total_amount']=$postData['sub_total_amount'];
             }
             if(!empty($postData['transport_cost'])){
                    $insertData['transport_cost']=$postData['transport_cost'];
             }
             
             if(!empty($postData['cutting_cost'])){
                $insertData['cutting_cost']=$postData['cutting_cost'];
             }
             
             if(!empty($postData['labour_cost'])){
                $insertData['labour_cost']=$postData['labour_cost'];
             }
             
             if(!empty($postData['other_cost'])){
                $insertData['other_cost']=$postData['other_cost'];
             }
