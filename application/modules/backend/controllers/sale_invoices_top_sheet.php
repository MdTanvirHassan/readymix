...
class Sale_invoices_top_sheet extends Site_Controller {
    ...
    function index($cust_id=false){
        ...
        $this->menu = 'sales';
        $this->sub_menu = 'sale';
        $this->sub_inner_menu = 'sale_invoice_top_sheet';
        ...
        if(!empty($cust_id)){        
          $sql = "select v.*,o.order_no,c.c_name,c.c_short_name,c.id as customer_id from tbl_invoice_top_sheet v left join tbl_sales_orders o on v.so_id=o.o_id left join tbl_customers c on v.customer_id=c.id where v.is_active=1  and v.customer_id=".$cust_id;
          $data['invoices'] = $this->m_common->customeQuery($sql);
       }else{

           $sql = "select v.*,o.order_no,c.c_name,c.c_short_name,c.id as customer_id from tbl_invoice_top_sheet v left join tbl_sales_orders o on v.so_id=o.o_id left join tbl_customers c on v.customer_id=c.id";        
           $data['invoices'] = $this->m_common->customeQuery($sql);
       }
       $data['customer_id']=$cust_id;
        ...
        $this->load->view('sale_invoices_top_sheet/v_sale_invoice', $data);
    }
    ...
    function add_sale_invoice() {
        ...
        $this->load->view('sale_invoices_top_sheet/v_add_sale_invoice', $data);
