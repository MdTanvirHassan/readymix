...
class Drivers extends Site_Controller {
    ...
    function add_driver() {
        ...
        $this->load->view('driver/v_add_driver');
    }
         ...
         if(!empty($postData)){
            ...
            if(!empty($postData['blood_group'])){
             ...
             if(!empty($result)){
                  ...
                  redirect_with_msg('drivers', 'Successfully Inserted');
             }
         }else{
              redirect_with_msg('drivers/add_driver', 'Please fill the form and submit');
         }
    ...
    function edit_driver($id) {
        ...
        $this->load->view('driver/v_edit_driver',$data);
    }
    ...
    function edit_driver_action($id) {
         ...
         if(!empty($postData)){
            ...
            if(!empty($postData['blood_group'])){
             ...
             if($result>=0){              
                  redirect_with_msg('drivers', 'Successfully Updated');
             }
         }else{
              redirect_with_msg('drivers', 'Please fill the form and submit');
         }
    ...
    function details_driver($id,$print=false) {
        ...
        $data['driver_info']=$this->m_common->get_row_array('tbl_driver',array('driver_id'=>$id),'*');      
        $this->load->view('driver/v_details_driver',$data);
    ...
    function delete_driver($id) {
        ...
        if(!empty($id)) {
            ...
            if(!empty($id)) {
                redirect_with_msg('drivers/index', 'Successfully Deleted');
            } else {
                redirect_with_msg('drivers/index', 'Data not deleted for an unexpected error');
            }
        } else {
            redirect_with_msg('drivers/index', 'Please click on delete button');
        }
    }
