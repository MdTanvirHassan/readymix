    ...
    //    $sql = "select pc.*,c.c_name,c_short_name,b.b_name,b.b_short_name,b.branch_name from tbl_payment_collections pc left join tbl_banks b on pc.bank_id=b.id  left join tbl_customers c on pc.customer_id=c.id  where pc.is_active=1 and pc.payment_status='Collected' and (collection_method='Pdc' or collection_method='Lc' or collection_method='Bg' or collection_method='Po') ";
        ...
        if(!empty($postData)){
            ...
            if (!empty($customer_id)) {
             ...
             if(!empty($f_date) & !empty($to_date)){              
                $sql="select pc.*,c.c_name,c_short_name,b.b_name,b.b_short_name,b.branch_name,tpc.category_name from tbl_payment_collections pc left join tbl_banks b on pc.bank_id=b.id  left join tbl_customers c on pc.customer_id=c.id left join tbl_product_categories tpc on pc.payment_for_id=tpc.category_id where $where and pc.check_date>='" . $f_date . "' and pc.check_date<='" . $to_date . "' and (pc.payment_status!='Received' and pc.payment_status!='Returned') and (collection_method='Pdc' or collection_method='Lc' or collection_method='Bg' or collection_method='Po') order by pc.check_date ASC,pc.bg_issue_date ASC";
             }else if (!empty($f_date)) {              
                $sql="select pc.*,c.c_name,c_short_name,b.b_name,b.b_short_name,b.branch_name,tpc.category_name from tbl_payment_collections pc left join tbl_banks b on pc.bank_id=b.id  left join tbl_customers c on pc.customer_id=c.id left join tbl_product_categories tpc on pc.payment_for_id=tpc.category_id where $where and pc.check_date>='" . $f_date . "' and (pc.payment_status!='Received' and pc.payment_status!='Returned') and (collection_method='Pdc' or collection_method='Lc' or collection_method='Bg' or collection_method='Po') order by pc.check_date ASC,pc.bg_issue_date ASC";
             }else if (!empty($to_date)) {               
                $sql="select pc.*,c.c_name,c_short_name,b.b_name,b.b_short_name,b.branch_name,tpc.category_name from tbl_payment_collections pc left join tbl_banks b on pc.bank_id=b.id  left join tbl_customers c on pc.customer_id=c.id left join tbl_product_categories tpc on pc.payment_for_id=tpc.category_id where $where and pc.check_date<='" . $to_date . "' and (pc.payment_status!='Received' and pc.payment_status!='Returned') and (collection_method='Pdc' or collection_method='Lc' or collection_method='Bg' or collection_method='Po') order by pc.check_date ASC,pc.bg_issue_date ASC";
             }else{                
                $sql="select pc.*,c.c_name,c_short_name,b.b_name,b.b_short_name,b.branch_name,tpc.category_name from tbl_payment_collections pc left join tbl_banks b on pc.bank_id=b.id  left join tbl_customers c on pc.customer_id=c.id left join tbl_product_categories tpc on pc.payment_for_id=tpc.category_id where $where and (pc.payment_status!='Received' and pc.payment_status!='Returned') and (collection_method='Pdc' or collection_method='Lc' or collection_method='Bg' or collection_method='Po') order pc.check_date ASC,pc.bg_issue_date ASC";
             }   
        }else{
