    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_content">
    <form class="form-horizontal" action="<?php echo site_url('bank/edit_bank_action/'.$bank_info[0]['id']); ?>" method="post" onsubmit="javascript: return validation()">
        <div class='form-group' >
            ...
            <div class="col-sm-4 input-group">
                ...
                <select  class="form-control" name="b_identification" id="bank_type">
                    ...
                    <option <?php if(!empty($bank_info[0]['b_identification'] =='Supplier')) echo 'selected';  ?> value="Supplier">Supplier</option>
                </select>
