...
<div class="row">
                                           ...
                                           <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                            <select  id="order_from" class="form-control e1" name="order_from">
                                                  ...
                                                  <!--  <option  value="Direct">Direct</option>-->
                                                    <option  value="Budget">Credit</option>
                    ...
                    <input type="hidden" value="1" id="count" />
                     ...
                     <table class="table table-bordered" id="myTable">
                             <thead class="thead-color">
                                 ...
                                 <th  style="text-align: center;" >M.Unit</th>
                                 <th  style="text-align: center;" >Budget Qty</th>
                                 <th  style="text-align: center;">P. Qty<sup style='color:red'>*</sup></th>
       ...
       <div class="separator-shadow row"></div>
        ...
        <div id="specification_raw_material">
            <div class="row">
                  <?php 
                    $total_condition=count($purchase_condition);
                ?>
                ...
                <table class="table table-bordered" id="specificationTable">
                    ...
                    <tbody id="material_specification">
                      ...
                      if($total_condition>0){ 
                            $j=0;
                           foreach($purchase_condition as $con){
                               $j++;
                          ?>  
                        
                            <tr  id="term_row_<?php echo $j; ?>">
                                <td><input required style="width:200px"   type="text"  name="t_or_c_name[]"  class="issue form-control" value="<?php echo $con['name']; ?>"></td>
                                <td>
                                   
                                    <textarea required style="width:700px"  name="t_or_c_description[]" class="issue form-control"><?php echo $con['description']; ?></textarea>
                                </td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="col-md-12 M-row">
                        ...
                        <table id="datatable" class="table table-bordered dataTable no-footer"  style="margin-top:75px;">
                            <thead class="thead-color">
                                <tr>
                                    <th style="vertical-align: middle;text-align: center">Indent Date</th>
                                    <th style="vertical-align: middle;text-align: center">Indent No.</th>
                            ...
                            <tbody id="item">
                                ...
                                foreach($item_list as $item){ 
                                    $remain_qty=$item['budget_qty']-($item['direct_p_order_qty']+$item['mon_indent_qnt']);
                                   
                                    $total_price=$item['unit_price']*$remain_qty;
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <input id="indent_no_de_<?php echo $i; ?>" type="hidden"  class="issue" value="<?php echo $item['indent_no']; ?>">
                                            <input id="bu_de_id_<?php echo $i; ?>" type="hidden"  class="issue" value="<?php echo $item['bu_d_id']; ?>">
                                            <input id="indent_de_id_<?php echo $i; ?>" type="hidden"  class="issue" value="<?php echo $item['indent_d_id']; ?>">
                                            <input id="item_de_id_<?php echo $i; ?>" type="hidden"  class="issue" value="<?php echo $item['item_id']; ?>">
                                            <input id="brand_de_id_<?php echo $i; ?>" type="hidden"  class="issue" value="<?php echo $item['brand_id']; ?>">
                                            <input id="item_name_de_id_<?php echo $i; ?>" type="hidden"  class="issue" value="<?php echo $item['item_name']; ?>">
                                            <input id="meas_unit_de_id_<?php echo $i; ?>" type="hidden"  class="issue" value="<?php echo $item['meas_unit']; ?>">
                                            <input id="budget_qty_de_id_<?php echo $i; ?>" type="hidden"  class="issue" value="<?php echo $remain_qty; ?>">
                                            <input id="unit_price_de_id_<?php echo $i; ?>" type="hidden"  class="issue" value="<?php echo $item['unit_price']; ?>">
                                            <input id="total_price_id_<?php echo $i; ?>" type="hidden"  class="issue" value="<?php echo $total_price; ?>">
                                            
                                            
                                            <?php echo date('d-m-Y',strtotime($item['indent_date'])); ?>
                                        </td>
                                        <td><?php echo $item['indent_no']; ?></td>
                                        <td><?php echo $item['item_name']; ?></td>
                                        <td><?php echo $item['meas_unit']; ?></td>
                                        <td><input id="select_" onclick="addItem(<?php echo $i; ?>)" style="text-align:center;" type="checkbox" /></td>
                                    </tr>
                                <?php } ?>
...
<script type="text/javascript">
    ...
    function addItem(id) {
       ...
       // $('#select_' + item_id).prop('checked', true);
        var bu_d_id=$('#bu_de_id_'+id).val();
        var indent_d_id=$('#indent_de_id_'+id).val();
        var item_id=$('#item_de_id_'+id).val();
        var brand_id=$('#brand_de_id_'+id).val();
        var item_name=$('#item_name_de_id_'+id).val();
        var meas_unit=$('#meas_unit_de_id_'+id).val();
        var remain_qty=$('#budget_qty_de_id_'+id).val();
        var unit_price=$('#unit_price_de_id_'+id).val();
        var n_remain_price=$('#total_price_id_'+id).val();
        var indent_no=$('#indent_no_de_'+id).val();
       // var test="test";
       ...
       // alert(meas_unit);
        ...
        str +='<td><button type="Button" style="padding-left:6px;padding-right:6px;font-size:8px;" id="button4" onclick="removeRow(' +count+ ')" class="btn btn-danger pull-left"><span class="glyphicon glyphicon-minus"></span></button></td>';
        str +='<td><input type="hidden" name="bu_d_id[]"  value="'+bu_d_id+'" ><input type="hidden" name="indent_d_id[]"  value="'+indent_d_id+'" ><input readonly  style="width:100%;"  type="text"  name="indent_no[]" id="indent_no_'+count+ '" class="issue form-control" value="'+indent_no+'"></td>';
        str +='<td>';
        str +='<input type="hidden"  name="item_id[]" id="item_id_" class="issue" value="'+item_id+'">';
        str +='<input type="hidden"  name="brand_id[]" id="brand_id_" class="issue" value="'+brand_id+'">';
        str +='<textarea readonly class="form-control" style="width:100%;"  name="name[]">'+item_name+'</textarea>';
        str +='</td>';
        str +='<td><input readonly style="width:100%;"  type="text"  name="m_unit[]" id="description_'+count+ '" class="issue form-control" value="'+meas_unit+'"></td>';
        str +='<td><input readonly style="width:100%;"  type="text"  name="budget_qnty[]" id="budget_qnty_'+count+ '" class="issue form-control" value="'+remain_qty+'"></td>';
        str +='<td><input  onkeyup="calculateSubtotal('+count+')" onchange="calculateSubtotal('+count+')" onblur="calculateSubtotal('+count+')"  style="width:100%;text-align:right;"  type="text"  name="quantity[]" id="quantity_'+count+'" class="issue number form-control" value="'+remain_qty+'"></td>';
        str +='<td><input  onkeyup="calculateSubtotal('+count+')" onchange="calculateSubtotal('+count+')" onblur="calculateSubtotal('+count+')"  style="width:100%;text-align:right;"  type="text"  name="unit_price[]" id="unit_price_'+count+'" class="issue number form-control" value="'+unit_price+'"></td>';
        str +='<td><input readonly  style="width:100%;text-align:right;"  type="text" class="form-control amount_"  name="amount[]" id="amount_'+count+'" class="issue" value="'+n_remain_price+'"></td>'; 
        str +='<td><textarea class="form-control" style="width:100%;"  name="remark[]">'+''+'</textarea></td>';
        str +='<td style="text-align: center;"><input checked type="checkbox" name="select_item[]" onclick="calculateSubtotal('+count+')"  id="select_item_' +count+ '" class="select_item_' +count+'" value="'+count+'" ></td>';
        str+='</tr>';
