        ...
        <div style="text-align: right">
            ...
            <table class="table" id="">
                <tr>
                 ...
                 <tr>
                   <td style="width:200px;border-top:0px;padding:0px;">Date:&nbsp;<?php echo date("d-m-Y",strtotime($purchase_order_info[0]['purchase_order_date'])); ?></td>
                   <td style="border-top:0px;padding-left:0px;"></td>
                </tr> 
                <tr>
              ...
              <br/>
                ...
                <table class="table" id="myTable1">
                    ...
                    <?php $j=0; foreach($copy_to as $copy){ 
                        ...
                        ?>
                        <tr>
                            <td style="width:200px;border-top:0px;padding:5px;"><?php echo $j.'. '. $copy['name'];  ?></td>
                            <td style="border-top:0px;padding:0px;"></td>
                        </tr>
                 <?php } ?>
                </table>   
