                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <?php foreach($payment_modes as $modes){ ?>
                                            <label class="radio-inline"><input type="radio" <?php if($modes['id']==$payment_info[0]['pm_id']) echo 'checked'; ?> name="pm_id" value="<?php echo $modes['id']; ?>"><?php echo $modes['mode_name']; ?></label>
                                        <?php } ?>    
                                    ...
                                    <div class="col-md-6">
                                     ...
                                     <?php foreach($payment_securities as $security){ ?>
                                        <label class="radio-inline"><input type="radio" <?php if($security['id']==$security_info[0]['security_id']) echo 'checked'; ?> name="security_id" value="<?php echo $security['id']; ?>"><?php echo $security['security_name']; ?></label>
                                    <?php } ?> 
