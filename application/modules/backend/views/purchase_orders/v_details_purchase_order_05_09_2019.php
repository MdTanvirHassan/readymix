                        ...
                        <div class="row" style="margin-left:0px;">   
                            <div class='form-group' >
                                ...
                                <div class="col-sm-6 input-group">
                                    ...
                                    <b><?php if($quotation['q_id']==$purchase_order_info[0]['q_id']) echo $quotation['reference_no'].'('.$quotation['dep_description'].')('.$quotation['SUP_NAME'].')'; ?></b>
                                                <?php } ?>
                            ...
                            <tbody id="purchase_items">
                               ...
                               <tfoot>
                                    <tr>
                                        ...
                                        <td colspan="3" style="text-align: right;"><b><?php if(!empty($purchase_order_info[0]['total_amount'])) echo $purchase_order_info[0]['total_amount']; ?></b></td>
                                    </tr>
                                </tfoot>
                          </table>
