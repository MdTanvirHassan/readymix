...
<div id="header">
  ...
  <div style="width:100%;">
    <div style="width:56%;float:left"><b>INV. NO : <?php echo ucfirst($sale_invoice_info[0]['inv_no']); ?></b><br><br>
      S.O. No.: <?php if(!empty($sale_invoice_info[0]['c_order_no'])) echo ucfirst($sale_invoice_info[0]['c_order_no']);else echo ucfirst($sale_invoice_info[0]['order_no']);  ?><br>
        ...
        <div class="page-content">
          ...
          <table id="maintable" class="table table-bordered table-hover table-striped" style="width:100%;text-align: center;margin-bottom: 10px;">
            ...
            <tr style="border-bottom:2px solid#000">
              ...
              <th style="text-align:right;vertical-align: middle;">BASE VALUE</th>
              <th style="text-align:right;vertical-align: middle;">VAT</th>
            ...
            ?>
              <tr>
                ...
                <td style="text-align:right;">
                   <?php echo number_format($total_base_price, 2); ?>
                </td>
            ...
            <tr style="border-top:2px solid#000">
              ...
              <td style="text-align:right"><?php echo number_format($net_total_base_price, 2); ?> <br> </td>
              <td style="text-align:right"><?php echo number_format($net_total_vat, 2); ?> <br> </td>
            ...
            <tr style="">
              <td colspan="6" style="text-align:left;margin-top: 20px"><b>Taka In Words = <?php $taka_in_word = convert_number_to_words(round($total_value, 2));
