    ...
    <p style=" text-align: center;text-decoration: underline;margin-top:-7px;">SALES INVOICE</p>
       ...
       <table class="table table-bordered table-hover table-striped" style="margin:0 auto;">
            <tr>
               ...
               <td colspan="3" style="text-align:left;">Date: <?php  echo date('d-m-Y',strtotime($sale_invoice_info[0]['sale_invoice_date'])); ?></td>
           </tr>
           <tr>
               <td colspan="4" style="text-align:left;">S.O. No.: <?php echo ucfirst($sale_invoice_info[0]['order_no']); ?></td>
               <td colspan="3" style="text-align:left;width:200px;">Date: <?php  echo date('d-m-Y',strtotime($sale_invoice_info[0]['sale_order_date'])); ?></td>
           </tr>
           <tr>
               <td colspan="4" style="text-align:left;">Customer Name: <?php echo ucfirst($sale_invoice_info[0]['c_name']); ?></td>
               <td colspan="3" style="text-align:left;width:200px;">Project Name: <?php  echo $sale_invoice_info[0]['project_name']; ?></td>
           </tr>
           <tr>
               <td colspan="4" style="text-align:left;">Customer Address: <?php echo ucfirst($sale_invoice_info[0]['billing_address']); ?></td>
               <td colspan="3" style="text-align:left;width:200px;">Project Address: <?php  echo $sale_invoice_info[0]['shipping_address']; ?></td>
           </tr>
           <!--
          ...
          -->
           ...
           <tr><td colspan="7"></td></tr>
                <tr id="row_1">
                        ...
                        <th style="border-left:1px solid;border-top:1px solid;border-right:1px solid;width:200px;" rowspan="2" style="width:100px;">VALUE</th>
               ...
               <?php $i=0; foreach($sale_invoice_details_info as $sale_invoice_details){ $i++;
                         $cub_m=0;
                         $cub_m=round($sale_invoice_details['quantity']/35.315,2);
                     ...
                     ?>
                           ...
                           <tr id="row_1">
                            ...
                            <td style="border-left:1px solid;border-top:1px solid;text-align:center;"><?php echo $cub_m;  ?></td>
                            ...
                            <td style="border-left:1px solid;border-top:1px solid;text-align:right;"><?php if(!empty($sale_invoice_details['unit_price'])) echo $sale_invoice_details['unit_price'];  ?></td>
