        ...
        <div class="row">
            <div class="col-md-6">
                    ...
                    <div class="col-sm-8 col-md-5 ">
                        <select disabled id="do_id" class="form-control" name="do_id">
             ...
             <div class="col-md-6">
                <div class="form-group row">
                    ...
                    <div class="col-sm-8 col-md-5 ">
                         ...
                         <input disabled required class="form-control" id="inv_no" name="inv_no" type="text" value="<?php if(!empty($sale_invoice_info[0]['inv_no'])) echo $sale_invoice_info[0]['inv_no']; ?>">
                    </div>
                </div>
            </div>
         ...
         <div class="row">
            <div class="col-md-6">
                <div class="form-group row">
                    ...
                    <div class="col-sm-8 col-md-5 "><input disabled class="form-control datepicker" name="sale_invoice_date" type="text" value="<?php if(!empty($sale_invoice_info[0]['sale_invoice_date'])) echo date('d-m-Y',strtotime($sale_invoice_info[0]['sale_invoice_date'])); ?>"></div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group row">
                    <div class="col-sm-4 col-md-3   labeltext" style="text-align: right;"><label for="inputdefault">Attention :</label></div>
                    <div class="col-sm-8 col-md-5 "><input disabled id="attention" class="form-control" name="attention" type="text" value="<?php if(!empty($sale_invoice_info[0]['attention'])) echo $sale_invoice_info[0]['attention']; ?>"></div>
                </div>
            </div>
         ...
         <div class="row">
            <div class="col-md-6">
                <div class="form-group row">
                    ...
                    <div class="col-sm-8 col-md-5 "><input disabled id="project_name" class="form-control" name="project_name" type="text" value="<?php if(!empty($sale_invoice_info[0]['project_name'])) echo $sale_invoice_info[0]['project_name']; ?>"></div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group row">
                    ...
                    <div class="col-sm-8 col-md-5 "><input disabled class="form-control" id="phone" name="phone" type="text" value="<?php if(!empty($sale_invoice_info[0]['phone'])) echo $sale_invoice_info[0]['phone']; ?>"></div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group row">
                    ...
                    <div class="col-sm-8 col-md-5 "><input disabled id="billing_address" class="form-control" name="billing_address" type="text" value="<?php if(!empty($sale_invoice_info[0]['billing_address'])) echo $sale_invoice_info[0]['billing_address']; ?>"></div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group row">
                    <div class="col-sm-4 col-md-3   labeltext" style="text-align: right;"><label for="inputdefault">Billing Email :</label></div>
                    <div class="col-sm-8 col-md-5 "><input disabled class="form-control" id="billing_email" name="billing_email" type="text" value="<?php if(!empty($sale_invoice_info[0]['billing_email'])) echo $sale_invoice_info[0]['billing_email']; ?>"></div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group row">
                    ...
                    <div class="col-sm-8 col-md-5 "><input disabled class="form-control" id="shipping_address" name="shipping_address" type="text" value="<?php if(!empty($sale_invoice_info[0]['shipping_address'])) echo $sale_invoice_info[0]['shipping_address']; ?>"></div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group row">
                    <div class="col-sm-4 col-md-3   labeltext" style="text-align: right;"><label for="inputdefault">Delivery Email :</label></div>
                    <div class="col-sm-8 col-md-5 "><input disabled class="form-control" id="shipping_email" name="shipping_email" type="text" value="<?php if(!empty($sale_invoice_info[0]['shipping_email'])) echo $sale_invoice_info[0]['shipping_email']; ?>"></div>
                </div>
            </div>
                ...
                <table class="table table-bordered" >
                    ...
                    <tbody id="sale_items">
                         ...
                         <tr class="" id="row_<?php echo $i; ?>">
                             ...
                             <td><input disabled  style="width:140px;"  type="text"  name="unit_price[]" id="unit_price_<?php echo $i; ?>" class="issue" value="<?php echo $sale_invoice_details['unit_price'] ?>"></td>
                             <td><input disabled  style="width:140px;"  type="text"  name="quantity[]" id="quantity_<?php echo $i; ?>" class="issue" value="<?php echo $sale_invoice_details['quantity'] ?>"></td>
                             <td><input disabled  style="width:140px;"  type="text" class="amount_<?php echo $i; ?>"  name="amount[]" id="amount_<?php echo $i; ?>" class="issue" value="<?php echo $sale_invoice_details['amount'] ?>"></td>
                       ...
                       <tfoot>
                            <tr>
                                ...
                                <td><input disabled style="width:140px;" id="sub_total"  name="total_amount" type="text" value="<?php if(!empty($sale_invoice_info[0]['total_amount'])) echo $sale_invoice_info[0]['total_amount']; ?>"></td>
                            </tr>
                        </tfoot>
                  </table>
