                ...
                <div class="x_panel">
                    <div class="x_content">
                        ...
                        <div id="remover" class="col-md-6 col-md-offset-3">
                            <form id="item-form" autocomplete="off" action="<?php site_url('backend/sales_invoice/index'); ?>" method="post">
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div style="margin-top: 15px;" class="col-md-10 col-md-offset-1">
                                    <input type="text" class="form-control datepicker" name="from_date" value="<?php if(!empty($from_date)) echo date('d-m-Y',strtotime($from_date));  ?>" placeholder="from date" />
                                 </div>

                                 <div style="margin-top: 15px;" class="col-md-10 col-md-offset-1">
                                    <input type="text" class="form-control datepicker" name="to_date" value="<?php if(!empty($to_date)) echo date('d-m-Y',strtotime($to_date));  ?>" placeholder="to date" />
                                 </div>
...
<!--                                    <input style="padding: 6px 40px;" type="submit" class="btn btn-primary" value="SEARCH"/>
                        ...
                        <?php if (in_array(2, $this->role)) { ?>
                            ...
                            <a href="<?php echo site_url('sale_invoices/add_direct_sale_invoice'); ?>" class="btn btn-sm btn-primary">ADD PREVIOUS INVOICE</a>
                             <a href="<?php echo site_url('sale_invoices/add_pump_bill'); ?>" class="btn btn-sm btn-primary">ADD PUMP BILL</a>
                        <?php } ?>    
                                                ...
                                                <?php if ($invoice['status']) { ?>
                                                    <?php if (in_array(3, $this->role)) { ?>
                                                        ...
                                                        <?php } ?>
                                                          ...
                                                          <?php }else if($invoice['invoice_type']=="Pump"){ ?>
                                                             <a href="<?php echo site_url('sale_invoices/edit_pump_bill/' . $invoice['inv_id']); ?>"><button class="btn btn-sm btn-info">Edit</button></a>
                                                          <?php }else{ ?>   
                                                          ...
                                                          <?php if($invoice['status']!=='Canceled'){ ?>
                                                                <?php 
                                                                  if(!empty($customer_id)){ ?>
                                                                      <button onclick="cancel_invoice('<?php echo site_url('sale_invoices/cancelInvoice/' . $invoice['inv_id']."/".$customer_id); ?>')" class="btn btn-sm" style="background-color: yellow;color:black">Cancel</button> 
                                                                <?php }else{ ?> 
                                                                       <button onclick="cancel_invoice('<?php echo site_url('sale_invoices/cancelInvoice/'.$invoice['inv_id']); ?>')" class="btn btn-sm" style="background-color: yellow;color:black">Cancel</button> 
                                                                <?php } ?>      
                                                           <?php } ?>        
                                                    <?php } ?>        
