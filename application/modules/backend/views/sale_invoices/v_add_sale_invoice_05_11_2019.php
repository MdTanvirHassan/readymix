                ...
                success: function (msg) {
                    ...
                    if(msg.item_list!=''){
                        $(msg.item_list).each(function (i, v) {
                            ...
                            str += '<td><input readonly onkeyup="" onchange="" onblur=""  style="width:140px;text-align: right;"  type="text"  name="quantity[]" id="quantity_' + (Number(i) + 1) + '" class="issue" value="' + v.quantity + '"></td>';
