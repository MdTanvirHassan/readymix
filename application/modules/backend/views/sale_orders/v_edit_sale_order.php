                ...
                <label for="title" class="col-sm-2 control-label">
                        ...
                        <span id="q_id_error" style="color:red"></span>
                            ...
                            <div class='form-group'>
                                <label for="title" class="col-sm-2 control-label">
                                    Customer Order No<sup class="required">*</sup> :
                                </label>
                                <div class="col-sm-4 input-group">
                                    <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                    <input  class="form-control"  id="c_order_no" name="c_order_no" type="text" value="<?php if(!empty($sale_order_info[0]['c_order_no'])) echo $sale_order_info[0]['c_order_no']; ?>">
                                </div>
                ...
                <table class="table table-bordered" id="myTable" >
                    ...
                    <tbody id="sale_items">
                         ...
                         <tr class="" id="row_<?php echo $i; ?>">
                            ...
                            <td><input required  style="width:50px;"  type="text" class=""  name="mu_name[]" id="item_amount_<?php echo $i; ?>" class="issue" value="<?php echo $sale_order_details['mu_name'] ?>"></td>
                            
                            <td><input onkeyup="calculateSubtotal(<?php echo $i; ?>)" onchange="calculateSubtotal(<?php echo $i; ?>)" onblur="calculateSubtotal(<?php echo $i; ?>)"   style="width:80px;text-align: right;"  type="text"  name="quantity[]" id="quantity_<?php echo $i; ?>" class="issue number" value="<?php echo $sale_order_details['quantity'] ?>"></td>
                            
                            <td><input onkeyup="calculateUnitPrice(<?php echo $i; ?>)" onchange="calculateUnitPrice(<?php echo $i; ?>)" onblur="calculateUnitPrice(<?php echo $i; ?>)"  style="width:70px;text-align: right;"  type="text"  name="base_price[]" id="base_price_<?php echo $i; ?>" class="issue number" value="<?php echo $sale_order_details['base_price'] ?>"></td> 
                            <td><input onkeyup="calculateUnitPrice(<?php echo $i; ?>)" onchange="calculateUnitPrice(<?php echo $i; ?>)" onblur="calculateUnitPrice(<?php echo $i; ?>)"  style="width:50px;text-align: right;"  type="text"  name="vat[]" id="vat_<?php echo $i; ?>" class="issue number" value="<?php echo $sale_order_details['vat'] ?>"></td> 
                            
                            <td><input onkeyup="calculateSubtotal(<?php echo $i; ?>)" onchange="calculateSubtotal(<?php echo $i; ?>)" onblur="calculateSubtotal(<?php echo $i; ?>)"  style="width:70px;text-align: right;"  type="text"  name="unit_price[]" id="unit_price_<?php echo $i; ?>" class="issue number" value="<?php echo $sale_order_details['unit_price'] ?>"></td>    
                            ...
                            <?php if(!empty($this->role) &&  !in_array(11,$this->role)){  ?>
                            <td><input  style="width:70px;text-align: right;"  type="text" class=""  name="commission[]" id="commission_<?php echo $i; ?>" class="issue" value="<?php echo $sale_order_details['commission'] ?>"></td>
                            <?php } ?>
...
var i = $('#sale_items').find('tr').length;
                             ...
                             str +='<td><input required  style="width:50px;"  type="text"  name="mu_name[]" id="mu_name_'+(Number(i) + 1) + '" class="issue" value=""></td>';
                             str +='<td><input required onkeyup="calculateSubtotal('+(Number(i) + 1)+')" onchange="calculateSubtotal('+(Number(i) + 1)+')" onblur="calculateSubtotal('+(Number(i) + 1)+')"  style="width:80px;text-align:right;"  type="text"  name="quantity[]" id="quantity_'+(Number(i) + 1)+'" class="issue number" value=""></td>';
                             
                             str += '<td><input  onkeyup="calculateUnitPrice(' + (Number(i) + 1) + ')" onchange="calculateUnitPrice(' + (Number(i) + 1) + ')" onblur="calculateUnitPrice(' + (Number(i) + 1) + ')"  style="width:70px;text-align:right;"  type="text"  name="base_price[]" id="base_price_' + (Number(i) + 1) + '" class="issue number" value=""></td>';
                             str += '<td><input  onkeyup="calculateUnitPrice(' + (Number(i) + 1) + ')" onchange="calculateUnitPrice(' + (Number(i) + 1) + ')" onblur="calculateUnitPrice(' + (Number(i) + 1) + ')"  style="width:50px;text-align:right;"  type="text"  name="vat[]" id="vat_' + (Number(i) + 1) + '" class="issue number" value=""></td>';
                             
                             str +='<td><input required onkeyup="calculateSubtotal('+(Number(i) + 1)+')" onchange="calculateSubtotal('+(Number(i) + 1)+')" onblur="calculateSubtotal('+(Number(i) + 1)+')"  style="width:70px;text-align:right;"  type="text"  name="unit_price[]" id="unit_price_'+(Number(i) + 1)+'" class="issue number" value=""></td>';
                             ...
                             <?php if(!empty($this->role) && !in_array(11,$this->role)){  ?>
                             str +='<td><input style="width:70px;text-align:right;"  type="text" class="commission_"  name="commission[]" id="commission_'+(Number(i) + 1)+'" class="issue" value=""></td>'; 
                             <?php } ?>
                       ...
                       if(msg.quotation_payment_info[0].a_pdc=='Pdc'){
                        ...
                        var total=0;
                         $(msg.item_list).each(function (i, v) {       
                             ...
                             str +='<td><input required  style="width:50px;"  type="text"  name="mu_name[]" id="mu_name_'+(Number(i) + 1) + '" class="issue" value="'+v.mu_name+'"></td>';
                             str +='<td><input required onkeyup="calculateSubtotal('+(Number(i) + 1)+')" onchange="calculateSubtotal('+(Number(i) + 1)+')" onblur="calculateSubtotal('+(Number(i) + 1)+')"  style="width:80px;text-align:right;"  type="text"  name="quantity[]" id="quantity_'+(Number(i) + 1)+'" class="issue number" value="'+v.quantity+'"></td>';
                             str += '<td><input  onkeyup="calculateUnitPrice(' + (Number(i) + 1) + ')" onchange="calculateUnitPrice(' + (Number(i) + 1) + ')" onblur="calculateUnitPrice(' + (Number(i) + 1) + ')"  style="width:70px;text-align:right;"  type="text"  name="base_price[]" id="base_price_' + (Number(i) + 1) + '" class="issue number" value="' + v.base_price + '"></td>';
                        str += '<td><input  onkeyup="calculateUnitPrice(' + (Number(i) + 1) + ')" onchange="calculateUnitPrice(' + (Number(i) + 1) + ')" onblur="calculateUnitPrice(' + (Number(i) + 1) + ')"  style="width:50px;text-align:right;"  type="text"  name="vat[]" id="vat_' + (Number(i) + 1) + '" class="issue number" value="' + v.vat + '"></td>';
                             str +='<td><input required onkeyup="calculateSubtotal('+(Number(i) + 1)+')" onchange="calculateSubtotal('+(Number(i) + 1)+')" onblur="calculateSubtotal('+(Number(i) + 1)+')"  style="width:70px;text-align:right;"  type="text"  name="unit_price[]" id="unit_price_'+(Number(i) + 1)+'" class="issue number" value="'+v.unit_price+'"></td>';
                             ...
                             <?php if(!empty($this->role) && !in_array(11,$this->role)){  ?>
                             str +='<td><input style="width:70px;text-align:right;"  type="text" class="commission_"  name="commission[]" id="commission_'+(Number(i) + 1)+'" class="issue" value="'+v.commission+'"></td>'; 
                             <?php } ?>
