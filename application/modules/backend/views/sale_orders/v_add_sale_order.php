                    ...
                    <div class="x_content">
                        <form class="form-horizontal" action="<?php echo site_url('sale_orders/add_sale_order_action'); ?>" method="post" onsubmit="javascript: return validation()">
                            ...
                            <div class='form-group'>
                                ...
                                <div class="col-sm-4 input-group">
                                    <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                    <input  class="form-control"  id="c_order_no" name="c_order_no" type="text" value="">
                                </div>
...
<script type="text/javascript">
    ...
    function addRow() {
        ...
        <?php if (!empty($this->role) && !in_array(11, $this->role)) {  ?>
            str += '<td><input style="width:70px;text-align:right;"  type="text" class="commission_' + (Number(i) + 1) + '"  name="commission[]" id="commission_' + (Number(i) + 1) + '" class="issue" value=""></td>';
        <?php } ?>
            ...
            $.ajax({
                ...
                success: function(msg) {
                    ...
                    $(msg.item_list).each(function(i, v) {
                        ...
                        <?php if (!empty($this->role) && !in_array(11, $this->role)) {  ?>
                            str += '<td><input style="width:70px;text-align:right;"  type="text" class="commission_' + (Number(i) + 1) + '"  name="commission[]" id="commission_' + (Number(i) + 1) + '" class="issue" value="' + v.commission + '"></td>';
                        <?php } ?>
