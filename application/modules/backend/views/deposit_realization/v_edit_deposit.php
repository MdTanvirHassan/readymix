            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_content">
                        ...
                        <form class="form-horizontal"action="<?php echo site_url('deposit_realization/edit_deposit_action/' . $deposit_info[0]['id']); ?>" method="post">
                             ...
                             <div class='form-group' >
                                ...
                                <div class="col-sm-4 input-group">
                                    ...
                                    <select  class="form-control" name="priority">
                                        ...
                                        <option <?php if($deposit_info[0]['priority']=="Low Value") echo 'selected'; ?> class="form-control" value="Low Value">Low Value</option>
                                        <option <?php if($deposit_info[0]['priority']=="High Value") echo 'selected'; ?> class="form-control" value="High Value">High Value</option>
                                        <option <?php if($deposit_info[0]['priority']=="Transfer") echo 'selected'; ?> class="form-control" value="Transfer">Transfer</option>
