<div class="right_col" style="background-color: #f1f1f1;padding-bottom:20px;">
     ...
     <div class="">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_content">
                        ...
                        <form class="form-horizontal" action="<?php echo site_url('deposit_realization/add_deposit_action'); ?>" method="post">
        ...
        <div class="form-group" style="margin-top: 40px;">
                                <div class="col-sm-2">
                                    <a href="<?php echo site_url('backend/deposit_realization') ?>" > <button type="button" class="btn btn-success button" style="padding:6px 4px;">GO BACK</button> </a>
                                </div>
    ...
    $('#allselect').click(function(){
     ...
     function collection_info(){
            ...
            if(customer_id!=''){
                $.ajax({
                    type: "POST",
                    url: "backend/deposit_realization/collection_info",
                            ...
                            if(data.collections!=''){
                                $(data.collections).each(function (i,v) {
                                    ...
                                    if(v.collection_method=='Pdc'){
                                        if(v.bank_deposit_date!=null){
                                            str += '<td>'+v.bank_deposit_date+'</td>';
                                        }else{
                                    ...
                                    str +='<td>';
                                    str +='<select  class="form-control" name="priority[]">';
                                    str +='<option  class="form-control" value="Low Value">Low Value</option>';
                                    str +='<option  class="form-control" value="High Value">High Value</option>';
                                    str +='<option  class="form-control" value="Transfer">Transfer</option>';
                                    str +='</td>';
