<div class="right_col" style="background-color: #f1f1f1;padding-bottom:20px;">
    ...
    <hr>
    <form action="<?php echo site_url('deposit_realization/add_deposit_action'); ?>" method="post">
        <div class="row">
            <div class="col-md-6">
                    ...
                    <div class="col-sm-8 col-md-5 ">
                        <select id="collection_id" class="form-control" name="collection_id">
                            ...
                            <?php foreach($collections as $collection){ ?>
                                <option class="form-control" value="<?php echo $collection['id'] ?>"><?php echo $collection['collection_method'].'('.$collection['no'].')' ?></option>
                            <?php } ?>
                       </select>
                    </div>
                </div>
             ...
             <div class="col-md-6">
                <div class="form-group row">
                    ...
                    <div class="col-sm-8 col-md-5 ">
                         <input id="deposit_date" required class="form-control datepicker" name="deposit_date" type="text" value="">
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group tenor row"  >
                    ...
                    <div class="col-sm-8 col-md-5 ">
                        <input readonly id="bank" class="form-control" name="tenor" type="text">
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group bg_expire_date row"  >
                    ...
                    <div class="col-sm-8 col-md-5 "><input readonly id="branch" class="form-control " name="bg_expire_date" type="text"></div>
                </div>
            </div>
        </div>
