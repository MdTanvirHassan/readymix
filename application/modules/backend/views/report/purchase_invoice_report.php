                        ...
                        <table style="width:100%;" id="player_table" class="table table-striped  table-bordered   responsive">
                                            ...
                                            $i=0;
                                              if(!empty($invoices)){
                                               ...
                                               foreach ($invoices as $invoice) {
                                                   ...
                                                   $total_paid_amount=$total_paid_amount+$invoice['paid_amount'];
                                                $i++;
                                                ?>
                                                    <tr>
                                                    ...
                                                    <td>
                                                     ...
                                                     <td style="text-align: right;">
                                                          <?php if(!empty($invoice['paid_amount'])) echo number_format($invoice['paid_amount'],2); ?>
                                                     </td>   
                                                        
                                                     <td style="text-align: right;">
                                                          <?php  echo number_format(($invoice['total_amount']-$invoice['paid_amount']),2); ?>
                                                     </td>   
                                       ...
                                       <?php    } ?>
                                                    <tr>
                                                        ...
                                                        <td style="text-align: right;"><b><?php echo number_format(($total_amount-$total_paid_amount),2); ?></b></td>
                                                    </tr>
                                      <?php             
                                             }else{
