...
<div style="padding:0" class="col-md-10 col-md-offset-1">
    ...
    <p style=" text-align: center;text-decoration: underline;">Return Report</p>
            ...
            <thead>
                <tr><td colspan="16"><?php echo $f_date; ?>&nbsp; To &nbsp<?php echo $to_date; ?></td></tr>
                                <tr>
                                    ...
                                    <th colspan="2" style="border-left:1px solid;border-top:1px solid;border-right:1px solid;width:300px;">Return</th>
                                      ...
                                      <?php if(!empty($data)){
                                                     ...
                                                     ?>
                                                            ...
                                                            foreach($data as $data_info){ 
                                                                ...
                                                                ?> 
                                                                    <tr>
                                                                        <td style="border-left:1px solid;border-top:1px solid;text-align: center;"><?php echo date('d-m-Y',strtotime($data_info['rr_date'])); ?></td>
