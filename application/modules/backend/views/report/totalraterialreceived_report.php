        ...
        <div class="panel panel-default">
            ...
            <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                ...
                <div class="panel-body">
                            ...
                            <form id="item-form" action="<?php site_url('backend/report/totalMaterialReceived'); ?>" method="post">
                             ...
                             <div class="row">
                              ...
                              <div style="margin-top: 15px;" class="col-md-4" >
                                    ...
                                    <select  class="form-control e1" placeholder="Select Item" id="item_id" name="item_id" onchange="javascript:brand_info();">
                                            ...
                                            $i=0;
                                              if(!empty($material_receives)){
                                                ...
                                                foreach($material_receives as $req){ 
                                                   ...
                                                   $net_receive_qty=$net_receive_qty+$req['receive_qty']; 
                                                   $net_receive_value=$net_receive_value+$req['amount']; 
                                             ...
                                             <?php } ?>   
                                               <?php if(!empty($item_id)) ?>    
                                                    <tr>
                                                        ...
                                                        <td style="text-align:right;"><?php //echo number_format($net_receive_qty,2) ?></td>
