                        ...
                        <form class="form-horizontal"  action="<?php echo site_url('customers/add_customer_action'); ?>" method="post" onsubmit="javascript: return validation()"  >
                            ...
                            <div class='form-group' >
                                ...
                                <div class="col-sm-4 input-group">
                                    ...
                                    <input  class="form-control" id="customer_name" name="c_name" type="text" placeholder="Full Name">
                            ...
                            <div class='form-group' >
                                ...
                                <div class="col-sm-4 input-group">
                                    <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                    <input  class="form-control" id="c_short_name" name="c_short_name" type="text" placeholder="Short Name">
                                ...
                                <div class="col-sm-4 input-group">
                                    <span class="input-group-addon"><i class="fa fa-check-square"></i></span>
                                    <input  class="form-control" id="key_person" name="key_person" type="text" placeholder="Key Person">
                            ...
                            <div class='form-group' >
                                ...
                                <div class="col-sm-4 input-group">
                                    <span class="input-group-addon"><i class="fa fa-check-square"></i></span>
                                    <input  class="form-control" id="c_email" name="c_email" type="text" placeholder="Email">
                            ...
                            <div class='form-group' >
                                ...
                                <div class="col-sm-4 input-group">
                                    <span class="input-group-addon"><i class="fa fa-check-square"></i></span>
                                    <input  class="form-control" id="c_contact_person" name="c_contact_person" type="text" placeholder="Contact Person">
                            ...
                            <div class='form-group' >
                                ...
                                <div class="col-sm-4 input-group">
                                    <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                    <input  class="form-control" id="head_office_mobile_no" name="head_office_mobile_no" type="text" placeholder="Head Office Phone No.">
                            ...
                            <!--        <div class="row">
                                         <div class="col-md-4">
                                            <div class="form-group row">
                                                <div class="col-sm-4 col-md-4  labeltext" style="text-align: right;">
                                                    <label for="inputdefault">Key P.<sup style="color:red;">*</sup>  :</label></div>
                                                <div class="col-sm-8 col-md-8  ">
                                                    <input  class="form-control" id="key_person" name="key_person" type="text" placeholder="Key Person">
                                                    <span id="key_person_error" style="color:red"></span>
                                                </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group row">
                                                <div class="col-sm-4 col-md-4  labeltext" style="text-align: right;">
                                                    <label for="inputdefault">Tin No.<sup style="color:red;">*</sup>  :</label></div>
                                                <div class="col-sm-8 col-md-8  ">
                                                    <input  class="form-control" id="tin_no" name="tin_no" type="text" placeholder="Tin Number">
                                                     <span id="tin_no_error" style="color:red"></span>
                                                </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group row">
                                                <div class="col-sm-4 col-md-4  labeltext" style="text-align: right;">
                                                    <label for="vat_reg">Vat Reg.<sup style="color:red;">*</sup>  :</label></div>
                                                <div class="col-sm-8 col-md-8  ">
                                                    <input  class="form-control" id="vat_reg" name="vat_reg" type="text" placeholder="Vat Reg.">
                                                     <span id="vat_reg_error" style="color:red"></span>
                                                </div>
                            ...
                            <!--        <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group row">
                                                <div class="col-sm-4 col-md-4  labeltext" style="text-align: right;"> 
                                                    <label for="inputdefault">Phone<sup style="color:red;">*</sup> :</label></div>
                                                <div class="col-sm-8 col-md-8  ">
                                                    <input  class="form-control" id="c_mobile_no" name="c_mobile_no" type="text" placeholder="Mobile Phone Number">
                                                     <span id="c_mobile_no_error" style="color:red"></span>
                                                </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group row">
                                                <div class="col-sm-4 col-md-4  labeltext" style="text-align: right;">
                                                    <label for="inputdefault">Email<sup style="color:red;">*</sup> :</label></div>
                                                <div class="col-sm-8 col-md-8  ">
                                                    <input  class="form-control" id="c_email" name="c_email" type="text" placeholder="Email">
                                                    <span id="c_email_error" style="color:red"></span>
                                                </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group row">
                                                <div class="col-sm-4 col-md-4  labeltext" style="text-align: right;"> 
                                                    <label for="inputdefault">Address<sup style="color:red;">*</sup> :</label></div>
                                                <div class="col-sm-8 col-md-8  ">
                                                    <input  class="form-control" id="c_contact_address" name="c_contact_address" type="text" placeholder="Head Office Address">
                                                     <span id="c_contact_address_error" style="color:red"></span>
                                                </div>
                            ...
                            <!--        <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group row">
                                                <div class="col-sm-4 col-md-4  labeltext" style="text-align: right;">
                                                    <label for="inputdefault">C. Person<sup style="color:red;">*</sup>  :</label></div>
                                                <div class="col-sm-8 col-md-8  ">
                                                    <input  class="form-control" id="c_contact_person" name="c_contact_person" type="text" placeholder="Contact Person">
                                                    <span id="c_contact_person_error" style="color:red"></span>
                                                </div>
