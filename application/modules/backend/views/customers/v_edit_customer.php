                        ...
                        <form class="form-horizontal"  action="<?php echo site_url('customers/edit_customer_action/'.$customer_info[0]['id']); ?>" method="post" onsubmit="javascript: return validation()"  >
                            <div class="row">
                                <h2><b>Company Info</b></h2>
                                    ...
                                    <div class="col-sm-4 input-group">
                                        <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                        <input  class="form-control" id="customer_name" name="c_name" type="text" placeholder="Company Name" value="<?php if (!empty($customer_info[0]['c_name'])) echo $customer_info[0]['c_name']; ?>">
                            ...
                            <div class="row">
                                    <div class='form-group' >
                                        ...
                                        <div class="col-sm-4 input-group">
                                            <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                            <input  class="form-control" id="c_short_name" name="c_short_name" type="text" placeholder="Company Short Name" value="<?php if (!empty($customer_info[0]['c_short_name'])) echo $customer_info[0]['c_short_name']; ?>">
                            ...
                            <div class="row">
                                    <div class='form-group' >
                                     ...
                                     <div class="col-sm-4 input-group">
                                         <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                         <input  class="form-control" id="head_office_mobile_no" name="head_office_mobile_no" type="text" placeholder="Head Office Mobile No." value="<?php if (!empty($customer_info[0]['head_office_mobile_no'])) echo $customer_info[0]['head_office_mobile_no']; ?>">
                                     ...
                                     <div class="col-sm-4 input-group">
                                         <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                         <input  class="form-control" id="head_office_phone_no" name="head_office_phone_no" type="text" placeholder="Head Office Phone No." value="<?php if (!empty($customer_info[0]['head_office_phone_no'])) echo $customer_info[0]['head_office_phone_no']; ?>">
                                         <span id="head_office_mobile_no_error" style="color:red"></span>
                                     </div>
                            ...
                            <div class="row">
                                ...
                                <div class='form-group' >
                                        ...
                                        <div class="col-sm-4 input-group">
                                            <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                            <input  class="form-control" id="key_person" name="key_person" type="text" placeholder="Key Person Name" value="<?php if (!empty($customer_info[0]['key_person'])) echo $customer_info[0]['key_person']; ?>">
                                        ...
                                        <div class="col-sm-4 input-group">
                                            <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                            <input  class="form-control" id="key_person_phone" name="key_person_phone" type="text" placeholder="Mobile Phone Number" value="<?php if (!empty($customer_info[0]['key_person_phone'])) echo $customer_info[0]['key_person_phone']; ?>">
                            ...
                            <div class="row">
                               ...
                               <div class='form-group' >  
                                    ...
                                    <label for="title" class="col-sm-2 control-label">
                                        ...
                                        <div class="col-sm-4 input-group">
                                            <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                            <input  class="form-control" id="key_person_email" name="key_person_email" type="text" placeholder="Keyperson Email" value="<?php if (!empty($customer_info[0]['key_person_email'])) echo $customer_info[0]['key_person_email']; ?>">
                            ...
                            <div class="row">
                                    ...
                                    <div class='form-group' >
                                        ...
                                        <div class="col-sm-4 input-group">
                                            <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                            <input  class="form-control" id="c_contact_person" name="c_contact_person" type="text" placeholder="Contact Person Name" value="<?php if (!empty($customer_info[0]['c_contact_person'])) echo $customer_info[0]['c_contact_person']; ?>">
                            ...
                            <div class="row">
                                    <div class='form-group' >
                                        ...
                                        <div class="col-sm-4 input-group">
                                            <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                            <input  class="form-control" id="c_email" name="c_email" type="text" placeholder="Contact Person Email" value="<?php if (!empty($customer_info[0]['c_email'])) echo $customer_info[0]['c_email']; ?>">
                                ...
                                <div class='form-group' >
                                        ...
                                        <div class="col-sm-4 input-group">
                                           ...
                                           <select class="form-control e1" id="product_category_id" name="product_category_id">
                                               ...
                                               <?php foreach($categories as $category){ ?>
                                                    <option <?php if($customer_info[0]['product_category_id']==$category['category_id']) echo "selected"; ?> class="form-control" value="<?php echo $category['category_id'] ?>"><?php echo $category['category_name'] ?></option>
                                                <?php } ?>                                                 
                                           </select>
                                    ...
                                    <div class="col-sm-4 input-group">
                                        ...
                                        <select class="form-control e1" id="customer_type" name="customer_type">
                                            ...
                                            <option <?php if($customer_info[0]['customer_type']=="in_house") echo "selected"; ?> value="in_house">In House</option>
                                            <option <?php if($customer_info[0]['customer_type']=="private") echo "selected"; ?> value="private">Private</option>
                                        </select>
                                        ...
                                        <div class="col-sm-4 input-group">
                                           ...
                                           <select class="form-control e1" id="sales_person_id" name="sales_person_id">
                                               ...
                                               <?php foreach($employees as $employee){ ?>
                                                    <option <?php if($customer_info[0]['sales_person_id']==$employee['id']) echo "selected"; ?> value="<?php echo $employee['id'] ?>"><?php echo $employee['name'] ?></option> 
                                               <?php } ?>
                                           </select>
