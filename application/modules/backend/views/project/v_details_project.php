                    ...
                    <div class="x_content">
                        ...
                        <div class="row">
                            <div class="col-md-3 box-primary">
                                <img class="profile-user-img img-responsive img-circle" src="<?php echo site_url('images/img.jpg')?>" alt="User profile picture">
            ...
            <div class="tab" role="tabpanel">
                ...
                <div class="tab-content tabs">
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="sales_order">
                        <table id="datatable" class="table datatable table-striped table-bordered table-hover dataTable no-footer">
                                        <thead>
                                            <tr>
