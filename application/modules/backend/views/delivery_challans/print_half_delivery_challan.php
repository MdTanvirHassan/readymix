...
<div>
  ...
  <p style="text-align: center;margin-top: -3px;font-weight: bold;font-size: 15px;">(A Unit Of Karim Group)</p>
    ...
    S.O. No.: <?php if(!empty($delivery_challan_info[0]['c_order_no'])) echo ucfirst($delivery_challan_info[0]['c_order_no']);else echo ucfirst($delivery_challan_info[0]['order_no']); ?>&nbsp; &nbsp;&nbsp; Date: <?php  echo date('d-m-Y',strtotime($delivery_challan_info[0]['sale_order_date'])); ?>
    ...
    <div style="float: right;width: 48%;border:1px solid;border-top:none; margin-bottom: 15px;margin-top:-5px;">
        ...
        <table class="table table-bordered table-hover table-striped" style="width:100%">
            ...
            <tr>
                ...
                <td style="font-size: 12px;">: <?php  echo $delivery_challan_info[0]['contact_person']; ?>(<?php  echo $delivery_challan_info[0]['contact_no']; ?>)</td>
            </tr>
     ...
     <table class="table table-bordered table-hover table-striped" border="1" style="width:100%;text-align: center;margin-bottom:10px;">
            ...
            -->    
                ...
                <tr>
                   <th style="vertical-align: middle;font-size:13px;"  >PRODUCT NAME</th>
                   <th style="font-size:13px;"><?php echo $delivery_challan_details_info[0]['mu_name']; ?>(Qty)</th>
                   <?php if($delivery_challan_details_info[0]['mu_name']=='CFT'){ ?>
                    <th style="font-size:13px;">CUM(Qty)</th>
                    <?php } ?>
                    <th style="vertical-align: middle;font-size:13px;">REMARK</th>
                 </tr>
