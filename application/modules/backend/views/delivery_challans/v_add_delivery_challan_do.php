                    ...
                    <div class="x_content">
                        <form class="form-horizontal" action="<?php echo site_url('delivery_challans/add_delivery_challan_action'); ?>" method="post" onsubmit="javascript: return validation()">
                            ...
                            <div class='form-group' >
                                ...
                                <div class="col-sm-4 input-group">
                                    <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                    <input  class="form-control" id="manual_dc_no" name="manual_dc_no" type="text" placeholder="Manual Challan No.">
                                ...
                                <table class="table table-bordered" id="myTable" >
                                    <thead class="thead-color">
                                        <tr >
                                            ...
                                            <th>Quantity (<span class="mu">CFT</span>)</th>              
                                            <th>Quantity(<span class="othermu">CUM</span>)</th>              
                                ...
                                <table class="table table-bordered" id="productionTable" >
                                    <thead class="thead-color">
                                        ...
                                        <tr >
                                            ...
                                            <th><span class="mu">CFT</span></th>
                                            <th><span class="othermu">CUM</span></th>
                                            <th><span class="mu">CFT</span></th>              
                                            <th><span class="othermu">CUM</span></th>              
                                            <th><span class="mu">CFT</span></th>
                                            <th><span class="othermu">CUM</span></th>
...
//            error = true;
    ...
    $('#do_id').change(function () {
        ...
        if (do_id != '') {
            ...
            $.ajax({
                url: '<?php echo site_url('delivery_challans/get_delivery_order_item_'); ?>',
                data: data,
                method: 'POST',
                dataType: 'json',
                success: function (msg) {
                    ...
                    $(msg.item_list).each(function (i, v) {
                        ...
                        str += '<tr>';
                        str += '<td><input type="hidden"  name="s_item_id[]" id="item_des_c1_" class="issue" value="' + v.s_item_id + '"><input readonly style="width:140px;"  type="text"  name="name[]" id="item_des_c1_'+(Number(i)+1)+ '" class="issue" value="' + v.product_name + '"></td>';
                        str += '<td>';
                        
                        str +='<input type="hidden"  style="width:140px;"  type="text"  name="base_price[]" id="base_price_' +(Number(i) + 1)+ '" class="base_price_' + (Number(i) + 1) + '" value="' + v.base_price + '">';
                        str +='<input type="hidden"  style="width:140px;"  type="text"  name="vat[]" id="vat_' +(Number(i) + 1)+ '" class="vat_' + (Number(i) + 1) + '" value="' + v.vat + '">';
                       ...
                       // str +='<input  readonly  onkeyup="calculateSubtotal(' + v.s_item_id + ')" onchange="calculateSubtotal(' + v.s_item_id + ')" onblur="calculateSubtotal(' + v.s_item_id + ')"  style="width:140px;text-align:right;"  type="text"  name="quantity[]" id="quantity_' + v.s_item_id + '" class="issue number" value="' + net_qty + '">';
                        str +='<input  readonly  onkeyup="calculateSubtotal(' +(Number(i) + 1)+ ',false)" onchange="calculateSubtotal(' +(Number(ti)+1)+ ',false)" onblur="calculateSubtotal(' +(Number(ti)+1)+ ',false)" style="width:140px;text-align:right;"  type="text"  name="quantity[]" id="quantity_'+(Number(i)+1)+ '" class="issue number" value="' +''+ '">';
                        str +='</td><td><input  readonly  onkeyup="calculateSubtotal(' +(Number(i) + 1)+ ',true)" onchange="calculateSubtotal(' +(Number(ti)+1)+ ',true)" onblur="calculateSubtotal(' +(Number(ti)+1)+ ',true)" style="width:140px;text-align:right;"  type="text"  name="quantity_cum[]" id="quantity_cum_'+(Number(i)+1)+ '" class="issue number" value="' +''+ '">';
                        str +='</td>';
                    ...
                    //alert(msg.water_info[0].product_id);
                    
                        var wa='';
                        wa += '<tr>';
                        wa += '<td><input type="hidden"  name="s_item_id[]" id="item_des_c1_" class="issue" value="' + msg.water_info[0].product_id + '"><input readonly style="width:140px;"  type="text"  name="name[]" id="item_des_c1_'+(Number(ti)+1)+ '" class="issue" value="' +msg.water_info[0].product_name+'"></td>';
                        wa += '<td>';
                        wa +='<input type="hidden"  style="width:140px;"  type="text"  name="unit_price[]" id="unit_price_' +(Number(ti)+1)+ '" class="unit_price_' + (Number(ti)+1) + '" value="' +0+ '">';
                        wa +='<input type="hidden"   style="width:140px;text-align:right;"  type="text" name="amount[]" id="amount_' + msg.water_info[0].product_id + '" class="amount_' + (Number(ti)+1) + '"  value="' +0+ '">';
                       // str +='<input  readonly  onkeyup="calculateSubtotal(' + v.s_item_id + ')" onchange="calculateSubtotal(' + v.s_item_id + ')" onblur="calculateSubtotal(' + v.s_item_id + ')"  style="width:140px;text-align:right;"  type="text"  name="quantity[]" id="quantity_' + v.s_item_id + '" class="issue number" value="' + net_qty + '">';
                        wa +='<input  readonly  onkeyup="calculateSubtotal(' +(Number(ti)+1)+ ',false)" onchange="calculateSubtotal(' +(Number(ti)+1)+ ',false)" onblur="calculateSubtotal(' +(Number(ti)+1)+ ',false)" style="width:140px;text-align:right;"  type="text"  name="quantity[]" id="quantity_'+(Number(ti)+1)+ '" class="issue number" value="' +''+ '">';
                        wa +='</td><td><input  readonly  onkeyup="calculateSubtotal(' +(Number(ti)+1)+ ',true)" onchange="calculateSubtotal(' +(Number(ti)+1)+ ',true)" onblur="calculateSubtotal(' +(Number(ti)+1)+ ',true)" style="width:140px;text-align:right;"  type="text"  name="quantity_cum[]" id="quantity_cum_'+(Number(ti)+1)+ '" class="issue number" value="' +''+ '">';
                        wa +='</td>';
                        wa += '<td><input readonly   style="width:140px;text-align:left;"  type="text" name="mu_name[]" id="mu_'+(Number(ti)+1)+'" class="amount_' + (Number(ti)+1) + '"  value="' +msg.water_info[0].measurement_unit+'"></td>';
                        wa += '<td>'+''+'</td>';
                      //  str += '<td><input onclick="calculateSubtotal(' + v.s_item_id + ')" style="width:40px;text-align:right;"  type="checkbox" name="select_product[]"    id="select_product_' + v.s_item_id + '" class="select_product_' + (Number(i) + 1) + '" value="' + v.s_item_id + '"></td>';
                        wa += '<td><input onclick="waterEnable('+(Number(ti)+1)+',false)" style="width:40px;text-align:right;"  type="checkbox" name="select_product[]"    id="select_product_' +(Number(ti) + 1)+ '" class="select_product_' + (Number(ti) + 1) + '" value="' + msg.water_info[0].product_id + '"></td>';
                        wa += '</tr>';
                        
                        $('#challan_items').append(wa);
                    ...
                    $(msg.order_products).each(function (j, w) {
                        if (w.delivery_quantity != null) {
                            ...
                            stock_qty = Number(w.production_qty);
                        }
             ...
             if(w.delivery_quantity == null) {
                        ...
                        str2 += '<td><input readonly  style="width:120px;text-align:right;"  type="text" class="stock_quantity_'+(Number(j)+1)+'"  name="stock_quantity[]" id="stock_quantity_' +(Number(j)+1)+'" class="issue" value="'+stock_qty.toFixed(2)+'"></td>';
                         if(w.mu_name=='CFT'){
                             ...
                             str2 += '<td><input readonly  style="width:120px;text-align:right;"  type="hidden" class="stock_quantity_cum_real_'+(Number(j)+1)+'"  id="stock_quantity_cum_real_' +(Number(j)+1)+'" class="issue" value="'+(stock_qty/35.31)+'"></td>';
            ...
            str2 += '<td><input readonly  style="width:120px;text-align:right;"  type="hidden" class="stock_quantity_cum_'+(Number(j)+1)+'"  id="stock_quantity_cum_real_' +(Number(j)+1)+'" class="issue" value="'+(stock_qty/2.41)+'"></td>';
        }else{
            ...
            str2 += '<td><input readonly  style="width:120px;text-align:right;"  type="hidden" class="stock_quantity_cum_real_'+(Number(j)+1)+'"  id="stock_quantity_cum_real_' +(Number(j)+1)+'" class="issue" value="'+(stock_qty)+'"></td>';
        }
        ...
        if(mu=='CFT')
            ...
            if(chk){
                if(stock_quantity_cum<$('#quantity_cum_'+id).val()){
                    $('#quantity_cum_'+id).val($('#stock_quantity_cum_'+id).val());
                    return false;
                }
