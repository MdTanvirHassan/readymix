    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_content">
                        <form class="form-horizontal" action="<?php echo site_url('delivery_challans/edit_delivery_challan_action/'.$delivery_challan_info[0]['dc_id']); ?>" method="post" onsubmit="javascript: return validation()" >
                       ...
                       <span id="delivery_challan_date_error" style="color:red"></span>
                            ...
                            <div class='form-group' >
                                ...
                                <div class="col-sm-4 input-group">
                                    <span class="input-group-addon"><i class="fa fa-check-square"></i></span>
                                      <input  class="form-control" id="billing_address" name="billing_address" type="text" placeholder="Billing Address" value="<?php if(!empty($delivery_challan_info[0]['billing_address'])) echo $delivery_challan_info[0]['billing_address']; ?>">
                        <span id="billing_address_error" style="color:red"></span>
                            ...
                            <div class='form-group' >
                                ...
                                <div class="col-sm-4 input-group">
                                    <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                     <input  class="form-control" id="billing_email" name="billing_email" type="text" placeholder="Billing Email" value="<?php if(!empty($delivery_challan_info[0]['billing_email'])) echo $delivery_challan_info[0]['billing_email']; ?>">
                        ...
                        <span id="shipping_address_error" style="color:red"></span>
                            ...
                            <div class='form-group' >
                              ...
                              <div class='form-group' >
                                ...
                                <div class="col-sm-4 input-group">
                                    <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                    <input  class="form-control" id="distance" name="distance" type="text" placeholder="Slump" value="<?php if(!empty($delivery_challan_info[0]['distance'])) echo $delivery_challan_info[0]['distance']; ?>">
                                    <span id="challan_time_error" style="color:red"></span>
                                </div>  
                            ...
                            <div class='form-group' >
                                ...
                                <div class="col-sm-4 input-group">
                                    <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                    <input  class="form-control" id="manual_dc_no" name="manual_dc_no" type="text" placeholder="Manual Challan No." value="<?php if(!empty($delivery_challan_info[0]['manual_dc_no'])) echo $delivery_challan_info[0]['manual_dc_no']; ?>">
                                    <span id=" manual_dc_no_error" style="color:red"></span>
                                </div>
                ...
                <table class="table table-bordered" id="myTable" >
                    <thead class="thead-color">
                     <tr>
                        ...
                        <th>Quantity (<?php echo $delivery_challan_details_info[0]['mu_name'] ?>)</th>              
                        <th>Quantity(CUM)</th>      
                    ...
                    <tbody id="challan_items">
                          <?php $i=0; foreach($delivery_challan_details_info as $delivery_challan_details){ 
                            ...
                            ?>
                         <tr class="" id="row_">
                             <td><input  type="hidden"  name="s_item_id[]" id="item_des_c1_" class="issue" value="<?php echo $delivery_challan_details['s_item_id'] ?>"><input readonly style="width:140px;"  type="text"  name="name[]" id="item_des_c1_" class="issue" value="<?php echo $delivery_challan_details['product_name'] ?>"></td>
                             <td>
                                 
                                 <input type="hidden"  style="width:140px;text-align: right;"  type="text"  name="base_price[]" id="base_price_<?php echo $delivery_challan_details['s_item_id'] ?>" class="base_price_<?php echo $i; ?>" value="<?php echo $delivery_challan_details['base_price'] ?>">
                                 <input type="hidden"  style="width:140px;text-align: right;"  type="text"  name="vat[]" id="vat_<?php echo $delivery_challan_details['s_item_id'] ?>" class="vat_<?php echo $i; ?>" value="<?php echo $delivery_challan_details['vat'] ?>">
                                 ...
                                 <input required onkeyup="calculateSubtotal(<?php echo $i; ?>,false)" onchange="calculateSubtotal(<?php echo $i; ?>,false)" onblur="calculateSubtotal(<?php echo $i; ?>,false)"  style="width:140px;text-align: right;"  type="text"  name="quantity[]" id="quantity_<?php echo $i; ?>" class="quantity_<?php echo $i; ?>" value="<?php echo $delivery_challan_details['quantity'] ?>">
                             </td>
                             <td>
                                 <?php 
                            ...
                            $val = round($delivery_challan_details['quantity']/35.31,2);
                                ...
                                $val = round($delivery_challan_details['quantity']/2.41,2);
                                 ...
                                 <input required onkeyup="calculateSubtotal(<?php echo $i; ?>,true)"  onchange="calculateSubtotal(<?php echo $i; ?>,true)" onblur="calculateSubtotal(<?php echo $i; ?>,true)"  style="width:140px;text-align: right;"  type="text"  name="quantity_cum[]" id="quantity_cum_<?php echo $i; ?>" class="quantity_cum_<?php echo $i; ?>" value="<?php echo $val; ?>">
                             </td>
                             ...
                             <td><input readonly  style="width:140px;text-align: left;"  type="text"   name="remark[]" id="remark_<?php echo $i; ?>" class="remark_<?php echo $i; ?>" value="<?php echo $delivery_challan_details['remarks'] ?>"></td>
                             <!--  <td><?php echo $delivery_challan_details['remarks']; ?></td>-->
                             <td><input checked onclick="calculateSubtotal(<?php echo $i; ?>,false)"  style="width:40px;"  type="checkbox" name="select_product[]"    id="select_product_<?php echo $i ?>" class="select_product_<?php echo $i; ?>" value="<?php echo $delivery_challan_details['s_item_id'] ?>"></td>
                          </tr>
                        <?php } ?>
        ...
        <div class="row">
            ...
            <table class="table table-bordered" id="orderTable" >
                    ...
                    <tbody id="order_items">
                        <?php $i=0; foreach($order_products as $order_product){ 
                            $due_quantity=$order_product['quantity']-$order_product['delivery_quantity'];
                            $i++;
                            ?>
                         <tr class="" id="row_<?php echo $i; ?>">
                             ...
                             <td><input readonly   style="width:140px;text-align: right;"  type="text"  name="delivery_quantity[]" id="delivery_quantity_<?php echo $i; ?>" class="issue" value="<?php echo $order_product['delivery_quantity']; ?>"></td>
            ...
            <table class="table table-bordered" id="orderTable" >
                    ...
                    <tbody id="order_items">
                        <?php $i=0; foreach($order_products as $order_product){ 
                            ...
                            $stock_quantity=$order_product['production_qty']-$order_product['delivery_quantity'];
                            $i++;
                            ?>
                         <tr class="" id="row_">
                             <td><input readonly style="width:140px;"  type="text"  name="product_name[]" id="product_name_" class="issue" value="<?php echo $order_product['product_name']; ?>"></td>
                             <td><input readonly  style="width:140px;text-align: right;"  type="text"  name="production_quantity[]" id="order_quantity_<?php echo $i; ?>" class="issue" value="<?php echo $order_product['production_qty']; ?>"></td>
                                 <?php 
                            if($order_product['measurement_unit']=='CFT'){
                            $val = round($order_product['production_qty']/35.31,2);
                            }else{  
                                $val = round($order_product['production_qty']/2.41,2);
                            }?>
                             <td><input readonly  style="width:140px;text-align: right;"  type="text"  name="production_quantity[]" id="order_quantity_<?php echo $i; ?>" class="issue" value="<?php echo $val; ?>"></td>
                               <?php 
                            if($order_product['measurement_unit']=='CFT'){
                            $val = round($order_product['delivery_quantity']/35.31,2);
                            }else{  
                                $val = round($order_product['delivery_quantity']/2.41,2);
                            }?>
                             <td><input readonly   style="width:140px;text-align: right;"  type="text"  name="d_quantity[]" id="delivery_quantity_<?php echo $i; ?>" class="issue" value="<?php echo $order_product['delivery_quantity']; ?>"></td>
                             <td><input readonly   style="width:140px;text-align: right;"  type="text"  name="d_quantity[]" id="delivery_quantity_<?php echo $i; ?>" class="issue" value="<?php echo $val; ?>"></td>
                             <td><input readonly  style="width:140px;text-align: right;"  type="text"   name="stock_quantity[]" id="due_quantity_<?php echo $i; ?>" class="issue" value="<?php echo $stock_quantity; ?>"></td>
                               <?php 
                            if($order_product['measurement_unit']=='CFT'){
                            $val = round($stock_quantity/35.31,2);
                            }else{  
                                $val = round($stock_quantity/2.41,2);
                            }?>
                             <td><input readonly  style="width:140px;text-align: right;"  type="text"   name="stock_quantity[]" id="due_quantity_<?php echo $i; ?>" class="issue" value="<?php echo $val; ?>"></td>
                          </tr>
                        <?php } ?>
