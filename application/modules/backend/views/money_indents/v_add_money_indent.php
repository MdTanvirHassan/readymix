                ...
                <thead class="thead-color">
                     <tr class="">
                      <!--  <th style="width:5%">Budget No.</th>-->
                        <th style="width:10%">Material Indent No.</th>
                    ...
                    <tbody>
                      ...
                      <tr class="" id="row_1">
                           ...
                           <input readonly style="width:100%" type="hidden"  name="budged_no[]" id="indent_id_<?php echo $i; ?>" class="issue" value="<?php if(!empty($budget_item['b_no'])) echo $budget_item['b_no'];  ?>" >
                    ...
                    -->
                       ...
                       <td style="width:8%">
                           <input style="width:100%"  type="hidden"  name="unit_name[]" id="unit_c1_<?php echo $i; ?>" class="issue" value="<?php if(!empty($budget_item['unit_name'])) echo $budget_item['unit_name'];  ?>">
                           <input style="width:100%"  type="hidden"  name="item_size[]" id="unit_c1_<?php echo $i; ?>" class="issue" value="<?php if(!empty($budget_item['item_size'])) echo $budget_item['item_size'];  ?>">
                      ...
                      <td style="width:8%">
                       ...
                       <td style="width:8%">
                        ...
                        <td style="width:10%">
                            <input style="width:100%;text-align: right;" readonly type="text"  name="value[]" id="mon_indent_value_<?php echo $i; ?>"  class="issue" value="<?php echo round($budget_item['budget_qty']*$budget_item['unit_price'],2);//if(!empty($budget_item['budget_value'])) echo $budget_item['budget_value'];   ?>" >
                        </td>
                      <td style="width:8%">
