...
<div class="row">
            ...
            <form class="form-horizontal" method="post" action="<?php echo site_url('money_indent/edit_money_indent_action/'.$money_indent_info[0]['mi_id']) ?>">
             ...
             <table class="table table-bordered" id="myTable" style="margin-top:20px;">
                 <thead class="thead-color">
                     <tr>
                      <!--  <th style="vertical-align: middle;width: 8%;text-align: center;">Budget No.</th>-->
                        <th style="vertical-align: middle;width: 10%;text-align: center;">Material Indent No.</th>
                    ...
                    <?php $i=0; foreach($budget_items as $budget_item){ $i++;?>
                      ...
                      <tr id="row_1">
                            ...
                            <input readonly type="hidden" style="width:100%"  name="budged_no[]" id="indent_id_<?php echo $i; ?>" class="issue form-control" value="<?php if(!empty($budget_item['b_no'])) echo $budget_item['b_no'];  ?>" >
                ...
                <!--        
                      <td style="width:8%">
                            <input  readonly type="text" style="width:100%"  name="item_size[]" id="unit_c1_<?php echo $i; ?>" class="issue form-control" value="<?php if(!empty($budget_item['item_size'])) echo $budget_item['item_size'];  ?>">
                        </td>    
                ...
                -->
                       ...
                       <td style="width:8%">
                           <input   type="hidden" style="width:100%"  name="item_size[]" id="unit_c1_<?php echo $i; ?>" class="issue form-control" value="<?php if(!empty($budget_item['item_size'])) echo $budget_item['item_size'];  ?>">
                           <input   type="hidden" style="width:100%"  name="unit_name[]" id="unit_c1_<?php echo $i; ?>" class="issue form-control" value="<?php if(!empty($budget_item['unit_name'])) echo $budget_item['unit_name'];  ?>">
                       ...
                       <td style="width:7%">
                        ...
                        <td>
                            <select  class="form-control e1"  id="supplier_id_<?php echo $i; ?>" name="supplier_id[]" >
                                <option value=''>Select Supplier</option>
                                <?php foreach($suppliers as $sup){ ?>
                                    <option <?php if($budget_item['supplier_id']==$sup['ID']) echo "selected"; ?> value="<?php echo $sup['ID'] ?>" ><?php echo $sup['SUP_NAME'] ?></option>
                                <?php } ?>
                            </select>
                        </td>
