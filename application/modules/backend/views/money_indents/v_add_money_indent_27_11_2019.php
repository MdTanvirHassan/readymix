                    ...
                    <tbody>
                      ...
                      <tr class="" id="row_1">
                        ...
                        <td>
                            ...
                            <input readonly type="text"  name="budged_no[]" id="indent_id_<?php echo $i; ?>" class="issue" value="<?php if(!empty($budget_item['b_no'])) echo $budget_item['b_no'];  ?>" >
                        </td>
                        
                        <td>      
                             <input style="width:100px;" disabled type="text"  name="indent_no1[]" id="indent_no1_<?php echo $i; ?>"  class="issue" value="<?php if(!empty($budget_item['indent_no'])) echo $budget_item['indent_no'];  ?>">
                        </td>
                        
                        <td>                 
                            <input style="width:100px;" disabled type="text"  name="department_name1[]" id="department_name1_<?php echo $i; ?>" class="issue" value="<?php if(!empty($budget_item['dep_description'])) echo $budget_item['dep_description'];  ?>">
                        </td>
                        ...
                        <td>
                             ...
                             <input disabled type="text"  name="item_name_description[]" id="item_des_c1_<?php echo $i; ?>" class="issue" value="<?php if(!empty($budget_item['item_description'])) echo $budget_item['item_description'];  ?>">
                        </td>
                        <td>
                            <input style="width:100px;" disabled type="text"  name="unit[]" id="unit_c1_<?php echo $i; ?>" class="issue" value="<?php if(!empty($budget_item['measurement_unit'])) echo $budget_item['measurement_unit'];  ?>">
                        </td>     
                        <td>
                           <input style="width:40px;text-align: right;" readonly  type="text"  name="budget_quantity[]" id="budget_qty_<?php echo $i; ?>"  class="issue" value="<?php if(!empty($budget_item['budget_qty'])) echo $budget_item['budget_qty'];  ?>">
                        </td>
                        <td>
                           <input style="width:40px;text-align: right;"   type="text"  name="quantity[]" onkeyup="calculateMoneyIndentAmount(<?php echo $i; ?>)" onchange="calculateMoneyIndentAmount(<?php echo $i; ?>)" onblur="calculateMoneyIndentAmount(<?php echo $i; ?>)"  id="mon_indent_qty_<?php echo $i; ?>"  class="issue" value="<?php if(!empty($budget_item['budget_qty'])) echo $budget_item['budget_qty'];  ?>">
                        </td>
                       
                        <td>
                            <input style="width:80px;text-align: right;"  type="text"  name="unit_price[]" id="unit_price_<?php echo $i; ?>" class="issue" onkeyup="calculateMoneyIndentAmount(<?php echo $i; ?>)" onchange="calculateMoneyIndentAmount(<?php echo $i; ?>)" onblur="calculateMoneyIndentAmount(<?php echo $i; ?>)" value="<?php if(!empty($budget_item['unit_price'])) echo $budget_item['unit_price'];  ?>" >
                        </td>
                        <td>
                            <input style="width:100px;text-align: right;" readonly type="text"  name="value[]" id="mon_indent_value_<?php echo $i; ?>"  class="issue" value="<?php if(!empty($budget_item['budget_value'])) echo $budget_item['budget_value'];  ?>" >
                        </td>
                        <td>
                           <input style="width:100px;" readonly type="text"  name="mode_name[]" id="payment_mode_<?php echo $i; ?>"  class="issue" value="<?php if(!empty($budget_item['mode_name'])) echo $budget_item['mode_name'];  ?>" >
                        </td>
