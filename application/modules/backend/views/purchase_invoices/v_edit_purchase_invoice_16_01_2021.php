                    ...
                    <div class="x_content">
                        <form class="form-horizontal" action="<?php echo site_url('purchase_invoices/edit_purchase_invoice_action/'.$purchase_invoice_info[0]['inv_id']); ?>" method="post" onsubmit="javascript: return validation()">
                           ...
                           <div class='form-group' >
                                ...
                                <div class="col-sm-4 input-group">
                                    <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                    <input  class="form-control" id="supplier_bill_no" name="supplier_bill_no" type="text" placeholder="Reference Number" value="<?php if(!empty($purchase_invoice_info[0]['supplier_bill_no'])) echo $purchase_invoice_info[0]['supplier_bill_no'];  ?>">
