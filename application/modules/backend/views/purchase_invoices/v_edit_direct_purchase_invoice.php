    ...
    <div class="">
        <div class="page-title">
            <div class="title_center">
                <h3>Edit Direct/Opening Invoice</h3>
            </div>
        </div>
        <div class="row">
                                ...
                                <div class="col-sm-4 input-group">
                                    ...
                                    <select id="bill_id" class="form-control e1" name="bill_id">
                                        ...
                                        <?php foreach ($bills as $bill) { ?>
                                            <?php if($bill['id']==$purchase_invoice_info[0]['bill_id']){ ?>
                                             ...
                                             <?php if(!empty($invoice_details_info)){ ?>
                                                ...
                                                foreach($invoice_details_info as $invoice_detail){ 
                                                    ...
                                                    <tr>
                                                       ...
                                                       -->
                                                       <td>
                                                            <select name="item_id[]" id="prod_<?php echo $i; ?>" class="form-control e1" onchange="changeProduct(1)">
                                                                <option value="">Select Item</option>
                                                                <?php foreach($items as $r){?>


                                                                    <option <?php if($invoice_detail['item_id']==$r['id']) echo "selected"; ?> rel="<?php echo $r['meas_unit']; ?>" value="<?php echo $r['id']; ?>"><?php echo $r['item_name']; ?></option>
                                                                <?php } ?>
                                                            </select>
                                                       </td>
                                                       
                                                        <td>
                                                            <input readonly  style="width:100px;"  type="text"  name="measurement_unit[]" id="dc_no" class="issue" value="<?php echo $invoice_detail['meas_unit']; ?>">
                                                        </td>
                                                        <td>
                                                            <input  onkeyup="calculateSubtotal(<?php echo $i; ?>)" onchange="calculateSubtotal(<?php echo $i; ?>)" onblur="calculateSubtotal(<?php echo $i; ?>)"  style="width:100px;text-align: right;"  type="text"  name="quantity[]" id="quantity_<?php echo $i; ?>" class="issue" value="<?php echo $invoice_detail['quantity']; ?>">
                                                        </td>
                                                        <td>
                                                            <input  onkeyup="calculateQuantityAmount(<?php echo $i; ?>)" onchange="calculateQuantityAmount(<?php echo $i; ?>)" onblur="calculateQuantityAmount(<?php echo $i; ?>)"  style="width:100px;text-align: right;"  type="text"  name="unit_price[]" id="unit_price_<?php echo $i; ?>" class="issue" value="<?php echo $invoice_detail['unit_price']; ?>">
                                                        </td>
                                                        <td>
                                                            <input  onkeyup="calculateQuantity(<?php echo $i; ?>)" onchange="calculateQuantity(<?php echo $i; ?>)" onblur="calculateQuantity(<?php echo $i; ?>)"  style="width:140px;text-align: right;"  type="text" class="amount_"  name="amount[]" id="amount_<?php echo $i; ?>" class="issue" value="<?php echo $invoice_detail['amount']; ?>">
                                                        </td>
                                                        <td>
                                                            <input style="width:140px;text-align: right;"  type="text" class="remark"  name="remark[]" id="remark_<?php echo $i; ?>" class="issue" value="<?php echo $invoice_detail['remark']; ?>">
                                                        </td>
                                                    </tr>
                                                <?php } ?>
                                            <?php } ?>
                                           ...
                                           <tfoot>
                                                ...
                                                <tr>
                                                 ...
                                                 <tr>
                                                    ...
                                                    <td><input onblur="javascript:calculateNetPayableAmount();" onkeyup="javascript:calculateNetPayableAmount();" onchange="javascript:calculateNetPayableAmount();"  style="width:140px;text-align: right;" class="number" id="discount"  name="discount" type="text" value="<?php if(!empty($purchase_invoice_info[0]['discount'])) echo $purchase_invoice_info[0]['discount'];  ?>"></td>
                                                </tr>
                                        
                                                <tr>
                                                    <td colspan="4" style="text-align:right;">Vat:</td>

                                                    <td><input onblur="javascript:calculateNetPayableAmount();" onkeyup="javascript:calculateNetPayableAmount();" onchange="javascript:calculateNetPayableAmount();"  style="width:140px;text-align: right;" class="number" id="vat"  name="vat" type="text" value="<?php if(!empty($purchase_invoice_info[0]['vat'])) echo $purchase_invoice_info[0]['vat'];  ?>"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="4" style="text-align:right;">Tax:</td>

                                                    <td><input onblur="javascript:calculateNetPayableAmount();" onkeyup="javascript:calculateNetPayableAmount();" onchange="javascript:calculateNetPayableAmount();"  style="width:140px;text-align: right;" class="number" id="tax"  name="tax" type="text" value="<?php if(!empty($purchase_invoice_info[0]['tax'])) echo $purchase_invoice_info[0]['tax'];  ?>"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="4" style="text-align:right;">Ait:</td>

                                                    <td><input onblur="javascript:calculateNetPayableAmount();" onkeyup="javascript:calculateNetPayableAmount();" onchange="javascript:calculateNetPayableAmount();"  style="width:140px;text-align: right;" class="number" id="ait"  name="ait" type="text" value="<?php if(!empty($purchase_invoice_info[0]['ait'])) echo $purchase_invoice_info[0]['ait'];  ?>"></td>
                                                </tr>
