            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_content">
                        ...
                        <?php if($user_type==1){ ?>
                                 <?php if($purchase_invoice_info[0]['audit_status']=="Approved"){ ?>                             
                                        <button onclick="reject('<?php echo site_url('purchase_invoices/reject_invoice/'.$purchase_invoice_info[0]['inv_id']); ?>')" class="btn btn-sm btn-warning">Reject</button>
                                  <?php }else if($purchase_invoice_info[0]['audit_status']=="Rejected"){ ?>
                                        <button onclick="approve('<?php echo site_url('purchase_invoices/approve_invoice/'.$purchase_invoice_info[0]['inv_id']); ?>')" class="btn btn-sm btn-primary">Approve</button>
                                   <?php }else{ ?>
                                        <button onclick="approve('<?php echo site_url('purchase_invoices/approve_invoice/'.$purchase_invoice_info[0]['inv_id']); ?>')" class="btn btn-sm btn-primary">Approve</button>
                                        <button onclick="reject('<?php echo site_url('purchase_invoices/reject_invoice/'.$purchase_invoice_info[0]['inv_id']); ?>')" class="btn btn-sm btn-warning">Reject</button>
                                   <?php } ?>
                        <?php }else{ ?>
                             <?php if ($employee_id == $approvers_info[0]) { ?>
                                    <?php  if(!empty($approvers_info[1])){ ?>
                                            <?php if($purchase_invoice_info[0]['audit_status']=="Pending"){ ?>
                                                    <button onclick="approve('<?php echo site_url('purchase_invoices/forward_invoice/'.$purchase_invoice_info[0]['inv_id']); ?>')" class="btn btn-success">Forward</button>&nbsp;&nbsp;
                                                     <button onclick="reject('<?php echo site_url('purchase_invoices/reject_invoice/'.$purchase_invoice_info[0]['inv_id']); ?>')" class="btn btn-warning">Reject</button>
                                            <?php } ?>

                                     <?php }else{ ?>
                                               <?php if($purchase_invoice_info[0]['audit_status']=="Pending"){ ?>
                                                     <button onclick="approve('<?php echo site_url('purchase_invoices/approve_invoice/'.$purchase_invoice_info[0]['inv_id']); ?>')" class="btn btn-primary">Approve</button>&nbsp;&nbsp;
                                                      <button onclick="reject('<?php echo site_url('purchase_invoices/reject_invoice/'.$purchase_invoice_info[0]['inv_id']); ?>')" class="btn btn-warning">Reject</button>
                                               <?php } ?>
                                     <?php } ?>           
                            <?php } ?>
                           ...
                           <?php if ($employee_id == $approvers_info[1]) { ?>
                                    <?php  if(!empty($approvers_info[2])){ ?>
                                            <?php if($purchase_invoice_info[0]['audit_status']=="Forward-By-First-Approver"){ ?>
                                                    <button onclick="approve('<?php echo site_url('purchase_invoices/forward_invoice/'.$purchase_invoice_info[0]['inv_id']); ?>')" class="btn btn-success">Forward</button>&nbsp;&nbsp;
                                                    <button onclick="reject('<?php echo site_url('purchase_invoices/reject_invoice/'.$purchase_invoice_info[0]['inv_id']); ?>')" class="btn btn-warning">Reject</button>
                                            <?php } ?>
                            ...
                            <?php if ($employee_id == $approvers_info[2]) { ?>
                                    <?php  if(!empty($approvers_info[3])){ ?>
                                            <?php if($purchase_invoice_info[0]['audit_status']=="Forward-By-Second-Approver"){ ?>  
                                                     <button onclick="approve('<?php echo site_url('purchase_invoices/forward_invoice/'.$purchase_invoice_info[0]['inv_id']); ?>')" class="btn btn-success">Forward</button>&nbsp;&nbsp;
                                                     <button onclick="reject('<?php echo site_url('purchase_invoices/reject_invoice/'.$purchase_invoice_info[0]['inv_id']); ?>')" class="btn btn-warning">Reject</button>
                                            <?php } ?>
                           ...
                           <?php if ($employee_id == $approvers_info[3]) { ?>
                                         ...
                                         <?php if($purchase_invoice_info[0]['audit_status']=="Forward-By-Third-Approver"){ ?>       
                                                <button onclick="approve('<?php echo site_url('purchase_invoices/approve_invoice/'.$purchase_invoice_info[0]['inv_id']); ?>')" class="btn btn-primary">Approve</button>&nbsp;&nbsp;
                                                <button onclick="reject('<?php echo site_url('purchase_invoices/reject_invoice/'.$purchase_invoice_info[0]['inv_id']); ?>')" class="btn btn-warning">Reject</button>
                                         <?php } ?>      
                        ...
                        <form class="form-horizontal" action="<?php echo site_url('purchase_invoices/edit_purchase_invoice_action/'.$purchase_invoice_info[0]['inv_id']); ?>" method="post" onsubmit="javascript: return validation()">
                            <div class="row" >
                                <div class='form-group'  >
                                    ...
                                    <div class="col-sm-6 input-group">
                                        ...
                                        <b><?php if($order['o_id']==$purchase_invoice_info[0]['po_id']) echo $order['SUP_NAME'] . '(' . $order['short_name'] . ')' . '(' . $order['order_no'] . ')' ?></b>
                                            <?php } ?>
                            ...
                            <div class="row" style="margin-top:5px;">
                                ...
                                <div class="col-sm-4 input-group">
                                    ...
                                    <b><?php if(!empty($purchase_invoice_info[0]['billing_address'])) echo $purchase_invoice_info[0]['billing_address'];  ?></b>
                            ...
                            <div class="row" style="margin-top:5px;">
                                    <div class='form-group' >
                                        ...
                                        <div class="col-sm-4 input-group">
                                            ...
                                            <b><?php if(!empty($purchase_invoice_info[0]['billing_email'])) echo $purchase_invoice_info[0]['billing_email'];  ?></b>
                                            ...
                                            foreach($invoice_details_info as $invoice_detail){ 
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: right;">
                                                        <b><?php echo $invoice_detail['quantity']; ?></b>
                                                    </td>
                                                    <td style="text-align: right;">
                                                        <b><?php echo $invoice_detail['unit_price']; ?></b>
                                                    </td>
                                                    <td style="text-align: right;">
                                                        <b><?php echo $invoice_detail['amount']; ?></b>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                        <?php } ?>
