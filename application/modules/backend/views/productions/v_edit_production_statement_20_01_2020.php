                 ...
                 <thead class="thead-color">
                    ...
                    <?php $i=0; foreach($production_details as $details){ $i++;?>
                      ...
                      <tr id="row_1">      
                            ...
                            <td><input type="text" onkeyup="productionCumQtyValidation(<?php echo $i; ?>)" onchange="productionCumQtyValidation(<?php echo $i; ?>)" id="production_qty_cum_<?php echo $i; ?>" class="number"  name="production_qty_cum[]" value="<?php echo round($details['schedule_qty']/35.31,2); ?>" /></td>;
                                                   <?php }else if($details['measurement_unit']=='MT'){ ?>
            <td><input type="text" onkeyup="productionCumQtyValidation(<?php echo $i; ?>)" onchange="productionCumQtyValidation(<?php echo $i; ?>)" id="production_qty_cum_<?php echo $i; ?>" class="number"  name="production_qty_cum[]" value="<?php echo round($details['schedule_qty']/2.41,2); ?>" /></td>
        <?php }else{ ?>
            <td><input type="text" onkeyup="productionCumQtyValidation(<?php echo $i; ?>)" onchange="productionCumQtyValidation(<?php echo $i; ?>)" id="production_qty_cum_<?php echo $i; ?>" class="number"  name="production_qty_cum[]" value="<?php echo round($details['schedule_qty'],2); ?>" /></td>
        <?php } ?>
