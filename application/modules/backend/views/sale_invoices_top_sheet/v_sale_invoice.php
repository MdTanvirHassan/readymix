...
<!--                                    <input style="padding: 6px 40px;" type="submit" class="btn btn-primary" value="SEARCH"/>
                        ...
                        <?php if (in_array(2, $this->role)) { ?>
                            <a href="<?php echo site_url('sale_invoices_top_sheet/add_sale_invoice'); ?>" class="btn btn-sm btn-primary">ADD INVOICE</a>
                                        ...
                                        <tr>
                                            ...
                                            <td class="col-md-4">
                                                ...
                                                <?php if (in_array(4, $this->role)) { ?>  
                                                    ...
                                                    <a href="<?php echo site_url('sale_invoices_top_sheet/details_sale_invoice/' . $invoice['inv_id']); ?>"><button class="btn btn-sm btn-primary">View</button></a>
                                                ...
                                                <?php } ?>     
                                                    ...
                                                    <a href="<?php echo site_url('sale_invoices_top_sheet/edit_sale_invoice/' . $invoice['inv_id']); ?>"><button class="btn btn-sm btn-info">Edit</button></a>
                                                           
                                                    <?php } ?>

                                                    <?php if (in_array(5, $this->role)) { ?>    
                                                       
                                                          <button onclick="delete_row('<?php echo site_url('sale_invoices_top_sheet/delete_sale_invoice/' . $invoice['inv_id']); ?>')" class="btn btn-sm btn-danger">Delete</button>
