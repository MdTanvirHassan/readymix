    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_content">
                        <form class="form-horizontal" action="<?php echo site_url('sale_invoices/edit_direct_sale_invoice_action/'.$sale_invoice_info[0]['inv_id']); ?>" method="post" onsubmit="javascript: return validation()">
                                        ...
                                        <tbody id="sale_items">
                                            <?php $i=0; foreach($sale_invoice_details_info as $sale_order_details){ 
                                                 ...
                                                 <tr class="" id="row_<?php echo $i; ?>">
                                                    <td><input  type="hidden"  name="s_item_id[]" id="product_id_<?php echo $i; ?>" class="issue" value="<?php echo $sale_order_details['s_item_id'] ?>"><input readonly style="width:140px;"  type="text"  name="name[]" id="item_des_c_<?php echo $i; ?>" class="issue" value="<?php echo $sale_order_details['product_name'] ?>"></td>
