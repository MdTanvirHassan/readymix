...
<!--                                       <span id="do_id_error" style="color:red"></span>-->
                                ...
                                <div class="col-sm-3">
                                    <label for="title" class="control-label">
                                    Select S.O<sup class="required">*</sup>  :
                                </label>
                                    <div class="input-group">
                                       <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                     <select  class="form-control e1" id="o_id" name="o_id" onchange="javascript:delivery_order_info();">
                            ...
                            <div class='form-group' >
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <div class="input-group">
                                       ...
                                       <input  type="text" name="from_date" id="from_date" class="form-control datepicker" value="<?php if(!empty($f_date)) echo $f_date; ?>" placeholder="From Date"> 
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <div class="input-group">
                                       <span class="input-group-addon"><i class="fa fa-clock-o"></i></span>
                                       <input  type="text" id="to_date" name="to_date" class="form-control datepicker" value="<?php if(!empty($to_date)) echo $to_date; ?>" placeholder="To Date"/>
                                ...
                                <div class="col-md-3">
                                    <a  onclick="javascript:searchForDc();" id="search" class="btn btn-primary" style="margin-top: 23px;">Search</a>
                                </div>
                            </div>
...
//                    $('#advance_adjusted_amount').val(msg.order_info[0].advance_received);
                    ...
                    if(msg.item_list!=''){
                        $(msg.item_list).each(function (i, v) {
                            ...
                            str +='<input readonly  style="width:140px;"  type="text"  name="dc_no[]" id="dc_no" class="issue" value="' + v.dc_no + '">';
                            str +='</td>';
    ...
    function project_info(){
        ...
        function delivery_order_info(){
                ...
                if(o_id!=''){
                    $.ajax({
                        type: "POST",
                        url: "backend/sales_report/deliveryOrderInfoSaleOrderWise",
                        data: "o_id="+o_id,
                        dataType: "json",
                        success: function (data){
                            var str1='';
...
//            $('#project_id').val('');
            ...
            var data = {'customer_id':customer_id,'project_id':project_id,'o_id':o_id,'do_id': do_id,'from_date': from_date,'to_date': to_date,}
            $.ajax({
                url: '<?php echo site_url('sale_invoices/get_order_item_new'); ?>',
                data: data,
                method: 'POST',
                dataType: 'json',
                success: function (msg) {
