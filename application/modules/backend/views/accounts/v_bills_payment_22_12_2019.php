     ...
     <div class="os-tabs-w menu-shad">
        <div class="os-tabs-controls">
            <ul class="nav nav-tabs upper">
                <?php 
                $this->role = checkUserPermission(9, 58, $userData); 
                ...
                <?php } ?> 
                <?php $this->role = checkUserPermission(9,59, $userData); if(empty($this->role) || !in_array(11,$this->role)){ ?>     
                    <li class="nav-item">
                ...
                <?php } ?>
                 ...
                 <?php $this->role = checkUserPermission(9, 60, $userData); if(empty($this->role) || !in_array(11,$this->role)){ ?>
                        <li class="nav-item">
