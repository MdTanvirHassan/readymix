    ...
    <form class="form-horizontal"  action="<?php echo site_url('accounts/add_payment_action'); ?>" method="post" onsubmit="javascript: return validation()">
        ...
        <div class='form-group' style="margin-bottom:30px;" >
                            ...
                            <?php foreach($invoices as $invoice){ ?>
                                <option class="form-control" value="<?php echo $invoice['inv_id'] ?>"><?php echo $invoice['inv_no']; ?></option>
                            <?php } ?>
        ...
        <div class='form-group' >
                            ...
                            <option class="form-control" value="Due">Due</option>    
         ...
         <div class='form-group' >
                                ...
                                <div class="col-sm-4 input-group">
                                    ...
                                    <select  id="payment_method" class="form-control" name="payment_method">
                                            ...
                                            <?php foreach($payment_modes as $mode){ ?>
                                                    <option class="form-control" value="<?php echo $mode['id']; ?>"><?php echo $mode['mode_name']; ?></option>
                                            <?php } ?>
                         ...
                         <span id="collection_method_error" style="color:red"></span>
                                ...
                                <div class="col-sm-4 input-group">
                                    <span class="input-group-addon"><i class="fa fa-check-square"></i></span>
                                    <input readonly   id="bill_amount" class="form-control number" name="bill_amount" type="text">
        ...
        if(inv_id!=''){
             ...
             $.ajax({
                    ...
                    success: function (msg) { 
                       var total_amount=msg.invoice_info[0].total_amount;
                      $('#bill_amount').val(total_amount);
