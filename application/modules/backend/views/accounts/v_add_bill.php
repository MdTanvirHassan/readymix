    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_content">
    <form class="form-horizontal"  action="<?php echo site_url('accounts/add_bill_action'); ?>" method="post" onsubmit="javascript: return validation()">
        ...
        <div class='form-group' >
                ...
                <div class="col-sm-4 input-group">
                    <span class="input-group-addon"><i class="fa fa-check-square"></i></span>
                    <input    id="supplier_bill_no" class="form-control " name="supplier_bill_no" type="text">
