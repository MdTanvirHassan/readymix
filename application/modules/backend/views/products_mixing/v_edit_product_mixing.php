            ...
            <table class="table table-bordered" id="myTable">
                    ...
                    foreach ($mixing_details_info as $mixing) {  
                      ...
                      <tr class="" id="row_<?php echo $i; ?>">
                          ...
                          <td> <select required style="width:200px;" class="e1" style="width:100px;" id="material_<?php echo $i; ?>" name="m_id[]" >
                         ...
                         <td>
                              <select required style="width:150px;" class="e1" style="width:100px;" id="mu_id_<?php echo $i; ?>" name="mu_id[]" >
                                       <option value="">Select Mu</option>
                                       <?php foreach($measurement_units as $unit){ ?>
                                           <option <?php if (!empty($mixing['mu_id']) && $mixing['mu_id'] == $unit['id']) echo "selected"; ?> value="<?php echo $unit['id'];  ?>"><?php if(!empty($unit['meas_unit'])) echo $unit['meas_unit']; ?></option>
                                       <?php } ?>
                              </select>
                        </td>                     
