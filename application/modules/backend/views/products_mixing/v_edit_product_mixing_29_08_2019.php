            ...
            <table class="table table-bordered" id="myTable">
                    ...
                    foreach ($mixing_details_info as $mixing) {  
                      ...
                      <tr class="row" id="row_<?php echo $i; ?>">
                        ...
                        <td><input required  style="width:140px;"  type="text"  name="quantity[]" id="quanity_<?php echo $i; ?>" class="issue number" value='<?php echo $mixing['quantity'];  ?>'></td>
                        <td><input required  style="width:140px;"  type="text"  name="conversion_factor[]" id="conversion_factor_<?php echo $i; ?>" class="issue number" value='<?php echo $mixing['conversion_factor'];  ?>'></td>
                        <?php if ($i > 1) { ?>
...
<!--                        <div class="row">
    ...
    <script type="text/javascript">
        ...
        str +='<td><input required  style="width:140px;"  type="text"  name="conversion_factor[]" id="conversion_factor_'+(Number(count) + 1) + '" class="issue number"></td>';
