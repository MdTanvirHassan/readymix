            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_content">
                        ...
                        <form class="form-horizontal" action="<?php echo site_url('products_mixing/add_product_mixing_action'); ?>" method="post" onsubmit="javascript: return validation()">
...
<!--                            <div class="row">
              ...
              <p><b>MATERIALS REQUIRE FOR 01 <span id="m_unit" ></span></b></p>   
            ...
            <table class="table table-bordered" id="myTable">
                    ...
                    <tbody>
                      ...
                      <tr class="" id="row_1">
                          ...
                          <td> 
                              <select required style="width:200px;" class="e1" style="width:100px;"  id="material_1" name="m_id[]" onchange="javascript:item_info(1);" >
                        ...
                        <td>
                            <select required style="width:150px;" class="e1" style="width:100px;"  id="mu_id_1" name="mu_id[]"  >
                                    <option value="">Select Mu</option>
                                    <?php foreach($measurement_units as $unit){ ?>
                                        <option value="<?php echo $unit['id'];  ?>"><?php if(!empty($unit['meas_unit'])) echo $unit['meas_unit']; ?></option>
                                    <?php } ?>
                             </select>
                        </td>     
                        
                        <td><input required style="width:140px;text-align:right;"  type="text"  onkeyup="calculateConvertQnty(1)" onchange="calculateConvertQnty(1)"   name="quantity[]" id="quantity_1" class="issue number"></td>
                        
                        <td><input required style="width:140px;text-align:right;"  type="text"  name="conversion_factor[]" onkeyup="calculateConvertQnty(1)" onchange="calculateConvertQnty(1)"  id="conversion_factor_1" class="issue number"></td>
                        <td><input required style="width:140px;text-align:right;"  type="text"  name="c_quantity[]" onkeyup="calculateRequireQnty(1)" onchange="calculateRequireQnty(1)"  id="c_quantity_1" class="issue number"></td>
                        <td><input readonly style="width:140px;"  type="text"  name="c_mu[]" id="c_mu_1" class="issue "></td>
                        <td></td>
                      </tr>
                      </tbody>
                  </table>
...
<!--                        <div class="row">
    ...
    <script type="text/javascript">
        ...
        function calculateConvertQnty(id){
            ...
            var item_m_unit=$('#mu_id_'+id).val();
            var meas_unit_name=$("#mu_id_"+id+" option:selected").text();
   ...
   function validation(){
        ...
        var mustr=$('#mu_id_1').html();
        
        var str= '<tr class="" id="row_' + (Number(count) + 1) + '">';
        str +='<td>'+(Number(count) + 1)+'</td>';
        str +='<td><select required class="e1" style="width:200px;"  name="m_id[]"  id="material_'+(Number(count)+1) + '" class="">'+itemstr+'</select></td>';
        str +='<td><select required class="e1" style="width:150px;"  name="mu_id[]"  id="mu_id_'+(Number(count)+1) + '" class="">'+mustr+'</select></td>';
