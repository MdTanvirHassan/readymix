 <div class="right_col" style="background-color: #f1f1f1;padding-bottom:20px;">
            <h2 style="text-align:center; ">Add Mixing Item </h2>
            <hr>
            <form action="<?php echo site_url('products_mixing/add_product_mixing_action'); ?>" method="post">
            ...
            <table class="table table-bordered" id="myTable">
                    ...
                    <tbody>
                      ...
                      <tr class="row" id="row_1">
                        ...
                        <td><input required style="width:140px;"  type="text"  name="quantity[]" id="quanitty_1" class="issue"></td>
