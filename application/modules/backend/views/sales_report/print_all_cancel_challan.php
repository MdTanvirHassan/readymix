...
<div style="padding-top:30px;" class="col-md-10 col-md-offset-1">
    ...
    <p style=" text-align: center;margin-top:-5px;margin-bottom:5px;">Canceled Challan</p> 
                ...
                <tr></tr>
                                ...
                                <tr>
                                  ...
                                  <?php if($user_type!=4){ ?>
                                   ...
                                   <th style="border-left:1px solid;border-top:1px solid;width:50px;">Bill Status</th>
                                  <?php }else{ ?>
                                   <th style="border-left:1px solid;border-top:1px solid;width:50px;">Qnty</th>
                                  <?php } ?>
                                   <th style="border-left:1px solid;border-top:1px solid;width:50px;border-right:1px solid;">Remark</th>
                                                            ...
                                                            foreach($challans as $challan){ 
                                                                ...
                                                                ?> 
                                                                     ...
                                                                     <tr>
                                                                        ...
                                                                        <?php if($user_type!=4){ ?>
                                                                            <td style="border-left:1px solid;border-top:1px solid;text-align:right;"><?php if(!empty($challan['quantity'])) echo number_format($challan['quantity'],2); ?></td>
                                                                            <td style="border-left:1px solid;border-top:1px solid;text-align:right;"><?php if(!empty($challan['unit_price'])) echo number_format($challan['unit_price'],2); ?></td>
                                                                            ...
                                                                            <td style="border-left:1px solid;border-top:1px solid;text-align:center;"><?php if(!empty($challan['bill_status'])) echo $challan['bill_status']; ?></td>
                                                                        <?php }else{ ?>
                                                                            <td style="border-left:1px solid;border-top:1px solid;text-align:right;"><?php if(!empty($challan['quantity'])) echo number_format($challan['quantity'],2); ?></td>
                                                                        <?php } ?> 
                                                                            
                                                                        <td style="border-left:1px solid;border-top:1px solid;border-right:1px solid;"><?php if(!empty($challan['remark'])) echo $challan['remark']; ?></td>
