...
<div style="padding:0" class="col-md-10 col-md-offset-1">
    ...
    <p style=" text-align: center;margin-top:-2px;margin-bottom:5px;">Cheque/PO/BG At Hand</p> 
            ...
            <thead>
                <tr></tr>
                                ...
                                <tr>
                                   ...
                                   <th style="border-left:1px solid;border-top:1px solid;width:150px;">Bank Deposit Date</th>
                                                            ...
                                                            foreach($orders as $order){ 
                                                                ...
                                                                ?> 
                                                                     ...
                                                                     <tr>
                                                                       ...
                                                                       <td style="border-left:1px solid;border-top:1px solid;"><?php if(!empty($order['bank_deposit_date'])) echo date('d-m-Y',strtotime($order['bank_deposit_date'])); ?></td>
