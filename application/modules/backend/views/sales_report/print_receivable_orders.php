...
<div style="padding:0" class="col-md-10 col-md-offset-1">
    ...
    <p style=" text-align: center;margin-top:-2px;margin-bottom:5px;">Receivable Sales Orders</p> 
            ...
            <thead>
                <tr></tr>
                                ...
                                <tr>
                                   ...
                                   <th style="border-left:1px solid;border-top:1px solid;width:100px;">Value</th>
                                   <th style="border-left:1px solid;border-top:1px solid;width:100px;">Received</th>
                                   <th style="border-left:1px solid;border-top:1px solid;border-right:1px solid;width:100px;">Due</th>
                                </tr>
                            </thead>
                             <tbody>
                                                            ...
                                                            foreach($orders as $order){ 
                                                                ...
                                                                ?> 
                                                                     ...
                                                                     <tr>
                                                                        ...
                                                                        <td style="border-left:1px solid;border-top:1px solid;text-align:right;"><?php if(!empty($order['total_amount'])) echo $order['total_amount']; ?></td>
                                                                        <td style="border-left:1px solid;border-top:1px solid;text-align:right;"><?php if(!empty($order['received_amount'])) echo $order['received_amount']; ?></td>
                                                                        <td style="border-left:1px solid;border-top:1px solid;border-right:1px solid;text-align:right;"><?php if(!empty($order['due_amount'])) echo $order['due_amount']; ?></td>

                                                                    </tr>
                                                            <?php } ?>
                                                                    <tr>
                                                                        <td colspan="5" style="text-align:right;border-left:1px solid;border-top:1px solid;border-bottom:1px solid;">Total</td>
                                                                        <td  style="text-align:right;border-left:1px solid;border-top:1px solid;border-bottom:1px solid;"><?php echo $total; ?></td>
                                                                        <td  style="text-align:right;border-left:1px solid;border-top:1px solid;border-bottom:1px solid;"><?php echo $t_received; ?></td>
                                                                        <td  style="text-align:right;border-left:1px solid;border-top:1px solid;border-right:1px solid;border-bottom:1px solid;"><?php echo $t_due; ?></td>
                                                                    </tr>
