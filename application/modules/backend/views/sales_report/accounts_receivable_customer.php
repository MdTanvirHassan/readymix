                ...
                <div class="panel-body">
                    ...
                    <div class="row" style="margin-top:-50px;">
                        <div id="remover" class="col-md-6 col-md-offset-3">
                            <form id="item-form" action="<?php echo site_url('sales_report/accounts_receivable_customer/'.$f_date.'/'.$to_date.'/'.$category_id.'/true'); ?>" method="post">
                                ...
                                <div style="margin-top: 15px;" class="col-md-10">
                                    ...
                                    <div class="col-md-10 col-md-offset-3">
                                        ...
                                        <input id="form-submit" style="padding: 6px 40px;" type="submit" class="btn btn-primary" value="PRINT" />
                    ...
                    <div id="header_div" style="margin-top: 10px;text-align: center;" class="col-md-10 col-md-offset-1">
                        ...
                        <h4>Accounts Receivable - <?php echo $cat_info[0]['category_name']; ?></h4>
                        <h4>Group Summary</h4>
