<div class="right_col" role="main" style="padding: 0px;">
                ...
                <div class="panel-body">
                    ...
                    <div class="row" style="margin-top:-50px;">
                        <div id="remover" class="col-md-6 col-md-offset-3">
                            <form id="item-form" action="<?php site_url('backend/sales_report/accounts_receivable'); ?>" method="post">


                                <div class="row">

                                    <div style="margin-top: 15px;" class="col-md-5 col-md-offset-1">
                                        <input type="text" name="from_date" class="form-control datepicker" autocomplete="off" value="<?php if (!empty($f_date)) echo $f_date; ?>" placeholder="From Date" />
                                    </div>

                                    <div style="margin-top: 15px;" class="col-md-5 ">
                                        <input type="text" name="to_date" class="form-control datepicker" autocomplete="off" value="<?php if (!empty($to_date)) echo $to_date; ?>" placeholder="To Date" />
                                    </div>
                                </div>
                                <!--End Row-->
                    ...
                    <div id="header_div" style="margin-top: 10px;text-align: center;" class="col-md-10 col-md-offset-1">
                        ...
                        <h4>Group Summary</h4>
                        <h4>Date : <?php if ($f_date == $to_date) echo date('d-m-Y', strtotime($f_date));
                                    else echo date('d-m-Y', strtotime($f_date)) . ' to ' . date('d-m-Y', strtotime($to_date)) ?></h4>
                    </div>
                    ...
                    <div class="tableFixHead" id="removeRow" style="width: 100%;height:500px;overflow-x: scroll;margin-bottom: 20px;">
                        ...
                        <table style="width:100%;font-size: 12px;" id="player_table" class="table table-bordered">
                            ...
                            <tbody style="">
                                ...
                                ?>
                                        <tr>
                                            <td><a target="_blank" href="<?php echo site_url('sales_report/accounts_receivable_customer/'.$f_date.'/'.$to_date.'/'.$pro['category_id']); ?>"><?php echo $pro['category_name']; ?></a></td>
    ...
    <script type="text/javascript">
        ...
        function submitForm(type) {
            if (type == 'print')
                var url = '<?php echo site_url(); ?>backend/sales_report/accounts_receivable/true';
            else
                var url = '<?php echo site_url(); ?>backend/sales_report/challanInvoiceComparisonExcel';
            $('#item-form').attr('action', url);
            $('#form-submit').click();
            $('#item-form').attr('action', '<?php echo site_url('backend/sales_report/accounts_receivable'); ?>');
        }
    </script>