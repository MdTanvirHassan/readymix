                          ...
                          <div class="row">  
                                ...
                                <div style="margin-top: 15px;" class="col-md-5 col-md-offset-1">
                                 ...
                                 <div style="margin-top: 15px;" class="col-md-5 ">
                                    <input  type="text" name="to_date" class="form-control datepicker1" value="<?php if(!empty($to_date)) echo $to_date; ?>" placeholder="To Date"/>
                                </div>
                          </div><!--End Row-->  
        ...
        <thead>
            <tr>
               ...
               <!-- <th class="col-lg-1">Challan Status</th>-->
                ...
                <th class="col-lg-1">Closing Reason</th>
                ...
                foreach ($delivery_orders as $order) { ?>
                    <tr>
                      ...
                      -->
                        ...
                        <td style="text-align: left">
                                <?php if(!empty($order['closing_reason'])) echo $order['closing_reason']; ?>
                        </td>
                          ...
                          <?php if(in_array(6,$this->role)){?>   
                               <?php if($order['closing_status']!="Closed"){ ?>       
                                  <!--  <button onclick="close_do('<?php echo site_url('delivery_orders/close_delivery_order/'.$order['do_id']."/".$customer_id); ?>')" class="btn btn-sm btn-danger" style="background-color: yellow;color:black;">Close</button> -->
                                    <button onclick="close_do(<?php echo $order['do_id']; ?>)" class="btn btn-sm btn-danger" style="background-color: yellow;color:black;">Close</button>
...
<!--Close Modal -->
<div class="modal fade" id="close_delivery_order"  role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="leave_form" action="<?php echo site_url('delivery_orders/close_delivery_order'); ?>" method="post">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title" id="myModalLabel">Close Delivery Order</h4>
                </div>
                        ...
                        <fieldset>
                            <div style="border:1px solid #cccccc;padding:13px 7px 1px 7px;margin-bottom:5px;">
                                ...
                                <div class="form-group" id="casual_leave_assign" >
                                    <label style="float:left;width:150px;">Reason: </label>
                                    <input type="hidden" style="width:300px;" class="form-control " placeholder="" id="do_id" name="do_id" type="text" value="">
                                 
                                    <textarea required class="form-controll" rows="5" cols="5" id="closing_reason" name="closing_reason"></textarea>
                                </div>
...
<script type="text/javascript">
 ...
 $('.datepicker1').datepicker({
    ...
    function close_do(id){
        $('#do_id').val(id);  
        $('#close_delivery_order').modal('show');
    }


    function close_do_30_03_2023(url){
    bootbox.confirm({
