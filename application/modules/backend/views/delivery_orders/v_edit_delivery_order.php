                ...
                <table class="table table-bordered" >
                    ...
                    <tbody id="delivery_items">
                         ...
                         <tr class="" id="row_<?php echo $quotation_details['s_item_id'] ?>">
                             ...
                             <td>
                                 <input type="hidden"  style="width:140px;text-align:right;"  type="text"  name="base_price[]" id="base_price_<?php echo $i; ?>" class="issue" value="<?php echo $delivery_order_details['base_price'] ?>">
                                 <input type="hidden"  style="width:140px;text-align:right;"  type="text"  name="vat[]" id="vat_<?php echo $i; ?>" class="issue" value="<?php echo $delivery_order_details['vat'] ?>">
                            ...
                            <td><input   style="width:140px;text-align: left;"  type="text" class="remark_<?php echo $i; ?>"  name="remark[]" id="remark_<?php echo $i; ?>" class="issue" value="<?php echo $delivery_order_details['remarks'] ?>"></td>
