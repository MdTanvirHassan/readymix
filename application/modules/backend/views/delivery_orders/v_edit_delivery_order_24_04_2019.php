         ...
         <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group row">
                    ...
                    <div class="col-sm-8 col-md-5 "><input required id="attention" class="form-control" name="attention" type="text" value="<?php if(!empty($delivery_order_info[0]['attention'])) echo $delivery_order_info[0]['attention']; ?>"></div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group row">
                    ...
                    <div class="col-sm-8 col-md-5 "><input required id="project_name" class="form-control" name="project_name" type="text" value="<?php if(!empty($delivery_order_info[0]['project_name'])) echo $delivery_order_info[0]['project_name']; ?>"></div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group row">
                    ...
                    <div class="col-sm-8 col-md-5 "><input required class="form-control" id="phone" name="phone" type="text" value="<?php if(!empty($delivery_order_info[0]['phone'])) echo $delivery_order_info[0]['phone']; ?>"></div>
                </div>
            </div>
                ...
                <table class="table table-bordered" >
                    ...
                    <tbody id="delivery_items">
                         ...
                         <tr class="" id="row_<?php echo $quotation_details['s_item_id'] ?>">
                             ...
                             <td><input required readonly  style="width:140px;"  type="text"  name="quantity[]" id="item_quantity_<?php echo $delivery_order_details['s_item_id'] ?>" class="issue" value="<?php echo $delivery_order_details['quantity'] ?>"></td>
