...
<div style="padding:50;" class="col-md-10 col-md-offset-1">
    ...
    <p style=" text-align: center;text-decoration: underline;margin-top:-7px;">DELIVERY ORDER</p>
       ...
       <table class="table table-bordered table-hover table-striped" style="margin:0 auto;">
           <tr>
               <td colspan="3" style="text-align:left;">D.O. No.: <?php echo ucfirst($delivery_order_info[0]['delivery_no']); ?></td>
               <td colspan="2" style="text-align:left;">Date: <?php  echo date('d-m-Y',strtotime($delivery_order_info[0]['delivery_order_date'])); ?></td>
           </tr>
           <tr>
               <td colspan="3" style="text-align:left;">S.O. No.: <?php echo ucfirst($delivery_order_info[0]['order_no']); ?></td>
               <td colspan="2" style="text-align:left;">Date: <?php  echo date('d-m-Y',strtotime($delivery_order_info[0]['sale_order_date'])); ?></td>
           </tr>
           <tr>
               <td colspan="3" style="text-align:left;">Customer Name: <?php echo ucfirst($delivery_order_info[0]['c_name']); ?></td>
               <td colspan="2" style="text-align:left;">Project Name: <?php  echo $delivery_order_info[0]['project_name']; ?></td>
           </tr>
           <tr>
               <td colspan="3" style="text-align:left;">Customer Address: <?php echo ucfirst($delivery_order_info[0]['billing_address']); ?></td>
               <td colspan="2" style="text-align:left;">Project Address: <?php  echo $delivery_order_info[0]['shipping_address']; ?></td>
           </tr>
           <tr>
               <td colspan="3" style="text-align:left;">Contact Person: <?php echo ucfirst($delivery_order_info[0]['attention']); ?></td>
               ...
               <?php $i=0; foreach($delivery_order_details_info as $delivery_order_details){ $i++;
                   ...
                   <?php if($i==$count){ ?>  
                           <tr id="row_1">
                            ...
                            <td style="border-left:1px solid;border-top:1px solid;border-bottom:1px solid;"><?php if(!empty($delivery_order_details['product_name'])) echo $delivery_order_details['product_name'];  ?></td>
                            <td style="border-left:1px solid;border-top:1px solid;border-bottom:1px solid;"><?php if(!empty($delivery_order_details['performance'])) echo $delivery_order_details['performance'];  ?></td> 
                            <td style="border-left:1px solid;border-top:1px solid;text-align:center;border-bottom:1px solid;"><?php if(!empty($delivery_order_details['quantity'])) echo $delivery_order_details['quantity'];  ?></td>
                            <td style="border-left:1px solid;border-top:1px solid;border-bottom:1px solid;"><?php if(!empty($delivery_order_details['measurement_unit'])) echo $delivery_order_details['measurement_unit'];  ?></td>
                            <td style="border-left:1px solid;border-top:1px solid;border-right:1px solid;text-align:right;border-bottom:1px solid;"><?php if(!empty($delivery_order_details['remark'])) echo $delivery_order_details['remark'];  ?></td>
                        </tr>  
                  <?php }else{ ?>  
                        <tr id="row_1">
