                    ...
                    success: function (msg) { 
                      ...
                      //  $('#customer_id').val(msg.sales_order_info[0].id);  
                        ...
                        //     total=total+Number(v.amount);
                             ...
                             str +='<input hidden  style="width:140px;text-align:right;"  type="text"  name="base_price[]" id="base_price_'+Number(i+1)+'" class="issue number" value="'+v.base_price+'">';
                             str +='<input hidden  style="width:140px;text-align:right;"  type="text"  name="vat[]" id="vat_'+Number(i+1)+'" class="issue number" value="'+v.vat+'">';
