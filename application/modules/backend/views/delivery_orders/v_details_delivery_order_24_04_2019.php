        ...
        <div class="row">
            <div class="col-md-6">
                    ...
                    <div class="col-sm-8 col-md-5 ">
                        <select disabled required id="o_id" class="form-control" name="o_id">
         ...
         <div class="row">
            <div class="col-md-6">
                <div class="form-group row">
                    ...
                    <div class="col-sm-8 col-md-5 "><input disabled required class="form-control datepicker" name="delivery_order_date" type="text" value="<?php if(!empty($delivery_order_info[0]['delivery_order_date'])) echo date('d-m-Y',strtotime($delivery_order_info[0]['delivery_order_date'])); ?>"></div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group row">
                    ...
                    <div class="col-sm-8 col-md-5 "><input readonly required id="attention" class="form-control" name="attention" type="text" value="<?php if(!empty($delivery_order_info[0]['attention'])) echo $delivery_order_info[0]['attention']; ?>"></div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group row">
                    ...
                    <div class="col-sm-8 col-md-5 "><input readonly required id="project_name" class="form-control" name="project_name" type="text" value="<?php if(!empty($delivery_order_info[0]['project_name'])) echo $delivery_order_info[0]['project_name']; ?>"></div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group row">
                    ...
                    <div class="col-sm-8 col-md-5 "><input readonly required class="form-control" id="phone" name="phone" type="text" value="<?php if(!empty($delivery_order_info[0]['phone'])) echo $delivery_order_info[0]['phone']; ?>"></div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group row">
                    ...
                    <div class="col-sm-8 col-md-5 "><input readonly required id="billing_address" class="form-control" name="billing_address" type="text" value="<?php if(!empty($delivery_order_info[0]['billing_address'])) echo $delivery_order_info[0]['billing_address']; ?>"></div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group row">
                    <div class="col-sm-4 col-md-3   labeltext" style="text-align: right;"><label for="inputdefault">Billing Email :</label></div>
                    <div class="col-sm-8 col-md-5 "><input readonly class="form-control" id="billing_email" name="billing_email" type="text" value="<?php if(!empty($delivery_order_info[0]['billing_email'])) echo $delivery_order_info[0]['billing_email']; ?>"></div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group row">
                    ...
                    <div class="col-sm-8 col-md-5 "><input readonly required class="form-control" id="shipping_address" name="shipping_address" type="text" value="<?php if(!empty($delivery_order_info[0]['shipping_address'])) echo $delivery_order_info[0]['shipping_address']; ?>"></div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group row">
                    <div class="col-sm-4 col-md-3   labeltext" style="text-align: right;"><label for="inputdefault">Delivery Email :</label></div>
                    <div class="col-sm-8 col-md-5 "><input readonly class="form-control" id="shipping_email" name="shipping_email" type="text" value="<?php if(!empty($delivery_order_info[0]['shipping_email'])) echo $delivery_order_info[0]['shipping_email']; ?>"></div>
                </div>
            </div>
                ...
                <table class="table table-bordered" >
                    ...
                    <tbody id="delivery_items">
                         ...
                         <tr class="" id="row_<?php echo $quotation_details['s_item_id'] ?>">
                             ...
                             <td><input readonly required readonly  style="width:140px;"  type="text"  name="quantity[]" id="item_quantity_<?php echo $delivery_order_details['s_item_id'] ?>" class="issue" value="<?php echo $delivery_order_details['quantity'] ?>"></td>
