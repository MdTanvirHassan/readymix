    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_content">
            <form class="form-horizontal" action="<?php echo site_url('bank_branches/edit_bank_branch_action/'.$bank_branch_info[0]['id']); ?>" method="post" onsubmit="javascript: return validation()">
                ...
                <div class='form-group' >
                                ...
                                <div class="col-sm-4 input-group">
                                    ...
                                    <input  class="form-control" id="category_name" name="branch_name" type="text" value="<?php if(!empty($bank_branch_info[0]['branch_name'])) echo $bank_branch_info[0]['branch_name']; ?>">
...
<!--                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8 col-md-5 ">
                                <input  class="form-control" id="category_name" name="category_name" type="text" value="<?php if(!empty($bank_branch_info[0]['category_name'])) echo $bank_branch_info[0]['category_name']; ?>">
                                <span id="category_name_error" style="color:red"></span>
                            </div>
                        </div>
                    </div>
                   ...
                   <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8 col-md-5 ">
                                <input  class="form-control" id="short_name" name="short_name" type="text" value="<?php if(!empty($bank_branch_info[0]['short_name'])) echo $bank_branch_info[0]['short_name']; ?>">
