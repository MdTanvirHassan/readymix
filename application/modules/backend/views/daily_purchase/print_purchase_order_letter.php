       ...
       <!--     <h2 style="text-align: center;">WAHID CONSTRUCTION LTD</h2>-->
            ...
            <table class="table" id="">
                <tr>
                   ...
                   <td style="width:20%;border-top:0px;padding-left:0px;text-align:right;">Date:&nbsp;<?php echo date("d-m-Y"); ?></td>
                </tr>
                        ...
                        <tbody id="quotation_item">
                               ...
                               foreach($purchase_order_details_info as $purchase_order_details){ 
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td style="border-left:1px solid;border-top:1px solid;text-align: right;">
                                            <?php if(!empty($purchase_order_details['unit_price'])) echo number_format($purchase_order_details['unit_price'],2); ?>
                                        </td>

                                        <td style="border-left:1px solid;border-top:1px solid;text-align: right;">
                                            <?php if(!empty($purchase_order_details['amount'])) echo number_format($purchase_order_details['amount'],2)." BDT"; ?>
                                        </td>
                           ...
                           <tfoot>
                                <tr>
                                    ...
                                    <td style="text-align: right;border-left:1px solid;border-top:1px solid;border-bottom:1px solid;"><?php if(!empty($purchase_order_info[0]['total_amount'])) echo number_format($purchase_order_info[0]['total_amount'])." BDT"; ?></td>
              ...
              <p style="margin-top:-10px;">Purchase Department</p>
                ...
                <table class="table" id="myTable1" style="margin-top:-10px;">
                    ...
                    <?php $j=0; foreach($copy_to as $copy){ 
                        ...
                        ?>
                        <tr>
                            <td style="width:500px;border-top:0px;padding:1px;"><?php echo $j.'. '. $copy['copy_description']  ?></td>
                            <td style="border-top:0px;padding:0px;"></td>
                        </tr>
                 <?php } ?>
                </table>   
