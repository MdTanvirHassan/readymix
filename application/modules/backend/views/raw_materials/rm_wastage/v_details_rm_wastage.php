                    ...
                    <div class="x_content">
                        ...
                        <div class='form-group' >
                             <label for="title" class="col-sm-2 control-label">
                              ...
                              <div class="col-sm-4 input-group">
                                            <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                            <input readonly class="form-control" id="tr_no" name="tr_no" type="text" value="<?php if(!empty($issue_info[0]['tr_no'])) echo $issue_info[0]['tr_no']; ?>">
                              </div>
                             <label for="title" class="col-sm-2 control-label">
                               Transfer/Memo. Date :
                            </label>
                             <div class="col-sm-4 input-group">
                                 <span class="input-group-addon"><i class="fa fa-check-square"></i></span>
                              <input readonly type="text"  id="tr_date" class="form-control datepicker"  name="tr_date" value="<?php if(!empty($issue_info[0]['tr_date'])) echo date('d-m-Y',strtotime($issue_info[0]['tr_date'])); ?>">
                        </div>
