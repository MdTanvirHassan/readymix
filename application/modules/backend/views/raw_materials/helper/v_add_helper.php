...
<div class="row">
            ...
            <form class="form-horizontal" method="post" action="<?php echo site_url('raw_materials/helpers/add_helper_action') ?>" onsubmit="javascript: return validation()">
                                ...
                                <label for="title" class="col-sm-2 control-label">
                                    Name.<sup style="color:red;">*</sup>:
                                     ...
                                     <div class="col-sm-4 input-group">
                                         ...
                                         <input class="form-control" id="helper_name" name="helper_name" type="text" value="">
