...
<div class="right_col" style="background-color: #f1f1f1;padding-bottom:20px;">
    ...
    <div class="">
                            ...
                            <div class='form-group' >
                                ...
                                <div class="col-sm-4 input-group">
                                    ...
                                    <select required id="transport_type" class="form-control e1" name="transport_type" onchange="javascript:transportInfo();">
                                        <option <?php if($delivery_challan_info[0]['transport_type']=="Self") echo "selected"; ?> value="Self">Self</option>
                ...
                <table class="table table-bordered" id="myTable" >
                    ...
                    <tbody id="mytableBody">
                         ...
                         <tr class="" id="row_">
                             ...
                             <td><input readonly  style="width:140px;text-align: left;"  type="text"   name="do_qty[]" id="do_qty_<?php echo $i; ?>" class="do_qty_<?php echo $i; ?>" value="<?php echo round($delivery_challan_details['do_qty'],2); ?>"></td>
                             <td>
        ...
        <div class="row">
           <div class="col-md-2">
                <a href="<?php echo site_url('raw_materials/delivery_challans') ?>" > <button type="button" class="btn btn-success button" style="padding:6px 4px;">GO BACK</button> </a>
           </div>
