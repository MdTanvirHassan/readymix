...
<div class="right_content">
     ...
     if (in_array(2, $this->role)) { ?>
        <a href="<?php echo site_url('raw_materials/delivery_challans/add_delivery_challan'); ?>" class="btn btn-sm btn-primary">ADD CHALLAN</a>
     <?php } ?>       
     ...
     $(document).ready(function(){
        $('#empTable').DataTable({
         "order": [[ 0, "DESC" ]],
          ...
          'serverMethod': 'post',
          'ajax': {
             'url':'<?=base_url()?>backend/raw_materials/delivery_challans/delv_challan_list'
          },
          'columns': [
             { data: 'dc_id' },
