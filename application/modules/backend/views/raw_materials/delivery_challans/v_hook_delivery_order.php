                    ...
                    <div class="x_content">
                      ...
                      <div class="row">
                        <div id="remover" class="col-md-6 col-md-offset-3">
                            <form id="item-form" action="<?php site_url('backend/raw_materials/delivery_challans/deliveryOrder/Hook'); ?>" method="post">
                            <div class="row">
                       ...
                       <td style="text-align: left">
                        ...
                        <td class="col-lg-2" >
                            ...
                            <?php  if (in_array(4, $this->role)) { ?>    
                                <a href="<?php echo site_url('raw_materials/delivery_challans/details_hook_delivery_order/'.$order['do_id']); ?>"><button class="btn btn-sm btn-primary">View</button></a>
                            <?php } ?>
