    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_content">
                        <form class="form-horizontal" action="<?php echo site_url('raw_materials/delivery_challans/add_delivery_challan_action'); ?>" method="post" onsubmit="javascript: return validation()">
                       ...
                       <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-2">
                                    <a href="<?php echo site_url('backend/raw_materials/delivery_challans') ?>" > <button type="button" class="btn btn-success button" style="padding:6px 4px;">GO BACK</button> </a>
...
//                        } 
                        ...
                        remaining_qty=Number(v.quantity)-Number(v.total_challan_qty);
                        remaining_qty=remaining_qty.toFixed(2);
...
//                        str +='</td>';
                        ...
                        str +='<input style="width:100%;"  type="text" onchange="checkChallanQuantity()" onkeyup="checkChallanQuantity()"  id="receive_qty_'+i+'" name="quantity[]" class="issue form-control challan-qty" value="">';
                        str +='</td>';
