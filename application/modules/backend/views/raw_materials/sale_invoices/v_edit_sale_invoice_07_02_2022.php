                                    ...
                                    <tbody id="sale_items">
                                        ...
                                        foreach ($sale_invoice_details_info as $sale_invoice_details) {
                                            ...
                                            <tr class="" id="row_<?php echo $i; ?>">
                                                <td><input type="hidden"  name="dc_details_id[]" id="dc_details_id_" class="issue" value="<?php echo $sale_invoice_details['dc_details_id']; ?>"><input readonly  style="width:140px;"  type="text" id="dc_no" class="issue" value="<?php echo date('d-m-Y', strtotime($sale_invoice_details['delivery_challan_date'])); ?>"></td>
                                                <td><input type="hidden"  name="dc_id[]" id="dc_id_" class="issue" value="<?php echo $sale_invoice_details['dc_id'] ?>"><input readonly  style="width:140px;"  type="text" id="dc_no" class="issue" value="<?php echo $sale_invoice_details['dc_no'] ?>"></td>
                                                ...
                                                <td><input readonly  style="width:140px;text-align: left;"  type="text"  name="mu_name[]" id="unit_price_<?php echo $i; ?>" class="issue" value="<?php echo $sale_invoice_details['meas_unit']; ?>"></td>
                                                <td><input readonly  style="width:140px;text-align: right;"  type="text"  name="unit_price[]" id="unit_price_<?php echo $i; ?>" class="issue" value="<?php echo $sale_invoice_details['unit_price']; ?>"></td>
                                                <td><input readonly  style="width:140px;text-align: right;"  type="text"  name="quantity[]" id="quantity_<?php echo $i; ?>" class="issue" value="<?php echo $sale_invoice_details['quantity'] ?>"></td>
                                                ...
                                                <td><input checked onclick="calculateSubtotal(<?php echo $i; ?>)"   type="checkbox"  name="select_product[]" id="select_product_<?php echo $i; ?>" class="each_select select_product_<?php echo $i; ?>"></td>
                                            </tr>
<?php }
...
?>
                                            <tr class="" id="row_<?php echo $i; ?>">
                                                ...
                                                <td><input readonly  style="width:140px;text-align: right;"  type="text"  name="quantity[]" id="quantity_<?php echo $i; ?>" class="issue" value="<?php echo $sale_invoice_details['quantity'] ?>"></td>
                                                <td><input readonly  style="width:140px;text-align: right;"  type="text" class="amount_<?php echo $i; ?>"  name="amount[]" id="amount_<?php echo $i; ?>" class="issue" value="<?php echo round(($sale_invoice_details['unit_price'] * $sale_invoice_details['quantity']), 2); ?>"></td>
                                                <td><input onclick="calculateSubtotal(<?php echo $i; ?>)"   type="checkbox"  name="select_product[]" id="select_product_<?php echo $i; ?>" class="each_select select_product_<?php echo $i; ?>"></td>
                                            </tr>
                                    <?php } ?>        
