    ...
    <div class="">
        <div class="page-title">
            <div class="title_center">
                <h3>Completed Delivery Order  List</h3>
                <!-- <a href="<?php echo site_url('raw_materials/rm_sales/details_delivery_order/'.$order['do_id']); ?>" target="_blank"><button class="btn btn-sm btn-primary">PRINT</button></a> -->
                    ...
                    <div class="x_content">
                      ...
                      <div class="row">
                        <div id="remover" class="col-md-12">
                            ...
                            <div class="row">
                                    <div style="margin-top: 15px;" class="col-md-6 col-md-offset-1">
                                ...
                                <!-- <div style="margin-top: 24px;" class="col-md-2">
                                    <a href="" style="padding: 10px 10px; background-color:#337ab7 !important;color:white" target="_blank">COMPLETED DELIVERY</a>
                                </div> -->
                    ...
                    <tr>
                        ...
                        <td class="col-lg-2" >
                            ...
                            <?php  if (in_array(4, $this->role)) { ?>    
                                <a href="<?php echo site_url('raw_materials/rm_sales/details_delivery_order/'.$order['do_id']); ?>" target="_blank"><button class="btn btn-sm btn-primary">View</button></a>
                            <?php } ?>
                            <!-- <?php  if (in_array(5, $this->role)) { ?>    
                                <a href="<?php echo site_url('raw_materials/rm_sales/print_completed_delivery_order/'.$order['do_id']); ?>" target="_blank"><button class="btn btn-sm btn-primary">PRINT</button></a>
                            <?php } ?> -->
                           <?php if (in_array(5, $this->role)){ ?>   
