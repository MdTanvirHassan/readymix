            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_content">
                        ...
                        <form class="form-horizontal" action="<?php echo site_url('raw_materials/rm_sales/add_rm_sale'); ?>" method="post" onsubmit="javascript: return validation()">
                        ...
                        <div class='form-group' >
                          ...
                          <div class="col-sm-4 input-group">
                                ...
                                <input readonly class="form-control" id="" name="issue_no" type="text" value="<?php if(!empty($issue_no)) echo $issue_no; ?>">
                        </div>
                        ...
                        <label for="title" class="col-sm-2 control-label">
                            Issue Date :
                             ...
                             <div class="col-sm-4 input-group">
                                ...
                                <input required id="issue_date" class="form-control datepicker"  name="issue_date" type="text" value="<?php echo date('d-m-Y'); ?>">
                        </div>
                            ...
                            <div class='form-group' >
                                ...
                                <div class="col-sm-4 input-group">
                                    <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                    <select required id="customer_id" class="form-control e1" name="customer_id" onchange="javascript:getLcDetails();">
                                        <option class="form-control" value="">Select Customer</option>
                                        <?php foreach($customers as $cust){ ?>
                                            <option class="form-control" value="<?php echo $cust['id']; ?>"><?php echo $cust['c_name']; ?></option>
                                        <?php } ?>    
                        ...
                        <div class='form-group' >
                             <label for="title" class="col-sm-2 control-label">
                              ...
                              <div class="col-sm-4 input-group">
                                            <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                            <input required class="form-control" id="do_no" name="do_no" type="text">
                              </div>
                             <label for="title" class="col-sm-2 control-label">
                               DO. Date :
                            </label>
                             <div class="col-sm-4 input-group">
                                 <span class="input-group-addon"><i class="fa fa-check-square"></i></span>
                              <input required type="text"  id="do_date" class="form-control datepicker"  name="do_date" value="<?php echo date('d-m-Y'); ?>">
                        </div>
                            ...
                            <div class="row" style="margin-left:0px;margin-top:5px;">           
                                <div class='form-group' >
                                  <label for="title" class="col-sm-2 control-label">
                                    ...
                                    <div class="col-sm-4 input-group">
                                              <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                               <input class="form-control" name="issue_remark" type="text">
                                    </div>
