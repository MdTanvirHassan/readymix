            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_content">
                        ...
                        <form class="form-horizontal" action="<?php echo site_url('raw_materials/rm_sales/edit_rm_sale/'.$issue_info[0]['id']); ?>" method="post" onsubmit="javascript: return validation()">
                        ...
                        <label for="title" class="col-sm-2 control-label">
                            Issue Date :
                             ...
                             <div class="col-sm-4 input-group">
                                ...
                                <input required id="issue_date" class="form-control datepicker"  name="issue_date" type="text" value="<?php if(!empty($issue_info[0]['issue_date'])) echo date('d-m-Y',strtotime($issue_info[0]['issue_date'])); ?>">
                        </div>
                            ...
                            <div class='form-group' >
                                ...
                                <div class="col-sm-4 input-group">
                                    <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                    <select required id="dept_id" class="form-control e1" name="customer_id" onchange="javascript:getLcDetails();">
                                        <option class="form-control" value="">Select Customer</option>
                                        <?php foreach($customers as $cust){ ?>
                                            <option <?php if($issue_info[0]['customer_id']==$cust['id']) echo "selected"; ?> class="form-control" value="<?php echo $cust['id']; ?>"><?php echo $cust['c_name']; ?></option>
                                        <?php } ?>    
                        ...
                        <div class='form-group' >
                             <label for="title" class="col-sm-2 control-label">
                              ...
                              <div class="col-sm-4 input-group">
                                            <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                            <input required class="form-control" id="do_no" name="do_no" type="text" value="<?php if(!empty($issue_info[0]['do_no'])) echo $issue_info[0]['do_no']; ?>">
                              </div>
                             <label for="title" class="col-sm-2 control-label">
                               DO. Date :
                            </label>
                             <div class="col-sm-4 input-group">
                                 <span class="input-group-addon"><i class="fa fa-check-square"></i></span>
                              <input required type="text"  id="do_date" class="form-control datepicker"  name="do_date" value="<?php if(!empty($issue_info[0]['do_date'])) echo date('d-m-Y',strtotime($issue_info[0]['do_date'])); ?>">
                        </div>
                            ...
                            <div class="row" style="margin-left:0px;margin-top:5px;">           
                                <div class='form-group' >
                                  <label for="title" class="col-sm-2 control-label">
                                    ...
                                    <div class="col-sm-4 input-group">
                                              <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                              <input class="form-control" name="issue_remark" type="text" value="<?php if(!empty($issue_info[0]['issue_remark'])) echo $issue_info[0]['issue_remark']; ?>">
                                    </div>
                                ...
                                <tbody id="mytableBody">
                                    ...
                                    <tr id="row_1" style="">
                                      ...
                                      <td>
                                       ...
                                       <td>
                                           <input required style="width:100%;" type="text"  id="accepted_bale_qty_<?php echo $i; ?>" name="bale_qty[]" class="form-control" value="<?php echo $r_item['bale_qty']; ?>">
                                       </td>
                                       
                                       <td>
                                           <input required style="width:100%;" type="text"  id="accepted_weight_<?php echo $i; ?>" name="issue_qty[]" onkeyup="calculateAmount(1)" onchange="calculateAmount(1)" onblur="calculateAmount(1)" class="form-control" value="<?php echo $r_item['issue_qty']; ?>">
                                           <input  style="width:100%;" type="hidden"  id="rate_<?php echo $i; ?>" name="rate[]" class="form-control" value="<?php echo $r_item['rate']; ?>">
                                           <input  style="width:100%;" type="hidden"  id="amount_<?php echo $i; ?>" name="amount[]" class="form-control" value="<?php echo $r_item['amount']; ?>">
                                       </td>
                                      ...
                                      <td>
                                           <input  style="width:100%;" type="text"  id="remark_<?php echo $i; ?>" name="remarks[]" class="form-control" value="<?php echo $r_item['remarks']; ?>">
                                      </td>
                ...
                <div class="form-group" style="margin-top: 40px;">
                        <div class="col-sm-2">
                            <a href="<?php echo site_url('backend/raw_materials/rm_sales') ?>" > <button type="button" class="btn btn-success button" style="padding:6px 4px;">GO BACK</button> </a>
                        </div>
