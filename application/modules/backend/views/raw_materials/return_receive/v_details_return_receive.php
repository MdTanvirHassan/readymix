                ...
                <div class="x_panel">
                    <div class="x_content">
                        ...
                        <div class='form-group' >
                             <label for="title" class="col-sm-2 control-label">
                              ...
                              <div class="col-sm-4 input-group">
                                            <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                            <input readonly class="form-control" id="mrr_challan" name="memo_no" type="text" value="<?php if(!empty($mrr[0]['memo_no'])) echo $mrr[0]['memo_no'] ?>">
                              </div>
                             <label for="title" class="col-sm-2 control-label">
                               Memo Date :
                            </label>
                             <div class="col-sm-4 input-group">
                                 <span class="input-group-addon"><i class="fa fa-check-square"></i></span>
                              <input readonly type="text"  id="memo_date" class="form-control datepicker"  name="memo_date" value="<?php if(!empty($mrr[0]['memo_date'])) echo date('d-m-Y',strtotime($mrr[0]['memo_date'])); ?>">
                        </div>
                  ...
                  <table class="table table-bordered" id="myTable">
                                ...
                                <tbody id="mytableBody">
                                  <?php foreach($receive_items as $r_item){ ?>  
                                    <tr id="row_1" style="">
                                      ...
                                      <td>
                                        <!--  <input style="width:100%;"  id="lot_1"  type="text"  name="lot_id[]" class="issue  form-control item_code_ajax">-->
                                          <select disabled style="width:100%;" required class="form-control" id="lot_d_id_1" name="lot_d_id[]" onchange="javascript:materialInfo(1)">
                                       ...
                                       <td>
                                           <input style="width:100%;"  type="hidden" id="lot_id_1" name="lot_id[]" class="issue form-control" value="<?php echo $r_item['lot_id']; ?>">
                                            <input readonly style="width:100%;" readonly type="text" id="code_1" name="code" class="issue form-control" value="<?php echo $r_item['item_code']; ?>">
                                       </td>
                                        
                                       <td>
                                           <input style="width:100%;" readonly type="hidden" id="item_id_1" name="item_id[]" class="issue form-control" value="<?php echo $r_item['item_id']; ?>">
                                            <input readonly style="width:100%;" readonly type="text" id="item_name_1" name="item_name" class="issue form-control" value="<?php echo $r_item['item_name']; ?>">
                                       </td>
                                       
                                       <td>
                                            <input readonly style="width:100%;" readonly type="text" id="origin_1" name="origin" class="issue form-control" value="<?php echo $r_item['origin']; ?>">
                                       </td>
                                        
                                       <td>
                                            <input readonly style="width:100%;" readonly type="text" id="staple_length_1" name="staple_length" class="issue form-control" value="<?php echo $r_item['staple_length']; ?>">
                                       </td>
                                       
                                       
                                       <td>
                                            <input readonly style="width:100%;" readonly type="text" id="mu_id_1" name="mu[]" class="issue form-control" value="<?php echo $r_item['meas_unit']; ?>">
                                       </td>
                                       
                                       <td>
                                           <input readonly style="width:100%;" type="text"  id="accepted_bale_qty_1" name="accepted_bale_qty[]" class="form-control" value="<?php echo $r_item['accepted_bale_qty']; ?>">
                                       </td>
                                       
                                       <td>
                                           <input readonly style="width:100%;" type="text"  id="accepted_weight_1" name="receive_qty[]" onkeyup="calculateAmount(1)" onchange="calculateAmount(1)" onblur="calculateAmount(1)" class="form-control" value="<?php echo $r_item['receive_qty']; ?>">
                                       </td>

                                       <td>
                                           <input readonly style="width:100%;" type="text"  id="rate_1" name="unit_price[]" class="form-control" value="<?php echo $r_item['unit_price']; ?>">
                                       </td>
                                       
                                       <td>
                                           <input readonly style="width:100%;" type="text"  id="amount_1" name="amount[]" class="form-control" value="<?php echo $r_item['amount']; ?>">
                                       </td>
                                       
                                      <td>
                                           <input readonly style="width:100%;" type="text"  id="remark_1" name="remark[]" class="form-control" value="<?php echo $r_item['remark']; ?>">
                                       </td>
