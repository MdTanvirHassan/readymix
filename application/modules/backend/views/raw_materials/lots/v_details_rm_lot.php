                            ...
                            <div class='form-group' >
                                ...
                                <div class="col-sm-4 input-group">
                                    <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                     ...
                                     <input readonly required id="item_code" class="form-control"  name="lot_number" type="text" value="<?php echo $lot_info[0]['lot_number'] ?>">
                                ...
                                <div class="col-sm-4 input-group">
                                    <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                    <select disabled required id="category_id" class="form-control e1" name="lot_type_id" >
                            ...
                            <div class='form-group' >
                             ...
                             <div class='form-group' >
                               ...
                               <label for="title" class="col-sm-2 control-label">
                                ...
                                <div class="col-sm-4 input-group">
                                    <span class="input-group-addon"><i class="fa fa-user"></i></span>                           
                                    <input readonly id="inv_no" class="form-control"  name="inv_no" type="text" value="<?php echo $lot_info[0]['inv_no'] ?>">
                                ...
                                <tbody id="mytableBody">
                                  ...
                                  foreach($lot_details as $details){ 
                                    ...
                                    <tr id="row_1" style="">
                                       ...
                                       <td>
                                            <input required style="width:100%;" readonly  type="text" id="inv_bale_qty_1" name="inv_bale_qty[]" class="issue form-control" value="<?php echo $details['inv_bale_qty']; ?>">
                                       </td>
                                       
                                       <td>
                                            <input required style="width:100%;" readonly type="text"  id="inv_weight_<?php echo $i; ?>" name="inv_weight[]" class="issue form-control" value="<?php echo $details['inv_weight']; ?>">
                                       </td>
                                       
                                       <td>
                                           <input required style="width:100%;" readonly type="text"  id="landed_weight_<?php echo $i; ?>" name="landed_weight[]" class="form-control" value="<?php echo $details['landed_weight']; ?>">
                                       </td>
                                       
                                       <td>
                                           <input required style="width:100%;" readonly type="text"  id="accepted_bale_qty_<?php echo $i; ?>" name="accepted_bale_qty[]" class="form-control" value="<?php echo $details['accepted_bale_qty']; ?>">
                                       </td>
                                       
                                       <td>
                                           <input required style="width:100%;" readonly type="text"  id="accepted_weight_<?php echo $i; ?>" name="accepted_weight[]" class="form-control" value="<?php echo $details['accepted_weight']; ?>">
                                       </td>
            ...
            $.ajax({
                ...
                success: function(msg) {
                    ...
                    $(msg.lc_details).each(function(i, v) {
                        ...
                        str +='<td>';
                        str +='<input style="width:100%;"  type="text" id="accepted_weight_'+i+'" name="accepted_weight[]" class="issue form-control" value="">';
                        str +='</td>';
