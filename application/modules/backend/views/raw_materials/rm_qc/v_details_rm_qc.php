                                ...
                                <tbody id="mytableBody">
                                 ...
                                 foreach($receive_items as $receive){ 
                                    ...
                                    <tr id="row_" style="">
                                       ...
                                       <td>
                                           <input readonly style="width:100%;" type="text"  id="accepted_bale_qty_<?php echo $i; ?>" name="accepted_bale_qty[]" class="form-control" value="<?php echo $receive['accepted_bale_qty']; ?>">
                                       </td>
                                       
                                       <td>
                                           <input readonly style="width:100%;" type="text"  id="accepted_weight_<?php echo $i; ?>" name="accepted_weight[]" class="form-control" onkeyup="calculateAmount(<?php echo $i; ?>)" onchange="calculateAmount(<?php echo $i; ?>)" onblur="calculateAmount(<?php echo $i; ?>)" value="<?php echo $receive['receive_qty']; ?>">
                                       </td>
