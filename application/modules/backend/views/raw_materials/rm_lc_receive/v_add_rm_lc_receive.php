 <div class="right_col" style="background-color: #f1f1f1;padding-bottom:20px;">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_content">
                        ...
                        <form class="form-horizontal" action="<?php echo site_url('raw_materials/rm_lc_receive/add_action_rm_lc_receive'); ?>" method="post" onsubmit="javascript: return validation()">
                        ...
                        <div class='form-group' >
                             <label for="title" class="col-sm-2 control-label">
                              ...
                              <div class="col-sm-4 input-group">
                                            <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                            <input required class="form-control" id="mrr_challan" name="mrr_challan" type="text">
                              </div>
                             <label for="title" class="col-sm-2 control-label">
                                Date :
                            </label>
    ...
    <script type="text/javascript">
      function getLcDetails() {
        ...
        if(lc_id != ''){
            $.ajax({
                url: '<?php echo site_url('raw_materials/rm_lc_receive/getLcLotDetails'); ?>',
                data: {
                    'lc_id': lc_id
                },
                method: 'POST',
...
//                        str +='</td>';
                        ...
                        str +='<td><input checked style="width:40px;text-align:right;"  type="checkbox" name="item_select[]"    id="select_product_'+v.item_id+'" class="select_product_'+i+'" value="'+i+'"></td>'; 
                        str +='</tr>';
