            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_content">
                        ...
                        <form class="form-horizontal" action="<?php echo site_url('raw_materials/rm_issue/add_rm_issue'); ?>" method="post" onsubmit="javascript: return validation()">
                        ...
                        <div class='form-group' >
                             <label for="title" class="col-sm-2 control-label">
                              ...
                              <div class="col-sm-4 input-group">
                                            <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                            <input required class="form-control" id="sr_no" name="sr_no" type="text">
                              </div>
                             <label for="title" class="col-sm-2 control-label">
                               SR. Date :
                            </label>
                             <div class="col-sm-4 input-group">
                                 <span class="input-group-addon"><i class="fa fa-check-square"></i></span>
                              <input required type="text"  id="sr_date" class="form-control datepicker"  name="sr_date" value="<?php echo date('d-m-Y'); ?>">
                        </div>
