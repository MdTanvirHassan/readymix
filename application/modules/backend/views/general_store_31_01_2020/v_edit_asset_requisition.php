<div class="right_col" style="background-color: #f1f1f1;padding-bottom:20px;">
            <h2 style="text-align:center; ">Edit Asset Requisition<br></h2>
                        ...
                        <h4 style="text-align: center;text-decoration: underline;"></h4>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-4 col-md-4 col-md-offset-3  labeltext" style="text-align: right;"><label for="inputdefault">Date :</label></div>
                                 <div class="col-sm-8 col-md-5 "><input required class="form-control datepicker"  name="date" type="text" value="<?php if (!empty($asset_requisition[0]['requisition_date'])) echo date('d-m-Y',strtotime($asset_requisition[0]['requisition_date'])); ?>"></div>
                            </div>
                    ...
                    <div class="col-md-6" style="">
                       ...
                       <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class=" col-sm-8 col-md-5 "><input class="form-control" id="inputdefault" name="remarks" type="text" value="<?php if (!empty($asset_requisition[0]['remarks'])) echo $asset_requisition[0]['remarks']; ?>"></div>
                        </div>
                      ...
                      <tr class="row" id="row_<?php echo $i; ?>">
                           <?php if ($i > 1) { ?>
                            ...
                            <?php } else { ?>
                                <td></td>
                                    <?php } ?>
                          <td> <select style="width:100px;" id="item_c_<?php echo $i; ?>" name="item_id[]" onchange="javascript:item_info(<?php echo $i; ?>);">
                        ...
                        <td><input  style="width:40px;" type="text"  name="indent_qty[]" id="indent_qty_c_<?php echo $i; ?>"  class="issue" value="<?php if (!empty($asset_requisition_detail['indent_qty'])) echo $asset_requisition_detail['indent_qty']; ?>"></td>
                   
                         <td><input style="width:100px;"  type="text"  name="expected_date[]" class="issue datepicker1" value="<?php if (!empty($asset_requisition_detail['expected_date'])) echo date('d-m-Y',strtotime($asset_requisition_detail['expected_date'])); ?>"></td>
                         <td><select style="width:110px;" id="asset_c_<?php echo $i; ?>" name="c_c_id[]" >
