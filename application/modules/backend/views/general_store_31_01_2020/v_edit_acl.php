    ...
    <div class="container sec_3">
        ...
        <table class="table table-bordered">
            ...
            <tr> <td>Employee Id</td>
                <td><select style='width:300px;' id="employee_id" class="e1 chosen-select form-control" name="employeeId">
            ...
            <tr>
                ...
                <td>
                    <select class="form-control" id="userType" name="userType">
                        ...
                        <option <?php if ($user[0]['user_type'] == '4') echo 'selected="selected"'; ?> class="form-control" value="2">Factory</option>
