                         ...
                         <div class='form-group' >
                             ...
                             <label for="title" class="col-sm-2 control-label">
                                    Item Code :
                                     ...
                                     <div class="col-sm-4 input-group">
                                         <span class="input-group-addon"><i class="fa fa-check-square"></i></span>
                                         <input  class="form-control" id="inputdefault" name="item_own_code" type="text">
                                </div>
                       ...
                       <div class='form-group' >
                         ...
                         <div class='form-group' >
                            ...
                            Brand<sup style="color:red;">*</sup> :
                             ...
                             <div class="col-sm-4 input-group">
                                 <span class="input-group-addon"><i class="fa fa-weibo"></i></span>
                                 <select required multiple id="brand_id" class="form-control e1" name="brand_id[]" >
                         ...
                         <div class='form-group' >
                             <label for="title" class="col-sm-2 control-label">
                            M.unit<sup style="color:red;">*</sup> :
                        </label>
                             <div class="col-sm-4 input-group">
                                 <span class="input-group-addon"><i class="fa fa-weibo"></i></span>
