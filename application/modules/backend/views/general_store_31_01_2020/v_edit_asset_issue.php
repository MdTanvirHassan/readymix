<div class="right_col" style="background-color: #f1f1f1;padding-bottom:20px;">
            <h2 style="text-align:center; ">Edit Asset Issue Info</h2>
            <hr>
            <div class="row">
             ...
             <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8 col-md-5 "><input required class="form-control datepicker" name="a_issue_date" type="text" value="<?php if(!empty($asset_issue[0]['a_issue_date'])) echo date('d-m-Y',strtotime($asset_issue[0]['a_issue_date'])); ?>"></div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-6">
                       ...
                       <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8 col-md-5 "><input class="form-control" name="a_isssue_remark" type="text" value="<?php if(!empty($asset_issue[0]['a_isssue_remark'])) echo $asset_issue[0]['a_isssue_remark']; ?>" ></div>
                        </div>    
                    </div>
       ...
       <tr class="row" id="row_<?php echo $i; ?>">
         <!-- <td></td>  -->
           <td> 
            ...
            <td><input id="pre_issue_qty_<?php echo $i; ?>" type="hidden" name="pre_issue_qty[]" value="<?php if (!empty($asset_issue_detail['issue_qty'])) echo $asset_issue_detail['issue_qty']; ?>" onkeyup="calculateTotal(<?php echo $i; ?>)" class="issue"><input required style="width:40px;" id="issue_qty_<?php echo $i; ?>" type="text" name="issue_qty[]" value="<?php if (!empty($asset_issue_detail['issue_qty'])) echo $asset_issue_detail['issue_qty']; ?>" onkeyup="calculateTotal(<?php echo $i; ?>)" class="issue"></td>
           

            <td><input style="width:100px;" type="text" name="remark[]" value="<?php if (!empty($asset_issue_detail['remark'])) echo $asset_issue_detail['remark']; ?>" class="issue"></td>
