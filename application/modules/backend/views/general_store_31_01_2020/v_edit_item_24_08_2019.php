...
<!--            <h2 style="text-align:center; ">Edit Item Information</h2>
            <hr>-->
<div class="">
                        ...
                        <label for="title" class="col-sm-2 control-label">
                           Item Code :
                            ...
                            Item Group :
                             ...
                             <div class="col-sm-4 input-group">
                                 <span class="input-group-addon"><i class="fa fa-check-square"></i></span>
                              <input required class="form-control" id="inputdefault" name="item_name" value="<?php if(!empty($item[0]['item_name'])) echo $item[0]['item_name']; ?>" type="text">
                        </div>
                ...
                <div class='form-group' >
                    ...
                    <?php if(!empty($item[0]['item_type']) && $item[0]['item_type']=="Consumable" ){ ?>
                            ...
                            Purchase Date :
                             ...
                             <div class="col-sm-4 input-group">
                                 <span class="input-group-addon"><i class="fa fa-check-square"></i></span>
                              <input class="form-control datepicker" id="pur_date" name="purchase_date" type="text" value="<?php if(!empty($item[0]['purchase_date'])) echo $item[0]['purchase_date']; ?>">
                        </div>
                    <?php }else{?>  
                    <label for="title" class="col-sm-2 control-label">
                            Purchase Date :
                             ...
                             <div class="col-sm-4 input-group">
                                 <span class="input-group-addon"><i class="fa fa-check-square"></i></span>
                              <input class="form-control datepicker" id="pur_date" name="purchase_date" type="text" value="<?php if(!empty($item[0]['purchase_date'])) echo date('d-m-Y',strtotime($item[0]['purchase_date'])); ?>">
                        </div>
                    <?php }?>
                    -->
