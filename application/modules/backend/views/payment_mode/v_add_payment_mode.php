<div class="right_col" style="background-color: #f1f1f1;padding-bottom:20px;">
    ...
    <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                 <div class="x_content">
                     <form class="form-horizontal" action="<?php echo site_url('payment_mode/add_payment_mode_action'); ?>" method="post">
                         ...
                         <div class='form-group' >
                            ...
                            <div class="col-sm-4 input-group">
                                        ...
                                        <input required  class="form-control" id="inputdefault" name="mode_name" type="text" value="">
                            </div>
                              <label for="title" class="col-sm-2 control-label">
                                    Payment Security :
                               </label>
                                    ...
                                    <select id="item_type" class="form-control" name="security_id">
                                        ...
                                        <?php if(!empty($payment_securities)){ ?>
                                                ...
                                                <?php foreach($payment_securities as $security){ ?>
                                                      <option class="form-control" value="<?php echo $security['id'] ?>"><?php echo $security['security_name'] ?></option>
                                                <?php } ?>   
                                        <?php } ?>      
