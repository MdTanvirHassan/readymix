                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php if (in_array(3, $this->role)) { ?>
                                                    <a href="<?php echo site_url('sale_target/edit_sale_target/' . $order['id']); ?>"><button class="btn btn-sm btn-info">Edit</button></a>
                                                <?php } ?>
                                                ...
                                                <?php if (in_array(5, $this->role)) { ?>
                                                    <button onclick="delete_row('<?php echo site_url('sale_target/delete_sale_target/' . $order['id']); ?>')" class="btn btn-sm btn-danger">Delete</button>
                                                <?php } ?>
