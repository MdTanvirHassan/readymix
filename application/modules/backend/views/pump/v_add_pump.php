    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_content">
                        <form class="form-horizontal" action="<?php echo site_url('pump/add_pump_action'); ?>" method="post" onsubmit="javascript: return validation()">                
                            <div class='form-group' >
                                ...
                                <div class="col-sm-3 input-group">
                                    <span class="input-group-addon"><i class="fa fa-user"></i></span>                                   
                                    <input  required class="form-control" readonly id="pump_no" name="pump_no" type="text" value="<?php echo $pump_no; ?>"></div>
                            ...
                            <div class='form-group' >
                                ...
                                <div class="col-sm-3 input-group">
                                    <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                    <input  class="form-control" id="group_name" name="group_name" type="text" placeholder="Group Name">
                                ...
                                <div class="col-sm-3 input-group">
                                    <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                    <input  class="form-control"  id="casting_qty" name="casting_qty" type="text" placeholder="Casting Qty">
                            ...
                            <div class='form-group' >
                                ...
                                <div class="col-sm-3 input-group">
                                    <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                    <input  class="form-control" id="person" name="person" type="text" placeholder="Person Qty">
                                ...
                                <div class="col-sm-3 input-group">
                                    <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                    <input  class="form-control"  id="per_person_bill" name="per_person_bill" type="text" placeholder="Per Person bill">
                                ...
                                <div class="col-sm-3 input-group">
                                    <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                    <input  class="form-control" id="total_bill" name="total_bill" value=" " readonly>
                            ...
                            <div class='form-group' >
                                ...
                                <div class="col-sm-3 input-group">
                                    <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                    <input  class="form-control" id="from_time" name="from_time" type="time" placeholder="From Time">
                                ...
                                <div class="col-sm-3 input-group">
                                    <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                    <input  class="form-control" id="to_time" name="to_time" type="time" placeholder="To Time">
