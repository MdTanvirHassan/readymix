                            ...
                            <div class="row">  
                                <div class="col-md-6">
                                    <div class='form-group row' >
                                                         ...
                                                         <div class="col-sm-8 col-md-8 input-group">
                                                             ...
                                                             <select required="" id="from_unit_id" class="form-control select2 from_unit_id"  name="from_unit_id" >
                                ...
                                <div class="col-md-6">
                                    <div class='form-group row' >
                                                         ...
                                                         <div class="col-sm-8 col-md-8 input-group">
                                                             <span class="input-group-addon"><i class="fa fa-recycle"></i></span>
                                                             <select required="" id="to_unit_id" class="form-control select2 to_unit_id"  name="to_unit_id" >
                                                                 <option value="">Select Project</option>
                                                        <?php foreach($departments as $row){?>
                                                        <?php if($row['d_id'] == $d_id){ continue;}?>
                                                        <option  value="<?php echo $row['d_id'];?>"><?php echo $row['dep_description'];?></option>
                                                        <?php }?>
                                                    </select> 
                                ...
                                <div class="col-md-6">
                                    <div class='form-group row' >
                                                         ...
                                                         <div class="col-sm-8 col-md-8 input-group">
                                                             ...
                                                             <select required="" onchange="currentquantity(1)" id="itemID" class="form-control select2 item_name"  name="item_id" >
                                ...
                                <div class="col-md-6">
                                    <div class='form-group row' >
                                                         ...
                                                         <div class="col-sm-8 col-md-8 input-group">
                                                             ...
                                                             <input required="" class="form-control datepicker" name="transfer_date" type="text" value="<?php echo date('d-m-Y')?>">
                            ...
                            <div class="row">  
                                <div class="col-md-6">
                                    <div class='form-group row' >
                                                         ...
                                                         <div class="col-sm-8 col-md-8 input-group">
                                                             <span class="input-group-addon"><i class="fa fa-recycle"></i></span>
                                                             <input required="" onblur="currentqueantityminus(1)" id="quantity" class="form-control" name="transfer_quantity" type="text" value="">  
                            ...
                            <div class="row">  
                                <div class="col-md-6">
                                    <div class='form-group row' >
                                                         ...
                                                         <div class="col-sm-8 col-md-8 input-group">
                                                             <span class="input-group-addon"><i class="fa fa-recycle"></i></span>
                                                            <input required id="price" class="form-control" name="price" type="text" value="">  
...
//                $('#stock_qty_'+id).val(msg.item_info[0].stock_amount);
                ...
                //    $('#total_quantity_hidden').val(msg.data.item_info[0].quantity);
                      $('#total_quantity').val(msg.data.quantity);
                      $('#total_quantity_hidden').val(msg.data.quantity);
                }else{
                    $('#total_quantity').val('');
