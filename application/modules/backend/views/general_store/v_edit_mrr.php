...
<div class="row">
                     ...
                     <div class="row" style="margin-left:0px;margin-top:5px;">        
                        <div class='form-group' >
                             <label for="title" class="col-sm-2 control-label">
                              ...
                              <div class="col-sm-4 input-group">
                                            <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                            <input class="form-control" id="mrr_challan" name="mrr_challan" type="text" value="<?php if(!empty($mrr[0]['mrr_challan'])) echo $mrr[0]['mrr_challan']; ?>">
                              </div>
                             <label for="title" class="col-sm-2 control-label">
                                Date :
                            </label>
                             <div class="col-sm-4 input-group">
                                 <span class="input-group-addon"><i class="fa fa-check-square"></i></span>
                              <input required id="mrr_challan_date" class="form-control datepicker"  name="mrr_challan_date" type="text" value="<?php if(!empty($mrr[0]['mrr_challan_date'])) echo date('d-m-Y',strtotime($mrr[0]['mrr_challan_date'])); ?>" >
                        </div>
    ...
    <?php $i=0; foreach($receive_items as $receive_item){ $i++;?>
       <tr class="" id="row_1">
        ...
        <td><input type="hidden"  name="o_details_id[]" id="o_details_id_<?php echo $i; ?>" class="issue" value="<?php if(!empty($receive_item['indent_d_id'])) echo $receive_item['indent_d_id'];  ?>"><input type="hidden"  name="indent_d_id[]" id="indent_d_id_<?php echo $i; ?>" class="issue" value="<?php if(!empty($receive_item['indent_d_id'])) echo $receive_item['indent_d_id'];  ?>"><input type="hidden"  name="brand_id[]" id="brand_id_" class="issue" value="<?php if(!empty($receive_item['brand_id'])) echo $receive_item['brand_id'];  ?>"><input type="hidden"  name="item_id[]" id="item_des_c1_" class="issue" value="<?php echo $receive_item['item_id']  ?>"><input readonly style="width:240px;"  type="text"  name="name[]" id="item_des_c1_" class="issue" value="<?php echo $receive_item['item_name']  ?>"></td>
        <td><input type="hidden"   style="width:140px;"  type="text"  name="unit_price[]" id="unit_price_<?php echo $i;  ?>" class="unit_price_" value="<?php echo $receive_item['unit_price']  ?>"><input readonly  style="width:80px;"  type="text"  name="measurement_unit[]" id="measurement_unit_" value="<?php echo $receive_item['meas_unit']  ?>"></td>
        <td><input readonly  style="width:100px;text-align:right;"  type="text"  name="item_size[]" id="size_<?php echo $i; ?>" class="issue" value="<?php echo $receive_item['item_size']  ?>"></td>
        <td><input disabled  style="width:140px;"  type="text"  name="size_unit[]" id="measurement_unit_" value="<?php echo $receive_item['unit_name']  ?>"></td>
        <td><input style="width:100px;text-align:right;"  type="text"  name="challan_qty[]" id="challan_quantity_<?php echo $i; ?>" class="issue" value="<?php echo $receive_item['challan_qty']  ?>"></td>
        <td><input   onkeyup="calculateAmount(<?php echo $i; ?>)" onchange="calculateAmount(<?php echo $i; ?>)" onblur="calculateAmount(<?php echo $i; ?>)"  style="width:100px;text-align:right;"  type="text"  name="receive_qty[]" id="receive_qty_<?php echo $i; ?>" class="issue" value="<?php echo $receive_item['receive_qty']  ?>"></td>
        <td><input style="width:100px;text-align:right;"  type="text"  name="wastage_qty[]" id="wastate_qty_<?php echo $i; ?>" class="issue" value="<?php echo $receive_item['wastage_qty']  ?>"></td>
        <td><input type="hidden" style="width:140px;"  type="text" name="amount[]" id="amount_<?php echo $i; ?>" class="amount_<?php echo $i; ?>"  value="<?php echo $receive_item['amount']  ?>"><input    style="width:140px;text-align:right;"  type="text" name="remark[]" value="<?php echo $receive_item['remark']  ?>"></td>
...
<script>
   ...
   function calculateAmount(id){
        ...
        if(r_quantity >challan_quantity || r_quantity<=0 ){ 
            $('#receive_qty_'+id).val('');
        }
