            ...
            <input type="hidden" id="count" value="<?php echo count($mrr_return_receive_details); ?>"/>
             <table class="table table-bordered" id="myTable">
                ...
                <?php $i = 0;
                   ...
                   <td>
                        <input id="unit_price_<?php echo $i; ?>" type="hidden" name="unit_price[]" value="<?php if (!empty($mrr_return_receive_detail['unit_price'])) echo $mrr_return_receive_detail['unit_price']; ?>"  class="issue">
                        <input id="receive_value_<?php echo $i; ?>"  type="hidden" name="receive_value[]" value="<?php if (!empty($mrr_return_receive_detail['receive_value'])) echo $mrr_return_receive_detail['receive_value']; ?>" class="issue">
                       <input required id="receive_qty_<?php echo $i; ?>" type="text" name="receive_qty[]" value="<?php if (!empty($mrr_return_receive_detail['receive_qty'])) echo $mrr_return_receive_detail['receive_qty']; ?>" onblur="calculateTotal(<?php echo $i; ?>)" onkeyup="calculateTotal(<?php echo $i; ?>)" onchange="calculateTotal(<?php echo $i; ?>)" class="issue number">
                   </td>
