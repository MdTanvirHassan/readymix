<div class="right_col" style="background-color: #f1f1f1;padding-bottom:20px;">
            <h2 style="text-align:center; ">Edit Asset Issue Return Receive</h2>
            <hr>
<!--            <div class="row">
                 <button style="margin-left:5px" id="button1" class="btn btn-primary pull-left"><span class='glyphicon glyphicon-plus'></span></button>   
            </div>-->
            <form method="post" action="<?php echo site_url('general_store/edit_action_asset_issue_receive/'.$issue_return[0]['a_ir_id']) ?>">
                  <input  class="form-control" id="inputdefault" name="ir_status" value="<?php if(!empty($issue_return[0]['a_ir_status'])) echo $issue_return[0]['a_ir_status']; ?>" type="hidden">
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8 col-md-5 "><input required class="form-control datepicker" name="a_ir_date"  type="text" value="<?php if(!empty($issue_return[0]['a_ir_date'])) echo date('d-m-Y',strtotime($issue_return[0]['a_ir_date'])); ?>"></div>
                        </div>
                    </div>
                </div>
                 ...
                 <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8 col-md-5 "><input required id="issue_date" class="form-control datepicker" name="a_issue_date" type="text" value="<?php if(!empty($issue_return[0]['a_issue_date'])) echo date('d-m-Y',strtotime($issue_return[0]['a_issue_date'])); ?>"></div>
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <?php $i = 0;
                   ...
                   <tr class="row" id="row_<?php echo $i; ?>">
                       ...
                       <td> 
                           ...
                           <input style="width:80px;" disabled type="text" value="<?php if(!empty($issue_return_detail['item_code'])) echo $issue_return_detail['item_code']; ?>" name="item_name_code[]" id="item_name_code_<?php echo $i; ?>" class="issue">
                       </td>
                   <td><input id="item_des_<?php echo $i; ?>" type="hidden" name="item_name_des[]" value="<?php if (!empty($issue_return_detail['item_name_des'])) echo $issue_return_detail['item_name_des']; ?>" class="issue"><input style="width:150px;" disabled id="item_des1_<?php echo $i; ?>" type="text" name="item_name_des1[]" value="<?php if (!empty($issue_return_detail['item_name_des'])) echo $issue_return_detail['item_name_des']; ?>" class="issue"></td>
                   <td><input id="unit_<?php echo $i; ?>" type="hidden" name="m_unit[]" value="<?php if (!empty($issue_return_detail['m_unit'])) echo $issue_return_detail['m_unit']; ?>" class="issue"><input style="width:100px;" disabled id="unit1_<?php echo $i; ?>" type="text" name="issue_m_unit1[]" value="<?php if (!empty($issue_return_detail['m_unit'])) echo $issue_return_detail['m_unit']; ?>" class="issue"></td>
                   <td><input id="issued_qty<?php echo $i; ?>" type="hidden" name="issued_qty[]" value="<?php if (!empty($issue_return_detail['issued_qty'])) echo $issue_return_detail['issued_qty']; ?>" class="issue"><input style="width:40px;" disabled id="indent_qty1_<?php echo $i; ?>" type="text" name="indent_qty1[]" value="<?php if (!empty($issue_return_detail['issued_qty'])) echo $issue_return_detail['issued_qty']; ?>" class="issue"></td>
                   <td><input style="width:40px;" required id="return_qty_<?php echo $i; ?>" type="text" name="receive_qty[]" value="<?php if (!empty($issue_return_detail['receive_qty'])) echo $issue_return_detail['receive_qty']; ?>" onkeyup="calculateTotal(<?php echo $i; ?>)" class="issue"></td>
                   
              
                   <td><input style="width:100px;" type="text" name="remark[]" value="<?php if (!empty($issue_return_detail['remark'])) echo $issue_return_detail['remark']; ?>" class="issue"></td>
