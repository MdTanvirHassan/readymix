             ...
             <table class="table table-bordered" id="myTable" style="margin-top:20px;">
                 <thead class="thead-color">
                     <tr>
                        ...
                        <th style="vertical-align: middle;width: 17%;text-align: center;">Item name & Description</th>
                        <th style="vertical-align: middle;width: 5%;text-align: center;">Unit</th>
                        <th style="vertical-align: middle;width: 7%;text-align: center;">Indent Qty</th>
                        ...
                        <th style="vertical-align: middle;width: 7%;text-align: center;">Budget Qty</th>
