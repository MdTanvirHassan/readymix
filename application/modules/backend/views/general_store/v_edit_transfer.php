                                ...
                                <div class="col-md-6">
                                    <div class='form-group row' >
                                                         ...
                                                         <div class="col-sm-8 col-md-8 input-group">
                                                            ...
                                                            <select onchange="currentquantity(1)" id="itemID" class="form-control e1 item_name"  name="item_id" >
                                                        <option class="form-control">Select Item</option>
                                                        <?php foreach($items as $row){?>
                                                        <option <?php if($row['id']== $transfer[0]['item_id']) echo 'selected';?>  value="<?php echo $row['id'];?>"><?php echo $row['item_name'];?></option>
                                                        <?php }?>
                                                    </select>  
                                ...
                                <div class="col-md-6">
                                    <div class='form-group row' >
                                                         ...
                                                         <div class="col-sm-8 col-md-8 input-group">
                                                             ...
                                                             <input class="form-control datepicker" name="transfer_date" type="text" value="<?php echo date('d-m-Y',  strtotime($transfer[0]['transfer_date']))?>">
                            ...
                            <div class="row">  
                                <div class="col-md-6">
                                    <div class='form-group row' >
                                                         ...
                                                         <div class="col-sm-8 col-md-8 input-group">
                                                             ...
                                                             <input required="" onblur="currentqueantityminus(1)" id="quantity" class="form-control" name="transfer_quantity" type="text" value="<?php echo $transfer[0]['transfer_quantity']?>">  
                                ...
                                <div class="col-md-6">
                                    <div class='form-group row' >
                                                         ...
                                                         <div class="col-sm-8 col-md-8 input-group">
                                                             <span class="input-group-addon"><i class="fa fa-recycle"></i></span>
                                                             <input readonly="" class="form-control" id="total_quantity" name="total_quantity" type="text" value="<?php echo $transfer[0]['total_quantity']?>"> 
                                                             <input disabled class="form-control" id="total_quantity_hidden" name="total_quantity_hidden" type="hidden" value="<?php echo $transfer[0]['total_quantity'] + $transfer[0]['transfer_quantity']?>">
                            ...
                            <div class="row">  
                                                    ...
                                                    <label for="title" class="col-sm-4 col-md-4 control-label">
                                                        ...
                                                        <?php foreach($departments as $row){?>
                                                                <?php if($row['d_id'] != $d_id){ continue;}?>
                                                                    <option   value="<?php echo $d_id;?>"><?php echo $row['dep_description'];?></option>
                                                                <?php }?>
                                                    </select> 
                                ...
                                <div class="col-md-6">
                                    <div class='form-group row' >
                                                        ...
                                                        <?php foreach($departments as $row){?>
                                                        <?php if($row['d_id'] == $d_id){ continue;}?>
                                                        <option <?php if($row['d_id'] == $transfer[0]['to_unit_id']) echo 'selected';?>  value="<?php echo $row['d_id'];?>"><?php echo $row['dep_description'];?></option>
                                                        <?php }?>
                                                    </select> 
                            ...
                            <div class="row">  
                                <div class="col-md-6">
                                    <div class='form-group row' >
                                                         ...
                                                         <div class="col-sm-8 col-md-8 input-group">
                                                             <span class="input-group-addon"><i class="fa fa-recycle"></i></span>
                                                             <input required id="price" class="form-control" name="price" type="text" value="<?php echo $transfer[0]['price']?>">  
                                ...
                                <div class="col-md-6">
                                    <div class='form-group row' >
                                                         ...
                                                         <div class="col-sm-8 col-md-8 input-group">
                                                             <span class="input-group-addon"><i class="fa fa-recycle"></i></span>
                                                        <textarea class="form-control" name="remarks"><?php echo $transfer[0]['remark']?></textarea> 
