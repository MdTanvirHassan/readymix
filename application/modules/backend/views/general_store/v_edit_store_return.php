            ...
            <input type="hidden" id="count" value="<?php echo count($return_receive_details); ?>"/>
             <table class="table table-bordered" id="myTable">
                <thead>
                  ...
                  <tr class="row">
                    <th>
                      <!--  <button style="margin-left:5px;display:<?php if($material_receive==$material_receive_return) echo "none"; ?>" type="button" id="button1" class="btn btn-primary pull-left"><span class='glyphicon glyphicon-plus'></span></button>   -->
                    </th>
                    <th>Item Code</th>
                ...
                <?php $i = 0;
                   ...
                   <tr class="row" id="row_<?php echo $i; ?>">
                       ...
                       <td> 
                           <input type="hidden" value="<?php if(!empty($return_receive_detail['receive_status'])) echo $return_receive_detail['receive_status']; ?>" name="receive_status[]" id="receive_status_<?php echo $i; ?>" class="issue">
                   ...
                   <td>
                       <input id="return_value_<?php echo $i; ?>"  type="hidden" name="return_value[]" value="<?php if (!empty($return_receive_detail['return_value'])) echo $return_receive_detail['return_value']; ?>" class="issue">
                       <input id="unit_price_<?php echo $i; ?>" type="hidden" name="unit_price[]" value="<?php if (!empty($return_receive_detail['unit_price'])) echo $return_receive_detail['unit_price']; ?>"  class="issue">
                       <input required id="return_qty_<?php echo $i; ?>" type="text" name="return_qty[]" value="<?php if (!empty($return_receive_detail['return_qty'])) echo $return_receive_detail['return_qty']; ?>" onkeyup="calculateTotal(<?php echo $i; ?>)" class="issue number">
                   </td>
...
<script>
    ...
    function calculateTotal(id){
        ...
        var net_price;
        var receive_quantity =Number($('#receive_qty_'+id).val());
        var r_quantity =Number($('#return_qty_'+id).val());
       
        var unit_price = $('#unit_price_'+id).val();
      
        
       if(r_quantity<=receive_quantity){
           ...
           $('#return_qty_'+id).val('');
           $('#return_value_'+id).val('');
           $('#return_value1_'+id).val('');  
       }    
    }
