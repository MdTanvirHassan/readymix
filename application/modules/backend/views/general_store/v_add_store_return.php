                ...
                <div class='form-group' >
                          ...
                          Return No.:
                              ...
                              <div class="col-sm-4 input-group">
                                ...
                                <input class="form-control" id="inputdefault" name="rr_no" type="hidden" value="<?php if(!empty($rr_auto_code)) echo $branch_info[0]['short_name'].'/R'.$rr_auto_code;  ?>">
                                <input disabled class="form-control" id="inputdefault" name="ir_no" type="text" value="<?php if(!empty($rr_auto_code)) echo $branch_info[0]['short_name'].'/R'.$rr_auto_code;  ?>">
                        </div>
                             <label for="title" class="col-sm-2 control-label">
                           Return Date :
                        </label>
            ...
            //    alert('test');
             var j=0;
                $('#receive_date').val(msg.receive[0].date);
                 ...
                 var str = '<thead> <tr ><th><button style="margin-left:5px;display:none"  type="button" id="button1" class="btn btn-primary pull-left"><span class="glyphicon glyphicon-plus"></span></button>   </th><th>Item Code</th><th>Item Description</th>  <th>MU</th><th>Received Qty</th><th>Return Qty</th><th>Remark</th></tr></thead><tbody>';
...
//                       str +='<input type="hidden" value="'+v.asset_id+'" name="asset_id[]" id="asset_id_'+j+'" class="issue">';
                       ...
                       str +='</td>';
                       str +='<td><input hidden type="text" name="return_value[]" id="return_value_'+j+'" class="issue"  value="">';
                       str +='<input type="hidden" name="unit_price[]" id="unit_price_'+j+'" class="issue"  value="'+v.unit_price+'">';
                       str +='<input required style="width:80px" type="text" name="return_qty[]" id="return_qty_'+j+'" class="issue" onkeyup="calculateTotal('+j+')" value="" >';
                       str +='</td>';
//                       str +='<td>';
//                       str +='<input type="hidden" name="unit_price[]" id="unit_price_'+j+'" class="issue"  value="'+v.unit_price+'">';
