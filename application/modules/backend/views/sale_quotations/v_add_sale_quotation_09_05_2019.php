...
<div class="right_col" style="background-color: #f1f1f1;padding-bottom:20px;">
    ...
    <hr>
    <form action="<?php echo site_url('sale_quotations/add_quotation_action'); ?>" method="post" onsubmit="javascript: return validation()" >
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-sm-4 col-md-2 ">
                               <input readonly style="text-align: right;" class="form-control" onkeyup="calculatePercentAmount('b_cash_percent')" onchange="calculatePercentAmount('b_cash_percent')" onblur="calculatePercentAmount('b_cash_percent')" id="b_cash_percent" name="b_cash_percent" type="text" placeholder="Percent">
                            </div>
                             <div class="col-sm-4 col-md-3 ">
                               <input readonly  style="text-align: right;" class="form-control" id="b_cash_amount" name="b_cash_amount" type="text" placeholder="Amount">
                            </div>
                             <div class="col-sm-4 col-md-3 ">
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-sm-4 col-md-2 ">
                               <input readonly style="text-align: right;" class="form-control" id="b_bg_tenor" name="b_bg_tenor" type="text" placeholder="T. Day">
                            </div>
                            <div class="col-sm-4 col-md-2 ">
                               <input readonly style="text-align: right;" class="form-control" onkeyup="calculatePercentAmount('b_bg_percent')" onchange="calculatePercentAmount('b_bg_percent')" onblur="calculatePercentAmount('b_bg_percent')" id="b_bg_percent" name="b_bg_percent" type="text" placeholder="Percent">
                            </div>
                             <div class="col-sm-4 col-md-3 ">
                               <input readonly style="text-align: right;" class="form-control" id="b_bg_amount" name="b_bg_amount" type="text" placeholder="Amount">
                            </div>
                            <div class="col-sm-4 col-md-3 ">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4 col-md-2 ">
                               <input readonly style="text-align: right;" class="form-control" id="b_lc_tenor" name="b_lc_tenor" type="text" placeholder="T.Day">
                            </div>
                             <div class="col-sm-4 col-md-2 ">
                               <input readonly style="text-align: right;" class="form-control" onkeyup="calculatePercentAmount('b_lc_percent')" onchange="calculatePercentAmount('b_lc_percent')" onblur="calculatePercentAmount('b_lc_percent')" id="b_lc_percent" name="b_lc_percent" type="text" placeholder="Percent">
                            </div>
                             <div class="col-sm-4 col-md-3 ">
                               <input readonly style="text-align: right;" class="form-control" id="b_lc_amount" name="b_lc_amount" type="text" placeholder="Amount">
                            </div>
                            <div class="col-sm-4 col-md-3 ">
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-sm-4 col-md-2 ">
                               <input readonly style="text-align: right;" class="form-control"  id="b_pdc_check" name="b_pdc_check" type="text" placeholder="T.Ch.">
                            </div>
                            <div class="col-sm-4 col-md-2 ">
                               <input readonly style="text-align: right;"class="form-control" onkeyup="calculatePercentAmount('b_pdc_percent')" onchange="calculatePercentAmount('b_pdc_percent')" onblur="calculatePercentAmount('b_pdc_percent')" id="b_pdc_percent" name="b_pdc_percent" type="text" placeholder="Percent">
                            </div>
                             <div class="col-sm-4 col-md-3 ">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4 col-md-2 ">
                                <input readonly style="text-align: right;" class="form-control" onkeyup="calculatePercentAmount('a_cash_percent')" onchange="calculatePercentAmount('a_cash_percent')" onblur="calculatePercentAmount('a_cash_percent')" id="a_cash_percent" name="a_cash_percent" type="text" placeholder="Percent">
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4 col-md-2 ">
                               <input readonly style="text-align: right;" class="form-control" id="a_bg_tenor" name="a_bg_tenor" type="text" placeholder="T.Day">
                            </div>
                            <div class="col-sm-4 col-md-2 ">
                               <input readonly style="text-align: right;" class="form-control" onkeyup="calculatePercentAmount('a_bg_percent')" onchange="calculatePercentAmount('a_bg_percent')" onblur="calculatePercentAmount('a_bg_percent')" id="a_bg_percent" name="a_bg_percent" type="text" placeholder="Percent">
                            </div>
                             <div class="col-sm-4 col-md-3 ">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4 col-md-2 ">
                               <input readonly style="text-align: right;" class="form-control" id="a_lc_tenor" name="a_lc_tenor" type="text" placeholder="T.Day">
                            </div>
                             <div class="col-sm-4 col-md-2 ">
                               <input readonly style="text-align: right;" class="form-control" onkeyup="calculatePercentAmount('a_lc_percent')" onchange="calculatePercentAmount('a_lc_percent')" onblur="calculatePercentAmount('a_lc_percent')" id="a_lc_percent" name="a_lc_percent" type="text" placeholder="Percent">
                            </div>
                             <div class="col-sm-4 col-md-3 ">
                               <input readonly style="text-align: right;" class="form-control"  id="a_lc_amount" name="a_lc_amount" type="text" placeholder="Amount">
                            </div>
                        </div>
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-sm-4 col-md-2 ">
                               <input readonly style="text-align: right;" class="form-control"  id="a_pdc_check" name="a_pdc_check" type="text" placeholder="T.Ch.">
                            </div>
                            <div class="col-sm-4 col-md-2 ">
                               <input readonly style="text-align: right;" class="form-control" onkeyup="calculatePercentAmount('a_pdc_percent')" onchange="calculatePercentAmount('a_pdc_percent')" onblur="calculatePercentAmount('a_pdc_percent')" id="a_pdc_percent" name="a_pdc_percent" type="text" placeholder="Percent">
                            </div>
                             <div class="col-sm-4 col-md-3 ">
                    ...
                    if(msg.products!=''){
                            ...
                            var total=0;
                             ...
                             //   total=total+Number(v.quote_price);
                                ...
                                str +='<td><input readonly onkeyup="calculateSubtotal('+(Number(i) + 1)+')" onchange="calculateSubtotal('+(Number(i) + 1)+')" onblur="calculateSubtotal('+(Number(i) + 1)+')"  style="width:40px;text-align: right;"  type="text"  name="quantity[]" id="quantity_'+(Number(i) + 1)+ '" class="issue" value="1"></td>';
                                str +='<td><input readonly onkeyup="calculateSubtotal('+(Number(i) + 1)+')" onchange="calculateSubtotal('+(Number(i) + 1)+')" onblur="calculateSubtotal('+(Number(i) + 1)+')"  style="width:80px;text-align: right;"  type="text"  name="unit_price[]" id="unit_price_'+(Number(i) + 1)+ '" class="issue" value="'+v.quote_price+'"></td>';
