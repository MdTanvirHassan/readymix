...
<div class="right_col" style="background-color: #f1f1f1;padding-bottom:20px;">
    ...
    <form action="<?php echo site_url('sale_quotations/add_quotation_action'); ?>" method="post">
         ...
         <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group row">
                    ...
                    <div class="col-sm-8 col-md-5 "><input required class="form-control" id="attention" name="attention" type="text"></div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group row">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group row">
                    ...
                    <div class="col-sm-8 col-md-5 "><input required readonly class="form-control" id="project_name" name="project_name" type="text"></div>
                </div>
            </div>
            <div class="col-md-6">
                    <div class="form-group row">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
             ...
             <div class="col-md-6">
                    ...
                    <div class="col-sm-8 col-md-5 ">
                        <textarea rows="" class="form-control" name="special_note"></textarea>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group row">
                    <div class="col-sm-4 col-md-4   " style=""><b>Before Delivery</b></div>
                    <div class="col-sm-8 col-md-5 ">
                 ...
                 <div class="form-group row">
                    ...
                    <div class="col-sm-4 col-md-2 ">
                       <input readonly class="form-control" onkeyup="calculatePercentAmount('b_cash_percent')" onchange="calculatePercentAmount('b_cash_percent')" onblur="calculatePercentAmount('b_cash_percent')" id="b_cash_percent" name="b_cash_percent" type="text" placeholder="Percent">
                    </div>
                 ...
                 <div class="form-group row">
                    ...
                    <div class="col-sm-4 col-md-2 ">
                       <input readonly class="form-control" id="b_bg_tenor" name="b_bg_tenor" type="text" placeholder="T. Day">
                    </div>
                    <div class="col-sm-4 col-md-2 ">
                       <input readonly class="form-control" onkeyup="calculatePercentAmount('b_bg_percent')" onchange="calculatePercentAmount('b_bg_percent')" onblur="calculatePercentAmount('b_bg_percent')" id="b_bg_percent" name="b_bg_percent" type="text" placeholder="Percent">
                    </div>
                     <div class="col-sm-4 col-md-3 ">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4 col-md-2 ">
                       <input readonly class="form-control" id="b_lc_tenor" name="b_lc_tenor" type="text" placeholder="T.Day">
                    </div>
                     <div class="col-sm-4 col-md-2 ">
                       <input readonly class="form-control" onkeyup="calculatePercentAmount('b_lc_percent')" onchange="calculatePercentAmount('b_lc_percent')" onblur="calculatePercentAmount('b_lc_percent')" id="b_lc_percent" name="b_lc_percent" type="text" placeholder="Percent">
                    </div>
                     <div class="col-sm-4 col-md-3 ">
                 ...
                 <div class="form-group row">
                    ...
                    <div class="col-sm-4 col-md-2 ">
                       <input readonly class="form-control"  id="b_pdc_check" name="b_pdc_check" type="text" placeholder="T.Ch.">
                    </div>
                    <div class="col-sm-4 col-md-2 ">
                       <input readonly class="form-control" onkeyup="calculatePercentAmount('b_pdc_percent')" onchange="calculatePercentAmount('b_pdc_percent')" onblur="calculatePercentAmount('b_pdc_percent')" id="b_pdc_percent" name="b_pdc_percent" type="text" placeholder="Percent">
                    </div>
                     <div class="col-sm-4 col-md-3 ">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4 col-md-2 ">
                        <input readonly class="form-control" onkeyup="calculatePercentAmount('a_cash_percent')" onchange="calculatePercentAmount('a_cash_percent')" onblur="calculatePercentAmount('a_cash_percent')" id="a_cash_percent" name="a_cash_percent" type="text" placeholder="Percent">
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4 col-md-2 ">
                       <input readonly class="form-control" id="a_bg_tenor" name="a_bg_tenor" type="text" placeholder="T.Day">
                    </div>
                    <div class="col-sm-4 col-md-2 ">
                       <input readonly class="form-control" onkeyup="calculatePercentAmount('a_bg_percent')" onchange="calculatePercentAmount('a_bg_percent')" onblur="calculatePercentAmount('a_bg_percent')" id="a_bg_percent" name="a_bg_percent" type="text" placeholder="Percent">
                    </div>
                     <div class="col-sm-4 col-md-3 ">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4 col-md-2 ">
                       <input readonly class="form-control" id="a_lc_tenor" name="a_lc_tenor" type="text" placeholder="T.Day">
                    </div>
                     <div class="col-sm-4 col-md-2 ">
                       <input readonly class="form-control" onkeyup="calculatePercentAmount('a_lc_percent')" onchange="calculatePercentAmount('a_lc_percent')" onblur="calculatePercentAmount('a_lc_percent')" id="a_lc_percent" name="a_lc_percent" type="text" placeholder="Percent">
                    </div>
                     <div class="col-sm-4 col-md-3 ">
                 ...
                 <div class="form-group row">
                    ...
                    <div class="col-sm-4 col-md-2 ">
                       <input readonly class="form-control"  id="a_pdc_check" name="a_pdc_check" type="text" placeholder="T.Ch.">
                    </div>
                    <div class="col-sm-4 col-md-2 ">
                       <input readonly class="form-control" onkeyup="calculatePercentAmount('a_pdc_percent')" onchange="calculatePercentAmount('a_pdc_percent')" onblur="calculatePercentAmount('a_pdc_percent')" id="a_pdc_percent" name="a_pdc_percent" type="text" placeholder="Percent">
                    </div>
                     <div class="col-sm-4 col-md-3 ">
                    ...
                    if(msg.products!=''){
                            ...
                            var total=0;
                             ...
                             //   total=total+Number(v.quote_price);
                                ...
                                str +='<td><input readonly  style="width:140px;"  type="text"  name="project_n[]" id="project_name_'+(Number(i) + 1)+ '" class="issue" value="'+v.project_name+'"></td>';
                                str +='<td><input   style="width:80px;"  type="text"  name="m_unit[]" id="m_unit_'+(Number(i) + 1) + '" class="issue" value="'+v.measurement_unit+'"></td>';
                                str +='<td><input readonly onkeyup="calculateSubtotal('+(Number(i) + 1)+')" onchange="calculateSubtotal('+(Number(i) + 1)+')" onblur="calculateSubtotal('+(Number(i) + 1)+')"  style="width:40px;"  type="text"  name="quantity[]" id="quantity_'+(Number(i) + 1)+ '" class="issue" value="1"></td>';
                                str +='<td><input readonly onkeyup="calculateSubtotal('+(Number(i) + 1)+')" onchange="calculateSubtotal('+(Number(i) + 1)+')" onblur="calculateSubtotal('+(Number(i) + 1)+')"  style="width:80px;"  type="text"  name="unit_price[]" id="unit_price_'+(Number(i) + 1)+ '" class="issue" value="'+v.quote_price+'"></td>';

                                str +='<td><input readonly  style="width:140px;"  type="text"  name="amount[]" id="amount_'+(Number(i) + 1) + '" class="amount_'+(Number(i) + 1)+'" value="'+v.quote_price+'"></td>';
