...
<div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_content">
    <form class="form-horizontal" action="<?php echo site_url('sale_quotations/add_quotation_action'); ?>" method="post" onsubmit="javascript: return validation()" >
        ...
        <div class='form-group' >
                  ...
                  <div class='form-group' >
                                ...
                                <div class="col-sm-4 input-group">
                                 ...
                                 <label for="title" class="col-sm-2 control-label">
                                    Bank Show<sup class="required">*</sup> :
                                </label>
                                <div class="col-sm-4 input-group">
                                    <span class="input-group-addon"><i class="fa fa-user"></i></span>
                ...
                <table class="table table-bordered" id="myTable">
                    <thead class="thead-color">
                     <tr >
                         ...
                         <th>Base Price<sup style='color:red'>*</sup></th>
                         <th>Vat<sup style='color:red'>*</sup></th>
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-sm-4 col-md-2 ">
                             ...
                             <div class="col-sm-4 col-md-3 ">
                               <input readonly  style="text-align: right;"  onkeyup="calculateAmountToPercent('b_cash_amount')" onchange="calculateAmountToPercent('b_cash_amount')" onblur="calculateAmountToPercent('b_cash_amount')"  class="number form-control" id="b_cash_amount" name="b_cash_amount" type="text" placeholder="Amount">
                            </div>
                             <div class="col-sm-4 col-md-3 ">
                        ...
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-sm-4 col-md-2 ">
                             ...
                             <div class="col-sm-4 col-md-3 ">
                               <input readonly style="text-align: right;" onkeyup="calculateAmountToPercent('b_pdc_amount')" onchange="calculateAmountToPercent('b_pdc_amount')" onblur="calculateAmountToPercent('b_pdc_amount')" class="form-control" id="b_pdc_amount" name="b_pdc_amount" type="text" placeholder="Amount">
                            </div>
                            <div class="col-sm-4 col-md-3 ">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4 col-md-2 ">
                             ...
                             <div class="col-sm-4 col-md-3 ">
                               <input readonly style="text-align: right;" onkeyup="calculateAmountToPercent('a_cash_amount')" onchange="calculateAmountToPercent('a_cash_amount')" onblur="calculateAmountToPercent('a_cash_amount')" class="form-control"  id="a_cash_amount" name="a_cash_amount" type="text" placeholder="Amount">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4 col-md-2 ">
                             ...
                             <div class="col-sm-4 col-md-3 ">
                               <input readonly style="text-align: right;" onkeyup="calculateAmountToPercent('a_bg_amount')" onchange="calculateAmountToPercent('a_bg_amount')" onblur="calculateAmountToPercent('a_bg_amount')" class="form-control" id="a_bg_amount" name="a_bg_amount" type="text" placeholder="Amount">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4 col-md-2 ">
                             ...
                             <div class="col-sm-4 col-md-3 ">
                               <input readonly style="text-align: right;" onkeyup="calculateAmountToPercent('a_lc_amount')" onchange="calculateAmountToPercent('a_lc_amount')" onblur="calculateAmountToPercent('a_lc_amount')" class="form-control number"  id="a_lc_amount" name="a_lc_amount" type="text" placeholder="Amount">
                            </div>
                        </div>
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-sm-4 col-md-2 ">
                             ...
                             <div class="col-sm-4 col-md-3 ">
                               <input readonly style="text-align: right;" onkeyup="calculateAmountToPercent('a_pdc_amount')" onchange="calculateAmountToPercent('a_pdc_amount')" onblur="calculateAmountToPercent('a_pdc_amount')" class="form-control" id="a_pdc_amount" name="a_pdc_amount" type="text" placeholder="Amount">
                            </div>
                        </div>
       ...
       <div class="row">
        ...
        <div class="form-group">
            ...
            <div id="special_note">
             <textarea rows="" class="form-control" name="special_note" placeholder="Wright Special Note"></textarea>
...
<!--        <div class="row">
           <div class="col-md-1 col-md-offset-3">
                <a href="<?php echo site_url('backend/sale_quotations') ?>" > <button type="button" class="btn btn-success button" style="padding:6px 4px;">REGISTER</button> </a>
...
//        }
                     ...
                     if(msg.products!=''){
                            ...
                            var total=0;
                             $(msg.products).each(function (i, v) {
                                ...
                                str +='<td><input type="hidden"  name="product_cost_id[]" id="product_cost_id_'+(Number(i) + 1) + '" class="issue" value="'+v.product_cost_id+'"><input readonly  style="width:120px;"  type="text"  name="cost_number[]" id="cost_number_'+(Number(i) + 1) + '" class="issue" value="'+v.cost_number+'"></td>';
                                str +='<td>';
                                str +='<input style="width:140px;"  type="hidden"  name="project_address[]" id="project_address_'+(Number(i) + 1)+ '" class="issue" value="'+v.address+'">';
                                str +='<input style="width:140px;"  type="hidden"  id="contact_person_'+(Number(i) + 1)+ '" class="issue" value="'+v.contact_person+'">';
                                str +='<input style="width:140px;"  type="hidden"   id="contact_no_'+(Number(i) + 1)+ '" class="issue" value="'+v.contact_no+'">';
                                str +='<input style="width:140px;"  type="hidden"  name="project_id_[]" id="project_id_'+(Number(i) + 1)+ '" class="issue" value="'+v.project_id+'">';
                                str +='<input readonly  style="width:140px;"  type="text"  name="project_n[]" id="project_name_'+(Number(i) + 1)+ '" class="issue" value="'+v.project_name+'">';
                                str +='</td>';
                                str +='<td><input required  style="width:80px;"  type="text"  name="mu_name[]" id="m_unit_'+(Number(i) + 1) + '" class="issue" value="'+v.measurement_unit+'"></td>';
                                str +='<td><input readonly onkeyup="calculateSubtotal('+(Number(i) + 1)+')" onchange="calculateSubtotal('+(Number(i) + 1)+')" onblur="calculateSubtotal('+(Number(i) + 1)+')"  style="width:80px;text-align: right;"  type="text"  name="quantity[]" id="quantity_'+(Number(i) + 1)+ '" class="issue number" value="1"></td>';
                                str +='<td><input readonly onkeyup="calculateUnitPrice('+(Number(i) + 1)+')" onchange="calculateUnitPrice('+(Number(i) + 1)+')" onblur="calculateUnitPrice('+(Number(i) + 1)+')"  style="width:80px;text-align: right;"  type="text"  name="base_price[]" id="base_price_'+(Number(i) + 1)+ '" class="issue number" value="'+(Number(v.price_in_cft)-Number(v.vat))+'"></td>';
                                str +='<td><input readonly onkeyup="calculateUnitPrice('+(Number(i) + 1)+')" onchange="calculateUnitPrice('+(Number(i) + 1)+')" onblur="calculateUnitPrice('+(Number(i) + 1)+')"  style="width:80px;text-align: right;"  type="text"  name="vat[]" id="vat_'+(Number(i) + 1)+ '" class="issue number" value="'+v.vat+'"></td>';
                                 if(v.measurement_unit=='MT'){
                                str +='<td><input readonly onkeyup="calculateSubtotal('+(Number(i) + 1)+')" onchange="calculateSubtotal('+(Number(i) + 1)+')" onblur="calculateSubtotal('+(Number(i) + 1)+')"  style="width:80px;text-align: right;"  type="text"  name="unit_price[]" id="unit_price_'+(Number(i) + 1)+ '" class="issue number" value="'+(v.quote_price/2.41).toFixed(2)+'"></td>';
                            }else if (v.measurement_unit=='CFT'){
                                str +='<td><input readonly onkeyup="calculateSubtotal('+(Number(i) + 1)+')" onchange="calculateSubtotal('+(Number(i) + 1)+')" onblur="calculateSubtotal('+(Number(i) + 1)+')"  style="width:80px;text-align: right;"  type="text"  name="unit_price[]" id="unit_price_'+(Number(i) + 1)+ '" class="issue number" value="'+v.price_in_cft+'"></td>';
                            }else
                ...
                success: function (msg) {  
                    if(msg.products!=''){
                            ...
                            var total=0;
                             ...
                             //   total=total+Number(v.quote_price);
                                str+= '<tr  id="row_' + (Number(i) + 1) + '">';
    ...
    $('#button1').click(function () {
        ...
        str +='<td><input required onkeyup="calculateSubtotal('+(Number(count) + 1)+')" onchange="calculateSubtotal('+(Number(count) + 1)+')" onblur="calculateSubtotal('+(Number(count) + 1)+')"  style="width:140px;"  type="text"  name="quantity[]" id="quantity_'+(Number(count) + 1) + '" class="issue"></td>';
        str +='<td><input required onkeyup="calculateSubtotal('+(Number(count) + 1)+')" onchange="calculateSubtotal('+(Number(count) + 1)+')" onblur="calculateSubtotal('+(Number(count) + 1)+')"  style="width:140px;"  type="text"  name="unit_price[]" id="unit_price_'+(Number(count) + 1) + '" class="issue"></td>';
  ...
  function calculateSubtotal(id){   
    ...
    //alert('test');
         ...
         if($('#select_product_'+id).prop('checked')){
           //  alert(id);
             var project_name=$('#project_name_'+id).val();
             var project_address=$('#project_address_'+id).val();
             var contact_person=$('#contact_person_'+id).val();
             var contact_no=$('#contact_no_'+id).val();
             
             
             var project_id=$('#project_id_'+id).val();
             var product_cost_id=$('#product_cost_id_'+id).val();
           ...
           //  alert(project_address);
             ...
             if(p_name==''){
                ...
                $('#shipping_address').val(project_address);
                
                if(contact_person!='' && contact_person!='null' && contact_person!='undefined'){
                    $('#contact_person').val(contact_person);
                }
                
                if(contact_no!='' && contact_no!='null' && contact_no!='undefined'){
                ...
                $('#base_price_'+id).prop('readonly',false);
                $('#vat_'+id).prop('readonly',false);
                
                $('#unit_price_'+id).prop('readonly',false);
                $('#unit_price_'+id).prop('required',true);
            }else if(p_name==project_name){
                ...
                $('#select_product_'+id).prop('checked',false);
                alert('Please select product of same project');
            } 
            
             $.ajax({
                url: '<?php echo site_url('sale_quotations/product_specification'); ?>',
                data: {product_cost_id:product_cost_id},
                method: 'POST',
                dataType: 'json',
                success: function (msg) {  
                   if(msg.product_specifications!=''){
                       $('#material_count').val(msg.product_specifications.length);
                       
                       var str='';
                       $(msg.product_specifications).each(function(i,v){
                           if(v.brand==null){
                               var brand='';
                           }else{
                               var brand=v.brand;
                            ...
                            str += '<tr  id="row_' + (Number(i) + 1) + '">';
                            str +='<td><input required  style="width:250px"  type="text"  name="material_name[]"  class="issue form-control" value="'+v.item_name+'"></td>';
                            str +='<td><input   style="width:350px"  type="text"  name="m_description[]"  class="issue form-control" value="'+brand+'"></td>';
                            str +='<td><button type="button" style="padding-left:6px;padding-right:6px;font-size:8px;" id="button2" onclick="removeMaterial(' + (Number(i) + 1) + ')" class="btn btn-danger pull-left"><span class="glyphicon glyphicon-minus"></span></button></td>'; 
                            str +='</tr>';          
                       });
