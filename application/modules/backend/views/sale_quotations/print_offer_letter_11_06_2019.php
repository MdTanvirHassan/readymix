...
<h2 style="text-align: center;">Karim Asphalt & Ready Mix Ltd. </h2>
        ...
        <table class="table" id="">
                ...
                <tr>
                    ...
                    <td style="border-top:0px;padding-left:0px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="border-bottom:1px solid;">Delivery Place:</span></td>
                </tr>
                 <tr>
                ...
                <table class="table table-bordered" id="myTable">
                    <thead>
                     <tr >
                         ...
                         <th style="text-align:center;border-left:1px solid;border-top:1px solid;">Value</th>
