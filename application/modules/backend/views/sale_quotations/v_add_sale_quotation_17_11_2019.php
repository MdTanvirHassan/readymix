    ...
    <form class="form-horizontal" action="<?php echo site_url('sale_quotations/add_quotation_action'); ?>" method="post" onsubmit="javascript: return validation()" >
        ...
        <div class='form-group' >
                        ...
                        <span id="phone_error" style="color:red"></span>
                                ...
                                <label for="title" class="col-sm-2 control-label">
                                    Billing Address<sup class="required">*</sup> :
                                </label>
                                <div class="col-sm-4 input-group">
                                    <span class="input-group-addon"><i class="fa fa-user"></i></span>
        ...
        <div class='form-group' >
                                <label for="title" class="col-sm-2 control-label">
                                  Prepared By<sup class="required">*</sup>  :
                                </label> 
                                <div class="col-sm-4 input-group">
                                    <span class="input-group-addon"><i class="fa fa-product-hunt"></i></span>
...
<!--        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group row">
                    <div class="col-sm-4 col-md-4  labeltext" style="text-align: right;"> 
                        <label for="inputdefault">Q.No<sup style="color:red;">*</sup> :</label></div>
            ...
            <div class="col-md-4 ">
                <div class="form-group row">
                    <div class="col-sm-4 col-md-4  labeltext" style="text-align: right;">
                        <label for="c_name">Date<sup style="color:red;">*</sup>  :</label></div>
                    <div class="col-sm-8 col-md-8  "> 
                       <input  class="form-control datepicker" id="quotation_date" name="quotation_date" type="text" value="<?php echo date('d-m-Y') ?>">
                       <span id="quotation_date_error" style="color:red"></span>
                    </div>
            ...
            <div class="col-md-4">
                <div class="form-group row">
                    <div class="col-sm-4 col-md-4  labeltext" style="text-align: right;">
                        <label for="c_short_name">Product Type<sup style="color:red;">*</sup>  :</label></div>
                    <div class="col-sm-8 col-md-8  ">
                        <select  id="category_id" class="form-control e1" name="category_id">
                            <option class="form-control" value="">Select Product Type</option>
                            <?php foreach($categories as $category){ ?>
...
<!--         <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group row">
                    <div class="col-sm-4 col-md-4  labeltext" style="text-align: right;"> 
                        <label for="inputdefault">Customer<sup style="color:red;">*</sup> :</label></div>
                    <div class="col-sm-8 col-md-8  ">
                       <select  id="customer_id" class="form-control e1" name="customer_id">
                            <option class="form-control" value="">Select Customer</option>
                            <?php foreach($customers as $customer){ ?>
            ...
            <div class="col-md-4 ">
                <div class="form-group row">
                    <div class="col-sm-4 col-md-4  labeltext" style="text-align: right;">
                        <label for="c_name">Project Name<sup style="color:red;">*</sup>  :</label></div>
                    <div class="col-sm-8 col-md-8  "> 
                       <input   class="form-control" id="project_id" name="project_id" type="hidden">
                       <input  readonly class="form-control" id="project_name" name="project_name" type="text">
                       <span id="project_name_error" style="color:red"></span>
            ...
            <div class="col-md-4">
                <div class="form-group row">
                    <div class="col-sm-4 col-md-4  labeltext" style="text-align: right;">
                        <label for="c_short_name">Attention<sup style="color:red;">*</sup>  :</label></div>
                    <div class="col-sm-8 col-md-8  ">
                        <input  class="form-control" id="attention" name="attention" type="text" placeholder="Attention Person Name">
                        <span id="attention_error" style="color:red"></span>
                    </div>
...
<!--        <div class="row">
            <div class="col-md-4">
                <div class="form-group row">
                    <div class="col-sm-4 col-md-4  labeltext" style="text-align: right;">
                        <label for="c_short_name">Phone<sup style="color:red;">*</sup>  :</label></div>
                    <div class="col-sm-8 col-md-8  ">
                        <input  class="form-control" id="phone" name="phone" type="text" placeholder="Phone">
                        <span id="phone_error" style="color:red"></span>
                    </div>
            ...
            <div class="col-md-4">
                <div class="form-group row">
                    <div class="col-sm-4 col-md-4  labeltext" style="text-align: right;">
                        <label for="c_short_name">B. Email<sup style="color:red;">*</sup>  :</label></div>
                    <div class="col-sm-8 col-md-8  ">
                        <input  class="form-control" id="billing_email" name="billing_email" type="text" placeholder="Billing Email">
                        <span id="billing_email_error" style="color:red"></span>
                    </div>
...
<!--         <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group row">
                    <div class="col-sm-4 col-md-4  labeltext" style="text-align: right;">
                        <label for="c_short_name">D. Email<sup style="color:red;">*</sup>  :</label></div>
                    <div class="col-sm-8 col-md-8  ">
                        <input  class="form-control" id="shipping_email" name="shipping_email" type="text" placeholder="Delivery Email">
                        <span id="shipping_email_error" style="color:red"></span>
                    </div>
            ...
            <div class="col-md-4">
                <div class="form-group row">
                    <div class="col-sm-4 col-md-4  labeltext" style="text-align: right;">
                        <label for="c_short_name">Sales Person:</label></div>
                    <div class="col-sm-8 col-md-8  ">
                        <select id="employee_id" class="form-control e1" name="employee_id">
                            <option class="form-control" value="">Select Employee</option>
                            <?php foreach($employees as $employee){ ?>
...
<!--        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group row">
                    <div class="col-sm-4 col-md-4  labeltext" style="text-align: right;">
                        <label for="c_short_name">Followup By<sup style="color:red;">*</sup>  :</label></div>
                    <div class="col-sm-8 col-md-8  ">
                         <select  id="followup_employee_id" class="form-control e1" name="followup_employee_id">
                            <option class="form-control" value="">Select Employee</option>
                            <?php foreach($employees as $employee){ ?>
