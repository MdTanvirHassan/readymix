    ...
    <form action="<?php echo site_url('sale_quotations/add_quotation_action'); ?>" method="post">
        ...
        <div class="row">
                ...
                <div class="form-group row">
                 ...
                 <div class="form-group row">
                    <div class="col-sm-4 col-md-2   labeltext" style="">
                        <label for="b_cash"><input id="b_cash"  type="checkbox" name="b_cash" value="Cash">&nbsp;Cash</label>
                    </div>
                 ...
                 <div class="form-group row">
                    <div class="col-sm-4 col-md-2   labeltext" style=""><label for="b_bg"><input id="b_bg" type="checkbox" name="b_bg" value="Bg">&nbsp;BG</label></div>
                    <div class="col-sm-4 col-md-2 ">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group row">
                    <div class="col-sm-4 col-md-2   labeltext" style=""><label for="a_bg"><input id="a_bg" type="checkbox" name="a_bg" value="Bg">&nbsp;BG</label></div>
                    <div class="col-sm-4 col-md-2 ">
                ...
                <div class="form-group row">
                    <div class="col-sm-4 col-md-2 labeltext" style=""><label for="a_lc"><input id="a_lc" type="checkbox" name="a_lc" value="Lc">&nbsp;LC</label></div>
                    <div class="col-sm-4 col-md-2 ">
                 ...
                 <div class="form-group row">
                    <div class="col-sm-4 col-md-2   labeltext" style=""><label for="a_pdc"><input id="a_pdc" type="checkbox" name="a_pdc" value="Pdc">&nbsp;PDC</label></div>
                    <div class="col-sm-4 col-md-2 ">
                    ...
                    if(msg.products!=''){
                            ...
                            var total=0;
                             $(msg.products).each(function (i, v) {
                                ...
                                str +='<td><button style="padding-left:6px;padding-right:6px;font-size:8px;" id="button2" onclick="removeRow(' + (Number(i) + 1) + ')" class="btn btn-danger pull-left"><span class="glyphicon glyphicon-minus"></span></button></td>'; 
                                ...
                                str +='<td><input type="hidden"  name="product_cost_id[]" id="product_cost_id_'+(Number(i) + 1) + '" class="issue" value="'+v.product_cost_id+'"><input readonly  style="width:140px;"  type="text"  name="cost_number[]" id="cost_number_'+(Number(i) + 1) + '" class="issue" value="'+v.cost_number+'"></td>';
                                str +='<td><input   style="width:140px;"  type="text"  name="description[]" id="description_'+(Number(i) + 1) + '" class="issue"></td>';
                                str +='<td><input required onkeyup="calculateSubtotal('+(Number(i) + 1)+')" onchange="calculateSubtotal('+(Number(i) + 1)+')" onblur="calculateSubtotal('+(Number(i) + 1)+')"  style="width:40px;"  type="text"  name="quantity[]" id="quantity_'+(Number(i) + 1) + '" class="issue" value="1"></td>';
                                str +='<td><input required onkeyup="calculateSubtotal('+(Number(i) + 1)+')" onchange="calculateSubtotal('+(Number(i) + 1)+')" onblur="calculateSubtotal('+(Number(i) + 1)+')"  style="width:140px;"  type="text"  name="unit_price[]" id="unit_price_'+(Number(i) + 1) + '" class="issue" value="'+v.quote_price+'"></td>';

                                str +='<td><input readonly  style="width:140px;"  type="text"  name="amount[]" id="amount_'+(Number(i) + 1) + '" class="issue" value="'+v.quote_price+'"></td>';
