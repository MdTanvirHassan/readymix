                            ...
                            <div class='form-group' >
                                ...
                                <div class="col-sm-4 input-group">
                                    <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                     ...
                                     <input required id="contact_no" class="form-control"  name="contact_no" type="text" value="<?php if(!empty($contact_info[0]['contact_no'])) echo $contact_info[0]['contact_no']; ?>">
                                ...
                                <div class="col-sm-4 input-group">
                                    <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                     ...
                                     <input required id="contact_date" class="form-control datepicker"  name="contact_date" type="text" value="<?php if(!empty($contact_info[0]['contact_date'])) echo date('d-m-Y',strtotime($contact_info[0]['contact_date'])); ?>">
                               ...
                               <label for="title" class="col-sm-2 control-label">
                                ...
                                <div class="col-sm-4 input-group">
                                    <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                     ...
                                     <input  id="lc_deadline" class="form-control datepicker"  name="lc_deadline" type="text" value="<?php if(!empty($contact_info[0]['lc_deadline'])) echo date('d-m-Y',strtotime($contact_info[0]['lc_deadline'])); ?>">
                                ...
                                <div class="col-sm-4 input-group">
                                    <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                     ...
                                     <input  id="shipment_deadline" class="form-control datepicker"  name="shipment_deadline" type="text" value="<?php if(!empty($contact_info[0]['shipment_deadline'])) echo date('d-m-Y',strtotime($contact_info[0]['shipment_deadline'])); ?>">
                           ...
                           <div class='form-group' >
                                ...
                                <div class="col-sm-4 input-group">
                                    <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                     ...
                                     <input id="local_agent" class="form-control "  name="local_agent" type="text" value="<?php if(!empty($contact_info[0]['local_agent'])) echo $contact_info[0]['local_agent']; ?>">
                                ...
                                <div class="col-sm-4 input-group">
                                    <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                     ...
                                     <input id="agent_contact" class="form-control "  name="agent_contact" type="text" value="<?php if(!empty($contact_info[0]['agent_contact'])) echo $contact_info[0]['agent_contact']; ?>">
                            ...
                            <div class='form-group' >
                                ...
                                <div class="col-sm-4 input-group">
                                    <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                     ...
                                     <input required id="shipment_port" class="form-control"  name="shipment_port" type="text" value="<?php if(!empty($contact_info[0]['shipment_port'])) echo $contact_info[0]['shipment_port']; ?>">
                                ...
                                <div class="col-sm-4 input-group">
                                    <span class="input-group-addon"><i class="fa fa-user"></i></span>                                   
                                    <input required  id="discharge_rate" onkeyup="javascript:checkNumeric();" onchange="javascript:checkNumeric();" onblur="javascript:checkNumeric();" class="form-control number"  name="discharge_rate" type="text" value="<?php if(!empty($contact_info[0]['discharge_rate'])) echo $contact_info[0]['discharge_rate']; ?>">
                            ...
                            <table class="table table-bordered" id="myTable">
                                ...
                                <tbody id="mytableBody">
                                    <?php $i=0; foreach($contact_details as $c_details){
                                        ...
                                        ?>
                                       <tr id="row_1">
                                            <td><button style="padding-left:6px;padding-right:6px;font-size:8px;" id="button2" onclick="removeRow(<?php echo $i; ?>)" class="btn btn-danger pull-left"><span class="glyphicon glyphicon-minus"></span></button></td>

                                            <td>
                                              <!--  <input style="width:100%;"  id="lot_1"  type="text"  name="lot_id[]" class="issue  form-control item_code_ajax">-->
                                                <select style="width:100%;" required class="form-control" id="item_id_<?php echo $i; ?>" name="item_id[]" onchange="javascript:itemInfo(<?php echo $i; ?>)">
                                         ...
                                         <!--   <td><input style="width:100%;"  id="staple_length_<?php echo $i; ?>"  type="text"  name="composition[]" class="issue  form-control " value="<?php echo $c_details['staple_length']; ?>"></td> -->
                                            <td><input style="width:100%;"  id="mu_<?php echo $i; ?>"  type="text"  name="mu[]"  class="issue  form-control " value="<?php echo $c_details['meas_unit']; ?>"></td>
                                            <td><input style="width:100%;"  id="total_qty_<?php echo $i; ?>"  type="text"  name="qty[]" onchange="calculateValue(<?php echo $i; ?>);" onkeyup="calculateValue(<?php echo $i; ?>);" onblur="calculateValue(<?php echo $i; ?>);"  class="issue  form-control number" value="<?php echo $c_details['qty']; ?>"></td>
                                            
                                            <td><input style="width:100%;"  id="rate_<?php echo $i; ?>"  type="text"  name="rate[]" onchange="calculateValue(<?php echo $i; ?>);" onkeyup="calculateValue(<?php echo $i; ?>);" onblur="calculateValue(<?php echo $i; ?>);" class="issue  form-control number" value="<?php echo $c_details['rate']; ?>"></td>
                                            <td><input style="width:100%;"  id="value_<?php echo $i; ?>"  type="text"  name="value[]" class="issue  form-control number" value="<?php echo $c_details['value']; ?>"></td>
...
<!--                        <div class="row">
    ...
    <script type="text/javascript">
       ...
       $('#button1').click(function () {
            ...
            str += '<td>';
            str +='<input readonly  style="width:100%;" class="form-control" style="width:300px;" type="text"  name="origin[]" id="origin_' + (Number(count) + 1) + '" class="issue">';
            str +='</td>';
            
            
            str += '<td>';
            str +='<input readonly  style="width:100%;" class="form-control" style="width:300px;" type="text"  name="grade[]" id="grade_' + (Number(count) + 1) + '"  class="issue">';
            str +='</td>';
