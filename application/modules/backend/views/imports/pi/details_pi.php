                        ...
                        <form class="form-horizontal" method="post" action="<?php echo site_url('imports/pi/edit_action_pi/'.$pi_info[0]['id']) ?>">
                            <div class="row">
                                <div class='form-group'>
                                    ...
                                    <div class="col-sm-4 input-group">
                                        ...
                                        <input readonly class="form-control" id="pi_no" name="pi_no" type="text" value="<?php if(!empty($pi_info[0]['pi_no'])) echo $pi_info[0]['pi_no']; ?>">
                                    </div>
                                    ...
                                    <div class="col-sm-4 input-group">
                                        ...
                                        <input disabled class="form-control datepicker" name="pi_date" type="text" value="<?php if(!empty($pi_info[0]['pi_date'])) echo date('d-m-Y',strtotime($pi_info[0]['pi_date'])); ?>">
                                    </div>
                            ...
                            <div class="row">
                                <div class='form-group'>
                                    ...
                                    <div class="col-sm-4 input-group">
                                        ...
                                        <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                        <select disabled class="form-control e1" id="s_contact_id" name="s_contact_id" onchange="javascript:getContactDetails();">
                                    ...
                                    <div class="col-sm-4 input-group">
                                        ...
                                        <select disabled class="form-control" name="party_bank">
                            ...
                            <div class="row">
                                <div class='form-group'>
                                    ...
                                    <div class="col-sm-4 input-group">
                                        <span class="input-group-addon"><i class="fa fa-user"></i></span>                                   
                                        <input readonly  id="discharge_rate" class="form-control"  name="discharge_rate" type="text" value="<?php if(!empty($pi_info[0]['discharge_rate'])) echo $pi_info[0]['discharge_rate']; ?>">
                                    ...
                                    <div class="col-sm-4 input-group">
                                        <span class="input-group-addon"><i class="fa fa-check-square"></i></span>
                                        <input readonly  class="form-control " name="lc_type" type="text" value="<?php if(!empty($pi_info[0]['lc_type'])) echo $pi_info[0]['lc_type']; ?>">
                                    </div>
                                ...
                                foreach($pi_details as $details){ 
                                    ...
                                    ?>    
                                        <tr id="row_<?php echo $i; ?>" style="">
                                           ...
                                           <td>
                                                <input readonly style="width:100%;" type="text" onchange="calculateTotal()" id="qty_<?php echo $i; ?>" name="qty[]" class="issue form-control" value="<?php echo $details['qty']; ?>">
                                           </td>

                                           <td><input readonly style="width:100%;" type="text" onchange="calculateTotal()" id="price_<?php echo $i; ?>" name="rate[]" class="form-control" value="<?php echo $details['rate']; ?>"></td>
