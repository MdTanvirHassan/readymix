    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_content">
                        <form class="form-horizontal" method="post" action="<?php echo site_url('imports/landed_cost/edit_action_landed_cost/'.$cost_info[0]['id']) ?>">
                            <div class="row">
                                    ...
                                    <div class="col-sm-4 input-group">
                                        ...
                                        <select required class="form-control e1" id="lc_id" name="lc_id" >
                                            ...
                                            <?php foreach ($lcs as $lc) { ?>
                                                <option <?php if($lc['lc_id']==$cost_info[0]['lc_id']) echo 'selected'; ?> value="<?php echo $lc['lc_id']; ?>"><?php if (!empty($lc['lc_no'])) echo $lc['lc_no'].'('.$lc['mother_vessel_name'].')'; ?></option>
                                            <?php } ?>
                                        </select>
                            ...
                            <div class="row">
                                <div class='form-group'>
                                    ...
                                    <div class="col-sm-4 input-group">
                                        <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                        <input  class="form-control" id="unit_price" name="unit_price" type="text" value="<?php echo $cost_info[0]['unit_price']; ?>">
                                    </div>
                                    ...
                                    <div class="col-sm-4 input-group">
                                        <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                        <input  class="form-control" id="uh_unit_price" name="uh_unit_price" type="text" value="<?php echo $cost_info[0]['uh_unit_price']; ?>">
                                    </div>
                            ...
                            <div class="row">
                                <div class='form-group'>
                                    ...
                                    <div class="col-sm-4 input-group">
                                        <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                        <input  class="form-control" id="bdt_rate" name="bdt_rate" type="text" value="<?php echo $cost_info[0]['bdt_rate']; ?>">
                                    </div>
                                    ...
                                    <div class="col-sm-4 input-group">
                                        <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                        <input  class="form-control" id="lc_qty" name="lc_qty" type="text" value="<?php echo $cost_info[0]['lc_qty']; ?>">
                                    </div>
                                   ...
                                   foreach($cost_heads as $c_h){ 
                                       ...
                                       ?>
                                        <tr id="row_1" style="">
                                           ...
                                           <td>
                                                <input style="width:100%;" readonly type="hidden" id="hook_cost_<?php echo $i; ?>" name="hook_cost[]" class="issue form-control" value="<?php echo $c_h['hook_cost']; ?>">
                                                <input style="width:100%;" readonly type="hidden" id="hook_cost_<?php echo $i; ?>" name="yard_cost[]" class="issue form-control" value="<?php echo $c_h['yard_cost']; ?>">
                                           ...
                                           <td>
                                                <input style="width:100%;"  type="text" id="cash_amount_<?php echo $i; ?>" name="cash_amount[]" onkeyup="javascipt:calculateTotal();" onchange="javascipt:calculateTotal()" onblur="javascipt:calculateTotal();" class="issue form-control" value="<?php echo $c_h['cash_amount']; ?>">
                                           </td>

                                           <td>
                                                <input style="width:100%;"  type="text" id="bank_loan_amount_<?php echo $i; ?>" name="bank_loan_amount[]" class="issue form-control" onkeyup="javascipt:calculateTotal();" onchange="javascipt:calculateTotal()" onblur="javascipt:calculateTotal();" value="<?php echo $c_h['bank_loan_amount']; ?>" >
                                           </td>

                                           <td>
                                                <input style="width:100%;"   type="text" id="total_amount_<?php echo $i; ?>" name="total_amount[]" class="issue form-control" value="<?php echo $c_h['total_amount']; ?>">
                                           </td>
                                ...
                                <tfoot>
                                    <tr>
                                        <th style="text-align:right" colspan='3'>Total
                                            <input type="hidden" id="grand_total_amount" name="grand_total_amount" value="<?php echo $cost_info[0]['grand_total_amount']; ?>">
                                        </th>
