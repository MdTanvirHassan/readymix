                    ...
                    <div class="col-md-6">
                     ...
                     <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8 col-md-5 ">  
                                <input disabled required   class="form-control" id="project_name" name="project_name" type="text" value="<?php if(!empty($product_quote_price[0]['project_name'])) echo $product_quote_price[0]['project_name'];  ?>">
                            </div>
                        </div>
                    </div> 
                         ...
                         foreach($material_costs as $material_cost){ 
                             ...
                             ?>
                                <tr>
                                        ...
                                        <td><input readonly required onkeyup="calculateSubtotal(<?php echo $i; ?>)" onchange="calculateSubtotal(<?php echo $i; ?>)" onblur="calculateSubtotal(<?php echo $i; ?>)"  style="width:140px;"  type="text"  name="quantity[]" id="quantity_<?php echo $i; ?>" class="issue" value="<?php echo $material_cost['quantity']; ?>"></td>
                                        <td><input readonly required onkeyup="calculateSubtotal(<?php echo $i; ?>)" onchange="calculateSubtotal(<?php echo $i; ?>)" onblur="calculateSubtotal(<?php echo $i; ?>)"  style="width:140px;"  type="text"  name="rate[]" id="rate_<?php echo $i; ?>" class="issue" value="<?php echo $material_cost['rate']; ?>"></td>
                      ...
                      <tfoot id="foot" >
                          <tr>
                           ...
                           <tr>
                              ...
                              <td><input readonly onkeyup="javascript:calculateOtherExpense();" onchange="javascript:calculateOtherExpense();" onblur="javascript:calculateOtherExpense();" style="width:140px;" type="text" id="foh" name="foh" value="<?php if(!empty($product_other_cost[0]['foh'])) echo $product_other_cost[0]['foh'];  ?>" /></td>
                          </tr>
                           <tr>
                              <td colspan="4" style="text-align: right;">AOH</td>
                              <td><input readonly onkeyup="javascript:calculateOtherExpense();" onchange="javascript:calculateOtherExpense();" onblur="javascript:calculateOtherExpense();" style="width:140px;" type="text" id="aoh" name="aoh" value="<?php if(!empty($product_other_cost[0]['aoh'])) echo $product_other_cost[0]['aoh'];  ?>" /></td>
                          </tr>
                           <tr>
                              <td colspan="4" style="text-align: right;">SOH</td>
                              <td><input readonly onkeyup="javascript:calculateOtherExpense();" onchange="javascript:calculateOtherExpense();" onblur="javascript:calculateOtherExpense();" style="width:140px;" type="text" id="soh" name="soh" value="<?php if(!empty($product_other_cost[0]['soh'])) echo $product_other_cost[0]['soh'];  ?>" /></td>
                          </tr>
                           <tr>
                              <td colspan="4" style="text-align: right;">Fin. Exp</td>
                              <td><input readonly onkeyup="javascript:calculateOtherExpense();" onchange="javascript:calculateOtherExpense();" onblur="javascript:calculateOtherExpense();" style="width:140px;" type="text" id="final_expense" name="final_expense" value="<?php if(!empty($product_other_cost[0]['final_expense'])) echo $product_other_cost[0]['final_expense'];  ?>" /></td>
                          ...
                          <tr>
                              ...
                              <td><input readonly onkeyup="javascript:calculateVatAit();" onchange="javascript:calculateVatAit();" onblur="javascript:calculateVatAit();" style="width:140px;" type="text" id="vat" name="vat" value="<?php if(!empty($product_other_cost[0]['vat'])) echo $product_other_cost[0]['vat'];  ?>" /></td>
                          </tr>
                           <tr>
                              <td colspan="4" style="text-align: right;">AIT</td>
                              <td><input readonly onkeyup="javascript:calculateVatAit();" onchange="javascript:calculateVatAit();" onblur="javascript:calculateVatAit();" style="width:140px;" type="text" id="ait" name="ait" value="<?php if(!empty($product_other_cost[0]['ait'])) echo $product_other_cost[0]['ait'];  ?>" /></td>
                              <td><input readonly style="width:140px;" type="text" id="total_vat_ait" name="t_ait_vat" value="<?php echo $total_vat_ait; ?>" /></td>
                          </tr>
                           <tr>
                          ...
                          <tr>
                              ...
                              <td><input readonly onkeyup="javascript:calculateProfit();" onchange="javascript:calculateProfit();" onblur="javascript:calculateProfit();" style="width:140px;" type="text" id="profit_percentage" name="profit_percentage" value="<?php if(!empty($product_other_cost[0]['profit_percentage'])) echo $product_other_cost[0]['profit_percentage'];  ?>" />%</td>
