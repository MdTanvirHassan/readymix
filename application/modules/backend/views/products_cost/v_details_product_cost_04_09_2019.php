                ...
                <table class="table table-bordered" id="myTable">
                    <thead>
                     <tr>
                         ...
                         <th>Costing Number <sup style='color:red'>*</sup></th>
                         <th>Product</th>
                         <th>Customer</th>
                         <th>Project Name</th>       
                     ...
                     <tbody>
                         <tr>
                             <td> <?php echo $product_quote_price[0]['cost_number'];  ?></td>
                             <td>
                                 <?php foreach($products as $product){ ?>
                                        <?php if($product_quote_price[0]['product_id']==$product['product_id'])  echo $product['product_name'].' '.'<b>Per '.$product_quote_price[0]['measurement_unit'].'</b>'; ?>
                                    <?php } ?>
                             </td>
                             <td>
                                 <?php foreach($customers as $customer){ ?>
                                        <?php if($product_quote_price[0]['customer_id']==$customer['id'])  echo $customer['c_name']; ?>
                                    <?php } ?>
                             </td>
                             <td>
                                 <?php foreach($projects as $project){ ?>
                                            <?php if($project['project_id']==$product_quote_price[0]['project_id']) echo $project['project_name'];  ?>
                                     <?php } ?>
                             </td>
                         </tr>
                     </tbody>
                    ...
                    <thead>
                     ...
                     <tbody id="material_body">
                      ...
                      <tfoot id="foot" >
                          ...
                          <tr>
                              <td colspan="4" style="text-align: left;">Transport Cost</td>
                           ...
                           <tr>
                              <td colspan="4" style="text-align: left;">Overhead Expense</td>
                          ...
                          <tr>
                              <td colspan="4" style="text-align: left;">Sales Commission</td>
