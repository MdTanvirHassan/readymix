                            ...
                            <table class="table table-bordered" id="myTable">
                                 ...
                                 //   $total_other_expense = $product_other_cost[0]['transport_cost'] + $product_other_cost[0]['overhead_expense'] + $product_other_cost[0]['sales_commission'] + $product_other_cost[0]['foh'] + $product_other_cost[0]['aoh'] + $product_other_cost[0]['soh'] + $product_other_cost[0]['final_expense'];
                                    ...
                                    foreach ($material_costs as $material_cost) {
                                        ...
                                        <tr>
                                            ...
                                            <td><input  style="width:140px;"  type="text"  name="brand[]" id="brand_<?php echo $i; ?>" class="issue" value="<?php echo $material_cost['brand']; ?>"></td>
                                            <?php if($material_cost['measurement_unit']=='MT'){ ?>
                                            <td><input class="number mu_cls" onkeyup="calculatePercent(<?php echo $i; ?>,0)" style="width:80px;text-align:right;"  type="text"  name="percent[]" id="percent_<?php echo $i; ?>"  value=""></td>
                                            <?php } ?>
                                            ...
                                            <td><input required onkeyup="calculateConvertQnty(<?php echo $i; ?>)" onchange="calculateConvertQnty(<?php echo $i; ?>)"   style="width:140px;text-align:right;"  type="text"  name="conversion_factor[]" id="conversion_factor_<?php echo $i; ?>" class="issue number" value="<?php echo $material_cost['conversion_factor']; ?>"></td>
                                            <td><input required onkeyup="calculateRequireQnty(<?php echo $i; ?>)" onchange="calculateRequireQnty(<?php echo $i; ?>)"   style="width:140px;text-align:right;"  type="text"  name="c_quantity[]" id="c_quantity_<?php echo $i; ?>" class="issue number" value="<?php echo $material_cost['c_quantity']; ?>"></td>
                                            <td><input  style="width:80px;"  type="text"  name="c_mu[]" id="c_mu_<?php echo $i; ?>" class="issue" value="<?php echo $material_cost['c_mu']; ?>"></td>
                                            <td><input required onkeyup="calculateSubtotal(<?php echo $i; ?>)" onchange="calculateSubtotal(<?php echo $i; ?>)"   style="width:140px;text-align:right;"  type="text"  name="rate[]" id="rate_<?php echo $i; ?>" class="issue number" value="<?php echo $material_cost['rate']; ?>"></td>
                                ...
                                <tfoot id="foot" >
                                    ...
                                    <tr>
                                        ...
                                        <td><input class="number" onkeyup="javascript:calculateOtherExpense();" onchange="javascript:calculateOtherExpense();" onblur="javascript:calculateOtherExpense();" style="width:140px;text-align:right;" type="text" id="transport_cost" name="transport_cost" value="<?php if (!empty($product_other_cost[0]['transport_cost'])) echo $product_other_cost[0]['transport_cost']; ?>" /></td>
                                    </tr>
                                    
                                    <tr>
                                        <td colspan="7" style="text-align: right;">Pumping Cost</td>
                                        <td><input class="number" onkeyup="javascript:calculateOtherExpense();" onchange="javascript:calculateOtherExpense();" onblur="javascript:calculateOtherExpense();" style="width:140px;text-align:right;" type="text" id="pumping_cost" name="pumping_cost" value="<?php if (!empty($product_other_cost[0]['pumping_cost'])) echo $product_other_cost[0]['pumping_cost']; ?>" /></td>
                                    </tr>
                                    
                                    <tr>
                                        <td colspan="7" style="text-align: right;">Overhead Expense</td>
                                        <td><input class="number" onkeyup="javascript:calculateOtherExpense();" onchange="javascript:calculateOtherExpense();" onblur="javascript:calculateOtherExpense();" style="width:140px;text-align:right;" type="text" id="overhead_expense" name="overhead_expense" value="<?php if (!empty($product_other_cost[0]['overhead_expense'])) echo $product_other_cost[0]['overhead_expense']; ?>" /></td>
                                    </tr>
                                    <tr>
                                        <td colspan="7" style="text-align: right;">Sales Commission</td>
                                        <td><input class="number" onkeyup="javascript:calculateOtherExpense();" onchange="javascript:calculateOtherExpense();" onblur="javascript:calculateOtherExpense();" style="width:140px;text-align:right;" type="text" id="sales_commission" name="sales_commission" value="<?php if (!empty($product_other_cost[0]['sales_commission'])) echo $product_other_cost[0]['sales_commission']; ?>" /></td>
                                    </tr>
                                    <!--
                                    <tr>
                                        <td colspan="7" style="text-align: right;">FOH</td>
                                        <td><input class="number" onkeyup="javascript:calculateOtherExpense();" onchange="javascript:calculateOtherExpense();" onblur="javascript:calculateOtherExpense();" style="width:140px;text-align:right;" type="text" id="foh" name="foh" value="<?php if (!empty($product_other_cost[0]['foh'])) echo $product_other_cost[0]['foh']; ?>" /></td>
                                    </tr>
                                    <tr>
                                        <td colspan="7" style="text-align: right;">AOH</td>
                                        <td><input class="number" onkeyup="javascript:calculateOtherExpense();" onchange="javascript:calculateOtherExpense();" onblur="javascript:calculateOtherExpense();" style="width:140px;text-align:right;" type="text" id="aoh" name="aoh" value="<?php if (!empty($product_other_cost[0]['aoh'])) echo $product_other_cost[0]['aoh']; ?>" /></td>
                                    </tr>
                                    <tr>
                                        <td colspan="7" style="text-align: right;">SOH</td>
                                        <td><input class="number" onkeyup="javascript:calculateOtherExpense();" onchange="javascript:calculateOtherExpense();" onblur="javascript:calculateOtherExpense();" style="width:140px;text-align:right;" type="text" id="soh" name="soh" value="<?php if (!empty($product_other_cost[0]['soh'])) echo $product_other_cost[0]['soh']; ?>" /></td>
                                    </tr>
                                    -->
                                    <tr>
                                        <td colspan="7" style="text-align: right;">Fin. Exp</td>
                                        <td><input class="number" onkeyup="javascript:calculateOtherExpense();" onchange="javascript:calculateOtherExpense();" onblur="javascript:calculateOtherExpense();" style="width:140px;text-align:right;" type="text" id="final_expense" name="final_expense" value="<?php if (!empty($product_other_cost[0]['final_expense'])) echo $product_other_cost[0]['final_expense']; ?>" /></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><input class="number" onkeyup="javascript:calculateVatAit();" onchange="javascript:calculateVatAit();" onblur="javascript:calculateVatAit();" style="width:140px;text-align:right;" type="text" id="vat" name="vat" value="<?php if (!empty($product_other_cost[0]['vat'])) echo $product_other_cost[0]['vat']; ?>" /></td>
                                    </tr>
                                    <tr>
                                        <td colspan="7" style="text-align: right;">AIT</td>
                                        <td><input class="number" onkeyup="javascript:calculateVatAit();" onchange="javascript:calculateVatAit();" onblur="javascript:calculateVatAit();" style="width:140px;text-align:right;" type="text" id="ait" name="ait" value="<?php if (!empty($product_other_cost[0]['ait'])) echo $product_other_cost[0]['ait']; ?>" /></td>
                                        <td><input style="width:140px;text-align:right;" type="text" id="total_vat_ait" name="t_ait_vat" value="<?php echo $total_vat_ait; ?>" /></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><input class="number" onkeyup="javascript:calculateProfit();" onchange="javascript:calculateProfit();" onblur="javascript:calculateProfit();" style="width:140px;text-align:right;" type="text" id="profit_percentage" name="profit_percentage" value="<?php if (!empty($product_other_cost[0]['profit_percentage'])) echo $product_other_cost[0]['profit_percentage']; ?>" />%</td>
                                        <td><input  onkeyup="javascript:calculateProfitPercentage();" onchange="javascript:calculateProfitPercentage();" onblur="javascript:calculateProfitPercentage();" style="width:140px;text-align:right;" type="text" id="total_profit" name="profit_amount" value="<?php if (!empty($product_other_cost[0]['profit_amount'])) echo $product_other_cost[0]['profit_amount']; ?>" /></td>
                                    </tr>
                                    <tr>
                                        <td colspan="8" style="text-align: right;"><b>Unit Price Per Cum</b></td>
                                        <td><input readonly style="width:140px;text-align:right;font-weight:bold;" type="text" id="quote_price" name="quote_price" value="<?php if (!empty($product_quote_price[0]['quote_price'])) echo $product_quote_price[0]['quote_price']; ?>" /></td>

                                    </tr>
                                    
                                   <tr>
                                        <td colspan="8" style="text-align: right;"><b>Unit Price Per Cft</b></td>
                                        <td><input readonly style="width:140px;text-align:right;font-weight:bold;" type="text" id="price_in_cft" name="price_in_cft" value="<?php if (!empty($product_quote_price[0]['price_in_cft'])) echo $product_quote_price[0]['price_in_cft']; ?>" /></td>
                  ...
                  if(msg.item_list!=''){
                      ...
                      var total=0;
                        ...
                        $(msg.item_list).each(function(i,v){
                            ...
                            str +='<td><input required class="number" onkeyup="calculateConvertQnty('+(Number(i) + 1)+')" onchange="calculateConvertQnty('+(Number(i) + 1)+')" onblur="calculateSubtotal('+(Number(i) + 1)+')"  style="width:140px;text-align:right;"  type="text"  name="quantity[]" id="quantity_'+(Number(i) + 1) + '"  value="'+v.quantity+'"></td>';
...
//       var soh=$('#soh').val();
  ...
  //     var total_other_expense=Number(transport_cost)+Number(overhead_expense)+Number(sales_commission)+Number(foh)+Number(aoh)+Number(soh)+Number(final_expense);
        var total_other_expense=Number(transport_cost)+Number(overhead_expense)+Number(sales_commission)+Number(final_expense)+Number(pumping_cost);
