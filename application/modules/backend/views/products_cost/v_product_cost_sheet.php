            ...
            <table class="table table-bordered" id="myTable">
                                <thead >
                                    <tr >
                                     ...
                                     <tr >
                                        <th colspan="10" style="border:none;">Casting Size: <?php echo $product_quote_price[0]['casting_size_cum'];?>  <?php echo "CUM"; //$product_quote_price[0]['measurement_unit'];?></th>
                                    ...
                                    <tr class="thead-color">
                                        ...
                                        <th>Mat. Cost</th>
                                        <th>Cost/CUM</th>
                                        <th>Cost/<?php echo $product_quote_price[0]['measurement_unit']; ?></th>
                                  ...
                                  //  $total_other_expense = $product_other_cost[0]['transport_cost'] + $product_other_cost[0]['overhead_expense'] + $product_other_cost[0]['sales_commission'] + $product_other_cost[0]['foh'] + $product_other_cost[0]['aoh'] + $product_other_cost[0]['soh'] + $product_other_cost[0]['final_expense'];
                                    ...
                                    foreach ($material_costs as $material_cost) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $material_cost['mu']; ?></td>
                                            <td style="text-align: right;"><?php echo round($material_cost['quantity']*$product_quote_price[0]['casting_size_cum'],2); ?></td>
                                            <td style="text-align: right;"><?php echo $material_cost['conversion_factor']; ?></td>
                                            <td style="text-align: right;"><?php echo round($material_cost['c_quantity']*$product_quote_price[0]['casting_size_cum'],2); ?></td>
                                            <td><?php echo $material_cost['c_mu']; ?></td>
                                            <td style="text-align: right;"><?php echo $material_cost['rate']; ?></td>
                                            <td style="text-align: right;"><?php echo round($material_cost['value']*$product_quote_price[0]['casting_size_cum'],2); ?></td>
                                            <td style="text-align: right;"><?php echo $material_cost['value']; ?></td>
                                            <td style="text-align: right;"><?php echo round(($material_cost['value']/$rate),2); ?></td>
                                        </tr>
                                        <?php
                                    }
                                ...
                                <tfoot id="foot" >
                                    ...
                                    <tr>
                                        <td colspan="9" style="text-align: right;">Transport Cost</td>
                                    ...
                                    <tr>
                                        <td colspan="9" style="text-align: right;">Pumping Cost</td>
                                     ...
                                     <tr>
                                        <td colspan="9" style="text-align: right;">Overhead Expense</td>
                                     ...
                                     <tr>
                                        <td colspan="9" style="text-align: right;">Sales Commission</td>
                                    ...
                                    <tr>
                                        <td colspan="9" style="text-align: right;">Administrative Exp</td>
                                     ...
                                     <tr>
                                        <td colspan="9" style="text-align: right;">Depreciation Expense</td>
                                    ...
                                    <tr>
                                        <td colspan="9" style="text-align: right;">Fin. Expense</td>
                                    ...
                                    <tr>
                                     ...
                                     <tr>
                                        <td colspan="9" style="text-align: right;">Profit</td>
                                    ...
                                    <tr>
                                        <td colspan="9" style="text-align: right;"><b>Selling Price</b></td>
