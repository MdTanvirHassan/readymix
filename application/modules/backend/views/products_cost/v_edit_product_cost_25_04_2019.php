...
<div class="right_col" style="background-color: #f1f1f1;padding-bottom:20px;">
            <h2 style="text-align:center; ">Edit Material Cost </h2>
            <hr>
            <form action="<?php echo site_url('products_cost/edit_product_cost_action/'.$product_quote_price[0]['product_cost_id']); ?>" method="post" onsubmit="javascript: return validation()">
                ...
                <div class="row">
                 <div class="col-md-6">
                   ...
                   <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8 col-md-5 "><select  style="width:200px;" class="e1" style="width:100px;" id="customer_id" name="customer_id" >
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8 col-md-5 ">  
                                <input    class="form-control" id="project_name" name="project_name" type="text" value="<?php if(!empty($product_quote_price[0]['project_name'])) echo $product_quote_price[0]['project_name'];  ?>">
                 ...
                 <div class="col-md-6">
                        <div class="form-group row">
                            <div class="col-sm-4 col-md-3  labeltext" style="text-align: right"><label for="inputdefault">Product<sup style="color:red">*</sup>  :</label></div>
                            <div class="col-sm-8 col-md-5 "><select  style="width:200px;" class="e1" style="width:100px;" id="product" name="product_id" >
            ...
            <table class="table table-bordered" id="myTable">
                    <thead>
                     ...
                     <tbody id="material_body">
                         ...
                         $i=0;
                         $total=0;
                         $total_other_expense=$product_other_cost[0]['foh']+$product_other_cost[0]['aoh']+$product_other_cost[0]['soh']+$product_other_cost[0]['final_expense'];
                         ...
                         foreach($material_costs as $material_cost){ 
                             ...
                             ?>
                                <tr>
                                        ...
                                        <td><input  style="width:140px;"  type="text"  name="meas_unit[]" id="meas_unit_<?php echo $i; ?>" class="issue" value="<?php echo $material_cost['meas_unit']; ?>"></td>
                                        <td><input required onkeyup="calculateSubtotal(<?php echo $i; ?>)" onchange="calculateSubtotal(<?php echo $i; ?>)" onblur="calculateSubtotal(<?php echo $i; ?>)"  style="width:140px;"  type="text"  name="quantity[]" id="quantity_<?php echo $i; ?>" class="issue" value="<?php echo $material_cost['quantity']; ?>"></td>
                                        <td><input required onkeyup="calculateSubtotal(<?php echo $i; ?>)" onchange="calculateSubtotal(<?php echo $i; ?>)" onblur="calculateSubtotal(<?php echo $i; ?>)"  style="width:140px;"  type="text"  name="rate[]" id="rate_<?php echo $i; ?>" class="issue" value="<?php echo $material_cost['rate']; ?>"></td>
                                        <td><input readonly style="width:140px;"  type="text"  name="value[]" id="value_<?php echo $i; ?>" class="issue" value="<?php echo $material_cost['value']; ?>"></td>
                                </tr>
                         <?php } 
                      ...
                      <tfoot id="foot" >
                          <tr>
                              ...
                              <td><input readonly style="width:140px;margin:0px;" type="text" id="total" name="total_material_cost" value="<?php echo $total; ?>" /></td>
                          </tr>
                           <tr>
                              <td colspan="4" style="text-align: right;">FOH</td>
                              <td><input onkeyup="javascript:calculateOtherExpense();" onchange="javascript:calculateOtherExpense();" onblur="javascript:calculateOtherExpense();" style="width:140px;" type="text" id="foh" name="foh" value="<?php if(!empty($product_other_cost[0]['foh'])) echo $product_other_cost[0]['foh'];  ?>" /></td>
                          </tr>
                           <tr>
                              <td colspan="4" style="text-align: right;">AOH</td>
                              <td><input onkeyup="javascript:calculateOtherExpense();" onchange="javascript:calculateOtherExpense();" onblur="javascript:calculateOtherExpense();" style="width:140px;" type="text" id="aoh" name="aoh" value="<?php if(!empty($product_other_cost[0]['aoh'])) echo $product_other_cost[0]['aoh'];  ?>" /></td>
                          </tr>
                           <tr>
                              <td colspan="4" style="text-align: right;">SOH</td>
                              <td><input onkeyup="javascript:calculateOtherExpense();" onchange="javascript:calculateOtherExpense();" onblur="javascript:calculateOtherExpense();" style="width:140px;" type="text" id="soh" name="soh" value="<?php if(!empty($product_other_cost[0]['soh'])) echo $product_other_cost[0]['soh'];  ?>" /></td>
                          </tr>
                           <tr>
                              <td colspan="4" style="text-align: right;">Fin. Exp</td>
                              <td><input onkeyup="javascript:calculateOtherExpense();" onchange="javascript:calculateOtherExpense();" onblur="javascript:calculateOtherExpense();" style="width:140px;" type="text" id="final_expense" name="final_expense" value="<?php if(!empty($product_other_cost[0]['final_expense'])) echo $product_other_cost[0]['final_expense'];  ?>" /></td>
                              <td><input readonly style="width:140px;" type="text" id="total_other_expense" value="<?php echo $total_other_expense; ?>" /></td>
                          </tr>
                          <tr>
                              <td colspan="4" style="text-align: right;">VAT</td>
                              <td><input onkeyup="javascript:calculateVatAit();" onchange="javascript:calculateVatAit();" onblur="javascript:calculateVatAit();" style="width:140px;" type="text" id="vat" name="vat" value="<?php if(!empty($product_other_cost[0]['vat'])) echo $product_other_cost[0]['vat'];  ?>" /></td>
                          </tr>
                           <tr>
                              <td colspan="4" style="text-align: right;">AIT</td>
                              <td><input onkeyup="javascript:calculateVatAit();" onchange="javascript:calculateVatAit();" onblur="javascript:calculateVatAit();" style="width:140px;" type="text" id="ait" name="ait" value="<?php if(!empty($product_other_cost[0]['ait'])) echo $product_other_cost[0]['ait'];  ?>" /></td>
                              <td><input style="width:140px;" type="text" id="total_vat_ait" name="t_ait_vat" value="<?php echo $total_vat_ait; ?>" /></td>
                          </tr>
                           <tr>
                              <td colspan="5" style="text-align: right;"></td>
                              <td><input readonly style="width:140px;" type="text" id="total_with_other_expense_vat" name="" value="<?php echo $total_with_other_expense_vat; ?>" /></td>
                             
                          </tr>
                          <tr>
                              <td colspan="4" style="text-align: right;">Profit</td>
                              <td><input onkeyup="javascript:calculateProfit();" onchange="javascript:calculateProfit();" onblur="javascript:calculateProfit();" style="width:140px;" type="text" id="profit_percentage" name="profit_percentage" value="<?php if(!empty($product_other_cost[0]['profit_percentage'])) echo $product_other_cost[0]['profit_percentage'];  ?>" />%</td>
                              <td><input readonly style="width:140px;" type="text" id="total_profit" name="profit_amount" value="<?php if(!empty($product_other_cost[0]['profit_amount'])) echo $product_other_cost[0]['profit_amount'];  ?>" /></td>
                          </tr>
                          <tr>
                              <td colspan="5" style="text-align: right;">Quote Price</td>
                              <td><input readonly style="width:140px;" type="text" id="quote_price" name="quote_price" value="<?php if(!empty($product_quote_price[0]['quote_price'])) echo $product_quote_price[0]['quote_price'];  ?>" /></td>
                  ...
                  var str='';
                   if(msg.item_list!=''){
                        $(msg.item_list).each(function(i,v){
                            ...
                            str +='<td><input readonly style="width:140px;"  type="text"  name="value[]" id="value_'+(Number(i) + 1) + '" class="issue"></td>';
                            str +='</tr>';
                        }); 
                        $('#foot').show();
                   }else{
