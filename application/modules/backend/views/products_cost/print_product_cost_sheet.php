            ...
            <table class="table table-bordered" id="myTable" style="border:none;margin:0 auto;">
                                <thead>
                                    <tr >
                                        ...
                                        <th colspan="2" style="border:none;;text-align: left;">Client: <?php echo $product_quote_price[0]['c_name'];?></th>
                                    </tr>
                                     <tr >
                                     ...
                                     <tr >
                                        <th colspan="10" style="border:none;text-align: left;">Casting Size: <?php echo $product_quote_price[0]['casting_size_cum'];?>  <?php echo "CUM"; //$product_quote_price[0]['measurement_unit'];?></th>
                                    ...
                                    <tr>
                                        ...
                                        <th style="text-align: center;border-left:1px solid;border-top:1px solid;border-right:1px solid;">Cost/<?php echo $product_quote_price[0]['measurement_unit']; ?></th>
                                ...
                                <tbody id="material_body">
                                   ...
                                   // $total_other_expense = $product_other_cost[0]['transport_cost'] + $product_other_cost[0]['overhead_expense'] + $product_other_cost[0]['sales_commission'] + $product_other_cost[0]['foh'] + $product_other_cost[0]['aoh'] + $product_other_cost[0]['soh'] + $product_other_cost[0]['final_expense'];
                                    ...
                                    foreach ($material_costs as $material_cost) {
                                        $total = $total + round($material_cost['value']*$product_quote_price[0]['casting_size_cum'],2);
                                        $total_qnty = $total_qnty + $material_cost['quantity'];
                                        $total_order_qnty=$total_order_qnty+round($material_cost['quantity']*$product_quote_price[0]['casting_size_cum'],2);
                                        $total_per_cum=$total_per_cum+$material_cost['value'];
                                        $total_per_cft=$total_per_cft+round(($material_cost['value']/$rate),2);
                                        $i++;
                                        ?>
                                        <tr>
                                            ...
                                            <td style="text-align: left;border-left:1px solid;border-top:1px solid;"><?php echo $material_cost['mu']; ?></td>
                                            <td style="text-align: right;border-left:1px solid;border-top:1px solid;"><?php echo round($material_cost['quantity']*$product_quote_price[0]['casting_size_cum'],2); ?></td>
                                            <td style="text-align: right;border-left:1px solid;border-top:1px solid;"><?php echo $material_cost['conversion_factor']; ?></td>
                                            <td style="text-align: right;border-left:1px solid;border-top:1px solid;"><?php echo round($material_cost['c_quantity']*$product_quote_price[0]['casting_size_cum'],2); ?></td>
                                            ...
                                            <td style="text-align: right;border-left:1px solid;border-top:1px solid;"><?php echo round($material_cost['value']*$product_quote_price[0]['casting_size_cum'],2); ?></td>
                                            <td style="text-align: right;border-left:1px solid;border-top:1px solid;"><?php echo $material_cost['value']; ?></td>
                                            <td style="text-align: right;border-left:1px solid;border-top:1px solid;border-right:1px solid;"><?php echo round(($material_cost['value']/$rate),2); ?></td>
                                        </tr>
                                        <?php
                                    }
                                   ...
                                   // $net_total_per_cft=$total_per_cft+        
                                    $total_with_other_expense_vat =$total+($total_other_expense*$product_quote_price[0]['casting_size_cum'])+($total_vat_ait*$product_quote_price[0]['casting_size_cum'])+ ($product_other_cost[0]['profit_amount']*$product_quote_price[0]['casting_size_cum']);
                                    ?>

                                </tbody>
                                <tfoot id="foot" >
                                    <tr>
                                        <td colspan="2" style="text-align: left;border-left:1px solid;border-top:1px solid;"><b>Total</b></td>
                                    ...
                                    <tr>
                                        <td colspan="9" style="text-align: left;border-left:1px solid;border-top:1px solid;">Transport Cost</td>
                                       
                                        <td style="text-align: right;border-left:1px solid;border-top:1px solid;">      
                                            <span style="width:140px;margin-right:0px;"  id="total_material_cost_amount"><?php echo round($product_other_cost[0]['transport_cost']*$product_quote_price[0]['casting_size_cum'],2); ?></span>
                                        </td>
                                        <td style="text-align: right;border-left:1px solid;border-top:1px solid;">
                                        ...
                                        <td style="text-align: right;border-left:1px solid;border-top:1px solid;border-right:1px solid;">
                                             ...
                                             <span style="width:140px;margin-right:0px;"  id="total_material_cost_amount"><?php echo round(($product_other_cost[0]['transport_cost']/$rate),2); ?></span>
                                        </td>
                                    </tr>
                                    
                                     <tr>
                                        <td colspan="9" style="text-align: left;border-left:1px solid;border-top:1px solid;">Pumping Cost</td>
                                       
                                        <td style="text-align: right;border-left:1px solid;border-top:1px solid;">      
                                            <span style="width:140px;margin-right:0px;"  id="total_material_cost_amount"><?php echo round($product_other_cost[0]['pumping_cost']*$product_quote_price[0]['casting_size_cum'],2); ?></span>
                                        </td>
                                        <td style="text-align: right;border-left:1px solid;border-top:1px solid;">
                                          
                                          <span style="width:140px;margin-right:0px;"  id="total_material_cost_amount"><?php echo $product_other_cost[0]['pumping_cost']; ?></span>
                                        </td>
                                        <td style="text-align: right;border-left:1px solid;border-top:1px solid;border-right:1px solid;">
                                          
                                             <span style="width:140px;margin-right:0px;"  id="total_material_cost_amount"><?php echo round(($product_other_cost[0]['pumping_cost']/$rate),2); ?></span>
                                        </td>
                                    </tr>
                                    
                                     <tr>
                                        <td colspan="9" style="text-align: left;border-left:1px solid;border-top:1px solid;">Overhead Expense</td>
                                       
                                        <td style="text-align: right;border-left:1px solid;border-top:1px solid;">      
                                            <span style="width:140px;margin-right:0px;"  id="total_material_cost_amount"><?php echo round($product_other_cost[0]['overhead_expense']*$product_quote_price[0]['casting_size_cum'],2); ?></span>
                                        </td>
                                        <td style="text-align: right;border-left:1px solid;border-top:1px solid;">  
                                        ...
                                        <td style="text-align: right;border-left:1px solid;border-top:1px solid;border-right:1px solid;">      
                                             <span style="width:140px;margin-right:0px;"  id="total_material_cost_amount"><?php echo round(($product_other_cost[0]['overhead_expense']/$rate),2); ?></span>
                                        </td>
                                    </tr>
                                     <tr>
                                        <td colspan="9" style="text-align: left;border-left:1px solid;border-top:1px solid;">Administrative Exp</td>
                                       
                                        <td style="text-align: right;border-left:1px solid;border-top:1px solid;">      
                                            <span style="width:140px;margin-right:0px;"  id="total_material_cost_amount"><?php echo round($product_other_cost[0]['admin_exp']*$product_quote_price[0]['casting_size_cum'],2); ?></span>
                                        </td>
                                        <td style="text-align: right;border-left:1px solid;border-top:1px solid;">  
                                          <span style="width:140px;margin-right:0px;"  id="total_material_cost_amount"><?php echo $product_other_cost[0]['admin_exp']; ?></span>
                                        </td>
                                        <td style="text-align: right;border-left:1px solid;border-top:1px solid;border-right:1px solid;">      
                                             <span style="width:140px;margin-right:0px;"  id="total_material_cost_amount"><?php echo round(($product_other_cost[0]['admin_exp']/$rate),2); ?></span>
                                        </td>
                                    </tr>
                                     <tr>
                                        <td colspan="9" style="text-align: left;border-left:1px solid;border-top:1px solid;">Depreciation Expense</td>
                                       
                                        <td style="text-align: right;border-left:1px solid;border-top:1px solid;">      
                                            <span style="width:140px;margin-right:0px;"  id="total_material_cost_amount"><?php echo round($product_other_cost[0]['dep_exp']*$product_quote_price[0]['casting_size_cum'],2); ?></span>
                                        </td>
                                        <td style="text-align: right;border-left:1px solid;border-top:1px solid;">  
                                          <span style="width:140px;margin-right:0px;"  id="total_material_cost_amount"><?php echo $product_other_cost[0]['dep_exp']; ?></span>
                                        </td>
                                        <td style="text-align: right;border-left:1px solid;border-top:1px solid;border-right:1px solid;">
                                            
                                             <span style="width:140px;margin-right:0px;"  id="total_material_cost_amount"><?php echo round(($product_other_cost[0]['dep_exp']/$rate),2); ?></span>
                                        </td>
                                    </tr>
                                     <tr>
                                        <td colspan="9" style="text-align: left;border-left:1px solid;border-top:1px solid;">Sales Commission</td>
                                       
                                        <td style="text-align: right;border-left:1px solid;border-top:1px solid;">      
                                            <span style="width:140px;margin-right:0px;"  id="total_material_cost_amount"><?php echo round($product_other_cost[0]['sales_commission']*$product_quote_price[0]['casting_size_cum'],2); ?></span>
                                        </td>
                                        <td style="text-align: right;border-left:1px solid;border-top:1px solid;">  
                                        ...
                                        <td style="text-align: right;border-left:1px solid;border-top:1px solid;border-right:1px solid;">      
                                             <span style="width:140px;margin-right:0px;"  id="total_material_cost_amount"><?php echo round(($product_other_cost[0]['sales_commission']/$rate),2); ?></span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="9" style="text-align: left;border-left:1px solid;border-top:1px solid;">Fin. Expense</td>
                                       
                                        <td style="text-align: right;border-left:1px solid;border-top:1px solid;">      
                                            <span style="width:140px;margin-right:0px;"  id="total_material_cost_amount"><?php echo round($product_other_cost[0]['final_expense']*$product_quote_price[0]['casting_size_cum'],2); ?></span>
                                        </td>
                                        <td style="text-align: right;border-left:1px solid;border-top:1px solid;">  
                                          <span style="width:140px;margin-right:0px;"  id="total_material_cost_amount"><?php echo $product_other_cost[0]['final_expense']; ?></span>
                                        </td>
                                        <td style="text-align: right;border-left:1px solid;border-top:1px solid;border-right:1px solid;">      
                                             <span style="width:140px;margin-right:0px;"  id="total_material_cost_amount"><?php echo round(($product_other_cost[0]['final_expense']/$rate),2); ?></span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="9" style="text-align: left;border-left:1px solid;border-top:1px solid;">VAT</td>
                                       
                                        <td style="text-align: right;border-left:1px solid;border-top:1px solid;">      
                                            <span style="width:140px;margin-right:0px;"  id="total_material_cost_amount"><?php echo round($product_other_cost[0]['vat']*$product_quote_price[0]['casting_size_cum'],2); ?></span>
                                        </td>
                                        <td style="text-align: right;border-left:1px solid;border-top:1px solid;">  
                                          <span style="width:140px;margin-right:0px;"  id="total_material_cost_amount"><?php echo $product_other_cost[0]['vat']; ?></span>
                                        </td>
                                        <td style="text-align: right;border-left:1px solid;border-top:1px solid;border-right:1px solid;">      
                                             <span style="width:140px;margin-right:0px;"  id="total_material_cost_amount"><?php echo round(($product_other_cost[0]['vat']/$rate),2); ?></span>
                                        </td>
                                    </tr>
                                     <tr>
                                        <td colspan="9" style="text-align: left;border-left:1px solid;border-top:1px solid;">AIT</td>
                                       
                                        <td style="text-align: right;border-left:1px solid;border-top:1px solid;">      
                                            <span style="width:140px;margin-right:0px;"  id="total_material_cost_amount"><?php echo round($product_other_cost[0]['ait']*$product_quote_price[0]['casting_size_cum'],2); ?></span>
                                        </td>
                                        <td style="text-align: right;border-left:1px solid;border-top:1px solid;">  
                                          <span style="width:140px;margin-right:0px;"  id="total_material_cost_amount"><?php echo $product_other_cost[0]['ait']; ?></span>
                                        </td>
                                        <td style="text-align: right;border-left:1px solid;border-top:1px solid;border-right:1px solid;">      
                                             <span style="width:140px;margin-right:0px;"  id="total_material_cost_amount"><?php echo round(($product_other_cost[0]['ait']/$rate),2); ?></span>
                                        </td>
                                    </tr>
                                     <tr>
                                        <td colspan="9" style="text-align: left;border-left:1px solid;border-top:1px solid;">Profit</td>
                                       
                                        <td style="text-align: right;border-left:1px solid;border-top:1px solid;">      
                                            <span style="width:140px;margin-right:0px;"  id="total_material_cost_amount"><?php echo round($product_other_cost[0]['profit_amount']*$product_quote_price[0]['casting_size_cum'],2); ?></span>
                                        </td>
                                        <td style="text-align: right;border-left:1px solid;border-top:1px solid;">  
                                          <span style="width:140px;margin-right:0px;"  id="total_material_cost_amount"><?php echo $product_other_cost[0]['profit_amount']; ?></span>
                                        </td>
                                        <td style="text-align: right;border-left:1px solid;border-top:1px solid;border-right:1px solid;">      
                                             <span style="width:140px;margin-right:0px;"  id="total_material_cost_amount"><?php echo round(($product_other_cost[0]['profit_amount']/$rate),2); ?></span>
                                        </td>
                                    </tr>
                                    
                                    <tr>
                                        <td colspan="9" style="text-align: left;border-left:1px solid;border-top:1px solid;border-bottom:1px solid;"><b>Selling Price</b></td>
                                        ...
                                        <td style="text-align: right;border-left:1px solid;border-top:1px solid;border-bottom:1px solid;border-right:1px solid;">      
                                            <b><span style="width:140px;margin-right:0px;"  id="total_material_cost_amount"><?php echo round(($net_total_per_cum/$rate),2); ?></span></b>
                                        </td>
                                    </tr>
