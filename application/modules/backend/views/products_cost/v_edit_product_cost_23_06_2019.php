                ...
                <div class="row">
                 <div class="col-md-6">
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-6">
                        <div class="form-group row">
                            <div class="col-sm-4 col-md-3 col-md-offset-3   labeltext" style="text-align: right"><label for="inputdefault">Project<sup style="color:red">*</sup>  :</label></div>
                            <div class="col-sm-8 col-md-5 ">  
                                 <select  style="width:200px;" class="e1"  id="project_id" name="project_id" >
                    ...
                    <thead>
                     ...
                     <tbody id="material_body">
                      ...
                      <tfoot id="foot" >
                          ...
                          <tr>
                              <td colspan="5" style="text-align: right;">Unit Price</td>
