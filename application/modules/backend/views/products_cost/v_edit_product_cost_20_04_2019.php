                 ...
                 <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8 col-md-5 "><select required style="width:200px;" class="e1" style="width:100px;" id="product" name="product_id" >
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8 col-md-5 "><select required style="width:200px;" class="e1" style="width:100px;" id="customer_id" name="customer_id" >
                     ...
                     <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8 col-md-5 ">  
                                <input required   class="form-control" id="project_name" name="project_name" type="text" value="<?php if(!empty($product_quote_price[0]['project_name'])) echo $product_quote_price[0]['project_name'];  ?>">
                            </div>
                        </div>
                    </div> 
