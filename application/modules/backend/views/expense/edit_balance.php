                        ...
                        <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                            <div class='form-group' >
                                ...
                                <div class="col-sm-4 col-md-4 input-group">
                                    ...
                                    <input class="form-control" type="text" name="amount" id="amount" value="<?php echo $balance[0]['amount']?>">
                                ...
                                <div class="col-sm-4 col-md-4 input-group">
                                    ...
                                    <input required=""  class="form-control datepicker" name="balance_date" type="text" value="<?php echo date('d-m-Y',strtotime($balance[0]['balance_date']))?>">
                                </div>
                            </div>
                            ...
                            <div class='form-group' >
                                ...
                                <div class="col-sm-4 input-group">
                                    ...
                                    <textarea class="form-control" name="remark" id="remark"><?php echo $balance[0]['remark']?></textarea>
                                </div>
