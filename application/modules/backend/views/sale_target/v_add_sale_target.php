                       ...
                       <tfoot>
                           ...
                           -->
                            <tr>
                                ...
                                <td><input readonly style="width:140px;text-align:right;" id="bep_sub_total"  name="bep_sub_total" type="text"></td>
                            </tr>
                        </tfoot>
                  </table>
...
var i = $('#sale_items').find('tr').length;
                             ...
                             str +='<td><input required  style="width:60px;"  type="text"  name="mu_name[]" id="mu_name_'+(Number(i) + 1) + '" class="issue" value=""></td>';
                             ...
                             str +='<td><input readonly  style="width:80px;text-align:right;"  type="text" class="amount_"  name="bep_amount[]" id="bep_amount_'+(Number(i) + 1)+'" class="issue" value=""></td>'; 
                       ...
                       if(msg.quotation_payment_info[0].a_pdc=='Pdc'){
                        ...
                        var total=0;
                         $(msg.item_list).each(function (i, v) {       
                             ...
                             str +='<td><input required onkeyup="calculateSubtotal('+(Number(i) + 1)+')" onchange="calculateSubtotal('+(Number(i) + 1)+')" onblur="calculateSubtotal('+(Number(i) + 1)+')"  style="width:140px;text-align:right;"  type="text"  name="bep_qty[]" id="bep_qty_'+(Number(i) + 1)+'" class="issue number" value="'+v.bep_qty+'"></td>';
                             str +='<td><input required onkeyup="calculateSubtotal('+(Number(i) + 1)+')" onchange="calculateSubtotal('+(Number(i) + 1)+')" onblur="calculateSubtotal('+(Number(i) + 1)+')"  style="width:140px;text-align:right;"  type="text"  name="bep_value[]" id="bep_value_'+(Number(i) + 1)+'" class="issue number" value="'+v.bep_value+'"></td>';
                             ...
                             str +='<td><input readonly  style="width:140px;text-align:right;"  type="text" class="amount_"  name="bep_amount[]" id="bep_amount_'+(Number(i) + 1)+'" class="issue" value="'+v.bep_amount+'"></td>'; 
