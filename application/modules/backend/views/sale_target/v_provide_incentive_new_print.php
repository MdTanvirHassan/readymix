...
<div id="header">
  ...
  <hr>
  <div style="">
    <h1 style="text-align: center;text-decoration: underline;margin-top:-2px;text-transform: uppercase;font-weight: bold;font-size:18px;">SALES INCENTIVE FOR THE MONTH OF - <?php echo date("F Y", strtotime($month)); ?></h1>
    <p style="text-align: center;font-weight:bold;margin:0px">Product : <?php echo $cat_name[0]['category_name']; ?></p>
  </div>
                        ...
                        <table class="table table-striped table-bordered" style="width:100%">
                            ...
                            ?>
                                    ...
                                    <tr>
                                        ...
                                        <?php } ?>
                                        <td style="vertical-align: middle;"><?php echo $target['name']; ?></td>
