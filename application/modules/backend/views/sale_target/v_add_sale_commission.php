                        ...
                        <form class="form-horizontal" action="<?php echo site_url('sale_target/add_sale_commission_action'); ?>" method="post" onsubmit="javascript: return validation()">
                            ...
                            <div class='form-group'>
                                ...
                                <div class="col-sm-4 input-group">
                                    <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                    <input readonly class="form-control" id="commission_no" name="inv_no" type="text" value="<?php echo $commission_no; ?>">
                                </div>
                                <label for="title" class="col-sm-2 control-label">
                            ...
                            <div class='form-group'>
                                ...
                                <div class="col-sm-4 input-group">
                                    <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                    <input class="form-control" id="beneficiary" name="beneficiary" type="text" value="">
                                </div>
                                <label for="title" class="col-sm-2 control-label">
                                ...
                                <div class="col-sm-4 input-group">
                                    <span class="input-group-addon"><i class="fa fa-check-square"></i></span>
                                    <input class="form-control" id="designation" name="designation" type="text" value="">
                                    <span id="sale_invoice_date_error" style="color:red"></span>
                                </div>
                                ...
                                <div class="col-sm-4 input-group">
                                    ...
                                    <select class="form-control e1" placeholder="Select Employee" id="employee_id" name="employee_id">
                                        ...
                                        <?php foreach ($employees as $customer) { ?>
                                            <option <?php if ($customer_id == $customer['id']) echo 'selected'; ?> value="<?php echo $customer['id'] ?>"><?php echo $customer['name'] ?></option>
                                        <?php } ?>
                                ...
                                <table class="table table-bordered" id="myTable">
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <td><input readonly style="width:140px;text-align: right;" id="sub_total_qty" name="sub_total_amount" type="text"></td>
