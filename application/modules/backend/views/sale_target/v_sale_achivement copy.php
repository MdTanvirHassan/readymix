                ...
                <div class="x_panel">
                    <div class="x_content">
                        ...
                        <form action="<?php echo site_url('backend/sale_target/achivement') ?>" method="post">
                            ...
                            <a href="<?php echo site_url('backend/sale_target/achivement_print/'.$month) ?>"><input type="button" value="Print" class="btn btn-primary pull-left" style="z-index:99;margin:0px;margin-left:-1px;"></a>
                            <a href="<?php echo site_url('backend/sale_target/employee_taarget_achivement_report/'.$month) ?>"><input type="button" value="Achievement Report" class="btn btn-primary pull-left" style="z-index:99;margin:0px;margin-left:10px;"></a>
                        </form>
                        <table class="table table-striped table-bordered">
                            ...
                            <tr>
                                <td><?php echo number_format($company_target[0]['total_amount'],2); ?></td>
                                <td><?php echo number_format($company_target[0]['bep_total'],2); ?></td>
                                <td><?php echo number_format($company_achive[0]['total'],2); ?></td>
                                <td>
                            ...
                            <?php foreach ($targets as $team) { ?>
                                ...
                                foreach ($team['employee'] as $tema_id => $target) { ?>
                                    <tr>
                                        ...
                                        $total_achive = 0;
                                        foreach ($cat as $c) {
                                            $team_total_target += $target['achive'][$c['category_id']]['target_qty'];
                                            $total_target += $target['achive'][$c['category_id']]['target_qty'];
                                            $total_achive += $target['achive'][$c['category_id']]['quantity'];
                                            $team_total_achive += $target['achive'][$c['category_id']]['quantity'];
                                        ?>
                                            <!-- <td><?php echo $target['achive'][$c['category_id']]['target_qty']; ?></td>
                                        <td><?php echo $target['achive'][$c['category_id']]['quantity']; ?></td> -->
                                            <td style="text-align:right;"><?php echo number_format($target['achive'][$c['category_id']]['target_qty'],2); ?></td>
                                            <td style="text-align:right;"><?php echo number_format($target['achive'][$c['category_id']]['quantity'],2); ?></td>
                                        <?php } ?>
                                        <?php if (($key == 0)) { ?>
                                            <td rowspan="<?php echo count($team['employee']); ?>" style="text-align:center;">
                                                <?php echo number_format($team['target'],2); ?>
                                            </td>
                                            <td rowspan="<?php echo count($team['employee']); ?>" style="text-align:center;">
                                                <?php echo number_format($team['achive'],2); ?>
                                            </td>
                                            <td rowspan="<?php echo count($team['employee']); ?>" style="text-align:center;">
