                ...
                <div class="x_panel">
                    <div class="x_content">
                        ...
                        <form action="<?php echo site_url('backend/sale_target/achivement') ?>" method="post">
                            ...
                            <a target="_blank" href="<?php echo site_url('backend/sale_target/achivement_print/'.$month) ?>"><input type="button" value="Print" class="btn btn-primary pull-left" style="z-index:99;margin:0px;margin-left:-1px;"></a>
                            <a target="_blank" href="<?php echo site_url('backend/sale_target/employee_taarget_achivement_report/'.$month) ?>"><input type="button" value="Achievement Report" class="btn btn-primary pull-left" style="z-index:99;margin:0px;margin-left:10px;"></a>
                        </form>
