            ...
            <div class="left_col scroll-view">
                <div class="navbar nav_title" style="border: 0;">
                 <!--   <a href="<?php echo site_url('backend/dashboard'); ?>" class="site_title"><img id="logo_img" src='<?php echo site_url('images/wcl_logo.png'); ?>' style='width:20%;margin-top:-10px;font-size:20px;'/><span>&nbsp; KMIX</span></span></a>-->
                     <a style="padding:0px;" href="<?php echo site_url('backend/dashboard'); ?>" class="site_title"><img id="logo_img" src='<?php echo site_url('images/wcl_logo.png'); ?>' style='width:100%;margin-top:-10px;;'/></span></a>
                </div>
...
<!--                                               <ul style="padding-left:0px;" class="receive">
                                   ...
                                   <?php $this->menu = checkMenuPermission(8, $userData);
                                        if (8 == $this->menu) {
                                    ?>        
                                            <li <?php if ($this->sub_menu == 'invoice') echo 'class="active"'; ?>><a href="<?php echo site_url('backend/purchase_invoices'); ?>" ><i class="fa fa-check-circle"></i><span class="main_menu_text">AUDIT & BILLING</span></a>
                               ...
                               <?php $this->menu = checkMenuPermission(9, $userData);
                                        if (9== $this->menu) {
                                    ?>        
                                            <li <?php if ($this->sub_menu == 'accounts') echo 'class="active"'; ?>><a href="<?php echo site_url('backend/accounts'); ?>" ><i class="fa fa-check-circle"></i><span class="main_menu_text">ACCOUNTS</span></a>
...
<!--                                        <li <?php if ($this->sub_inner_menu == 'project') echo 'class="active"'; ?>><a href="<?php echo site_url('backend/projects'); ?>"><i class="fa fa-dashboard"></i><span class="main_menu_text">Projects</span></a></li>-->
                      ...
                      <?php $this->role = checkMenuPermission(13, $userData);
                                if (13== $this->role) {
                         ?>       
                            <li <?php if ($this->menu == 'production') echo 'class="active"'; ?>><a href="<?php echo site_url('backend/productions')?>"><i class="fa fa-chrome"></i><span class="main_menu_text">PRODUCTIONS</span></a></li>    
                     <?php } ?>            
