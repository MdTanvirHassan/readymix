        ...
        <div class="top_nav">
            ...
            <nav>
              ...
              <ul class="nav navbar-nav navbar-right">
                  <li style="float:left;height: 61px;padding-right:10px;margin-left:-80px;"><p style="text-align: center;color:#81878C;margin-top:20px;font-size:19px;">4AXIZ ERP</p></li>
