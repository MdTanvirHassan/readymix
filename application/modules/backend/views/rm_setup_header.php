 <div class="os-tabs-controls">
            <ul class="nav nav-tabs upper">
               ...
               <?php $this->role = checkUserPermission(18,136, $userData); if(empty($this->role) || !in_array(11,$this->role)){ ?>    
                ...
                <?php $this->role = checkUserPermission(18,136, $userData); if(empty($this->role) || !in_array(11,$this->role)){ ?>    
                    <li class="nav-item">
                        <a class="nav-link <?php if ($this->sub_inner_menu == 'rm_landed_cost_head') echo 'active'; ?>" href="<?php echo site_url('backend/raw_materials/landed_cost_head'); ?>">
                            <span>Landed Cost Head</span></a>
                    </li>
                <?php } ?>     
