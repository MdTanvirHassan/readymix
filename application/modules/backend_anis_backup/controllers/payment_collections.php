      ...
      //  $where = "pc.unit_id=$branch_id";
        ...
        if (!empty($postData)) {
            ...
            if (!empty($customer_id)) {
             ...
             if(!empty($f_date) & !empty($to_date)){
              //  $sql = "select pc.*,c.c_name,c_short_name from tbl_payment_collections pc left join tbl_customers c on pc.customer_id=c.id where $where and pc.receive_date>='" . $f_date . "' and pc.receive_date<='" . $to_date . "' and pc.is_active=1 and pc.payment_status='Collected' order by pc.id desc";
                  $sql = "select pc.*,c.c_name,c_short_name,tpc.category_name from tbl_payment_collections pc left join tbl_customers c on pc.customer_id=c.id left join tbl_product_categories tpc on pc.payment_for_id=tpc.category_id where $where and pc.receive_date>='" . $f_date . "' and pc.receive_date<='" . $to_date . "' and (pc.payment_status='Collected' || pc.payment_status='Dishonored') order by pc.receive_date desc";
             }else if (!empty($f_date)) {
              //  $sql = "select pc.*,c.c_name,c_short_name from tbl_payment_collections pc left join tbl_customers c on pc.customer_id=c.id where $where and pc.receive_date>='" . $f_date .  "' and pc.is_active=1 and pc.payment_status='Collected' order by pc.id desc"; 
                  $sql = "select pc.*,c.c_name,c_short_name,tpc.category_name from tbl_payment_collections pc left join tbl_customers c on pc.customer_id=c.id left join tbl_product_categories tpc on pc.payment_for_id=tpc.category_id where $where and pc.receive_date>='" . $f_date .  "' and (pc.payment_status='Collected' || pc.payment_status='Dishonored') order by pc.receive_date desc"; 
             }else if (!empty($to_date)) {
               // $sql = "select pc.*,c.c_name,c_short_name from tbl_payment_collections pc left join tbl_customers c on pc.customer_id=c.id where $where and pc.receive_date<='" . $to_date .  "' and pc.is_active=1 and pc.payment_status='Collected' order by pc.id desc";  
                  $sql = "select pc.*,c.c_name,c_short_name,tpc.category_name from tbl_payment_collections pc left join tbl_customers c on pc.customer_id=c.id left join tbl_product_categories tpc on pc.payment_for_id=tpc.category_id where $where and pc.receive_date<='" . $to_date .  "' and (pc.payment_status='Collected' || pc.payment_status='Dishonored') order by pc.receive_date desc";  
             }else{
               // $sql = "select pc.*,c.c_name,c_short_name from tbl_payment_collections pc left join tbl_customers c on pc.customer_id=c.id where $where and pc.is_active=1 and pc.payment_status='Collected' order by pc.id desc";   
                  $sql = "select pc.*,c.c_name,c_short_name,tpc.category_name from tbl_payment_collections pc left join tbl_customers c on pc.customer_id=c.id left join tbl_product_categories tpc on pc.payment_for_id=tpc.category_id where $where and (pc.payment_status='Collected' || pc.payment_status='Dishonored') order by pc.receive_date desc";   
             }   
        }else{
         //   $sql = "select pc.*,c.c_name,c_short_name from tbl_payment_collections pc left join tbl_customers c on pc.customer_id=c.id where pc.is_active=1 and pc.payment_status='Collected' and pc.unit_id=" . $branch_id . ' order by pc.id desc';
            $sql = "select pc.*,c.c_name,c_short_name,tpc.category_name from tbl_payment_collections pc left join tbl_customers c on pc.customer_id=c.id left join tbl_product_categories tpc on pc.payment_for_id=tpc.category_id where pc.is_active=1 and (pc.payment_status='Collected' || pc.payment_status='Dishonored') order by pc.receive_date desc";
