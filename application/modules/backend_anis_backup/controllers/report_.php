...
//                            }
                            ...
                            if($opening_qty>0){
                                ...
                                $avilable_quantity = $data['group'][$key1]['group_items'][$key]['receive_qty'] + $data['group'][$key1]['group_items'][$key]['issue_return_qty'] + $data['group'][$key1]['group_items'][$key]['mrr_receive_qty'] + $data['group'][$key1]['group_items'][$key]['adjust_qty'];
                                $avilable_value = $data['group'][$key1]['group_items'][$key]['receive_value'] + $data['group'][$key1]['group_items'][$key]['issue_return_value'] + $data['group'][$key1]['group_items'][$key]['mrr_receive_value'] + $data['group'][$key1]['group_items'][$key]['adjust_value'];
                                $available_rate = round($avilable_value / $avilable_quantity, 2);
                            }
                            ...
                            if (!empty($issue_qty[0]['issue_qty'])) {
                                if($avilable_quantity>=$issue_qty[0]['issue_qty']){
                                    $data['group'][$key1]['group_items'][$key]['issue_qty'] = $issue_qty[0]['issue_qty'];
                                    $data['group'][$key1]['group_items'][$key]['issue_value'] = $available_rate * $issue_qty[0]['issue_qty'];
                        ...
                        if($avilable_quantity>=$issue_qty[0]['issue_qty']){    
                            ...
                            $total_issue_qty =$data['group'][$key1]['group_items'][$key]['return_qty'] + $data['group'][$key1]['group_items'][$key]['delivery_qty'];
                        }    
                            
                            $total_issue_value = $total_issue_qty * $available_rate;
...
//                            }
                            ...
                            $balance_value = $available_rate*$balance;
...
//                        }
                    ...
                    if($opening_qty>0){   
                        ...
                        $avilable_quantity = $data['items'][$key]['receive_qty'] + $data['items'][$key]['issue_return_qty'] + $data['items'][$key]['mrr_receive_qty'] + $data['items'][$key]['adjust_qty'];
                        $avilable_value = $data['items'][$key]['receive_value'] + $data['items'][$key]['issue_return_value'] + $data['items'][$key]['mrr_receive_value'] + $data['items'][$key]['adjust_value'];
                        $available_rate = round($avilable_value / $avilable_quantity, 2);
                    }    
                        ...
                        if (!empty($issue_qty[0]['issue_qty'])) {
                          ...
                          if($avilable_quantity>=$issue_qty[0]['issue_qty']){  
                             $data['items'][$key]['issue_qty'] = $issue_qty[0]['issue_qty'];
                             $data['items'][$key]['issue_value'] = $available_rate * $issue_qty[0]['issue_qty'];
                     ...
                     if($avilable_quantity>=$issue_qty[0]['issue_qty']){     
                        ...
                        $total_issue_qty=$data['items'][$key]['return_qty'] + $data['items'][$key]['delivery_qty']; 
                     }   
                        
                        
                        $total_issue_value = $available_rate * $total_issue_qty;
                        $total_issue_rate = $available_rate;
                        ...
                        $balance = $avilable_quantity - $total_issue_qty;
                        $balance_value = $balance * $available_rate;
                        $balance_rate = $available_rate;
...
//                        // $details_info[$j]['issue_value']=$issue_qty[0]['issue_value'];
//                        $details_info[$j]['issue_value'] = $issue_rate * $issue_qty[0]['issue_qty'];
//                    } else {
...
//                    }
               ...
               if($avilable_quantity>=$issue_qty[0]['issue_qty']){
                ...
                $total_issue_value = $issue_rate * $total_issue_qty;
                $total_issue_rate = $issue_rate;
                    ...
                    $closing_qty = $total_receive_qty + $opening_qty - $total_issue_qty;
                    $closing_value = $issue_rate * $closing_qty;
