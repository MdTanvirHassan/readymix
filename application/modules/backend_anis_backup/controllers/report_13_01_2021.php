...
//                    }
                    ...
                    $re_sql="select sum(mrrd.receive_qty) as total_receive from  tbl_material_receive_requisition_details mrrd left join material_receive_requisition mrr on mrrd.mrr_id=mrr.mrr_id where mrr.unit_id=".$branch_id." and mrrd.receive_date>='2021-01-01' and mrrd.item_id=".$item['id'];
                    ...
                    $cons_info=array();
                    $cons_sql="select sum(consumption_quantity) as total_consumption from  tbl_item_comsumption  where unit_id=".$branch_id." and item_id=".$item['id'];
                    ...
                    $adj_sql="select sum(qty) as total_adjustment from  tbl_item_adjustment  where unit_id=".$branch_id." and item_id=".$item['id'];
           ...
           //   $this->load->view('general_store/v_item_stock',$data);
              ...
              $data['projects']=$this->m_common->get_row_array('department','','*');
               ...
               foreach($data['items'] as $key=>$item){
                    ...
                    $data['items'][$key]['stock_amount']=$opening_qty+$recive_qty-$consumption_qty;
                    if($data['items'][$key]['stock_amount']<=0){
                        unset($data['items'][$key]);
                    }
            } 
