                ...
                success:function(msg){
                     ...
                     var str='';
                        ...
                        if(msg.quotation_info[0].type_name=="Material" || msg.quotation_info[0].type_name=="Asset"){
                            ...
                            str +='<tr>';
                            str +='<td colspan="6" style="text-align:right;vertical-align: middle;font-weight: bold;font-size: 20px;">Transport Cost:</td>';
                            str +='<td colspan="3"><input onblur="javascript:calculateNetPayableAmount();" onkeyup="javascript:calculateNetPayableAmount();" onchange="javascript:calculateNetPayableAmount();" class="form-control number"  style="width:140px;text-align: right;" id="transport_cost"  name="transport_cost" type="text"></td>';
                            str +='</tr>';
                            
                            
                            str +='<tr>';
                            str +='<td colspan="6" style="text-align:right;vertical-align: middle;font-weight: bold;font-size: 20px;">Cutting Cost:</td>';
                            str +='<td colspan="3"><input onblur="javascript:calculateNetPayableAmount();" onkeyup="javascript:calculateNetPayableAmount();" onchange="javascript:calculateNetPayableAmount();" class="form-control number"  style="width:140px;text-align: right;" id="cutting_cost"  name="cutting_cost" type="text"></td>';
                            str +='</tr>';
                            
                            str +='<tr>';
                            str +='<td colspan="6" style="text-align:right;vertical-align: middle;font-weight: bold;font-size: 20px;">Labour Cost:</td>';
                            str +='<td colspan="3"><input onblur="javascript:calculateNetPayableAmount();" onkeyup="javascript:calculateNetPayableAmount();" onchange="javascript:calculateNetPayableAmount();" class="form-control number"  style="width:140px;text-align: right;" id="labour_cost"  name="labour_cost" type="text"></td>';
                            str +='</tr>';
                            
                            str +='<tr>';
                            str +='<td colspan="6" style="text-align:right;vertical-align: middle;font-weight: bold;font-size: 20px;">Other Cost:</td>';
                            str +='<td colspan="3"><input onblur="javascript:calculateNetPayableAmount();" onkeyup="javascript:calculateNetPayableAmount();" onchange="javascript:calculateNetPayableAmount();" class="form-control number"  style="width:140px;text-align: right;" id="other_cost"  name="other_cost" type="text"></td>';
                            str +='</tr>';
                            
                            str +='<tr>';
                            str +='<td colspan="6" style="text-align:right;vertical-align: middle;font-weight: bold;font-size: 20px;">Discount:</td>';
                            ...
                            str +='<td colspan="6" style="text-align:right;vertical-align: middle;font-weight: bold;font-size: 20px;">Net Total:</td>';
                               ...
                               // alert(order_from);
                                if(order_from=="Direct"){
                                   ...
                                   // str +='<td><input type="hidden"  name="item_id[]" id="item_id_" class="issue" value="'+v.item_id+'"><input readonly style="width:100%;"  type="text"  name="name[]" id="item_des_c1_" class="issue form-control" value="'+v.item_name+'"></td>';
                                    ...
                                    k=k+1; 
                                    str+='<tr>';
                                    str +='<td><input type="hidden" name="mi_d_id[]"  value="'+v.mi_d_id+'" ><input type="hidden" name="indent_d_id[]"  value="'+v.indent_d_id+'" ><input readonly  style="width:110%;"  type="text"  name="indent_no[]" id="indent_no_'+k+ '" class="issue form-control" value="'+v.indent_no+'"></td>';
                                    //str +='<td><input type="hidden"  name="item_id[]" id="item_id_" class="issue" value="'+v.item_id+'"><input readonly style="width:100%;"  type="text"  name="name[]" id="item_des_c1_" class="issue form-control" value="'+v.item_name+'"></td>';
                                    str +='<td>';
                                    str +='<input type="hidden"  name="item_id[]" id="item_id_" class="issue" value="'+v.item_id+'">';
                                    str +='<input type="hidden"  name="brand_id[]" id="brand_id_" class="issue" value="'+v.brand_id+'">';
                                    str +='<textarea disabled class="form-control" style="width:100%;"  name="name[]">'+v.item_name+'</textarea>';
                                    str +='</td>';
                                    str +='<td><input readonly style="width:70%;"  type="text"  name="m_unit[]" id="description_'+k+ '" class="issue form-control" value="'+v.meas_unit+'"></td>';
                                //    str +='<td><input readonly style="width:100%;"  type="text"  name="item_size[]" id="item_size_'+k+ '" class="issue form-control" value="'+v.item_size+'"></td>';
                                //    str +='<td><input readonly style="width:100%;"  type="text"  name="unit_name[]" id="unit_name_'+k+ '" class="issue form-control" value="'+v.unit_name+'"></td>';
                                    str +='<td><input readonly style="width:70%;"  type="text"  name="m_indent_qnty[]" id="m_indent_qnty_'+k+ '" class="issue form-control" value="'+remain_qty+'"></td>';
                                    str +='<td><input readonly onkeyup="calculateSubtotal('+k+')" onchange="calculateSubtotal('+k+')" onblur="calculateSubtotal('+k+')"  style="width:70%;text-align:right;"  type="text"  name="quantity[]" id="quantity_'+k+'" class="issue number form-control" value="'+remain_qty+'"></td>';
                                    str +='<td><input readonly onkeyup="calculateSubtotal('+k+')" onchange="calculateSubtotal('+k+')" onblur="calculateSubtotal('+k+')"  style="width:100%;text-align:right;"  type="text"  name="unit_price[]" id="unit_price_'+k+'" class="issue number form-control" value="'+v.unit_price+'"></td>';
                                    str +='<td><input readonly  style="width:100%;text-align:right;"  type="text" class="form-control amount_"  name="amount[]" id="amount_'+k+'" class="issue" value="'+n_remain_price+'"></td>'; 
                                    str +='<td><textarea class="form-control" style="width:100%;"  name="remark[]">'+''+'</textarea></td>';
                                    str +='<td style="text-align:center;"><input  type="checkbox" name="select_item[]" onclick="calculateSubtotal('+k+')"  id="select_item_' +k+ '" class="select_item_' +k+'" value="'+k+'" ></td>';
   ...
   function validation(){
    ...
    function calculateSubtotal(id){
        ...
        // var table_row=Number(rowCount)-2;
         ...
         var net_total=sub_total+transport_cost+cutting_cost+labour_cost+other_cost-discount;
