                       ...
                       <div class="row" style="margin-left:0px;margin-top:5px;"> 
                            <div class='form-group' >
                                ...
                                <div class="col-sm-4 input-group">
                                       ...
                                       <input   class="form-control" id="quotation_no" name="quotation_no" type="text" value="">
                                </div>
                    ...
                    <input type="hidden" value="1" id="count" />
                            ...
                            <tbody id="quotation_item">
                                <tr  id="row_1">
                                  ...
                                  <td> <select class="e1 form-control" style="width:100%;" id="item_1" name="item_id[]" onchange="javascript:item_info(1);">
                                            <option value="">Select Item</option>
                                            <?php foreach($items as $item){ ?>
                                                <option value="<?php echo $item['id'];  ?>"><?php if(!empty($item['item_code'])) echo $item['item_code']."(". $item['item_name'].")"; ?></option>
                                            <?php } ?>
                                     </select></td>
                                    <td><input style="width:100%;" disabled type="text"  name="item_name_description[]" id="m_unit_1" class="issue form-control"></td>
                                    <td><input class="form-control" required style="width:100%"  type="text" onkeyup="calculateSubtotal(1)" onchange="calculateSubtotal(1)" onblur="calculateSubtotal(1)"  name="quantity[]" id="quantity_1" class="number issue"></td>
                                    <td><input class="form-control" required style="width:100%;"  type="text" onkeyup="calculateSubtotal(1)" onchange="calculateSubtotal(1)" onblur="calculateSubtotal(1)"  name="unit_price[]" id="unit_price_1" class="number issue"></td>
                                    <td><input readonly required style="width:100%;"  type="text"  name="amount[]" id="amount_1" class="issue form-control"></td>
                                    <td>
                                        <textarea class="form-control" style="width:200px;height: 34px;" name="remark[]"></textarea>
                                    </td>
                                    <td></td>
                            ...
                            <tbody id="service_item">
                                ...
                                <tr  id="row_1">
                                    ...
                                    <td>
                                    <select class="e1 form-control" style="width:100%" id="service_1" name="service_id[]" >
                                        <option value="">Select Service</option>                                    
                                    </select></td>
                                  
                                    <td><input  style="width:100%;text-align: right;"  type="text" onkeyup="calculateServiceSubtotal(1)" onchange="calculateServiceSubtotal(1)"  name="s_amount[]" id="s_amount_1" class="issue number form-control"></td>
                                    <td>
...
//                            $('#shipping_email').val(msg.suppplier_info[0].EMAIL);
                              ...
                              if(msg.services!=''){
                                    $(msg.services).each(function (i, v) {
                                         str += '<option value="' + v.id + '">' +v.service_name+ '</option>';
                                    });
                             }
                              $('#service_1').html(str);
    ...
    $('#button1').click(function () {
        ...
        str +='<td><select required class="e1" style="width:100%"  onchange="item_info(' + (Number(count) + 1) + ')" name="item_id[]" id="item_'+(Number(count) + 1) + '" class="form-control">'+itemstr+'</select></td>';
        str +='<td><input   style="width:100%;" disabled  type="text"  name="description[]" id="m_unit_'+(Number(count) + 1) + '" class="issue form-control"></td>';
        str +='<td><input class="form-control" required onkeyup="calculateSubtotal('+(Number(count) + 1)+')" onchange="calculateSubtotal('+(Number(count) + 1)+')" onblur="calculateSubtotal('+(Number(count) + 1)+')"  style="width:100%;"  type="text"  name="quantity[]" id="quantity_'+(Number(count) + 1) + '" class="issue number"></td>';
        str +='<td><input class="form-control" required onkeyup="calculateSubtotal('+(Number(count) + 1)+')" onchange="calculateSubtotal('+(Number(count) + 1)+')" onblur="calculateSubtotal('+(Number(count) + 1)+')"  style="width:100%;"  type="text"  name="unit_price[]" id="unit_price_'+(Number(count) + 1) + '" class="issue number"></td>';
        
        str +='<td><input readonly  style="width:100%;"  type="text"  name="amount[]" id="amount_'+(Number(count) + 1) + '" class="issue form-control"></td>';
        str +='<td><textarea class="form-control" style="width:200px;height: 34px;" name="remark[]"></textarea></td>';
     ...
     $('#serviceButton').click(function () {
        ...
        str +='<td><input required  style="width:100%;text-align:right;"  type="text" onkeyup="calculateServiceSubtotal('+(Number(count)+1)+')" onchange="calculateServiceSubtotal('+(Number(count)+1)+')"  name="s_amount[]" id="s_amount_'+(Number(count) + 1) + '" class="issue form-control"></td>';
