                ...
                <div class="x_panel">
                         ...
                         <div class="row" style="margin-left:0px;margin-top:5px;">     
                            <div class='form-group' >
                                ...
                                <div class="col-sm-4 input-group">
                                       ...
                                       <input  required  class="form-control" id="quotation_no" name="quotation_no" type="text" value="<?php if(!empty($quotation_info[0]['quotation_no'])) echo $quotation_info[0]['quotation_no']; ?>">
                                </div>
                                ...
                                <div class='form-group' >
                                 ...
                                 <label for="title" class="col-sm-2 control-label">
                                    ...
                                    <div class="col-sm-4 input-group">
                                        ...
                                        <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                        <select required class="form-control" id="q_type" name="q_type">
                                            <?php foreach ($indent_types as $indent_type) { ?>
                                                <option <?php if($quotation_info[0]['q_type']==$indent_type['id']) echo "selected"; ?> value="<?php echo $indent_type['id']; ?>"><?php if (!empty($indent_type['type_name'])) echo $indent_type['type_name']; ?></option>
                                            <?php } ?>
                                        </select>
                    ...
                    <table class="table table-bordered" id="myTable" style="display:<?php if($quotation_info[0]['type_name']!="Material") echo "none"; ?>">
                           ...
                           foreach($quotation_details_info as $quotation_detail){ 
                            ...
                            <tr  id="row_<?php echo $i; ?>">
                                ...
                                <td> <select style="width:200px;" class="e1 form-control" style="width:100%;" id="item_<?php echo $i; ?>" name="item_id[]" onchange="javascript:item_info(<?php echo $i; ?>);">
                                ...
                                <td><input style="width:100%" disabled type="text"  name="m_unit[]" id="m_unit_<?php echo $i; ?>" class="issue form-control" value="<?php echo $quotation_detail['meas_unit']; ?>"></td>
                                <td><input <?php if($quotation_info[0]['type_name']=="Material") echo "required"; ?> style="width:100%;"  type="text" onkeyup="calculateSubtotal(<?php echo $i; ?>)" onchange="calculateSubtotal(<?php echo $i; ?>)" onblur="calculateSubtotal(<?php echo $i; ?>)"  name="quantity[]" id="quantity_<?php echo $i; ?>" class="number issue form-control" value="<?php echo $quotation_detail['quantity']; ?>"></td>
                                <td><input <?php if($quotation_info[0]['type_name']=="Material") echo "required"; ?> style="width:100%;"  type="text" onkeyup="calculateSubtotal(<?php echo $i; ?>)" onchange="calculateSubtotal(<?php echo $i; ?>)" onblur="calculateSubtotal(<?php echo $i; ?>)"  name="unit_price[]" id="unit_price_<?php echo $i; ?>" class="number issue form-control" value="<?php echo $quotation_detail['unit_price']; ?>"></td>
                                <td><input <?php if($quotation_info[0]['type_name']=="Material") echo "required"; ?> style="width:100%;text-align: right;" readonly  type="text"  name="amount[]" id="amount_<?php echo $i; ?>" class="issue form-control" value="<?php echo $quotation_detail['amount']; ?>"></td>
                                <td>
                                    <textarea class="form-control" style="width:200px;height: 34px;" id="remark_<?php echo $i; ?>" name="remark[]"><?php echo $quotation_detail['remark']; ?></textarea>
                                </td>
                                <?php if ($i > 1) { ?>
                   ...
                   <?php } ?>
                               ...
                               <tfoot class="tfoot-color">
                                    <tr>
                                        <td colspan="4" style="text-align:right;vertical-align: middle;font-weight: bold;font-size: 20px;"">Subtotal:</td>

                                        <td colspan="3"><input class="form-control" readonly style="width:140px;text-align: right;" id="sub_total"  name="total_amount" type="text" value="<?php if(!empty($quotation_info[0]['total_amount'])) echo $quotation_info[0]['total_amount']; ?>"></td>
                                    </tr>
                                </tfoot>
                     </table>
                    ...
                    <table class="table table-bordered" id="serviceTable" style="display:<?php if($quotation_info[0]['type_name']!="Service") echo "none"; ?>">
                            ...
                            <tr  id="row_<?php echo $i; ?>">
                                ...
                                <td><select  class="e1 form-control" style="width:100%" id="service_<?php echo $i; ?>" name="service_id[]" >
                                        <option value="">Select Service</option>
                                        <?php foreach($services as $service){ ?>
                                            <option <?php if($service['id']==$quotation_detail['service_id']) echo 'selected'; ?> value="<?php echo $service['id'];  ?>"><?php if(!empty($service['service_name'])) echo $service['service_name']; ?></option>
                                        <?php } ?>
                                </select></td>
                                
                                <td><input <?php if($quotation_info[0]['type_name']=="Service") echo "required"; ?> style="width:100%;text-align: right;"   type="text"  name="s_amount[]" id="s_amount_<?php echo $i; ?>" onkeyup="calculateServiceSubtotal(<?php echo $i; ?>)" onchange="calculateServiceSubtotal(<?php echo $i; ?>)" class="issue form-control" value="<?php echo $quotation_detail['amount']; ?>"></td>
                                <td>
                                    <textarea class="form-control" style="width:100%;height: 34px;" id="remark_<?php echo $i; ?>" name="s_remark[]"><?php echo $quotation_detail['remark']; ?></textarea>
                     quotation_item               
                                </td>
                                <?php if ($i > 1) { ?>
                                <td><button style="padding-left:6px;padding-right:6px;font-size:8px;" id="button2" onclick="removeRow('<?php echo $i; ?>')" class="btn btn-danger pull-right"><span class="glyphicon glyphicon-minus"></span></button></td>
                   ...
                   <?php } ?>
                               ...
                               <tfoot>
                                    <tr class="tfoot-color">
                                        ...
                                        <td colspan="3"><input class="form-control" readonly style="width:140px;text-align: right;" id="service_sub_total"  name="s_total_amount" type="text" value="<?php if(!empty($quotation_info[0]['total_amount'])) echo $quotation_info[0]['total_amount']; ?>"></td>
                                    </tr>
                                </tfoot>
                          </table>
...
//                             $('#quotation_item').html(str);
    ...
    $('#button1').click(function () {
        ...
        str +='<td><select required class="e1 form-contrl" style="width:100%"  onchange="item_info(' + (Number(count) + 1) + ')" name="item_id[]" id="item_'+(Number(count) + 1) + '" class="">'+itemstr+'</select></td>';
        str +='<td><input   style="width:100%;" disabled  type="text"  name="description[]" id="m_unit_'+(Number(count) + 1) + '" class="issue form-control"></td>';
        str +='<td><input required onkeyup="calculateSubtotal('+(Number(count) + 1)+')" onchange="calculateSubtotal('+(Number(count) + 1)+')" onblur="calculateSubtotal('+(Number(count) + 1)+')"  style="width:100%;"  type="text"  name="quantity[]" id="quantity_'+(Number(count) + 1) + '" class="issue number form-control"></td>';
        str +='<td><input required onkeyup="calculateSubtotal('+(Number(count) + 1)+')" onchange="calculateSubtotal('+(Number(count) + 1)+')" onblur="calculateSubtotal('+(Number(count) + 1)+')"  style="width:100%;"  type="text"  name="unit_price[]" id="unit_price_'+(Number(count) + 1) + '" class="issue number form-control"></td>';
        
        str +='<td><input readonly  style="width:100%;"  type="text"  name="amount[]" id="amount_'+(Number(count) + 1) + '" class="issue form-control"></td>';
        str +='<td><input class="form-control" style="width:200px;height: 34px;"  type="text"  name="remark[]" id="remark_'+(Number(count) + 1) + '" class="issue"></td>';
    ...
    $('#serviceButton').click(function () {
        ...
        var str= '<tr  id="row_' + (Number(count) + 1) + '">';    
        str +='<td><select required class="e1 form-control" style="width:100%;"   name="service_id[]" id="service_'+(Number(count) + 1) + '" class="">'+itemstr+'</select></td>';   
        str +='<td><input required  style="width:100px;text-align: right;"  type="text" onkeyup="calculateServiceSubtotal('+(Number(count)+1)+')" onchange="calculateServiceSubtotal('+(Number(count)+1)+')"  name="s_amount[]" id="s_amount_'+(Number(count) + 1) + '" class="issue form-control"></td>';
