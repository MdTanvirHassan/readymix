    ...
    <form action="<?php echo site_url('purchase_quotations/edit_quotation_action/'.$quotation_info[0]['q_id']); ?>" method="post" onsubmit="javascript: return validation()" >
        ...
        <div class="row">
            ...
            <div class="col-md-4">
              ...
              <div class="col-md-4">
                <div class="form-group row">
                    <div class="col-sm-4 col-md-4  labeltext" style="text-align: right;"><label for="c_short_name">Unit<sup style="color:red;">*</sup>  :</label></div>
                    <div class="col-sm-8 col-md-8  ">
                        <select disabled  id="unit_id" class="form-control e1" name="unit_id">
         ...
         <div class="row">
            ...
            <div class="col-md-4">
             ...
             <div class="col-md-4">
                <div class="form-group row">
                    <div class="col-sm-4 col-md-4  labeltext" style="text-align: right;"> <label for="inputdefault">Supplier<sup style="color:red;">*</sup> :</label></div>
                    <div class="col-sm-8 col-md-8  ">
                       <select disabled  id="supplier_id" class="form-control e1" name="supplier_id">
         ...
         <div class="row">
           ...
           <div class="col-md-4">
                <div class="form-group row">
                    <div class="col-sm-4 col-md-4  labeltext" style="text-align: right;"><label for="c_short_name">Contact No.<sup style="color:red;">*</sup>  :</label></div>
                    <div class="col-sm-8 col-md-8  ">
                         ...
                         <?php 
                           ...
                           foreach($quotation_details_info as $quotation_detail){ 
                            ...
                            <tr  id="row_<?php echo $i; ?>">
                                ...
                                <td> <select disabled style="width:200px;" class="e1" style="width:100px;" id="item_<?php echo $i; ?>" name="item_id[]" onchange="javascript:item_info(<?php echo $i; ?>);">
                                ...
                                <td><input style="width:80px;"  type="text" onkeyup="calculateSubtotal(<?php echo $i; ?>)" onchange="calculateSubtotal(<?php echo $i; ?>)" onblur="calculateSubtotal(<?php echo $i; ?>)"  name="quantity[]" id="quantity_<?php echo $i; ?>" class="number issue" value="<?php echo $quotation_detail['quantity']; ?>"></td>
                                <td><input style="width:80px;"  type="text" onkeyup="calculateSubtotal(<?php echo $i; ?>)" onchange="calculateSubtotal(<?php echo $i; ?>)" onblur="calculateSubtotal(<?php echo $i; ?>)"  name="unit_price[]" id="unit_price_<?php echo $i; ?>" class="number issue" value="<?php echo $quotation_detail['unit_price']; ?>"></td>
                                <td><input style="width:140px;"  type="text"  name="amount[]" id="amount_<?php echo $i; ?>" class="issue" value="<?php echo $quotation_detail['amount']; ?>"></td>
        ...
        <div class="row">
           <div class="col-md-1 col-md-offset-3">
                <a href="<?php echo site_url('backend/purchase_quotations') ?>" > <button type="button" class="btn btn-success button" style="padding:6px 4px;">REGISTER</button> </a>
