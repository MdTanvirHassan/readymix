                                ...
                                <table class="table table-bordered" id="myTable" >
                                    ...
                                    <tfoot>
                                        ...
                                        <tr>
                                            ...
                                            <td><input onblur="javascript:calculateNetPayableAmount();" onkeyup="javascript:calculateNetPayableAmount();" onchange="javascript:calculateNetPayableAmount();"  style="width:140px;text-align: right;" id="discount"  name="discount" type="text"></td>
                                        </tr>
                                        
                                        <tr>
                                            <td colspan="5" style="text-align:right;">Vat:</td>

                                            <td><input onblur="javascript:calculateNetPayableAmount();" onkeyup="javascript:calculateNetPayableAmount();" onchange="javascript:calculateNetPayableAmount();"  style="width:140px;text-align: right;" id="vat"  name="vat" type="text"></td>
                                        </tr>
                                        <tr>
                                            <td colspan="5" style="text-align:right;">Tax:</td>

                                            <td><input onblur="javascript:calculateNetPayableAmount();" onkeyup="javascript:calculateNetPayableAmount();" onchange="javascript:calculateNetPayableAmount();"  style="width:140px;text-align: right;" id="tax"  name="tax" type="text"></td>
                                        </tr>
                                        <tr>
                                            <td colspan="5" style="text-align:right;">Ait:</td>

                                            <td><input onblur="javascript:calculateNetPayableAmount();" onkeyup="javascript:calculateNetPayableAmount();" onchange="javascript:calculateNetPayableAmount();"  style="width:140px;text-align: right;" id="ait"  name="ait" type="text"></td>
                                        </tr>
