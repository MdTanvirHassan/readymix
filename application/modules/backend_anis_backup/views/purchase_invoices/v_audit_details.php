            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_content">
                        ...
                        <?php if($user_type==1){ ?>
                                 <button onclick="addRemark(<?php echo $purchase_invoice_info[0]['inv_id']; ?>)" class="btn btn-sm btn-primary">Remark</button>
                    ...
                    <?php } ?>      
                        ...
                        <form class="form-horizontal" action="<?php echo site_url('purchase_invoices/edit_purchase_invoice_action/'.$purchase_invoice_info[0]['inv_id']); ?>" method="post" onsubmit="javascript: return validation()">
                           ...
                           <div class="separator-shadow row"></div>
                            ...
                            <div class="row">
                                <div class="col-md-2">
                                    <a href="<?php echo site_url('backend/purchase_invoices/audit') ?>" > <button type="button" class="btn btn-success button" style="padding:6px 4px">GO BACK</button> </a>
                                </div>
                                <div class="col-md-2 ">
