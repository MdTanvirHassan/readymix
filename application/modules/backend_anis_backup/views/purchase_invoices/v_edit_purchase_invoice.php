                            ...
                            <div class="row">
                                ...
                                <table class="table table-bordered" id="myTable" >
                                            ...
                                            foreach($invoice_details_info as $invoice_detail){ 
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <input readonly  style="width:140px;"  type="text"  name="po_no[]" id="dc_no" class="issue" value="<?php echo $invoice_detail['order_no']; ?>">
                                                    </td>
                                                    
                                                    <td>
                                                        
                                                        <input readonly  style="width:140px;"  type="text"  name="mrr_no[]" id="dc_no" class="issue" value="<?php echo $invoice_detail['mrr_no']; ?>">
                                                    </td>
                                                    
                                                    <td>
                                                        <input type="hidden"  name="mrrd_id[]" id="mrrd_id_" class="issue" value="<?php echo $invoice_detail['mrrd_id']; ?>">
                                                    ...
                                                    <td>
                                                        <input readonly onkeyup="" onchange="" onblur=""  style="width:100px;text-align: right;"  type="text"  name="quantity[]" id="quantity_" class="issue" value="<?php echo $invoice_detail['quantity']; ?>">
                                                    </td>
                                                    <td>
                                                        <input readonly  style="width:100px;text-align: right;"  type="text"  name="unit_price[]" id="unit_price_" class="issue" value="<?php echo $invoice_detail['unit_price']; ?>">
                                                    </td>
                                                    <td>
                                    ...
                                    <tfoot>
                                       ...
                                       <tr>
                                            <td colspan="7" onblur="javascript:calculateNetPayableAmount();" onkeyup="javascript:calculateNetPayableAmount();" onchange="javascript:calculateNetPayableAmount();" style="text-align:right;">Discount:</td>

                                            <td><input class="number" onblur="javascript:calculateNetPayableAmount();" onkeyup="javascript:calculateNetPayableAmount();" onchange="javascript:calculateNetPayableAmount();"  style="width:140px;text-align: right;" id="discount"  name="discount" type="text" value="<?php if(!empty($purchase_invoice_info[0]['discount'])) echo $purchase_invoice_info[0]['discount'];  ?>"></td>
                                        </tr>
                                        
                                        
                                        <tr>
                                            <td colspan="7" onblur="javascript:calculateNetPayableAmount();" onkeyup="javascript:calculateNetPayableAmount();" onchange="javascript:calculateNetPayableAmount();" style="text-align:right;">Vat:</td>

                                            <td><input class="number" onblur="javascript:calculateNetPayableAmount();" onkeyup="javascript:calculateNetPayableAmount();" onchange="javascript:calculateNetPayableAmount();"  style="width:140px;text-align: right;" id="vat"  name="vat" type="text" value="<?php if(!empty($purchase_invoice_info[0]['vat'])) echo $purchase_invoice_info[0]['vat'];  ?>"></td>
                                        </tr>
                                        <tr>
                                            <td colspan="7" style="text-align:right;">Tax:</td>

                                            <td><input class="number" onblur="javascript:calculateNetPayableAmount();" onkeyup="javascript:calculateNetPayableAmount();" onchange="javascript:calculateNetPayableAmount();"  style="width:140px;text-align: right;" id="tax"  name="tax" type="text" value="<?php if(!empty($purchase_invoice_info[0]['tax'])) echo $purchase_invoice_info[0]['tax'];  ?>"></td>
                                        </tr>
                                        <tr>
                                            <td colspan="7" style="text-align:right;">Ait:</td>

                                            <td><input class="number" onblur="javascript:calculateNetPayableAmount();" onkeyup="javascript:calculateNetPayableAmount();" onchange="javascript:calculateNetPayableAmount();"  style="width:140px;text-align: right;" id="ait"  name="ait" type="text" value="<?php if(!empty($purchase_invoice_info[0]['ait'])) echo $purchase_invoice_info[0]['ait'];  ?>"></td>
                                        </tr>
