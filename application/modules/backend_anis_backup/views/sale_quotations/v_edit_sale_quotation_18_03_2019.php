        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group row">
                 ...
                 <div class="form-group row">
                    <div class="col-sm-4 col-md-2   labeltext" style=""><label for="b_cash"><input id="b_cash" type="checkbox" <?php if($payment_info[0]['b_cash']=="Cash") echo 'checked'; ?> name="b_cash" value="Cash">&nbsp;Cash</label></div>
                 ...
                 <div class="form-group row">
                    <div class="col-sm-4 col-md-2   labeltext" style=""><label for="b_bg"><input id="b_bg" type="checkbox" <?php if($payment_info[0]['b_bg']=="Bg") echo 'checked'; ?> name="b_bg" value="Bg">&nbsp;BG</label></div>
                    <div class="col-sm-4 col-md-2 ">
                ...
                <div class="form-group row">
                    <div class="col-sm-4 col-md-2   labeltext" style=""><label for="b_lc"><input id="b_lc" name="b_lc" type="checkbox" <?php if($payment_info[0]['b_lc']=="Lc") echo 'checked'; ?> value="Lc">&nbsp;LC</label></div>
                    <div class="col-sm-4 col-md-2 ">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group row">
                    <div class="col-sm-4 col-md-2   labeltext" style=""><label for="a_cash"><input id="a_cash" type="checkbox" <?php if($payment_info[0]['a_cash']=="Cash") echo 'checked'; ?> name="a_cash" value="Cash">&nbsp;Cash</label></div>
                     <div class="col-sm-4 col-md-2 ">
                ...
                <div class="form-group row">
                    <div class="col-sm-4 col-md-2   labeltext" style=""><label for="a_bg"><input id="a_bg" type="checkbox" <?php if($payment_info[0]['a_bg']=="Bg") echo 'checked'; ?> name="a_bg" value="Bg">&nbsp;BG</label></div>
                    <div class="col-sm-4 col-md-2 ">
                ...
                <div class="form-group row">
                    <div class="col-sm-4 col-md-2 labeltext" style=""><label for="a_lc"><input id="a_lc" type="checkbox" <?php if($payment_info[0]['a_lc']=="Lc") echo 'checked'; ?> name="a_lc" value="Lc">&nbsp;LC</label></div>
                    <div class="col-sm-4 col-md-2 ">
                 ...
                 <div class="form-group row">
                    <div class="col-sm-4 col-md-2   labeltext" style=""><label for="a_pdc"><input id="a_pdc" type="checkbox" <?php if($payment_info[0]['a_pdc']=="Pdc") echo 'checked'; ?> name="a_pdc" value="Pdc">&nbsp;PDC</label></div>
                    <div class="col-sm-4 col-md-2 ">
