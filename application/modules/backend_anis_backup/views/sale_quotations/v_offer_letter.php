...
<!--    <div style="text-align: right">
        ...
        <table class="table" id="">
            <tr>
               <td style="border-top:0px;padding:0px;">Ref:&nbsp;<?php echo $quotation_info[0]['reference_no']; ?></td>
               <td style="border-top:0px;padding-left:0px;"></td>
            </tr>
             <tr>
               <td style="border-top:0px;padding:0px;">Date:&nbsp;<?php echo date("d-m-Y"); ?></td>
               <td style="border-top:0px;padding-left:0px;"></td>
            </tr> 
            <tr>
                ...
                <td style="border-top:0px;padding-left:0px;"></td>
                 ...
                 <tr>
                     ...
                     <td style="border-top:0px;padding:0px;text-align: left;" colspan="2">Delivery Place:</td>
                </tr>
                 <tr>
                    <td style="border-top:0px;padding:0px;" colspan="6">Managing Director</td>
                    <td style="border-top:0px;padding:0px;text-align: left;">Project Name:&nbsp;<?php echo $quotation_info[0]['project_name']; ?></td>
                </tr>
                <tr>
                    <td style="border-top:0px;padding:0px;" colspan="6"><?php echo $quotation_info[0]['c_name']; ?></td>
                    <td style="border-top:0px;padding:0px;text-align: left;">Address:&nbsp;<?php echo $quotation_info[0]['shipping_address']; ?></td>
                </tr>
                <tr>
                    <td style="border-top:0px;padding:0px;" colspan="6"><?php echo $quotation_info[0]['c_contact_address']; ?></td>
                    <td style="border-top:0px;padding:0px;text-align: left;">Contact Name:&nbsp;<?php echo $quotation_info[0]['contact_person']; ?></td>
                </tr>
               <tr>
                    <td style="border-top:0px;padding:0px;" colspan="6"></td>
                    <td style="border-top:0px;padding:0px;text-align: left;">Phone:&nbsp;<?php echo $quotation_info[0]['contact_no']; ?></td>
                </tr>
            </table>       
