    ...
    <form action="<?php echo site_url('sale_quotations/edit_quotation_action/'.$quotation_info[0]['q_id']); ?>" method="post">
         ...
         <div class="row">
               <div class="col-md-6">
                <div class="form-group row">
                    ...
                    <div class="col-sm-8 col-md-5 ">
                         <select required id="category_id" class="form-control e1" name="category_id">
           ...
           <div class="col-md-6">
                    ...
                    <div class="col-sm-8 col-md-5 ">
                        <select required id="customer_id" class="form-control" name="customer_id">
         ...
         <div class="row">
          ...
          <div class="col-md-6">
                <div class="form-group row">
                    ...
                    <div class="col-sm-8 col-md-5 "><input required class="form-control" id="phone" name="phone" type="text" value="<?php if(!empty($quotation_info[0]['phone'])) echo $quotation_info[0]['phone']; ?>"></div>
                </div>
           </div>  
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                    ...
                    <div class="col-sm-8 col-md-5 ">
                        <select required id="thanks_employee_id" class="form-control e1" name="thanks_employee_id">
                            <option class="form-control" value="">Select Employee</option>
                            <?php foreach($employees as $employee){ ?>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                     ...
                                     <td>
                                        <input  style="width:140px;"  type="text"  name="description[]" id="description_<?php echo $i; ?>" class="issue" value="<?php if(!empty($quotation_detail['project_name'])) echo $quotation_detail['project_name']; ?>">
                                    </td>

                                     <td>
                                        <input required onkeyup="calculateSubtotal(<?php echo $i; ?>)" onchange="calculateSubtotal(<?php echo $i; ?>)" onblur="calculateSubtotal(<?php echo $i; ?>)"  style="width:140px;"  type="text"  name="quantity[]" id="quantity_<?php echo $i; ?>" class="issue" value="<?php if(!empty($quotation_detail['quantity'])) echo $quotation_detail['quantity']; ?>">
                                    </td>
                                    <td>
                                        <input required onkeyup="calculateSubtotal(<?php echo $i; ?>)" onchange="calculateSubtotal(<?php echo $i; ?>)" onblur="calculateSubtotal(<?php echo $i; ?>)"  style="width:140px;"  type="text"  name="unit_price[]" id="unit_price_<?php echo $i; ?>" class="issue" value="<?php if(!empty($quotation_detail['unit_price'])) echo $quotation_detail['unit_price']; ?>">
                                    </td>

                                    <td>
                                        <input readonly  style="width:140px;"  type="text"  name="amount[]" id="amount_<?php echo $i; ?>" class="issue" value="<?php if(!empty($quotation_detail['amount'])) echo $quotation_detail['amount']; ?>">
                                    </td>
                                     <td>
            ...
            <div class="col-md-6">
                <div class="form-group row">
                     ...
                     <?php if(!empty($payment_info[0]['b_cash'])){ ?>
                        <div class="col-sm-4 col-md-2   labeltext" style=""><label for="b_cash"><input onclick="enablePaymentCondition('b_cash')" id="b_cash" type="checkbox" <?php if($payment_info[0]['b_cash']=="Cash") echo 'checked'; ?> name="b_cash" value="Cash">&nbsp;Cash</label></div>
                         <div class="col-sm-4 col-md-2 ">
                           <input class="form-control" id="b_cash_tenor" name="b_cash_tenor" type="text" placeholder="T. Day">
                        </div>
                        <div class="col-sm-4 col-md-2 ">
                 ...
                 <div class="form-group row">
                   <?php if(!empty($payment_info[0]['b_bg'])){ ?>
                        ...
                        <div class="col-sm-4 col-md-2 ">
                           <input required class="form-control" id="b_bg_tenor" name="b_bg_tenor" type="text" placeholder="T. Day" value="<?php if(!empty($payment_info[0]['b_bg_tenor'])) echo $payment_info[0]['b_bg_tenor']; ?>">
                        </div>
                        <div class="col-sm-4 col-md-2 ">
                ...
                <div class="form-group row">
                  <?php if(!empty($payment_info[0]['b_lc'])){ ?>
                        ...
                        <div class="col-sm-4 col-md-2 ">
                           <input required class="form-control" id="b_lc_tenor" name="b_lc_tenor" type="text" placeholder="T.Day" value="<?php if(!empty($payment_info[0]['b_lc_tenor'])) echo $payment_info[0]['b_lc_tenor']; ?>">
                        </div>
                         <div class="col-sm-4 col-md-2 ">
                 ...
                 <div class="form-group row">
                     <?php if(!empty($payment_info[0]['b_pdc'])){ ?>
                        ...
                        <div class="col-sm-4 col-md-2 ">
                           <input required class="form-control" id="b_pdc_check" name="b_pdc_check" type="text" placeholder="T.Ch." value="<?php if(!empty($payment_info[0]['b_pdc_check'])) echo $payment_info[0]['b_pdc_check']; ?>">
                        </div>
                        <div class="col-sm-4 col-md-2 ">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group row">
                    <?php if(!empty($payment_info[0]['a_cash'])){ ?>
                        <div class="col-sm-4 col-md-2   labeltext" style=""><label for="a_cash"><input onclick="enablePaymentCondition('a_cash')" id="a_cash" type="checkbox" <?php if($payment_info[0]['a_cash']=="Cash") echo 'checked'; ?> name="a_cash" value="Cash">&nbsp;Cash</label></div>
                         <div class="col-sm-4 col-md-2 ">
                           <input class="form-control" id="a_cash_tenor" name="a_cash_tenor" type="text" placeholder="T. Day">
                        </div>
                        <div class="col-sm-4 col-md-2 ">
                ...
                <div class="form-group row">
                    <?php if(!empty($payment_info[0]['a_bg'])){ ?>
                        ...
                        <div class="col-sm-4 col-md-2 ">
                           <input required class="form-control" id="a_bg_tenor" name="a_bg_tenor" type="text" placeholder="T.Day" value="<?php if(!empty($payment_info[0]['a_bg_tenor'])) echo $payment_info[0]['a_bg_tenor']; ?>">
                        </div>
                        <div class="col-sm-4 col-md-2 ">
                ...
                <div class="form-group row">
                    <?php if(!empty($payment_info[0]['a_lc'])){ ?>
                        ...
                        <div class="col-sm-4 col-md-2 ">
                           <input required  class="form-control" id="a_lc_tenor" name="a_lc_tenor" type="text" placeholder="T.Day" value="<?php if(!empty($payment_info[0]['a_lc_tenor'])) echo $payment_info[0]['a_lc_tenor']; ?>">
                        </div>
                         <div class="col-sm-4 col-md-2 ">
                 ...
                 <div class="form-group row">
                     <?php if(!empty($payment_info[0]['a_pdc'])){ ?>
                        ...
                        <div class="col-sm-4 col-md-2 ">
                           <input required class="form-control" id="a_pdc_check" name="a_pdc_check" type="text" placeholder="T.Ch." value="<?php if(!empty($payment_info[0]['a_pdc_check'])) echo $payment_info[0]['a_pdc_check']; ?>">
                        </div>
                        <div class="col-sm-4 col-md-2 ">
