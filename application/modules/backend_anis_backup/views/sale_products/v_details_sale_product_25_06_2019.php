 <div class="right_col" style="background-color: #f1f1f1;padding-bottom:20px;">
            <h2 style="text-align:center; ">Details Product Information </h2>
            <hr>
                 ...
                 <div class="row">      
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8 col-md-5 "><input required class="form-control" id="inputdefault" name="p_code" type="text" value="<?php if(!empty($sale_product_info[0]['p_code'])) echo $sale_product_info[0]['p_code']; ?>"></div>
                        </div>
                    </div>
