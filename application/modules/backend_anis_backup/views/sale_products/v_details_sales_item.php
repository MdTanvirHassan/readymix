 <div class="right_col" style="background-color: #f1f1f1;padding-bottom:20px;">
            <h2 style="text-align:center; ">Details Item  </h2>
            <hr>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8 col-md-5 "><input disabled class="form-control" id="inputdefault" name="s_item_name" type="text" value='<?php if(!empty($sales_item_info[0]['s_item_name'])) echo $sales_item_info[0]['s_item_name']; ?>'></div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8 col-md-5 ">
                                <select disabled id="payment_condition" class="form-control" name="category">
                                    <option class="form-control" value="">Select Category</option>
                                    <option <?php if(!empty($sales_item_info[0]['category']=='Asphalt')) echo 'selected'; ?> class="form-control" value="Asphalt">Asphalt</option>
                                    <option <?php if(!empty($sales_item_info[0]['category']=='Readymix')) echo 'selected'; ?> class="form-control" value="Readymix">Readymix</option>  
                      ...
                      <tr class="row" id="row_<?php echo $i; ?>">
                           <?php if ($i > 1) { ?>
                            ...
                            <?php } else { ?>
                                <td></td>
                            <?php } ?>
                          <td> <select disabled required style="width:200px;" class="e1" style="width:100px;" id="item_c_1" name="m_id[]" >
                        ...
                        <td><input disabled  style="width:140px;"  type="text"  name="quantity[]" id="item_des_c1_1" class="issue" value='<?php echo $sales_item_material['quantity'];  ?>'></td>
                        <td><input disabled  style="width:140px;"  type="text"  name="price[]" id="item_des_c1_1" class="issue" value='<?php echo $sales_item_material['price'];  ?>'></td>
                        <td><input disabled  style="width:140px;"  type="text"  name="price[]" id="item_des_c1_1" class="issue" value='<?php echo $sales_item_material['amount'];  ?>'></td>
                      </tr>
                    <?php } ?>   
                      </tbody>
                  </table>
        <?php } ?>   
                <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-2 ">
                                <a href="<?php echo site_url('backend/sales_item/edit_sales_item/'.$sales_item_info[0]['s_item_id']) ?>" > <button type="button" class="btn btn-success button">EDIT</button> </a>
                            </div>
                            <div class="col-md-2">
