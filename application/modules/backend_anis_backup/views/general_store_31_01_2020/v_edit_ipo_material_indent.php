                                    ...
                                    foreach ($ipo_material_indent_details as $ipo_material_indent_detail) {
                                        ...
                                        ?>  
                                                <tr id="row_<?php echo $i; ?>">
                                                    ...
                                                    <td><input type="hidden" id="item_des_c_<?php echo $i; ?>"  name="item_name_description[]" value="<?php if (!empty($ipo_material_indent_detail['item_name_description'])) echo $ipo_material_indent_detail['item_name_description']; ?>" class="issue"><input  disabled type="text" id="item_des_c1_<?php echo $i; ?>"  name="item_name_description[]" value="<?php if (!empty($ipo_material_indent_detail['item_name_description'])) echo $ipo_material_indent_detail['item_name_description']; ?>" class="issue form-control"></td>
                                                    <td><input type="hidden" id="unit_c_<?php echo $i; ?>"  name="unit[]" value="<?php if (!empty($ipo_material_indent_detail['unit'])) echo $ipo_material_indent_detail['unit']; ?>" class="issue"><input  disabled type="text" id="unit_c1_<?php echo $i; ?>"  name="unit[]" value="<?php if (!empty($ipo_material_indent_detail['unit'])) echo $ipo_material_indent_detail['unit']; ?>" class="issue form-control"></td>
