                            ...
                            <div class="row">  
                                ...
                                <div class="col-md-6">
                                    <div class='form-group row' >
                                                        ...
                                                        <?php foreach($departments as $row){?>
                                                        <?php if($row['d_id'] == $d_id){ continue;}?>
                                                        <option <?php if($row['d_id'] == $transfer[0]['to_unit_id']) echo 'selected';?>  value="<?php echo $row['d_id'];?>"><?php echo $row['short_name'];?></option>
                                                        <?php }?>
                                                    </select> 
                            ...
                            <div class="row">  
                                <div class="col-md-6">
                                    <div class='form-group row' >
                                                         ...
                                                         <div class="col-sm-8 col-md-8 input-group">
                                                             <span class="input-group-addon"><i class="fa fa-recycle"></i></span>
                                                            <input id="price" class="form-control" name="price" type="text" value="<?php echo $transfer[0]['price']?>">  
