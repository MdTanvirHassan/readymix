            ...
            <table class="table table-bordered" id="myTable">
                    ...
                    <tbody>
                      ...
                      <tr class="row" id="row_1">
                        ...
                        <td><input  style="width:40px;" type="text"  name="indent_qty[]" id="indent_qty_c_1" onkeyup="calculateEstvalueConsume(1)" class="issue"></td>
                        
                        <td><input type="hidden"  name="unit_price[]" id="unit_price_c_1" class="issue"><input style="width:80px;" disabled type="text"  name="unit_price[]" id="unit_price_c1_1" class="issue"></td>
                 ...
                 <table class="table table-bordered" id="myTable1" style="display:none;">
                    ...
                    <tbody>
                      ...
                      <tr class="row" id="row_1">
                        ...
                        <td><input type="hidden" name="stock_qty_a[]" id="stock_qty_a_1" class="issue"><input style="width:40px;" disabled type="text" name="stock_qty_a[]" id="stock_qty_a1_1" class="issue"></td>
                        <td><input  style="width:40px;" type="text"  name="indent_qty_a[]" id="indent_qty_a_1" onkeyup="calculateEstvalueAsset(1)" class="issue"></td>
