...
<div class="row">
    ...
    <?php $i=0; foreach($receive_items as $receive_item){ $i++;?>
       <tr class="" id="row_1">
         ...
         <td><input type="hidden"  name="item_id[]" id="item_des_c1_" class="issue" value="<?php echo $receive_item['item_id']  ?>"><input disabled style="width:140px;"  type="text"  name="name[]" id="item_des_c1_" class="issue" value="<?php echo $receive_item['item_name']  ?>"></td>
