 <div class="right_col" style="background-color: #f1f1f1;padding-bottom:20px;">
    ...
    <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                 <div class="x_content">
                     <form class="form-horizontal" action="<?php echo site_url('brand/add_brand_action') ?>" method="post">
                                ...
                                <label for="title" class="col-sm-2 control-label">
                                    Name<sup style="color:red">*</sup> :
                                       ...
                                       <div class="col-sm-4 input-group">
                                           ...
                                           <input required class="form-control" id="inputdefault" name="brand_name" type="text">
                                 </div>
                                <label for="title" class="col-sm-2 control-label">
                                 Description :
                              </label>
