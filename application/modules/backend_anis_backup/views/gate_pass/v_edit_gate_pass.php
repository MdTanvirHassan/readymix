...
<div class="row">
            ...
            <form class="form-horizontal" method="post" action="<?php echo site_url('gate_pass/edit_gate_pass_action/'.$gate_pass[0]['id']) ?>">
                        ...
                        <div class='form-group' >
                                <label for="title" class="col-sm-2 control-label">
                                    Gate pass No.<sup style="color:red;">*</sup>:
                                     ...
                                     <div class="col-sm-4 input-group">
                                         ...
                                         <input required="" class="form-control" id="pass_no" name="pass_no" type="text" value="<?php echo $gate_pass[0]['pass_no']?>">
                               ...
                               <label for="title" class="col-sm-2 control-label">
                                   Pass Date<sup style="color:red;">*</sup>:
                                     ...
                                     <div class="col-sm-4 input-group">
                                         <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                         <input class="form-control datepicker" id="date" name="date" type="text" value="<?php echo date('d-m-Y',  strtotime($gate_pass[0]['date']))?>">
                        ...
                        <div class='form-group' >
                                   ...
                                   Delivery Challan No.
                                     ...
                                     <div class="col-sm-4 input-group">
                                         ...
                                         <select class="form-control select2" id="dc_id" name="dc_id">
                                           ...
                                           <option <?php if($gate_pass[0]['dc_id']== $row['dc_id']) echo 'selected';?> value="<?php echo $row['dc_id']?>"><?php echo $row['dc_no'];?></option>
                                              <?php }?>
                                         </select>
                               ...
                               <label for="title" class="col-sm-2 control-label">
                                   Address<sup style="color:red;">*</sup>:
                                     ...
                                     <div class="col-sm-4 input-group">
                                         <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                         <input required="" type="text" name="address" class="form-control" value="<?php echo $gate_pass[0]['address']?>">
                                   ...
                                   Driver Name.
                                     ...
                                     <div class="col-sm-4 input-group">
                                         ...
                                         <select class="form-control select2" id="driver_id" name="driver_id">
                                           ...
                                           <option <?php if($gate_pass[0]['driver_id']== $row['driver_id']) echo 'selected';?>  value="<?php echo $row['driver_id']?>"><?php echo $row['driver_name'];?></option>
                                              <?php }?>
                                         </select>
                                   ...
                                   Truck No<sup style="color:red;">*</sup>:
                                     ...
                                     <div class="col-sm-4 input-group">
                                         ...
                                         <select required="" class="form-control select2" id="truck_id" name="truck_id">
                                           ...
                                           <option <?php if($gate_pass[0]['truck_id']== $row['truck_id']) echo 'selected';?> value="<?php echo $row['truck_id']?>"><?php echo $row['truck_no'];?></option>
                                              <?php }?>
                                         </select>
                ...
                <div class="form-group">
                   <label class="check_container">Kind of issue
                       <input type="checkbox" name="issue" value="1" <?php if($gate_pass[0]['issue']== 1) echo 'checked';?> >
  <span class="checkmark"></span>
</label>
 <label class="check_container">Sales
     <input type="checkbox" name="sale" value="1" <?php if($gate_pass[0]['sale']== 1) echo 'checked';?>>
  <span class="checkmark"></span>
</label>                 
 <label class="check_container">No-Returnable
     <input type="checkbox" name="non_return" value="1" <?php if($gate_pass[0]['non_return']== 1) echo 'checked';?>>
  <span class="checkmark"></span>
</label>                 
 <label class="check_container">Returnable
  <input type="checkbox" name="return" value="1" <?php if($gate_pass[0]['return']== 1) echo 'checked';?>>
  <span class="checkmark"></span>
</label>                 
                </div>
          ...
          <table id="create_new_row" class="table table-bordered">
              <?php $rowcount = count($gate_pass_details); ?>
                                <tr>
                                    <th onclick="createrow()"  style="color:red;text-align: center;font-size: 23px;cursor: pointer;width:5%;"><i class=" fa fa-plus"></i><input type="hidden" id="current_row" value="<?php echo $rowcount;?>"></th>
                                    <th style="width:5%;">SL</th>
                                    <th>Note</th>
                                    
                                </tr>
                                <?php $i=1; foreach ($gate_pass_details as $key=>$row){ ?>
                                <tr id="remove_<?php echo $i;?>">
                                    <?php if($i == 1){?>
                                    <td></td>
                                    <?php }else{?>
                                    <td onclick="remove('<?php echo $i?>')" style="color:red;text-align: center;font-size: 23px;cursor: pointer;"><i class="fa fa-minus"></i></td>
                                    <?php }?>
                                    <td><?php echo $i;?></td>
                                    
                                    <td>
                                        <textarea required="" style=" height:40px;" class="form-control" name="note[<?php echo $i;?>]"><?php echo $row['note'];?></textarea>  
                                    </td>
                                </tr>
                                <?php $i++; } ?>  
                            </table>              
