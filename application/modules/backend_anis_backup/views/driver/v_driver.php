...
<div class="right_content">
     <?php $this->role = checkUserPermission(13,61, $userData);  if (in_array(2, $this->role)) {  ?>
            <a href="<?php echo site_url('drivers/add_driver'); ?>" class="btn btn-sm btn-primary">ADD DRIVER</a>
     <?php } ?>    
                    ...
                    <tr>
                        ...
                        <td>
                                ...
                                <?php  if (in_array(3, $this->role)) {  ?>    
                                    <a href="<?php echo site_url('drivers/edit_driver/'.$driver['driver_id']); ?>"><button class="btn btn-sm btn-info">Edit</button></a>
                                <?php } ?>   
                            
                           <?php  if (in_array(4, $this->role)) {  ?>         
                                <a href="<?php echo site_url('drivers/details_driver/'.$driver['driver_id']); ?>"><button class="btn btn-sm btn-success">Details</button></a>
                           <?php } ?>
                           <?php  if(in_array(5, $this->role)){  ?>        
                               
                                    <button onclick="delete_row('<?php echo site_url('drivers/delete_driver/'.$driver['driver_id']); ?>')" class="btn btn-sm btn-danger">Delete</button>
