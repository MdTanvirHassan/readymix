...
<div style="padding:0" class="col-md-10 col-md-offset-1">
    ...
    <p style=" text-align: center;text-decoration: underline;">Adjustment Report</p>
                             ...
                             <tbody>
                                      ...
                                      <?php if(!empty($data)){
                                                     ...
                                                     ?>
                                                            ...
                                                            <?php } ?>
                                                                    <tr><td colspan="2" style="border-left:1px solid;border-top:1px solid;border-bottom:1px solid;text-align: right;">Total</td><td style="border-left:1px solid;border-top:1px solid;border-bottom:1px solid;text-align: right;"><b><?php echo number_format($total_receive_qty,2); ?></b></td><td style="border-left:1px solid;border-top:1px solid;border-bottom:1px solid;border-right:1px solid;text-align: right;"><b><?php echo number_format($total_receive_value,2); ?></b></td></tr>         
                                                            ...
                                                            foreach($data as $data_info){ 
                                                                ...
                                                                ?> 
                                                                    <tr>
                                                                        ...
                                                                        <td style="border-left:1px solid;border-top:1px solid;text-align: center;"><?php echo $data_info['item_name']; ?></td>
                                                                        <td style="border-left:1px solid;border-top:1px solid;text-align: center;"><?php echo $data_info['meas_unit']; ?></td>
                                                                        <td style="border-left:1px solid;border-top:1px solid;text-align: right;"><?php echo $data_info['consumption_quantity']; ?></td>
                                                                        <td style="border-left:1px solid;border-top:1px solid;border-right:1px solid;text-align: right;"><?php echo $data_info['amount']; ?></td>


                                                                    </tr>
                                                            <?php } ?>
                                                                    <tr><td colspan="3" style="border-left:1px solid;border-top:1px solid;border-bottom:1px solid;text-align: right;">Total</td><td style="border-left:1px solid;border-top:1px solid;border-bottom:1px solid;text-align: right;"><b><?php echo number_format($total_receive_qty,2); ?></b></td><td style="border-left:1px solid;border-top:1px solid;border-bottom:1px solid;border-right:1px solid;text-align: right;"><b><?php echo number_format($total_receive_value,2); ?></b></td></tr>         
