                            ...
                            <div id="remover" class="col-md-6 col-md-offset-3">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <select required class="form-control" name="salesline">
                                ...
                                <div style="margin-top: 10px; display: <?php if(!in_array($rType,array('quarterly','monthly','yearly','range'))) echo 'none';?>" id="typeHtml" class="col-md-12">
                                    <div class="col-md-4"><lable id="typeLabel"><?php if($rType =='yearly')echo "Year";else if($rType =='monthly')echo "Month";else if($rType =='range')echo "Range";else echo "Month" ?></label></div>
                                    <div class="col-md-8">
                                        <input style="display: <?php if($rType !='yearly') echo 'none'; ?>" type="text" id="year" name="year" class="form-control yearpicker" value="<?php if(!empty($year))echo $year; ?>" placeholder="Select Year"/>
                                        ...
                                        <select style="display:<?php if($rType !='quarterly') echo 'none'; ?>" required id="quarter" class="form-control" name="quarter">
