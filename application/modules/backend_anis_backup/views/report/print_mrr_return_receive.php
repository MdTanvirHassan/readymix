...
<div style="padding:0" class="col-md-10 col-md-offset-1">
    ...
    <p style=" text-align: center;text-decoration: underline;">Mrr Return Receive Report</p>
                                      ...
                                      <?php if(!empty($data)){
                                                     ...
                                                     ?>
                                                            ...
                                                            foreach($data as $data_info){ 
                                                                $total_receive_qty=$total_receive_qty+$data_info['mrr_receive_qty'];
                                                                $total_receive_value=$total_receive_value+$data_info['mrr_receive_value'];
                                                                ?> 
                                                                    <tr>
                                                                        ...
                                                                        <td style="border-left:1px solid;border-top:1px solid;border-right:1px solid;text-align: right;"><?php echo $data_info['mrr_receive_value']; ?></td>
