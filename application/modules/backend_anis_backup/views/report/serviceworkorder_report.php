                ...
                <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <div style="margin-top: 15px;" class="col-md-4">
                                    ...
                                    <select  class="form-control select2" placeholder="Select Supplier" id="supplier_id" name="supplier_id">
...
<!--                                <div style="margin-top: 15px;" class="col-md-4">
                    ...
                    <div class="row" id="printablediv">
                        ...
                        <div id="header_div" style="margin-top: 15px;text-align: center;" class="col-md-10 col-md-offset-1">
                            ...
                            <h4>Service Work Order Report</h4>
                                            ...
                                            $i=0;
                                              if(!empty($purchase_orders)){
                                                ...
                                                ?>
                                                    <tr>
                                                        <td><?php echo $i; ?></td>
                                                        <td><?php echo $req['purchase_order_date']; ?></td>
