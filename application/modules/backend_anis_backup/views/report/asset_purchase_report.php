<div class="right_col" role="main" style="padding: 0px;">
    <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div id="remover" class="col-md-6 col-md-offset-3">
                            <form id="item-form" action="<?php site_url('backend/report/assetPurchaseReport'); ?>" method="post" />
                            ...
                            <div class="row">
                                ...
                                <div style="margin-top: -30px;" class="col-md-5">
                                    <select required class="form-control" placeholder="Select Item" id="item" name="item">
                            ...
                            <div class="row">
                                <div style="margin-top: 15px;" class="col-md-5 col-md-offset-1">
                                    <input type="text" name="from_date" class="form-control datepicker" value="<?php if (!empty($f_date)) echo $f_date;
                                                                                                                else //echo $first_date; 
                                                                                                                ?>" placeholder="Select Date" />
                                </div>

                                <div style="margin-top: 15px;" class="col-md-5 ">
                                    <input type="text" name="to_date" class="form-control datepicker" value="<?php if (!empty($to_date)) echo $to_date;
                                                                                                                else //echo $last_date; 
                                                                                                                ?>" placeholder="Select Date" />
                                </div>
                            </div>
                                ...
                                <table id="workprogram" style="width:100%;font-size: 11px;" id="player_table" class="fixed_headers table table-striped datatable-scroll table-bordered bootstrap-datatable datatable responsive">
                                    ...
                                    <tbody>
                                        <?php if (!empty($group)) { ?>
                                            ...
                                            ?>
                                                <tr>
                                                    <td colspan="14" style="text-align:left;"><?php echo $grp['item_group'] ?></td>
                                                </tr>
                                                <?php
                                                $total_value = 0;
                                                $i = 0;
                                                ...
                                                ?>
                                                    <tr>
                                                        <td><?php echo $i; ?></td>
                                                        <td><?php echo $data_info['dep_description']; ?></td>

                                                        <td><?php echo $data_info['group_short_name']; ?></td>
                                                        <td><?php echo $data_info['item_name']; ?></td>
                                                        <td><?php echo $data_info['item_description']; ?></td>

                                                        <td><?php echo $data_info['origin']; ?></td>
                                                        <td><?php echo $data_info['SUP_NAME'] . "," . $data_info['ADDRESS']; ?></td>
                                                        <td><?php echo $data_info['c_c_name']; ?></td>

                                                        <td><?php echo $data_info['c_name']; ?></td>
                                                        <td><?php echo date('d-m-Y', strtotime($data_info['receive_date'])); ?></td>
                                                        <td><?php echo $data_info['receive_qty']; ?></td>

                                                        <td><?php echo $data_info['unit_price']; ?></td>
                                                        <td style="text-align: right;"><?php echo $value; ?></td>
                                                        <td><?php echo "WCL-" . $data_info['item_code']; ?></td>
                                                ...
                                                <?php if (!empty($grp['group_items'])) { ?>
                                                    <tr>
                                                        ...
                                                        <td style="text-align:right;"><?php if (!empty($total_value)) echo (int) $total_value;
                                                                                        else echo "-";  ?></td>
                                                        <td></td>
        ...
        <script type="text/javascript">
            function submitForm() {
                var url = '<?php echo site_url(); ?>backend/report/assetPurchaseReport/true';
                $('#item-form').attr('action', url);
                $('#form-submit').click();
                $('#empoyee-form').attr('action', '<?php echo site_url('backend/report/assetPurchaseReport'); ?>');
            }
            ...
            function project_or_asset_or_item_info() {
                ...
                $.ajax({
                    type: "POST",
                    url: "backend/report/asset_group_or_item",
