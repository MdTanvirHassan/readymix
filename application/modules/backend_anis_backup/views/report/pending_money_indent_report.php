        ...
        <div class="panel panel-default">
            ...
            <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                ...
                <div class="panel-body">
                            ...
                            <form id="item-form" action="<?php site_url('backend/report/pendingMoneyIndentReport'); ?>" method="post">
                    ...
                    <div class="row" id="printablediv">
                        ...
                        <div id="header_div" style="margin-top: 15px;text-align: center;" class="col-md-10 col-md-offset-1">
                            ...
                            <h4>Pending Money Indent Report</h4>
                                            ...
                                            $test=$i;
                                              if(!empty($indents)){
                                                ...
                                                foreach($indents as $req){ 
                                                    $net_total_value=$net_total_value+$req['value'];
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $req['mo_indent_no']; ?></td>
                                                        ...
                                                        <td style="text-align:right;"><?php echo number_format($req['value']); ?></td>
                                                        <td style="text-align:right;"><?php 
