<div class="right_col" role="main" style="padding: 0px;">
    <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
        <div class="panel panel-default">
            <div class="panel-heading" role="tab" id="headingOne">
                <h4 class="panel-title clearfix" style="text-align:center">
                    <a href="<?php echo site_url('backend/sales_report'); ?>" class="btn btn-sm btn-primary pull-left">
                        << GO BACK</a> Invoice Commission Report
                </h4>
            </div>
            ...
            <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                ...
                <div class="panel-body">
                    ...
                    <!--<a style="float:right;" href="<?php echo site_url('backend/sales_report/invoiceSummaryReport/true'); ?>" class="btn btn-sm btn-primary">PRINT</a>-->
                    <div class="row">
                        <div id="remover" class="col-md-12">
                            <form id="item-form" action="<?php site_url('backend/sales_report/allDeliveryChallan'); ?>" method="post" />


                            <div class="col-md-3">
                                <div style="margin-top: 15px;" class="col-md-12">
                                    <select class="form-control e1" placeholder="Select Branch" id="branch_id" name="branch_id" onchange="javascript:project_info();">
                                        <option value="">Select Branch</option>
                                        <?php foreach ($branches as $branch) { ?>
                                            <option <?php if ($branch_id == $branch['d_id']) echo 'selected'; ?> value="<?php echo $branch['d_id'] ?>"><?php echo $branch['dep_description']; ?></option>
                                        <?php } ?>
                            ...
                            <div class="col-md-3">
                                <div style="margin-top: 15px;" class="col-md-12">
                                    <select class="form-control e1" placeholder="Select Project" id="project_id" name="project_id" onchange="javascript:sales_order_info();">
                                        ...
                                        ?>
                                                <option <?php if ($project['project_id'] == $project_id) echo 'selected'; ?> value="<?php echo $project['project_id'] ?>"><?php echo $project['project_name']; ?></option>
                            ...
                            <div class="col-md-3">
                                <div style="margin-top: 15px;" class="col-md-12">
                                    <select class="form-control e1" placeholder="Select Order" id="o_id" name="o_id">
                                        <option value="">Select Orders</option>
                                        <?php foreach ($all_orders as $all_order) { ?>
                                            <option <?php if ($order_id == $all_order['o_id']) echo 'selected'; ?> value="<?php echo $all_order['o_id'] ?>"><?php echo $all_order['order_no'] ?></option>
                                        <?php } ?>
                            ...
                            <div class="col-md-3">
                                <div style="margin-top: 15px;" class="col-md-12">
                                    <select class="form-control e1" placeholder="Select Type" id="sale_person_id" name="sale_person_id">
                                        <option value="">Sales Person</option>
                                        <?php foreach ($employees as $employee) { ?>
                                            <option <?php if ($sale_person_id == $employee['id']) echo 'selected'; ?> value="<?php echo $employee['id'] ?>"><?php echo $employee['name'] ?></option>
                                        <?php } ?>
                            ...
                            <!--
                             <div class="row">
                                    <div style="margin-top: 15px;" class="col-md-10 col-md-offset-1">
                                      <select  class="form-control e1" placeholder="Select Status" id="product_id" name="bill_status" >
                                          <option value="" >Select Bill Status</option>
                                          <option <?php if ($bill_status == "Pending") echo "selected"; ?> value="Pending" >Pending</option>
                                          <option <?php if ($bill_status == "Generated") echo "selected"; ?> value="Generated" >Generated</option>
    ...
    <input style="padding: 6px 40px;" type="button" id="print_div" class="btn btn-primary" value="PRINT"/>-->
                                    <input id="form-submit" type="submit" class="btn btn-primary" value="SEARCH" />
                    ...
                    <div id="header_div" style="margin-top: 15px;text-align: center;" class="col-md-10 col-md-offset-1">
                        ...
                        <h4>Invoice Commission Report</h4>
    ...
    <script type="text/javascript">
        ...
        function submitForm(type) {
            if (type == 'print')
                var url = '<?php echo site_url(); ?>backend/sales_report/salesCommission/true';
            else
                var url = '<?php echo site_url(); ?>backend/sales_report/salesCommissionExcel';
            $('#item-form').attr('action', url);
            $('#form-submit').click();
            $('#item-form').attr('action', '<?php echo site_url('backend/sales_report/salesCommission'); ?>');
        }
    </script>