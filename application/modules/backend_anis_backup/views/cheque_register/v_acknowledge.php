...
<div class="row">
                            ...
                            <div class="col-md-6">
                                <p>NO. : <?php echo $issuedCheque[0]['vourch_no'];?></p>
                                <p>Date. : <?php echo date('d-m-Y',  strtotime($issuedCheque[0]['issued_date']));?></p>
                            </div>
                        ...
                        <table border="1"  class="table" style="width: 100%;">
                            ...
                            <th style="width:10%;text-align: center;">Paid to / Accounts Head</th>
                            <th style="width:15%;text-align: center;">Paid For</th>
                            ...
                            <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:5%;text-align: center;"><?php echo $issuedCheque[0]['SUP_NAME'];?></td>
                                        <td style="width:5%;text-align: center;"><?php echo $issuedCheque[0]['remarks'];?></td>
                                        <td style="width:5%;text-align: center;"><?php echo number_format($issuedCheque[0]['amount'],2);?></td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align:center;"><?php echo number_format($issuedCheque[0]['amount'],2);?></td>
                                    </tr>
                        ...
                        <p>In word : <?php echo convert_number_to_words($issuedCheque[0]['amount']) ;?></p>
                        <br>
                        <br>
