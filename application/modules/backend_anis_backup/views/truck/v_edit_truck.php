...
<div class="row">
            ...
            <form class="form-horizontal" method="post" action="<?php echo site_url('trucks/edit_truck_action/'.$truck_info[0]['truck_id']) ?>" onsubmit="javascript: return validation()">
                ...
                <div class="row" style="margin-bottom: 20px">
                    <div class="col-md-2">
                        <a href="<?php echo site_url('backend/trucks/') ?>" > <button type="button" class="btn btn-success button">GO BACK</button> </a>
