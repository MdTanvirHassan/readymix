                                ...
                                <div class="col-sm-4 input-group">
                                    ...
                                    <select id="c_id" class="form-control e1" name="employee_id">
                                        ...
                                        <?php foreach($employees as $em){ ?>
                                            <option <?php if($em['id']==$sale_target_info[0]['employee_id']) echo "selected"; ?> class="form-control" value="<?php echo $em['id'] ?>"><?php echo $em['name']; ?></option>
                                        <?php } ?>
                                   </select>
                        <span id="c_id_error" style="color:red"></span>
                               ...
                               <label for="title" class="col-sm-2 control-label">
                                ...
                                <div class="col-sm-4 input-group">
                                    ...
                                    <input  class="form-control monthpicker" id="month" name="month" type="text" value="<?php echo $sale_target_info[0]['month'] ?>">
                ...
                <table class="table table-bordered" id="myTable" >
                    ...
                    <tbody id="sale_items">
                         ...
                         <tr class="" id="row_<?php echo $i; ?>">
                            <td><input  type="hidden"  name="category_id[]" id="product_id_<?php echo $i; ?>" class="issue" value="<?php echo $sale_order_details['category_id'] ?>"><input readonly style="width:140px;"  type="text"  name="name[]" id="item_des_c_<?php echo $i; ?>" class="issue" value="<?php echo $sale_order_details['category_name'] ?>"></td>
                            <td><input required  style="width:80px;"  type="text" class=""  name="mu_name[]" id="item_amount_<?php echo $i; ?>" class="issue" value="<?php echo $sale_order_details['mu_name'] ?>"></td>
                            ...
                            <td><input onkeyup="calculateSubtotal(<?php echo $i; ?>)" onchange="calculateSubtotal(<?php echo $i; ?>)" onblur="calculateSubtotal(<?php echo $i; ?>)"  style="width:80px;text-align: right;"  type="text"  name="unit_price[]" id="unit_price_<?php echo $i; ?>" class="issue number" value="<?php echo $sale_order_details['unit_price'] ?>"></td>    
                            <td><input onkeyup="calculateSubtotal(<?php echo $i; ?>)" onchange="calculateSubtotal(<?php echo $i; ?>)" onblur="calculateSubtotal(<?php echo $i; ?>)"  style="width:80px;text-align: right;"  type="text"  name="bep_qty[]" id="bep_qty_<?php echo $i; ?>" class="issue number" value="<?php echo $sale_order_details['bep_qty'] ?>"></td>    
                            <td><input readonly  style="width:80px;text-align: right;"  type="text" class=""  name="amount[]" id="amount_<?php echo $i; ?>" class="issue" value="<?php echo $sale_order_details['amount'] ?>"></td>
                            <td><input readonly  style="width:80px;text-align: right;"  type="text" class=""  name="bep_amount[]" id="bep_amount_<?php echo $i; ?>" class="issue" value="<?php echo $sale_order_details['bep_amount'] ?>"></td>
                       ...
                       <tfoot>
                           ...
                           -->
                            <tr>
                                ...
                                <td><input readonly style="width:140px;text-align: right;" id="sub_total"  name="total_amount" type="text" value="<?php if(!empty($sale_target_info[0]['total_amount'])) echo $sale_target_info[0]['total_amount']; ?>"></td>
                          
                                <td><input readonly style="width:140px;text-align: right;" id="bep_sub_total"  name="bep_sub_total" type="text" value="<?php if(!empty($sale_target_info[0]['bep_total'])) echo $sale_target_info[0]['bep_total']; ?>"></td>
                            </tr>
                        </tfoot>
                  </table>
...
var i = $('#sale_items').find('tr').length;
                             ...
                             str +='<td><input required  style="width:80px;"  type="text"  name="mu_name[]" id="mu_name_'+(Number(i) + 1) + '" class="issue" value=""></td>';
                             ...
                             str +='<td><input required onkeyup="calculateSubtotal('+(Number(i) + 1)+')" onchange="calculateSubtotal('+(Number(i) + 1)+')" onblur="calculateSubtotal('+(Number(i) + 1)+')"  style="width:80px;text-align:right;"  type="text"  name="unit_price[]" id="unit_price_'+(Number(i) + 1)+'" class="issue number" value=""></td>';
                             str +='<td><input required onkeyup="calculateSubtotal('+(Number(i) + 1)+')" onchange="calculateSubtotal('+(Number(i) + 1)+')" onblur="calculateSubtotal('+(Number(i) + 1)+')"  style="width:80px;text-align:right;"  type="text"  name="bep_qty[]" id="bep_qty_'+(Number(i) + 1)+'" class="issue number" value=""></td>';
                             str +='<td><input readonly  style="width:80px;text-align:right;"  type="text" class="amount_"  name="amount[]" id="amount_'+(Number(i) + 1)+'" class="issue" value=""></td>'; 
                             str +='<td><input readonly  style="width:80px;text-align:right;"  type="text" class="amount_"  name="bep_amount[]" id="amount_'+(Number(i) + 1)+'" class="issue" value=""></td>'; 
...
//        }
    ...
    function calculateSubtotal(id){
         ...
         var bep_qty=$('#bep_qty_'+id).val();
         var amount=Number(unit_price)*Number(quantity);
         amount=amount.toFixed(2);
         var bep_amount=Number(unit_price)*Number(bep_qty);
         bep_amount=bep_amount.toFixed(2);
         $('#amount_'+id).val(amount);
         $('#bep_amount_'+id).val(bep_amount);
         var rowCount = $('#myTable tr').length;
         var table_row=Number(rowCount)-2;
         for(var i=1;i<=table_row;i++){
             var amt=$('#amount_'+i).val();
             var bep_amt=$('#bep_amount_'+i).val();
             sub_total=sub_total+Number(amt)
             bep_sub_total=bep_sub_total+Number(bep_amt)
       ...
       //  alert(sub_total)
         sub_total=sub_total.toFixed(2);
         $('#sub_total').val(sub_total);
         bep_sub_total=bep_sub_total.toFixed(2);
         $('#bep_sub_total').val(bep_sub_total);
