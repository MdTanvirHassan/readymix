    ...
    <p style=" text-align: center;margin-top:-3px;">(A Unit Of Karim Group)</p>
     ...
     <?php }else{ ?>
           ...
           <table class="table table-bordered table-hover table-striped" style="margin:0 auto;">
                 ...
                 <table class="table table-bordered table-hover table-striped" style="margin:0 auto;">
                     <tr><td style="width:100px;font-size:15px;"><span style="border-top:1px solid;">PREP. BY</span></td><td style="width:200px;text-align: center;"><span style="border-top:1px solid;">STORE IN-CHARGE</span></td><td style="width:40px;"></td><td  style="width:200px;text-align: center;"><span style="border-top:1px solid;">GENERAL  MANAGER</span></td></tr>
                 </table>  
