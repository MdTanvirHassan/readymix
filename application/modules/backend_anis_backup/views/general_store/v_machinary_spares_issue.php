<div class="right_col" style="background-color: #f1f1f1;padding-bottom:20px;">
            <h2 style="text-align:center; ">Machinery spares issue session</h2>
            <hr>
            <form>
                <div class="row">
                    <div class="col-md-6">
                 ...
                 <div class="row">
                    <div class="col-md-6">
                        <div class="form-group row">
                            <div class="col-sm-4 col-md-5  labeltext"><label for="inputdefault">SR/Issue Note:</label></div>
                            <div class="col-sm-8 col-md-7 "><input class="form-control" id="inputdefault" type="text"></div>
                        </div>
                    </div>
                    <div class="col-md-6">
            ...
            <h2 style="text-align:center; ">Article List & information</h2>
             <hr>
             <table class="table table-bordered">
    <thead>
      <tr>
        <th>Art.code</th>
        <th>Articles Name&Description</th>
        <th>M.unit</th>
        <th>Issue Quality</th>
        <th>Unit Price</th>
        <th>Issue value</th>
