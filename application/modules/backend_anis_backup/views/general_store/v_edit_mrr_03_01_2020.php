...
<div class="row">
                              ...
                              <div class="col-sm-6 input-group">
                                  ...
                                  <select required id="po_id" class="form-control e1" name="po_id">
                                    ...
                                    <?php foreach($purchase_orders as $purchase_order){ ?>
                                        <option <?php if($mrr[0]['po_id']==$purchase_order['o_id']) echo 'selected'; ?> value="<?php echo $purchase_order['o_id'];  ?>"><?php if(!empty($purchase_order['order_no'])) echo $purchase_order['order_no']; ?></option>
                                    <?php } ?>
                                </select>
                        </div>
                             <label for="title" class="col-sm-2 control-label">
    ...
    <?php $i=0; foreach($receive_items as $receive_item){ $i++;?>
       <tr class="" id="row_1">
         ...
         <td><input type="hidden"  name="item_id[]" id="item_des_c1_" class="issue" value="<?php echo $receive_item['item_id']  ?>"><input readonly style="width:140px;"  type="text"  name="name[]" id="item_des_c1_" class="issue" value="<?php echo $receive_item['item_name']  ?>"></td>
        <td><input type="hidden"   style="width:140px;"  type="text"  name="unit_price[]" id="unit_price_"<?php echo $receive_item['item_id']  ?>"" class="unit_price_" value="<?php echo $receive_item['unit_price']  ?>"><input readonly  style="width:140px;"  type="text"  name="measurement_unit[]" id="measurement_unit_" value="<?php echo $receive_item['meas_unit']  ?>"></td>
        ...
        <td><input   onkeyup="calculateSubtotal(<?php echo $receive_item['item_id']; ?>)" onchange="calculateSubtotal(<?php echo $receive_item['item_id']; ?>)" onblur="calculateSubtotal(<?php echo $receive_item['item_id']; ?>)"  style="width:100px;text-align:right;"  type="text"  name="receive_qty[]" id="quantity_<?php echo $receive_item['item_id']; ?>" class="issue" value="<?php echo $receive_item['receive_qty']  ?>"></td>
        <td><input style="width:100px;text-align:right;"  type="text"  name="wastage_qty[]" id="quantity_<?php echo $receive_item['item_id']; ?>" class="issue" value="<?php echo $receive_item['wastage_qty']  ?>"></td>
        <td><input type="hidden" style="width:140px;"  type="text" name="amount[]" id="amount_<?php echo $receive_item['item_id']; ?>" class="amount_<?php echo $i; ?>"  value="<?php echo $receive_item['amount']  ?>"><input    style="width:140px;text-align:right;"  type="text" name="remark[]" value="<?php echo $receive_item['remark']  ?>"></td>
