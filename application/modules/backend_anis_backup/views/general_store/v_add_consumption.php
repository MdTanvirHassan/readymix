                    ...
                    <div class="x_content">
                        <form class="form-horizontal" action="<?php echo site_url('general_store/add_consumption'); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <table id="create_new_row" class="table table-bordered">
                                ...
                                <!--    
                                    <td>
                                        <select onchange="currentquantity(1)" id="brand_id_1" class="form-control select2 item_name"  name="brand_id[1]" >
                                ...
                                -->    
                                    ...
                                    <td>
                                        <input required onblur="currentqueantityminus(1)" id="quantity_1" class="form-control" name="consumption_quantity[1]" type="text" value="">
                                    ...
                                    <td>
                                        ...
                                        <input  class="form-control" id="total_quantity_hidden_1" name="total_quantity_hidden[1]" type="hidden" value=""> 
                                    </td>
                                    <td>
...
?>
    ...
    // $('.item_name').change(function(){
     ...
     function getBrand(row){
      ...
      var data = {'item_id': item_id}
        ...
        $.ajax({
            url: '<?php echo site_url('general_store/item_brand'); ?>',
            data: data,
            method: 'POST',
            dataType: 'json',
    ...
    function currentquantity(row){
            ...
            var item_id  = $('#itemID_'+row).val();
            var brand_id  = $('#brand_id_'+row).val();
            ...
            if(item_id!=''){
                ...
                var data = {'item_id': item_id,'brand_id':brand_id}
