                                 ...
                                 <?php $i=0; foreach($budget_items as $budget_item){ $i++;?>
                                        ...
                                        <!--  <td><input type="text" readonly  name="indent_date[]" id="indent_date_<?php echo $i; ?>" class=" form-control issue" value="<?php if(!empty($budget_item['indent_date'])) echo $budget_item['indent_date'];  ?>" ></td> -->
                                          ...
                                          <td>
                                              ...
                                              <?php if(!empty($budget_item['item_name_description'])) echo $budget_item['item_name_description'];  ?>
                                          </td>
                                          <td><input type="hidden"  name="unit[]" id="unit_c_<?php echo $i; ?>" class="issue" value="<?php if(!empty($budget_item['unit'])) echo $budget_item['unit'];  ?>"><?php if(!empty($budget_item['unit'])) echo $budget_item['unit'];  ?></td>   
                                          
                                          <td><input type="hidden"  name="indent_qty[]" id="indent_qty_<?php echo $i; ?>"  class="issue" value="<?php if(!empty($budget_item['indent_qty'])) echo $budget_item['indent_qty'];  ?>"><?php if(!empty($budget_item['indent_qty'])) echo $budget_item['indent_qty'];  ?></td>

                                          
                                          <td style="text-align: center;"><input type="checkbox" class="form-control" onclick="addItem(<?php echo $i; ?>);" id="item_select_<?php echo $i; ?>" name="item_select[]" value="<?php echo $i-1; ?>" ></td>
        ...
        if($('#select_'+item_id).prop('checked')){
            ...
            $.ajax({
                ...
                success: function (msg) {
                    ...
                    str += '<td>';
                    str += '<input type="hidden" name="indent_date[]" id="indent_date_'+item_id+'" class="issue" value="'+item_id+'" >';
                    str +='<input type="hidden"  name="asset_id[]" id="asset_id_'+item_id+'" class="issue" value="" >';
                    str +='<input type="hidden"  name="c_c_id[]" id="c_c_id_'+item_id+'" class="issue" value="" >';
                    str +='<input type="hidden"  name="department_id[]" id="department_id_'+item_id+'" class="issue" value="" >';
                    str +='<input type="hidden"  name="indent_id[]" id="indent_id_'+item_id+'" class="issue" value="" >';
                    str +='<input type="hidden"  name="indent_no[]" id="indent_no_'+item_id+'" class="issue" value="" >';
                    
                    str +='<input type="hidden"  name="indent_d_id[]" id="indent_d_id_'+item_id+'" class="issue" value="">';
                    str +='<input type="hidden"  name="item_id[]" id="item_id_'+item_id+'" class="issue" value="">';
                    str +='<input type="hidden"  name="item_code[]" id="item_des_'+item_id+'" class="issue form-control" value="">';
                    str +='<input type="hidden" name="department_name[]" id="department_name_'+item_id+'" value="" >';
                    str +='<input type="hidden"  name="brand_id[]" id="brand_id_'+item_id+'" class="issue" value="">';
                    
                    str +='<input type="hidden"  name="item_name_description[]" id="item_des_c_'+item_id+'" class="issue" value="">';
                    str +='<input type="hidden"  name="unit[]" id="unit_c_'++'" class="issue" value="">';
                    str +='<input type="hidden"  name="indent_qty[]" id="indent_qty_'+item_id+'"  class="issue" value="">';
                    str +='<input type="hidden"  name="net_budgeted_qty[]" id="net_budgeted_qty_'+item_id+'" class="issue" value="" >';
                    str +='<input type="hidden"  name="budget_value[]" id="budget_value_'+item_id+'" class="issue" value="" >';
