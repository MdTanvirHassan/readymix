                 ...
                 <div class="x_content">
                     <form class="form-horizontal" action="<?php echo site_url('general_store/add_action_item_information'); ?>" method="post" enctype="multipart/form-data">
                             ...
                             <div class="col-sm-4 input-group">
                                 ...
                                 <select   id="brand_id" class="form-control e1" name="brand_id" >
                                    ...
                                    <?php foreach($brands as $brand){ ?>
                                            <option class="form-control" value="<?php echo $brand['id']; ?>"><?php echo $brand['brand_name']; ?></option>
                                    <?php } ?>
                                </select>
                        </div>
                             <label for="title" class="col-sm-2 control-label">
                        ...
                        <div class='form-group' >
                            ...
                            <div class="col-sm-4 input-group">
                                    <span class="input-group-addon"><i class="fa fa-check-square"></i></span>
                                    <input class="form-control" id="inputdefault" name="min_level" type="text">
                             </div> 
                            ...
                            <div class="col-sm-4 input-group">
                                    <span class="input-group-addon"><i class="fa fa-check-square"></i></span>
                                    <input  class="form-control" id="inputdefault" name="max_level" type="text">
                            </div>
                        ...
                        <div class='form-group' >
                             ...
                             <label for="title" class="col-sm-2 control-label">
                                 Order Level :
                                  ...
                                  <div class="col-sm-4 input-group">
                                      <span class="input-group-addon"><i class="fa fa-check-square"></i></span>
                                    <input class="form-control" id="inputdefault" name="order_level" type="text">
                             </div> 
                                    ...
                                    Moving Type :
                                     ...
                                     <div class="col-sm-4 input-group">
                                       ...
                                       <select  id="moving_type" class="form-control" name="moving_type">
                                            ...
                                            <option class="form-control" value="second">Slow</option>
