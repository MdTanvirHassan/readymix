                              ...
                              <div class="col-sm-6 input-group">
                                  ...
                                  <select required id="po_id" class="form-control e1" name="po_id">
                                    ...
                                    <?php foreach($purchase_orders as $purchase_order){ ?>
                                        <option value="<?php echo $purchase_order['o_id'];  ?>"><?php if(!empty($purchase_order['order_no'])) echo $purchase_order['SUP_NAME'].'('.$purchase_order['order_no'].')'.'('.date("d-m-Y",strtotime($purchase_order['purchase_order_date'])).')'; ?></option>
                                    <?php } ?>
                                </select>
                        </div>
                             <label for="title" class="col-sm-2 control-label">
...
<script>
                    ...
                    success: function (msg) { 
                        ...
                        var amount;
                         $(msg.item_list).each(function (i, v) {
                             ...
                             str+='<tr>';
                             str +='<td><input type="hidden"  name="o_details_id[]" id="o_details_id_'+(Number(i) + 1)+'" class="issue" value="'+v.o_details_id+'" ><input type="hidden"  name="indent_d_id[]" id="indent_id_'+(Number(i) + 1)+'" class="issue" value="'+v.indent_d_id+'" ><input type="hidden"  name="brand_id[]" id="brand_id_'+(Number(i) + 1)+'" class="issue" value="'+v.brand_id+'"><input type="hidden"  name="item_id[]" id="item_des_c1_" class="issue" value="'+v.item_id+'"><input readonly style="width:240px;"  type="text"  name="name[]" id="item_des_c1_" class="issue" value="'+v.item_name+'"></td>';
                             str +='<td><input type="hidden"   style="width:140px;"  type="text"  name="unit_price[]" id="unit_price_'+(Number(i) + 1)+'" class="unit_price_'+(Number(i) + 1)+'" value="'+v.unit_price+'"><input readonly  style="width:80px;"  type="text"  name="measurement_unit[]" id="measurement_unit_'+(Number(i) + 1)+'" value="'+v.meas_unit+'"></td>';
                             str +='<td><input style="width:100px;text-align:right;"  type="text"  name="item_size[]" id="item_size_'+(Number(i) + 1)+'" class="issue" value="'+v.item_size+'"></td>';
                             str +='<td><input style="width:80px;text-align:right;"  type="text"  name="size_unit[]" id="size_unit_'+(Number(i) + 1)+'" class="issue" value="'+v.unit_name+'"></td>';
                             str +='<td><input required style="width:100px;text-align:right;"  type="text"  name="challan_qty[]" id="challan_quantity_'+(Number(i) + 1)+'" class="issue" value="'+net_qty+'"></td>';
                             str +='<td><input required  onkeyup="calculateAmount('+(Number(i) + 1)+')" onchange="calculateAmount('+(Number(i) + 1)+')" onblur="calculateAmount('+(Number(i) + 1)+')" id="receive_qty_'+(Number(i) + 1)+'"  style="width:100px;text-align:right;"  type="text"  name="receive_qty[]" id="quantity_'+(Number(i) + 1)+'" class="issue" value="'+net_qty+'"></td>';
                             str +='<td><input style="width:100px;text-align:right;"  type="text"  name="wastage_qty[]" id="wastage_quantity_'+v.item_id+'" class="issue" value=""></td>';
                             str +='<td><input type="hidden" style="width:140px;"  type="text" name="amount[]" id="amount_'+(Number(i) + 1)+'" class="amount_'+(Number(i) + 1)+'"  value="'+amount+'"><input    style="width:140px;text-align:right;"  type="text" name="remark[]" id="amount_'+(Number(i) + 1)+'" class="remark_'+(Number(i) + 1)+'" ></td>'; 
    ...
    function calculateAmountPre(id){
    //    alert('test');
        var net_price;
        var r_quantity = Number($('#receive_qty_'+id).val());
...
//            alert('Please fill the  Or Challlan field');
...
//        }
        ...
        if($('#mrr_challan_date').val() == ''){
            alert('Please fill the Challan Date field');
