                            ...
                            <div class="row">
                                    <div class='form-group' >
                                        ...
                                        <div id="item_type" style="display:<?php if($ipo_material_indent[0]['type_name']!="Material") echo 'none'; ?>">
                                                ...
                                                <div class="col-sm-4 input-group">  
                                                    <b>   <?php if (!empty($ipo_material_indent[0]['dept_name'])) echo $ipo_material_indent[0]['dept_name']; ?>  </b>     
                                                </div>
                                        </div>    
                                    ...
                                    foreach ($ipo_material_indent_details as $ipo_material_indent_detail) {
                                        ...
                                        ?>  
                                                <tr id="row_<?php echo $i; ?>">
                                                    ...
                                                    <td><?php if (!empty($ipo_material_indent_detail['item_size'])) echo $ipo_material_indent_detail['item_size']; ?></td>
                                                    <td><?php if (!empty($ipo_material_indent_detail['unit_name'])) echo $ipo_material_indent_detail['unit_name']; ?></td>
          ...
          <?php }else{ ?> 
                  ...
                  <?php } ?>        
                            <div class="row" style="margin-bottom: 20px">
                                ...
                                -->
                                <div class="col-md-2">
                                    <a href="<?php echo site_url('backend/general_store/indentList') ?>" > <button type="button" class="btn btn-success button">GO BACK</button> </a>
