           ...
           <tr><td colspan="7"></td><td style="border-left:1px solid;border-top:1px solid;border-right:1px solid;width:150px;">Date.<br><?php echo date('d-m-Y',strtotime($budget_info[0]['b_date'])); ?></td></tr>
               ...
               <?php $i=0; foreach($budgeted_items as $budgeted_item){ $i++;
                  ...
                  <?php // }else{ ?>   
                           <tr id="row_1">
                            ...
                            <td style="border-left:1px solid;border-top:1px solid;border-right:1px solid;text-align:right;"><?php if(!empty($budgeted_item['budget_value'])) echo number_format($budgeted_item['budget_value']);  ?></td>
                        </tr>  
                  <?php // } ?>      
               ...
               <?php } ?>
                        <tr id="row_1">
                            ...
                            <td style="border-left:1px solid;border-top:1px solid;border-right:1px solid;border-bottom:1px solid;text-align:right;"><b><?php if(!empty($total_value)) echo number_format($total_value);  ?></b></td>
                        </tr>  
                        <tr><td></td></tr>
                         <tr><td></td></tr>
                         <tr><td></td></tr>
