                            ...
                            <table class="table table-bordered" id="myTable">
                                ...
                                <tbody>
                                    ...
                                    <tr id="row_1">
                                        <td></td>
                                        <td> 
                                            <select class="e1 form-control" style="width:100%;" id="item_c_1" name="item_id[]" onchange="javascript:item_info(1);">
                                       ...
                                       <td><input type="hidden"  name="item_name_description[]" id="item_des_c_1" class="issue form-control"><input disabled type="text"  name="item_name_description[]" id="item_des_c1_1" class="issue form-control"></td>
                                        <td>
                                            <input type="hidden"  name="unit[]" id="unit_c_1" class="issue">
                                            <input style="width:100%;" disabled type="text"  name="unit[]" id="unit_c1_1" class="issue form-control">
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <input style="width:100%;" disabled type="text" name="stock_qty[]" id="stock_qty_c1_1" class="issue form-control">
                                        </td>
                                        <td>
                                            <input type="hidden"  name="unit_price[]" id="unit_price_c_1" class="issue">
                                            <input style="width:100%;" type="text"  name="indent_qty[]" id="indent_qty_c_1" onkeyup="calculateEstvalueConsume(1)" class="issue form-control">
                                        </td>
                                       
                                        <td><input style="width:100%;" type="text"  name="expected_date[]" class="issue datepicker1 form-control"></td>
                                        <td> <select style="width:100%;" id="asset_c_1" class="e1 form-control" name="asset_id[]" >
                                        ...
                                        <td> 
                                            <select style="width:100%;"  class="e1 form-control"  id="c_c_id" name="c_c_id[]" >
                                        ...
                                        <td>
                                            <textarea style="width:100%;height: 34px;" class="form-control"  name="remark[]"></textarea>
                                        </td>
                            ...
                            <table class="table table-bordered" id="myTable1" style="display:none;">
                                <thead class="thead-color">
                                    <tr>
                                        ...
                                        <th>Last Supplier</th>
                                        -->
                                        <th style="vertical-align: middle;width: 10%;text-align: center;">Stock Qty</th>
