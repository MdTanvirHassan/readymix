                            ...
                            <div class="row">
                                <div class='form-group' >
                                    ...
                                    <div class="col-sm-4 input-group">
                                        ...
                                        <input class="form-control" id="inputdefault" name="ipo_number" type="hidden" value="<?php if (!empty($indent_auto_number)) echo $branch_info[0]['short_name'] . "/IN" . $indent_auto_number; ?>">
                                        <input disabled class="form-control" id="inputdefault" name="ipo_number1" type="text" value="<?php if (!empty($indent_auto_number)) echo $branch_info[0]['short_name'] . "/IN" . $indent_auto_number; ?>">
                                    </div>
                                ...
                                <div class='form-group' >
                                    ...
                                    <div class="col-sm-4 input-group">
                                      ...
                                      <!--   <input required class="form-control datepicker"  name="date" type="text" value="<?php echo date('d-m-Y') ?>">-->
                                        <input required class="form-control " readonly  name="date" type="text" value="<?php echo date('d-m-Y') ?>">
                                    </div>
                                    ...
                                    <div class="col-sm-4 input-group">
                                        <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                            ...
                                            <?php foreach ($projects as $pro) { ?>
                                                    <option value="<?php echo $pro['d_id']; ?>"><?php if (!empty($pro['dep_code'])) echo $pro['dep_description'] . "(" . $pro['dep_code'] . ")"; ?></option>
    <?php } ?>
                                            </select>
                                            <?php } else { ?>
    ...
    function addItem(item_id) {
        ...
        $.ajax({
            ...
            success: function (msg) {
                ...
                str += '<textarea disabled class="form-control" style="width:100%;" rowspan="3" name="des[]">' + item_description + '</textarea>';
                str += '</td>'
                ...
                str += '<td><textarea rowspan="3" class="form-control" style="width:100%;" name="remark[]"></textarea></td>';
                str += '</tr>';
...
//       }    
    ...
    $('#indent_type').change(function () {
        ...
        if (indent_type == "Material" || indent_type == "Asset") {
    ...
    function showServiceOrMaterial() {
        var indent_type = $('#indent_type :selected').text();
