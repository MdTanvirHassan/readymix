               ...
               <div class="row">
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8 col-md-7 "><input class="form-control" id="inputdefault" name="mrr_no" value="<?php if(!empty($mrr[0]['mrr_no'])) echo $mrr[0]['mrr_no']; ?>" type="text"></div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group row">
                            <div class="col-sm-4 col-md-5  labeltext"><label for="inputdefault">MRR Date :</label></div>
                             <div class="col-sm-8 col-md-7 "><input class="form-control datepicker"  name="mrr_date" value="<?php if(!empty($mrr[0]['mrr_date'])) echo $mrr[0]['mrr_date']; ?>" type="text"></div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            <div class="col-sm-4 col-md-5  labeltext"><label for="inputdefault">DAte :</label></div>
                             <div class="col-sm-8 col-md-7 "><input class="form-control datepicker"  name="mrr_challan_date" value="<?php if(!empty($mrr[0]['mrr_challan_date'])) echo $mrr[0]['mrr_challan_date']; ?>" type="text"></div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-6">
                       <?php if(!empty($mrr[0]['mrr_type']) && $mrr[0]['mrr_type']=="challan" ){ ?>
                        <div class="form-group row" id="challan">
                            ...
                            <div class="col-sm-8 col-md-7 "><input class="form-control"  name="mrr_challan" value="<?php if(!empty($mrr[0]['mrr_challan'])) echo $mrr[0]['mrr_challan']; ?>" type="text"></div>
                        </div>
                        <div class="form-group row" style="display:none" id="invoice">
                            ...
                            <div class="col-sm-8 col-md-7 "><input class="form-control"  name="mrr_invoice" value="<?php if(!empty($mrr[0]['mrr_invoice'])) echo $mrr[0]['mrr_invoice']; ?>" type="text"></div>
                        </div>
                       <?php }else{ ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            <div class="col-sm-4 col-md-5  labeltext"><label for="inputdefault">Date :</label></div>
                             <div class="col-sm-8 col-md-7 "><input class="form-control datepicker"  name="mrr_procurement_date" value="<?php if(!empty($mrr[0]['mrr_procurement_date'])) echo $mrr[0]['mrr_procurement_date']; ?>" type="text"></div>
                        </div>
                    </div>
                </div>
                 <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            <div class="col-sm-4 col-md-5  labeltext"><label for="inputdefault">QC Date :</label></div>
                             <div class="col-sm-8 col-md-7 "><input class="form-control datepicker" name="mrr_qc_date" value="<?php if(!empty($mrr[0]['mrr_qc_date'])) echo $mrr[0]['mrr_qc_date']; ?>" type="text"></div>
                        </div>
                    </div>
                </div>
                 <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            <div class="col-sm-4 col-md-5  labeltext"><label for="inputdefault">Indent Date:</label></div>
                             <div class="col-sm-8 col-md-7 "><input class="form-control datepicker" name="mrr_ipo_date" value="<?php if(!empty($mrr[0]['mrr_ipo_date'])) echo $mrr[0]['mrr_ipo_date']; ?>" type="text" id="mrr_ipo_date"></div>
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <tbody>
                 <?php $i=0; foreach($mrr_details as $mrr_detail){ $i++; ?>  
                    ...
                    <?php }else{ ?>
                        <td></td>
                    <?php } ?>
                    <td> <select id="item_<?php echo $i; ?>" name="item_id[]" onchange="javascript:item_info(<?php echo $i; ?>);">
                    ...
                    <td><input id="item_des_<?php echo $i; ?>" type="text" name="item_description[]" value="<?php if(!empty($mrr_detail['item_description'])) echo $mrr_detail['item_description']; ?>" class="issue"></td>
                    <td><input id="unit_<?php echo $i; ?>" type="text" name="measurement_unit[]" value="<?php if(!empty($mrr_detail['measurement_unit'])) echo $mrr_detail['measurement_unit']; ?>" class="issue"></td>
                    <td><input id="receive_qty_<?php echo $i; ?>" type="text" name="receive_qty[]" value="<?php if(!empty($mrr_detail['receive_qty'])) echo $mrr_detail['receive_qty']; ?>" onkeyup="calculateTotal(<?php echo $i; ?>)" class="issue"></td>
                    <td><input id="unit_price_<?php echo $i; ?>" type="text" name="unit_price[]" value="<?php if(!empty($mrr_detail['unit_price'])) echo $mrr_detail['unit_price']; ?>" onkeyup="calculateTotal(<?php echo $i; ?>)" class="issue"></td>
                    <td><input id="others_<?php echo $i; ?>" type="text" name="cf_cost[]" value="<?php if(!empty($mrr_detail['cf_cost'])) echo $mrr_detail['cf_cost']; ?>" onkeyup="calculateTotal(<?php echo $i; ?>)" class="issue"></td>
                    <td><input id="total_cost_<?php echo $i; ?>" type="text" name="total_cost[]" value="<?php if(!empty($mrr_detail['total_cost'])) echo $mrr_detail['total_cost']; ?>" class="issue"></td>
                    <td><input id="remark_<?php echo $i; ?>" type="text" name="remark[]" value="<?php if(!empty($mrr_detail['remark'])) echo $mrr_detail['remark']; ?>"  class="issue"></td>
