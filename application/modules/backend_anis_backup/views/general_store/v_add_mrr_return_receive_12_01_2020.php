               ...
               <div class='form-group' >
                           ...
                           MRR-RR No.:
                              ...
                              <div class="col-sm-4 input-group">
                                ...
                                <input class="form-control" id="inputdefault" name="mrr_rr_no" type="hidden" value="<?php if(!empty($mrr_rr_auto_code)) echo 'MRR-RR'.$mrr_rr_auto_code;  ?>">
                                <input disabled class="form-control" id="inputdefault" name="ir_no" type="text" value="<?php if(!empty($mrr_rr_auto_code)) echo  'MRR-RR'.$mrr_rr_auto_code;  ?>">
                        </div>
                             <label for="title" class="col-sm-2 control-label">
                            Receive Date :
                        </label>
