                        ...
                        <form class="form-horizontal" method="post" action="<?php echo site_url('general_store/edit_action_budget/'.$budget_info[0]['b_id']) ?>">
                          ...
                          <div class='form-group' >
                                    ...
                                    <label for="title" class="col-sm-2 control-label">
                                     ...
                                     <div class="col-sm-4 input-group">
                                      <span class="input-group-addon"><i class="fa fa-user"></i></span>       
                                      <input disabled class="form-control" id="inputdefault" name="ipo_number1" type="text" value="<?php if(!empty($budget_info[0]['dep_description'])) echo $budget_info[0]['dep_description'];  ?>">
                                    </div>
            ...
            <table class="table table-bordered" id="myTable">
                <thead class="thead-color">
                     ...
                     <!--   <th style="vertical-align: middle;width: 20%;text-align: center;">Project</th> -->
                        ...
                        <th style="vertical-align: middle;width: 9%;text-align: center;">Size</th>
                        <th style="vertical-align: middle;width: 9%;text-align: center;">Size Unit</th>
                        ...
                        <th style="vertical-align: middle;width: 3%;text-align: center;">Select</th>
                    ...
                    <?php $i=0; foreach($budgeted_items as $budgeted_item){ $i++;?>
                      ...
                      <tr id="row_1">
                        ...
                        <td>
                            ...
                            <input type="hidden"  name="indent_d_id[]" id="indent_d_id_<?php echo $i; ?>" class="issue" value="<?php if(!empty($budgeted_item['indent_d_id'])) echo $budgeted_item['indent_d_id'];  ?>">
                            <input type="hidden"  name="item_id[]" id="item_id_<?php echo $i; ?>" class="issue" value="<?php if(!empty($budgeted_item['item_id'])) echo $budgeted_item['item_id'];  ?>">
                            <input type="hidden"  name="item_code[]" id="item_des_<?php echo $i; ?>" class="issue" value="<?php if(!empty($budgeted_item['item_code'])) echo $budgeted_item['item_code'];  ?>">
                            <input  type="hidden"  name="department_name[]" id="department_name_<?php echo $i; ?>" value="<?php if(!empty($budgeted_item['department_name'])) echo $budgeted_item['department_name'];  ?>" >
                            ...
                            <input type="hidden" disabled class="form-control"  name="department_name1[]" value="<?php if(!empty($budgeted_item['department_name'])) echo $budgeted_item['department_name'];  ?>">
                            
                            <input type="hidden"  name="item_name_description[]" id="item_des_c_<?php echo $i; ?>" class="issue" value="<?php if(!empty($budgeted_item['item_description'])) echo $budgeted_item['item_description'];  ?>">
                           
                            <input type="text" disabled class="form-control"  name="item_name_description[]" value="<?php if(!empty($budgeted_item['item_description'])) echo $budgeted_item['item_description'];  ?>">
                        </td>
                        ...
                        <td><input readonly  type="text"  name="item_size[]" id="indent_qty_c_<?php echo $i; ?>"  class="issue form-control" value="<?php if(!empty($budgeted_item['item_size'])) echo $budgeted_item['item_size'];  ?>"></td>
                        <td><input readonly  type="text"  name="unit_name[]" id="indent_qty_c_<?php echo $i; ?>"  class="issue form-control" value="<?php if(!empty($budgeted_item['unit_name'])) echo $budgeted_item['unit_name'];  ?>"></td>
