...
<div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_content">
            <form class="form-horizontal" method="post" action="<?php echo site_url('general_store/add_action_issue_session') ?>">
             ...
             <div class='form-group' >
                          ...
                          Issue NO.:
                            ...
                            Date :
                             ...
                             <div class="col-sm-4 input-group">
                              ...
                              <input required class="form-control datepicker" name="issue_date" type="text" value="<?php echo date('d-m-Y'); ?>">
                        </div>
                ...
                <div class='form-group' >
                          ...
                          SR/Indent:
                                  ...
                                  <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                   <select required id="mrr_ipo_no" class="form-control" name="issue_ipo_no"  onchange="javascript:indent_info();">
                                    ...
                                    <?php foreach($indents as $indent){ ?>
                                        <option value="<?php echo $indent['ipo_m_id'];  ?>"><?php if(!empty($indent['ipo_number'])) echo $indent['dep_description'].'('.$indent['ipo_number'].')'; ?></option>
                                    <?php } ?>
                                </select>
                        </div>
                             <label for="title" class="col-sm-2 control-label">
                            Project :
                             ...
                             <div class="col-sm-4 input-group">
                                 <span class="input-group-addon"><i class="fa fa-check-square"></i></span>
                              <input required id="dep_name" class="form-control " name="dep_name" type="text">
                        </div>
                ...
                <div class='form-group' >
                          ...
                          Date:
                              ...
                              <div class="col-sm-4 input-group">
                                  <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                   <input required id="issue_ipo_date" class="form-control datepicker" name="issue_ipo_date" type="text">
                        </div>
                             <label for="title" class="col-sm-2 control-label">
                            Issue Type :
                        </label>
                ...
                <div class='form-group' >
                          ...
                          Remarks:
                              ...
                              <div class="col-sm-4 input-group">
                                  <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                   <input class="form-control" name="isssue_remark" type="text">
                        </div>
                             <label for="title" class="col-sm-2 control-label">
                            Delivery No :
                        </label>
                             <div class="col-sm-4 input-group">
                                 <span class="input-group-addon"><i class="fa fa-check-square"></i></span>
                              <input id="delivery_no" class="form-control" name="delivery_no" type="text">
                        </div>
...
<!--                <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8 col-md-5 "><input class="form-control" name="isssue_remark" type="text"></div>
                        </div>    
                    </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group row" id="delivey" style="display:none;">
                            ...
                            <div class="col-sm-8 col-md-5 "><input id="delivery_no" class="form-control" name="delivery_no" type="text"></div>
                        </div>
                    </div>
