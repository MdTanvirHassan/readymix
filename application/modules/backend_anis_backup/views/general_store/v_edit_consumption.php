                            ...
                            <table id="create_new_row" class="table table-bordered">
                                ...
                                <tr>
                                 ...
                                 -->   
                                    ...
                                    <td>
                                        <input  id="quantity_1" class="form-control" name="consumption_quantity[1]" type="text" value="<?php echo $consumption[0]['consumption_quantity']?>">
                                        <input  id="rate" class="form-control" name="rate[1]" type="hidden" value="<?php echo $consumption[0]['rate']?>">
                                    </td>
                                    
                                    <td>
                                        <input readonly="" class="form-control" id="total_quantity_1" name="total_quantity[1]" type="text" value="<?php echo $consumption[0]['total_quantity'];?>"> 
                                        <input  class="form-control" id="total_quantity_hidden_1" name="total_quantity_hidden[1]" type="hidden" value="<?php echo $consumption[0]['total_quantity'];?>"> 
                                    </td>
                                    <td>
