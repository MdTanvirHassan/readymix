...
<div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_content">
            <form class="form-horizontal" method="post" action="<?php echo site_url('general_store/add_action_issue_return') ?>">
                           ...
                           IRR No.:
                              ...
                              <div class="col-sm-4 input-group">
                                  <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                   <input  class="form-control" id="inputdefault" name="ir_code" type="hidden" value="<?php if(!empty($ir_code)) echo $ir_code;  ?>">
                                <input class="form-control" id="inputdefault" name="ir_no" type="hidden" value="<?php if(!empty($ir_auto_code)) echo 'IRR'.$ir_auto_code;  ?>">
                                <input disabled class="form-control" id="inputdefault" name="ir_no" type="text" value="<?php if(!empty($ir_auto_code)) echo  'IRR'.$ir_auto_code;  ?>">
                        </div>
                             <label for="title" class="col-sm-2 control-label">
                            Receive Date :
                        </label>
                             <div class="col-sm-4 input-group">
                              ...
                              <input required class="form-control datepicker" name="ir_date"  type="text" value="<?php echo date('d-m-Y') ?>">
                        </div>
                ...
                <div class='form-group' >
                           ...
                           Issue No. :
                                  ...
                                  <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                   <select required id="issue_no" class="form-control" name="issue_no" onchange="javascript:issue_item_info()">
                                    ...
                                    <?php foreach($issue_numbers as $issue_number){ ?>
                                        <option value="<?php echo $issue_number['issue_id'];  ?>"><?php if(!empty($issue_number['issue_no'])) echo $issue_number['issue_no']; ?></option>
                                    <?php } ?>
                                </select>
                        </div>
                             <label for="title" class="col-sm-2 control-label">
                            Date :
                             ...
                             <div class="col-sm-4 input-group">
                                 <span class="input-group-addon"><i class="fa fa-check-square"></i></span>
                              <input id="issue_date" class="form-control datepicker" name="issue_date" type="text">
                        </div>
