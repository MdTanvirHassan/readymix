...
<div style="padding:0" class="col-md-10 col-md-offset-1">
       ...
       <table class="table table-bordered table-hover table-striped" style="margin:0 auto;">
           ...
           <tr><td colspan="7"></td></tr>
                <tr id="row_1">
                        ...
                        <th style="border-left:1px solid;border-top:1px solid;" rowspan="2">PRODUCT NAME</th>
                        <th style="border-left:1px solid;border-top:1px solid;width:200px;" rowspan="2">PERFORMANCE</th>
                      
                        <th style="border-left:1px solid;border-top:1px solid;" colspan="2">QNT</th>
                        <th style="border-left:1px solid;border-top:1px solid;"rowspan="2">RATE<br>(Per Cft)</th>
                        <th style="border-left:1px solid;border-top:1px solid;border-right:1px solid;width:60px;" rowspan="2">VALUE</th>
    ...
    <table class="table table-bordered table-hover table-striped" style="margin:0 auto;">
       <tr><td style="width:190px;font-size:15px;"><span style="border-top:1px solid;">PREPARED BY</span></td><td style="width:30px;"></td><td style="width:200px;text-align: center;"><span style="border-top:1px solid;">CHECKED BY</span></td><td style="width:30px;"></td><td  style="width:200px;text-align: center;"><span style="border-top:1px solid;">CONFIRM BY</span></td></tr>
    </table>
