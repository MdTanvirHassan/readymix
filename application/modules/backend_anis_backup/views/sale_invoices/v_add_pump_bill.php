    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_content">
                        <form class="form-horizontal" action="<?php echo site_url('sale_invoices/add_pump_bill_action'); ?>" method="post" onsubmit="javascript: return validation()">
                            ...
                            <div class='form-group' style="margin-bottom:15px;" >
                                <label for="title" class="col-sm-2 control-label">
                                     Select Sales Order<sup class="required">*</sup>  :
                                </label> 
                                <div class="col-sm-6 input-group">
                                    <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                     <select  class="form-control e1" placeholder="Select Sales Order" id="o_id" name="o_id" onchange="javascript:delivery_order_info();" >
                             ...
                             <div class="row">
                                <input type="hidden" value="1" id="count" >
                                    <table class="table table-bordered" id="myTable" >
                                        ...
                                        <tbody id="sale_items">
                                             <tr id="row_1">;
                                                <td><input required readonly style="width:140px;"  type="text"  name="service_name[]" id="service_name_1" class="issue" value="Pump"></td>;

                                                <td><input required readonly  style="width:140px;"  type="text"  name="mu_name[]" id="mu_name_1" class="issue" value="Pcs"></td>';
                                                <td>
                                                <input required onkeyup="calculateSubtotal(1)" onchange="calculateSubtotal(1)" onblur="calculateSubtotal(1)"  style="width:140px;text-align:right;"  type="text"  name="quantity[]" id="quantity_1" value="1"></td>
    ...
    function sales_order_info(){
            ...
            //    alert(project_id);
                ...
                //    alert(project_id);
                    $.ajax({
                        type: "POST",
                        url: "backend/sale_invoices/salesOrderInfoForPump",
