    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_content">
            <form class="form-horizontal" action="<?php echo site_url('product_categories/edit_product_category_action/'.$product_category_info[0]['category_id']); ?>" method="post" onsubmit="javascript: return validation()">
                ...
                <div class='form-group' >
                                ...
                                <div class="col-sm-4 input-group">
                                    ...
                                    <input  class="form-control" id="category_name" name="category_name" type="text" value="<?php if(!empty($product_category_info[0]['category_name'])) echo $product_category_info[0]['category_name']; ?>">
                                ...
                                <div class="col-sm-4 input-group">
                                     <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                    <input  class="form-control" id="short_name" name="short_name" type="text" value="<?php if(!empty($product_category_info[0]['short_name'])) echo $product_category_info[0]['short_name']; ?>">
...
<!--                <div class="row">
             ...
             <div class="form-group" style="margin-top: 40px;">
                                <div class="col-sm-2">
                                    <a href="<?php echo site_url('backend/product_categories') ?>" > <button type="button" class="btn btn-success button" style="padding:6px 4px;">GO BACK</button> </a>
                                </div>
