...
<div class="right_col" style="background-color: #f1f1f1;padding-bottom:20px;">
    ...
    <?php  if (in_array(2, $this->role)) { ?>
         <a href="<?php echo site_url('product_categories/add_product_category'); ?>" class="btn btn-sm btn-primary">ADD CATEGORY</a>
    <?php } ?>     
            ...
            <?php if (count($product_categories)) {
                foreach ($product_categories as $product_category) { ?>
                    <tr>
                        ...
                        <td>
                            <?php if(!empty($product_category['category_name'])) echo $product_category['category_name']; ?>
                        </td>
                         
                        <td>
                            <?php if(!empty($product_category['short_name'])) echo $product_category['short_name']; ?>
                        </td>
                        ...
                        <td>
                          <?php  if (in_array(3, $this->role)) { ?>  
                                <a href="<?php echo site_url('product_categories/edit_product_category/'.$product_category['category_id']); ?>"><button class="btn btn-sm btn-info">Edit</button></a>
                          <?php } ?> 
                          <?php  if (in_array(5, $this->role)) { ?>     
                                <button onclick="delete_row('<?php echo site_url('product_categories/delete_product_category/'.$product_category['category_id']); ?>')" class="btn btn-sm btn-danger">Delete</button>
                          <?php } ?>  
                        </td>
                    </tr>
    <?php }
