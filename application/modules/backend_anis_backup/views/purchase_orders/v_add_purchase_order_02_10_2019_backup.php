...
<div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_content">
                      <form action="<?php echo site_url('purchase_orders/add_purchase_order_action'); ?>" method="post" onsubmit="javascript: return validation()" >
                            ...
                            <tbody id="service_items">
                               ...
                               <tfoot class="tfoot-color">
                                    <tr>
                                        ...
                                        <td colspan="2"><input readonly style="width:42%;text-align: right;" class="form-control" id="service_sub_total"  name="s_total_amount" type="text"></td>
                                    </tr>
                                </tfoot>
                          </table>
                        ...
                        if(msg.quotation_info[0].type_name=="Material"){
                            ...
                            $('#serviceTabe').hide();
                             ...
                             if(order_from=="Direct"){
                                ...
                                str +='<th  style="text-align: center;" >M. Unit</th>';
                            ...
                            $(msg.item_list).each(function (i, v){       
                               // total=total+Number(v.amount);
                                ...
                                if(order_from=="Direct"){
                                    ...
                                    str +='<td><input type="hidden"  name="item_id[]" id="item_id_" class="issue" value="'+v.item_id+'"><input readonly style="width:100%;"  type="text"  name="name[]" id="item_des_c1_" class="issue form-control" value="'+v.item_name+'"></td>';
                                    str +='<td><input readonly style="width:100%;"  type="text"  name="m_unit[]" id="description_'+(Number(i) + 1) + '" class="issue form-control" value="'+v.meas_unit+'"></td>';
                                    str +='<td><input readonly style="width:100%;"  type="text"  name="budget_qnty[]" id="budget_qnty_'+(Number(i) + 1) + '" class="issue form-control" value="'+v.budget_qty+'"></td>';
                                    str +='<td><input readonly onkeyup="calculateSubtotal('+(Number(i) + 1)+')" onchange="calculateSubtotal('+(Number(i) + 1)+')" onblur="calculateSubtotal('+(Number(i) + 1)+')"  style="width:100%;text-align:right;"  type="text"  name="quantity[]" id="quantity_'+(Number(i) + 1)+'" class="issue number form-control" value="'+v.budget_qty+'"></td>';
                                    ...
                                    str +='<td><input readonly  style="width:100%;text-align:right;"  type="text" class="form-control amount_"  name="amount[]" id="amount_'+(Number(i) + 1)+'" class="issue" value="'+v.budget_value+'"></td>'; 
                                    str +='<td><textarea class="form-control" style="width:100%;height:34px" name="remark[]">'+''+'</textarea></td>';
                                    str +='<td style="text-align: center;"><input type="checkbox" name="select_item[]" onclick="calculateSubtotal('+(Number(i)+1)+')"  id="select_item_' +(Number(i) +1)+ '" class="select_item_' +(Number(i) + 1)+'" value="'+Number(i)+'" ></td>';
                                    str+='</tr>';
                                    ...
                                    str +='<td><input type="hidden"  name="item_id[]" id="item_id_" class="issue" value="'+v.item_id+'"><input readonly style="width:100%;"  type="text"  name="name[]" id="item_des_c1_" class="issue form-control" value="'+v.item_name+'"></td>';
                                    str +='<td><input readonly style="width:100%;"  type="text"  name="m_unit[]" id="description_'+(Number(i) + 1) + '" class="issue form-control" value="'+v.meas_unit+'"></td>';
                                    str +='<td><input readonly style="width:100%;"  type="text"  name="m_indent_qnty[]" id="m_indent_qnty_'+(Number(i) + 1) + '" class="issue form-control" value="'+v.quantity+'"></td>';
                                    str +='<td><input readonly onkeyup="calculateSubtotal('+(Number(i) + 1)+')" onchange="calculateSubtotal('+(Number(i) + 1)+')" onblur="calculateSubtotal('+(Number(i) + 1)+')"  style="width:100%;text-align:right;"  type="text"  name="quantity[]" id="quantity_'+(Number(i) + 1)+'" class="issue number form-control" value="'+v.quantity+'"></td>';
                                    str +='<td><input readonly onkeyup="calculateSubtotal('+(Number(i) + 1)+')" onchange="calculateSubtotal('+(Number(i) + 1)+')" onblur="calculateSubtotal('+(Number(i) + 1)+')"  style="width:100%;text-align:right;"  type="text"  name="unit_price[]" id="unit_price_'+(Number(i) + 1)+'" class="issue number form-control" value="'+v.unit_price+'"></td>';
                                    str +='<td><input readonly  style="width:100%;text-align:right;"  type="text" class="form-control amount_"  name="amount[]" id="amount_'+(Number(i) + 1)+'" class="issue" value="'+v.value+'"></td>'; 
                                    str +='<td><textarea class="form-control" style="width:100%;height:34px" name="remark[]">'+''+'</textarea></td>';
                                    str +='<td style="text-align: center;"><input type="checkbox" name="select_item[]" onclick="calculateSubtotal('+(Number(i)+1)+')"  id="select_item_' +(Number(i) +1)+ '" class="select_item_' +(Number(i) + 1)+'" value="'+Number(i)+'" ></td>';
                                    str+='</tr>';
                                }    
