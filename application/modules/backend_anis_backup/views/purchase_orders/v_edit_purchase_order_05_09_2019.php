...
<?php foreach ($employees as $employee) { ?>
                            ...
                            <div class="row" style="margin-top: 20px;">
                                ...
                                <table class="table table-bordered" id="myTable" style="display:<?php if ($purchase_order_info[0]['order_type'] != "Material") echo 'none'; ?>">
...
foreach ($purchase_order_details_info as $purchase_order_details) {
    ...
    ?>
                                            <tr class="" id="row_<?php echo $i; ?>">
                                                <td><input  type="hidden"  name="item_id[]" id="product_id_<?php echo $i; ?>" class="issue" value="<?php echo $purchase_order_details['item_id'] ?>"><input readonly style="width:100%"  type="text"  name="name[]" id="item_des_c1_" class="issue form-control" value="<?php echo $purchase_order_details['item_name'] ?>"></td>
                                                ...
                                                <td><input onkeyup="calculateSubtotal(<?php echo $i; ?>)" onchange="calculateSubtotal(<?php echo $i; ?>)" onblur="calculateSubtotal(<?php echo $i; ?>)"   style="width:100%;text-align: right;"  type="text"  name="quantity[]" id="quantity_<?php echo $i; ?>" class="issue form-control" value="<?php echo $purchase_order_details['quantity'] ?>"></td>
                                                ...
                                                <td><input readonly  style="width:100%;text-align: right;"  type="text" class="form-control"  name="amount[]" id="amount_<?php echo $i; ?>" class="issue" value="<?php echo $purchase_order_details['amount'] ?>"></td>
                                                <td><input   style="width:100%;"  type="text" class="form-control"  name="remark[]" id="item_amount_<?php echo $i; ?>" class="issue" value="<?php echo $purchase_order_details['remark'] ?>"></td>
                                ...
                                <table class="table table-bordered" id="serviceTable" style="display:<?php if ($purchase_order_info[0]['order_type'] != "Service") echo 'none' ?>">
                                    <thead class="thead-color">
                                        <tr>
