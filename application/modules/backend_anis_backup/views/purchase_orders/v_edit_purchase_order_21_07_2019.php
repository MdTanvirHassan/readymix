                            ...
                            <tbody id="purchase_items">
                                 <?php $i=0; foreach($purchase_order_details_info as $purchase_order_details){ 
                                     ...
                                     <tr class="" id="row_<?php echo $i; ?>">
                                        <td><input  type="hidden"  name="item_id[]" id="product_id_<?php echo $i; ?>" class="issue" value="<?php echo $purchase_order_details['item_id'] ?>"><input readonly style="width:140px;"  type="text"  name="name[]" id="item_des_c1_" class="issue" value="<?php echo $purchase_order_details['item_name'] ?>"></td>
                                        <td><input   style="width:140px;"  type="text" class=""  name="m_unit[]" id="item_amount_<?php echo $i; ?>" class="issue" value="<?php echo $purchase_order_details['meas_unit'] ?>"></td>
                                        <td><input onkeyup="calculateSubtotal(<?php echo $i; ?>)" onchange="calculateSubtotal(<?php echo $i; ?>)" onblur="calculateSubtotal(<?php echo $i; ?>)"   style="width:140px;text-align: right;"  type="text"  name="quantity[]" id="quantity_<?php echo $i; ?>" class="issue" value="<?php echo $purchase_order_details['quantity'] ?>"></td>
                                        <td><input onkeyup="calculateSubtotal(<?php echo $i; ?>)" onchange="calculateSubtotal(<?php echo $i; ?>)" onblur="calculateSubtotal(<?php echo $i; ?>)"  style="width:140px;text-align: right;"  type="text"  name="unit_price[]" id="unit_price_<?php echo $i; ?>" class="issue" value="<?php echo $purchase_order_details['unit_price'] ?>"></td>    
                                        <td><input readonly  style="width:140px;text-align: right;"  type="text" class=""  name="amount[]" id="amount_<?php echo $i; ?>" class="issue" value="<?php echo $purchase_order_details['amount'] ?>"></td>
                                        <td><input   style="width:140px;"  type="text" class=""  name="remark[]" id="item_amount_<?php echo $i; ?>" class="issue" value="<?php echo $purchase_order_details['remark'] ?>"></td>
                               ...
                               <tfoot>
                                    <tr>
                                        ...
                                        <td colspan="3"><input readonly style="width:140px;text-align: right;" id="sub_total"  name="total_amount" type="text" value="<?php if(!empty($purchase_order_info[0]['total_amount'])) echo $purchase_order_info[0]['total_amount']; ?>"></td>
                                    </tr>
                                </tfoot>
                          </table>
            ...
            <div class="col-md-6">
                <div class="form-group row">
                 ...
                 <div class="form-group row">
                   <?php if(!empty($payment_info[0]['b_bg'])){ ?>
                        ...
                        <div class="col-sm-4 col-md-2 ">
                           <input required style="text-align: right;" class="form-control" id="b_bg_tenor" name="b_bg_tenor" type="text" placeholder="T. Day" value="<?php if(!empty($payment_info[0]['b_bg_tenor'])) echo $payment_info[0]['b_bg_tenor']; ?>">
                        </div>
                        <div class="col-sm-4 col-md-2 ">
                ...
                <div class="form-group row">
                  <?php if(!empty($payment_info[0]['b_lc'])){ ?>
                        ...
                        <div class="col-sm-4 col-md-2 ">
                           <input required style="text-align: right;" class="form-control" id="b_lc_tenor" name="b_lc_tenor" type="text" placeholder="T.Day" value="<?php if(!empty($payment_info[0]['b_lc_tenor'])) echo $payment_info[0]['b_lc_tenor']; ?>">
                        </div>
                         <div class="col-sm-4 col-md-2 ">
                 ...
                 <div class="form-group row">
                     <?php if(!empty($payment_info[0]['b_pdc'])){ ?>
                        ...
                        <div class="col-sm-4 col-md-2 ">
                           <input required style="text-align: right;" class="form-control" id="b_pdc_check" name="b_pdc_check" type="text" placeholder="T.Ch." value="<?php if(!empty($payment_info[0]['b_pdc_check'])) echo $payment_info[0]['b_pdc_check']; ?>">
                        </div>
                        <div class="col-sm-4 col-md-2 ">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group row">
                    <?php if(!empty($payment_info[0]['a_cash'])){ ?>
                        <div class="col-sm-4 col-md-2   labeltext" style=""><label for="a_cash"><input onclick="enablePaymentCondition('a_cash')" id="a_cash" type="checkbox" <?php if($payment_info[0]['a_cash']=="Cash") echo 'checked'; ?> name="a_cash" value="Cash">&nbsp;Cash</label></div>
                         <div class="col-sm-4 col-md-2 ">
                           <input style="text-align: right;" class="form-control" id="a_cash_tenor" name="a_cash_tenor" type="text" placeholder="T. Day" value="<?php if(!empty($payment_info[0]['a_cash_tenor'])) echo $payment_info[0]['a_cash_tenor']; ?>">
                        </div>
                        <div class="col-sm-4 col-md-2 ">
                ...
                <div class="form-group row">
                    <?php if(!empty($payment_info[0]['a_bg'])){ ?>
                        ...
                        <div class="col-sm-4 col-md-2 ">
                           <input required style="text-align: right;" class="form-control" id="a_bg_tenor" name="a_bg_tenor" type="text" placeholder="T.Day" value="<?php if(!empty($payment_info[0]['a_bg_tenor'])) echo $payment_info[0]['a_bg_tenor']; ?>">
                        </div>
                        <div class="col-sm-4 col-md-2 ">
                ...
                <div class="form-group row">
                    <?php if(!empty($payment_info[0]['a_lc'])){ ?>
                        ...
                        <div class="col-sm-4 col-md-2 ">
                           <input required  style="text-align: right;" class="form-control" id="a_lc_tenor" name="a_lc_tenor" type="text" placeholder="T.Day" value="<?php if(!empty($payment_info[0]['a_lc_tenor'])) echo $payment_info[0]['a_lc_tenor']; ?>">
                        </div>
                         <div class="col-sm-4 col-md-2 ">
                 ...
                 <div class="form-group row">
                     <?php if(!empty($payment_info[0]['a_pdc'])){ ?>
                        ...
                        <div class="col-sm-4 col-md-2 ">
                           <input required style="text-align: right;" class="form-control" id="a_pdc_check" name="a_pdc_check" type="text" placeholder="T.Ch." value="<?php if(!empty($payment_info[0]['a_pdc_check'])) echo $payment_info[0]['a_pdc_check']; ?>">
                        </div>
                        <div class="col-sm-4 col-md-2 ">
                    ...
                    <tbody id="material_specification">
                     <?php $i=0; foreach($purchase_conditions as $purchase_condition){ 
                        ...
                        <tr id="row_<?php echo $i; ?>">
                            ...
                            <td><input required  style="width:250px"  type="text"  name="t_or_c_name[]"  class="issue form-control" value="<?php echo $purchase_condition['t_or_c_name']  ?>"></td>
                            <td><input required  style="width:350px"  type="text"  name="t_or_c_description[]"  class="issue form-control" value="<?php echo $purchase_condition['t_or_c_description']  ?>"></td>
