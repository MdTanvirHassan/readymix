       ...
       <div class='form-group' style="margin-bottom:30px;" >
        ...
        <div class='form-group' >
                           ...
                           <?php if($payment_mode[0]['b_cash']=="Cash" || $payment_mode[0]['a_cash']=="Cash"){ ?>
                                <option <?php if($payment_info[0]['payment_method']=="Cash") echo 'selected'; ?> class="form-control" value="Cash">Cash</option>
                           <?php } ?>
                          <?php if($payment_mode[0]['b_pdc']=="Pdc" || $payment_mode[0]['a_pdc']=="Pdc"){ ?>   
                              <option <?php if($payment_info[0]['payment_method']=="Pdc") echo 'selected'; ?> class="form-control" value="Pdc">Cheque</option>
                          <?php } ?>  
                           <?php if($payment_mode[0]['b_bg']=="Bg" || $payment_mode[0]['a_bg']=="Bg"){ ?>      
                               <option <?php if($payment_info[0]['payment_method']=="Bg") echo 'selected'; ?> class="form-control" value="Bg">Bg</option>
                           <?php } ?>
                           <?php if($payment_mode[0]['b_lc']=="Lc" || $payment_mode[0]['a_lc']=="Lc"){ ?>
                                <option <?php if($payment_info[0]['payment_method']=="Lc") echo 'selected'; ?> class="form-control" value="Lc">Lc</option>
                           <?php } ?> 
                       </select>
        ...
        <div class="form-group">
                ...
                <?php if(!empty($payment_info[0]['check_no'])){ ?>
            ...
            <label for="title" class="col-sm-2 control-label">
                                ...
                                <div class="col-sm-4 input-group">
                                    <span class="input-group-addon"><i class="fa fa-check-square"></i></span>
                                    <input required id="check_no" class="number form-control" name="check_no" type="text" value="<?php if(!empty($payment_info[0]['check_no'])) echo $payment_info[0]['check_no']; ?>">
                                </div>
                    
                <?php }else if(!empty($payment_info[0]['po_no'])){ ?>
            <label for="title" class="col-sm-2 control-label">
                                   Po No<sup class="required">*</sup> :
                                </label>
                                <div class="col-sm-4 input-group">
                                    <span class="input-group-addon"><i class="fa fa-check-square"></i></span>
                                    <input required id="po_no" class="number form-control" name="po_no" type="text" value="<?php if(!empty($payment_info[0]['po_no'])) echo $payment_info[0]['po_no']; ?>">
                                </div>
            
              <?php }else if(!empty($payment_info[0]['bg_no'])){ ?>  
            ...
            <label for="title" class="col-sm-2 control-label">
                                ...
                                <div class="col-sm-4 input-group">
                                    <span class="input-group-addon"><i class="fa fa-check-square"></i></span>
                                    <input required id="bg_no" class="number form-control" name="bg_no" type="text" value="<?php if(!empty($payment_info[0]['bg_no'])) echo $payment_info[0]['bg_no']; ?>">
                                </div>
            
            
               <?php }else if(!empty($payment_info[0]['lc_no'])){ ?> 
            <label for="title" class="col-sm-2 control-label">
                                   Lc. No<sup class="required">*</sup> :
                                </label>
                                <div class="col-sm-4 input-group">
                                    <span class="input-group-addon"><i class="fa fa-check-square"></i></span>
                                    <input required id="lc_no" class="number form-control" name="lc_no" type="text" value="<?php if(!empty($payment_info[0]['lc_no'])) echo $payment_info[0]['lc_no']; ?>">
                                </div>
               ...
               <?php } ?> 
                ...
                <?php if(!empty($payment_info[0]['check_date'])){ ?>
            ...
            <label for="title" class="col-sm-2 control-label">
                                ...
                                <div class="col-sm-4 input-group">
                                    <span class="input-group-addon"><i class="fa fa-check-square"></i></span>
                                    <input required id="check_date" class="form-control datepicker" name="check_date" type="text" value="<?php if(!empty($payment_info[0]['check_date'])) echo date('d-m-Y',strtotime($payment_info[0]['check_date'])) ?>">
                                </div>
            
                <?php }else if(!empty($payment_info[0]['po_date'])){ ?>
            <label for="title" class="col-sm-2 control-label">
                                   PO. Date<sup class="required">*</sup> :
                                </label>
                                <div class="col-sm-4 input-group">
                                    <span class="input-group-addon"><i class="fa fa-check-square"></i></span>
                                    <input required id="po_date" class="form-control datepicker" name="po_date" type="text" value="<?php if(!empty($payment_info[0]['po_date'])) echo date('d-m-Y',strtotime($payment_info[0]['po_date'])) ?>">
                                </div>
            
            
                    
                <?php }else if(!empty($payment_info[0]['bg_issue_date'])){ ?>
            <label for="title" class="col-sm-2 control-label">
                                   Bg. Issue Date<sup class="required">*</sup> :
                                </label>
                                <div class="col-sm-4 input-group">
                                    <span class="input-group-addon"><i class="fa fa-check-square"></i></span>
                                    <input required id="bg_issue_date" class="form-control datepicker" name="bg_issue_date" type="text" value="<?php if(!empty($payment_info[0]['bg_issue_date'])) echo date('d-m-Y',strtotime($payment_info[0]['bg_issue_date'])) ?>">
                                </div>
            
                    
                <?php }else if(!empty($payment_info[0]['lc_date'])){ ?>
            <label for="title" class="col-sm-2 control-label">
                                   Lc Date<sup class="required">*</sup> :
                                </label>
                                <div class="col-sm-4 input-group">
                                    <span class="input-group-addon"><i class="fa fa-check-square"></i></span>
                                    <input required id="lc_date" class="form-control datepicker" name="lc_date" type="text" value="<?php if(!empty($payment_info[0]['lc_date'])) echo date('d-m-Y',strtotime($payment_info[0]['lc_date'])) ?>">
                                </div>
         ...
         <div class="form-group">
           ...
           <?php if(!empty($payment_info[0]['tenor'])){ ?>
            ...
            <label for="title" class="col-sm-2 control-label">
                                ...
                                <div class="col-sm-4 input-group">
                                    <span class="input-group-addon"><i class="fa fa-check-square"></i></span>
                                    <input required id="tenor" class="number form-control" name="tenor" type="text" value="<?php if(!empty($payment_info[0]['tenor'])) echo $payment_info[0]['tenor']; ?>">
                                </div>
           <?php }?>
                <?php if(!empty($payment_info[0]['bg_expire_date'])){ ?>
            <label for="title" class="col-sm-2 control-label">
                                   Exp. Date<sup class="required">*</sup> :
                                </label>
                                <div class="col-sm-4 input-group">
                                    <span class="input-group-addon"><i class="fa fa-check-square"></i></span>
                                    <input required id="bg_expire_date" class="form-control datepicker" name="bg_expire_date" type="text" value="<?php if(!empty($payment_info[0]['bg_expire_date'])) echo date('d-m-Y',strtotime($payment_info[0]['bg_expire_date'])) ?>">
                                </div>
        ...
        <div class='form-group' >
             <div id="bank" style="display:<?php if($payment_info[0]['collection_method']=="Cash") echo 'none'; ?>">
                                <label for="title" class="col-sm-2 control-label">
                            ...
                            <?php foreach($banks as $bank){ ?>
                                <option <?php if($payment_info[0]['bank_id']==$bank['id']) echo 'selected'; ?>  class="form-control" value="<?php echo $bank['id'] ?>"><?php echo $bank['b_short_name'].'('.$bank['branch_name'].')' ?></option>
                            <?php } ?>
                       </select>
                                </div>
                </div>
