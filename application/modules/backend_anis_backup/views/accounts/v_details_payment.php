    ...
    <form class="form-horizontal"action="<?php echo site_url('payment_collections/edit_collection_action/'.$payment_info[0]['id']); ?>" method="post" onsubmit="javascript: return validation()">
        ...
        <div class='form-group' >
                                ...
                                <div class="col-sm-4 input-group">
                                    ...
                                    <select disable  id="supplier_id" class="form-control e1" name="supplier_id">
                        ...
                        <span id="supplier_id_error" style="color:red"></span>
                                ...
                                <div class="col-sm-4 input-group">
                                    ...
                                    <input readonly  class="form-control datepicker" name="payment_date" type="text" value="<?php if(!empty($payment_info[0]['payment_date'])) echo date('d-m-Y',strtotime($payment_info[0]['payment_date'])) ?>">
        ...
        <div class='form-group' >
                                ...
                                <div class="col-sm-4 input-group">
                                    <span class="input-group-addon"><i class="fa fa-check-square"></i></span>
                                    <input readonly  onkeyup="checkCollectAmount()" onchange="checkCollectAmount()"  id="amount" class="number form-control" name="amount" type="text" value="<?php if(!empty($payment_info[0]['amount'])) echo $payment_info[0]['amount']; ?>">
                        <span id="amount_error" style="color:red"></span>
                         ...
                         <div class="col-sm-4 input-group">
                                    <span class="input-group-addon"><i class="fa fa-check-square"></i></span>
                                    <input readonly  class="form-control " name="remark" type="text" value="<?php if(!empty($payment_info[0]['remark'])) echo $payment_info[0]['remark']; ?>">
                          </div>
