    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_content">
                        <form class="form-horizontal" action="<?php echo site_url('backend/expense/editExpense/'.$expense[0]['expenseID']) ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class='form-group' >
                                ...
                                <div class="col-sm-8 col-md-8 input-group">
                                    ...
                                    <input required class="form-control" type="text"  id="expense" name="expense" value="<?php echo $expense[0]['expense']?>" >
                                    <input   type="hidden" id="expenseID"  value="<?php echo $expense[0]['expenseID']?>" >
                            ...
                            <div class='form-group' >
                                ...
                                <div class="col-sm-8 col-md-8 input-group">
                                    ...
                                    <select onchange="extype()" id="type" name="type" class="form-control">
                                        ...
                                        <option <?php if( $expense[0]['type'] == 'Normal') echo 'selected'?> value="Normal">Normal</option>
                                        <option <?php if( $expense[0]['type'] == 'Service') echo 'selected'?>  value="Service"> Service</option>
                                        <option <?php if( $expense[0]['type'] == 'Product') echo 'selected'?>  value="Product">Product</option>
                                    </select>
                                    -->
                                    <select  id="type" name="type" class="form-control">
                                                <option <?php if( $expense[0]['type'] == 'Petty Cash') echo 'selected'?> value="Petty Cash">Petty Cash</option>
                                ...
                                <div class="col-md-6">
                                    <div class='form-group' >
                                        ...
                                        <div class="col-sm-8 input-group">
                                            ...
                                            <input required class="form-control number" id="amount" name="amount" type="text" onkeyup="javascript:balanceCheck();" onchange="javascript:balanceCheck();" onblur="javascript:balanceCheck();" value="<?php echo $expense[0]['amount']?>">
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class='form-group' >
                                        ...
                                        <div class="col-sm-8 col-md-8 input-group">
                                            ...
                                            <input required=""  class="form-control datepicker" name="expense_date" type="text" value="<?php echo date('d-m-Y', strtotime($expense[0]['expense_date'])) ?>">
                                        </div>
                            ...
                            <div class="row" id="exproduct" style="display:<?php if( $expense[0]['type'] == 'Product') echo 'block'; else echo 'none';?>">
                                <div class="col-md-6">
                                    <div class='form-group' >
                                        <label for="title" class="col-sm-4 control-label">
                                            Quantity :
                                        ...
                                        <div class="col-sm-8 input-group">
                                            ...
                                            <input  class="form-control" name="qty" type="text" value="<?php echo $expense[0]['qty']?>">
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-6" id="service_id" style="display:<?php if( $expense[0]['type'] == 'Service') echo 'block'; else echo 'none';?>">
                                    <div class='form-group' >
                                        <label for="title" class="col-sm-4 control-label">
                                            Service :
                                        </label> 
                                ...
                                <div class="col-md-6">
                                    <div class='form-group' >
                                        ...
                                        <div class="col-sm-8 col-md-8 input-group">
                                            <span class="input-group-addon"><i class="fa fa-check-square"></i></span>
                                            <input  class="form-control" name="remark" type="text" value="<?php echo $expense[0]['remark']?>">
                                        </div>
                            ...
                            <div class='form-group' >
                               <label for="title" class="col-sm-2 control-label">
                                ...
                                <div class="col-sm-10 input-group" >
                                    <div id="imageDiv">
                                       <?php foreach($expense_document as $row){?>  
                                    <i onclick="closeImage(<?php echo $row['expense_document_id']?>)" style="color:red;font-size: 16px;" class="fa fa-minus-circle"></i>
	        ...
	        <div class="col-md-6">
	              ...
	              onInvalidFileDrop: onInvalidFileDrop
                            ...
                            <div class="form-group" style="margin-top: 40px;">
                                ...
                                <div class=" col-sm-2">
                                    <button id="submitCheck" type="submit" class="btn btn-primary button">UPDATE</button>
                                </div>
...
<script>
    ...
    function closeImage(d_id){
     ...
     var data = {'d_id': d_id}
        ...
        $.ajax({
            url: '<?php echo site_url('expense/delete_iamge'); ?>',
            data: data,
            method: 'POST',
            dataType: 'json',
