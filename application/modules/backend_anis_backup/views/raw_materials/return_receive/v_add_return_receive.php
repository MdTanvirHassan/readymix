            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_content">
                        ...
                        <form class="form-horizontal" action="<?php echo site_url('raw_materials/return_receive/add_action_return_receive'); ?>" method="post" onsubmit="javascript: return validation()">
                        ...
                        <div class='form-group' >
                          ...
                          <div class="col-sm-4 input-group">
                                ...
                                <input readonly class="form-control" id="" name="return_no" type="text" value="<?php if(!empty($return_no)) echo $return_no; ?>">
                        </div>
                                ...
                                <div class="col-sm-4 input-group">
                                    ...
                                    <select required id="dept_id" class="form-control e1" name="dept_id" onchange="javascript:getLcDetails();">
                                        ...
                                        <?php foreach($departments as $dep){ ?>
                                            <option class="form-control" value="<?php echo $dep['id']; ?>"><?php echo $dep['dept_name']; ?></option>
                                        <?php } ?>    
                        ...
                        <div class='form-group' >
                             <label for="title" class="col-sm-2 control-label">
                              ...
                              <div class="col-sm-4 input-group">
                                            <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                            <input required class="form-control" id="mrr_challan" name="memo_no" type="text">
                              </div>
                             <label for="title" class="col-sm-2 control-label">
                               Memo Date :
                            </label>
                                ...
                                <tbody id="mytableBody">
                                    <tr id="row_1" style="">
                                      ...
                                      <td>
                                       ...
                                       <td>
                                           <input required style="width:100%;" type="text"  id="accepted_weight_1" name="receive_qty[]" onkeyup="calculateAmount(1)" onchange="calculateAmount(1)" onblur="calculateAmount(1)" class="form-control">
                                       </td>

                                       <td>
                                           <input required style="width:100%;" type="text"  id="rate_1" name="unit_price[]" class="form-control">
                                       </td>
                                       
                                       <td>
                                           <input required style="width:100%;" type="text"  id="amount_1" name="amount[]" class="form-control">
                                       </td>
                                       
                                      <td>
                                           <input  style="width:100%;" type="text"  id="remark_1" name="remark[]" class="form-control">
                                      </td>
