...
<div class="row">
            ...
            <form class="form-horizontal" method="post" action="<?php echo site_url('raw_materials/ships/edit_truck_action/'.$truck_info[0]['truck_id']) ?>" onsubmit="javascript: return validation()">
                
                        <div class='form-group' >
                                <label for="title" class="col-sm-2 control-label">
                                   Ship No.<sup style="color:red;">*</sup>:
                               </label> 
