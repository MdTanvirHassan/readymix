                        ...
                        <td>
                            ...
                            <?php //if($mrr['mrr_status']=="applied" || $mrr['mrr_status']=="rejected" ){ ?>
                                ...
                                <?php if($mrr['qc_status']=="Approved"){ ?>
                                  ...
                                  <?php } ?> 
                               <?php }else{ ?>
                                 <!--   <a href="<?php echo site_url('raw_materials/rm_receive/reject_material_receive_requisition/'.$mrr['mrr_id']); ?>"><button class="btn btn-sm btn-warning">Reject</button></a> -->
                               <?php } ?>
