...
<div class="right_content">
     <?php $this->role = checkUserPermission(18,126, $userData);  if (in_array(2, $this->role)) {  ?>
            <a href="<?php echo site_url('raw_materials/helpers/add_helper'); ?>" class="btn btn-sm btn-primary">ADD HELPER</a>
     <?php } ?>    
                    ...
                    <tr>
                        ...
                        <td>
                                ...
                                <?php  if (in_array(3, $this->role)) {  ?>    
                                    <a href="<?php echo site_url('raw_materials/helpers/edit_helper/'.$helper['helper_id']); ?>"><button class="btn btn-sm btn-info">Edit</button></a>
                                <?php } ?>   
                            
                           <?php  if (in_array(4, $this->role)) {  ?>         
                                <a href="<?php echo site_url('raw_materials/helpers/details_helper/'.$helper['helper_id']); ?>"><button class="btn btn-sm btn-success">Details</button></a>
                           <?php } ?>
                           <?php  if(in_array(5, $this->role)){  ?>        
                               
                                    <button onclick="delete_row('<?php echo site_url('raw_materials/helpers/delete_helper/'.$helper['helper_id']); ?>')" class="btn btn-sm btn-danger">Delete</button>
