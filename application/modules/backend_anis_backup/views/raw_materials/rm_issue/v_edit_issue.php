                    ...
                    <div class="x_content">
                        ...
                        <div class='form-group' >
                             <label for="title" class="col-sm-2 control-label">
                              ...
                              <div class="col-sm-4 input-group">
                                            <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                            <input required class="form-control" id="sr_no" name="sr_no" type="text" value="<?php if(!empty($issue_info[0]['sr_no'])) echo $issue_info[0]['sr_no']; ?>">
                              </div>
                             <label for="title" class="col-sm-2 control-label">
                               SR. Date :
                            </label>
                             <div class="col-sm-4 input-group">
                                 <span class="input-group-addon"><i class="fa fa-check-square"></i></span>
                              <input required type="text"  id="sr_date" class="form-control datepicker"  name="sr_date" value="<?php if(!empty($issue_info[0]['sr_date'])) echo date('d-m-Y',strtotime($issue_info[0]['sr_date'])); ?>">
                        </div>
