                    ...
                    <div class="x_content">
                        ...
                        <div class='form-group' >
                             <label for="title" class="col-sm-2 control-label">
                              ...
                              <div class="col-sm-4 input-group">
                                            <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                            <input readonly class="form-control" id="do_no" name="do_no" type="text" value="<?php if(!empty($issue_info[0]['do_no'])) echo $issue_info[0]['do_no']; ?>">
                              </div>
                             <label for="title" class="col-sm-2 control-label">
                               DO. Date :
                            </label>
                             <div class="col-sm-4 input-group">
                                 <span class="input-group-addon"><i class="fa fa-check-square"></i></span>
                              <input readonly type="text"  id="do_date" class="form-control datepicker"  name="do_date" value="<?php if(!empty($issue_info[0]['do_date'])) echo date('d-m-Y',strtotime($issue_info[0]['do_date'])); ?>">
                        </div>
