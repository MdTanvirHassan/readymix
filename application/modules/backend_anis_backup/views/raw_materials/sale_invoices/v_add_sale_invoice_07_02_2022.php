                        ...
                        <form class="form-horizontal" action="<?php echo site_url('raw_materials/sale_invoices/add_sale_invoice_action'); ?>" method="post" onsubmit="javascript: return validation()">
                             ...
                             <div class='form-group' style="margin-bottom:15px;" >
                                ...
                                <div class="col-sm-6 input-group">
                                    <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                     <select  class="form-control e1" placeholder="Select Customer" id="customer_id" name="customer_id" onchange="javascript:delivery_order_info();" >
                            ...
                            <div class='form-group' >
                                ...
                                <div class="col-sm-4 input-group">
                                    <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                    <input type="hidden" id="h_customer_id" name="customer_id" value="" >
            ...
            $.ajax({
                ...
                success: function (msg) {
                    ...
                    if (item_id != '') {
                        if (item_id > 999) {
                           // item_sl_no = item_id;
                           item_sl_no ="YARD/INV/" + msg.order_info[0].c_short_name + '/' + final + '/'+ item_id;
                        } else if (item_id > 99) {
                            item_sl_no ="YARD/INV/" + msg.order_info[0].c_short_name + '/' + final + '/' + "0" + item_id;
                        } else if (item_id > 9) {
                            item_sl_no ="YARD/INV/" + msg.order_info[0].c_short_name + '/' + final + '/' + "00" + item_id;
                        } else {
                            item_sl_no ="YARD/INV/" + msg.order_info[0].c_short_name + '/' + final + '/' + "000" + item_id;
                        }
                    } else {
                        item_id = 1;
                        item_sl_no ="YARD/INV/" + msg.order_info[0].c_short_name + '/' + final + '/' + '0001';
                    }
                    ...
                    if(msg.item_list!=''){
                        $(msg.item_list).each(function (i, v) {
                            ...
                            str += '<td><input readonly style="width:80px;text-align: right;"  type="text"  name="so_quantity[]" id="so_quantity_' + (Number(i) + 1) + '" class="issue" value=""></td>';
