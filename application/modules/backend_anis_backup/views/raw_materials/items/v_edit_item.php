...
<div class="right_col" style="background-color: #f1f1f1;padding-bottom:20px;">
    ...
    <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                 <div class="x_content">
                      <form class="form-horizontal" action="<?php echo site_url('raw_materials/rm_setup/edit_rm_item_action/'.$item[0]['id']); ?>" method="post" enctype="multipart/form-data">
                            ...
                            Material Group<sup style="color:red;">*</sup> :
                             ...
                             <select required id="item_category" class="form-control e1" name="item_category" >
                                    ...
                                    <?php foreach($categories as $category){ ?>
                                            <option <?php if(!empty($item[0]['item_category']) && ($item[0]['item_category']== $category['c_id'])) echo "selected"; ?> class="form-control" value="<?php echo $category['c_id']; ?>"><?php echo $category['c_name'].'('.$category['c_description'].")"."(".$category['start_code']."-".$category['end_code'].")"; ?></option>
                                    <?php } ?>
                                </select>
                        </div>  
                         ...
                         <label for="title" class="col-sm-2 control-label">
                            Material Code<sup style="color:red;">*</sup> :
                             ...
                             <input id="item_c" type="hidden" name="item_c" value="" >
                                ...
                                <input id="item_code" class="form-control"  name="item_code" type="hidden" value="<?php if(!empty($item[0]['item_code'])) echo $item[0]['item_code']; ?>">
                                <input id="item_code1" readonly  class="form-control"  name="item_code" type="text" value="<?php if(!empty($item[0]['item_code'])) echo $item[0]['item_code']; ?>">
                        </div>
                         ...
                         <div class='form-group' >
                            <label for="title" class="col-sm-2 control-label">
                                Type/Grade :
                                 ...
                                 <div class="col-sm-4 input-group">
                                     <span class="input-group-addon"><i class="fa fa-check-square"></i></span>
                                   <input  class="form-control" id="item_grade" name="item_grade" type="text" value="<?php if(!empty($item[0]['item_grade'])) echo $item[0]['item_grade']; ?>">
                            </div>
                            ...
                            <div class="col-sm-4 input-group">
                                   <span class="input-group-addon"><i class="fa fa-check-square"></i></span>
                                   <input  class="form-control" id="inputdefault" name="origin" type="text" value="<?php if(!empty($item[0]['origin'])) echo $item[0]['origin']; ?>">
                            </div>
                         ...
                         <div class='form-group' >
                            ...
                            <label for="title" class="col-sm-2 control-label">
                                Store Location :
                                  ...
                                  <div class="col-sm-4 input-group">
                                      <span class="input-group-addon"><i class="fa fa-check-square"></i></span>
                                    <input class="form-control" id="inputdefault" name="store_location" type="text" value="<?php if(!empty($item[0]['store_location'])) echo $item[0]['store_location']; ?>">
                             </div> 
                        ...
                        <div class='form-group' >
                            ...
                            <div class="col-sm-4 input-group">
                                    <span class="input-group-addon"><i class="fa fa-check-square"></i></span>
                                    <input onkeyup="javascript:checkNumeric();" onchange="javascript:checkNumeric();" onblur="javascript:checkNumeric();" class="form-control number" id="inputdefault" name="min_level" type="text" value="<?php if(!empty($item[0]['min_level'])) echo $item[0]['min_level']; ?>">
                             </div> 
                            ...
                            <div class="col-sm-4 input-group">
                                    <span class="input-group-addon"><i class="fa fa-check-square"></i></span>
                                    <input onkeyup="javascript:checkNumeric();" onchange="javascript:checkNumeric();" onblur="javascript:checkNumeric();"  class="form-control number" id="inputdefault" name="max_level" type="text" value="<?php if(!empty($item[0]['max_level'])) echo $item[0]['max_level']; ?>">
                            </div>
                        ...
                        <div class='form-group' >
                             ...
                             <label for="title" class="col-sm-2 control-label">
                                 Order Level :
                                  ...
                                  <div class="col-sm-4 input-group">
                                      <span class="input-group-addon"><i class="fa fa-check-square"></i></span>
                                    <input onkeyup="javascript:checkNumeric();" onchange="javascript:checkNumeric();" onblur="javascript:checkNumeric();" class="form-control number" id="inputdefault" name="order_level" type="text" value="<?php if(!empty($item[0]['order_level'])) echo $item[0]['order_level']; ?>">
                             </div> 
