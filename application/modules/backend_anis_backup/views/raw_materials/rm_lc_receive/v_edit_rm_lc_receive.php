            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_content">
                        ...
                        <form class="form-horizontal" action="<?php echo site_url('raw_materials/rm_lc_receive/edit_action_rm_lc_receive/'.$mrr[0]['mrr_id']); ?>" method="post" onsubmit="javascript: return validation()">
                        ...
                        <div class='form-group' >
                             <label for="title" class="col-sm-2 control-label">
                              ...
                              <div class="col-sm-4 input-group">
                                    <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                    <input required class="form-control" id="mrr_challan" name="mrr_challan" type="text" value="<?php if(!empty($mrr[0]['mrr_challan'])) echo $mrr[0]['mrr_challan']; ?>">
                              </div>
                             <label for="title" class="col-sm-2 control-label">
                                Date :
                            </label>
                  ...
                  <table class="table table-bordered" id="myTable">
                                ...
                                <tbody id="mytableBody">
                                 ...
                                 foreach($receive_items as $receive){ 
                                    ...
                                    <!--   
                                       <td>
                                            <input required style="width:100%;"  type="text" id="inv_bale_qty_<?php echo $i; ?>" name="inv_qty[]" class="issue form-control" value="<?php echo $receive['inv_qty']; ?>">
                                       </td>
                                    -->   
                                       <td>
                                            <input required style="width:100%;"  type="text" id="inv_bale_qty_<?php echo $i; ?>" onkeyup="calculateTotal()" name="receive_qty[]" class="issue form-control" value="<?php echo $receive['receive_qty']; ?>">
                                       </td>
                ...
                <div class="form-group" style="margin-top: 40px;">
                        <div class="col-sm-2">
                            <a href="<?php echo site_url('backend/raw_materials/rm_lc_receive') ?>" > <button type="button" class="btn btn-success button" style="padding:6px 4px;">GO BACK</button> </a>
                        </div>
        ...
        if(lc_id != ''){
            $.ajax({
                ...
                success: function(msg) {
                    $('#lc_date').val(msg.lc_info[0].date);
                    var str='';
