            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_content">
                        ...
                        <form class="form-horizontal" action="<?php echo site_url('raw_materials/rm_transfers/edit_rm_transfer/'.$issue_info[0]['id']); ?>" method="post" onsubmit="javascript: return validation()">
                        ...
                        <div class='form-group' >
                             <label for="title" class="col-sm-2 control-label">
                              ...
                              <div class="col-sm-4 input-group">
                                            <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                            <input required class="form-control" id="tr_no" name="tr_no" type="text" value="<?php if(!empty($issue_info[0]['tr_no'])) echo $issue_info[0]['tr_no']; ?>">
                              </div>
                             <label for="title" class="col-sm-2 control-label">
                               Transfer/Memo Date :
                            </label>
                             <div class="col-sm-4 input-group">
                                 <span class="input-group-addon"><i class="fa fa-check-square"></i></span>
                              <input required type="text"  id="tr_date" class="form-control datepicker"  name="tr_date" value="<?php if(!empty($issue_info[0]['tr_date'])) echo date('d-m-Y',strtotime($issue_info[0]['tr_date'])); ?>">
                        </div>
