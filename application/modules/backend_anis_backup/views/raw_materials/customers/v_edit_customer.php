            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_content">
                        ...
                        <form class="form-horizontal"  action="<?php echo site_url('raw_materials/customers/edit_customer_action/'.$customer_info[0]['id']); ?>" method="post" onsubmit="javascript: return validation()"  >
                            <div class="row">
                            ...
                            <div class="row">
                                <h2><b>Sales Person Info</b></h2>
                                    <div class='form-group' >
                                        ...
                                        <div class="col-sm-4 input-group">
                                           <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                           <select class="form-control e1" name="sales_person_id">
                                               <option value="">Select sales person</option>
                                               <?php foreach($employees as $employee){ ?>
                                                    <option <?php if($employee['id']==$customer_info[0]['sales_person_id']) echo 'selected'; ?> value="<?php echo $employee['id'] ?>"><?php echo $employee['name'] ?></option> 
                                               <?php } ?>
                                           </select>
