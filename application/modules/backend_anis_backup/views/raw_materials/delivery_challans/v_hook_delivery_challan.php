...
<div class="right_content">
     ...
     if (in_array(2, $this->role)) { ?>
        <a href="<?php echo site_url('raw_materials/delivery_challans/add_hook_delivery_challan'); ?>" class="btn btn-sm btn-primary">ADD CHALLAN</a>
     <?php } ?>       
...
<div class="modal fade" id="challan_cancel"  role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="leave_form" action="<?php echo site_url('raw_materials/delivery_challans/cancel_delivery_challan'); ?>" method="post">
     ...
     $(document).ready(function(){
        $('#empTable').DataTable({
         "order": [[ 0, "DESC" ]],
          ...
          'serverMethod': 'post',
          'ajax': {
             'url':'<?=base_url()?>backend/raw_materials/delivery_challans/hook_delv_challan_list'
          },
          'columns': [
             { data: 'dc_id' },
