    ...
    <div class="">
        <div class="page-title">
            <div class="title_center">
                <h3>Detais Delivery Challan</h3>
                <?php if($delivery_challan_info[0]['status']=="Approved"){ ?>
                    <a target="_blank" style="float:right;margin-top:10px;" href="<?php echo site_url('raw_materials/delivery_challans/details_delivery_challan/'.$delivery_challan_info[0]['dc_id'].'/true'); ?>" class="btn btn-sm btn-warning">PRINT</a>
                <?php } ?>
            </div>
        </div>
        <div class="row">
