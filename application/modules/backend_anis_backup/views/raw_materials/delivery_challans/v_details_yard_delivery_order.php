...
<?php } ?>  
        ...
        <div class="row">
           <div class="col-md-2">
                <a href="<?php echo site_url('raw_materials/delivery_challans/deliveryOrder/Yard') ?>" > <button type="button" class="btn btn-success button" style="padding:6px 4px">GO BACK</button> </a>
            </div>
