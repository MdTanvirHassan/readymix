...
<div style="padding:0" class="col-md-10 col-md-offset-1">
    ...
    <p style=" text-align: center;margin-top:-2px;margin-bottom:5px;">Cheque/PO/BG In Accounts</p> 
            ...
            <thead>
                <tr></tr>
                                ...
                                <tr>
                                   ...
                                   <th style="border-left:1px solid;border-top:1px solid;width:150px;">Receive Date</th>
                                   ...
                                   <th style="border-left:1px solid;border-top:1px solid;border-right:1px solid;width:100px;">Status</th>
                                </tr>
                            </thead>
                             <tbody>
                                                     ...
                                                     ?>
                                                            ...
                                                            foreach($orders as $order){ 
                                                                ...
                                                                ?> 
                                                                     ...
                                                                     <tr>
                                                                       ...
                                                                       <td style="border-left:1px solid;border-top:1px solid;"><?php if(!empty($order['receive_date'])) echo date('d-m-Y',strtotime($order['receive_date'])); ?></td>
                                                                       ...
                                                                       <td style="border-left:1px solid;border-top:1px solid;text-align:right;"><?php if(!empty($order['amount'])) echo number_format($order['amount'],2); ?></td>
                                                                       <td style="border-left:1px solid;border-top:1px solid;border-right:1px solid;"><?php if(!empty($order['payment_status'])) echo $order['payment_status']; ?></td>
                                                            ...
                                                            <?php } ?>
                                                                    <tr>
                                                                        ...
                                                                        <td  style="text-align:right;border-left:1px solid;border-top:1px solid;border-bottom:1px solid;"><?php echo number_format($total,2); ?></td>
