<div class="right_col" role="main" style="padding: 0px;">
            ...
            <div class="panel-heading" role="tab" id="headingOne">
                <h4 class="panel-title clearfix" style="text-align:center">
                    <a href="<?php echo site_url('backend/sales_report'); ?>" class="btn btn-sm btn-primary pull-left">
                        << GO BACK</a> Achivement Details Report
                </h4>
            </div>
                                ...
                                <div style="margin-top: 15px;" class="col-md-12">
                                    <select class="form-control e1" placeholder="Select Type" id="sale_person_id" name="sale_person_id">
                                        ...
                                        foreach ($employees as $employee) { ?>
                                            <option <?php if ($sale_person_id == $employee['id']) {
                                                        echo 'selected';
                                                        $ename = $employee['name'];
                                                    } ?> value="<?php echo $employee['id'] ?>"><?php echo $employee['name'] ?></option>
                                        <?php } ?>
    ...
    <input style="padding: 6px 40px;" type="button" id="print_div" class="btn btn-primary" value="PRINT"/>-->
                    ...
                    <div id="header_div" style="margin-top: 15px;text-align: center;" class="col-md-10 col-md-offset-1">
                        ...
                        <h4>Sales Achievement Report for <?php echo $ename; ?></h4>
                        ...
                        <table class="table table-striped table-bordered" style="width:100%">
                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $target['order_no']; ?></td>
    ...
    <script type="text/javascript">
        ...
        function submitForm(type) {
            if (type == 'print')
                var url = '<?php echo site_url(); ?>backend/sales_report/salesAchivementDetails/true';
            else
                var url = '<?php echo site_url(); ?>backend/sales_report/salesAchivementExcel';
            $('#item-form').attr('action', url);
            $('#form-submit').click();
            $('#item-form').attr('action', '<?php echo site_url('backend/sales_report/salesAchivementDetails'); ?>');
        }
    </script>