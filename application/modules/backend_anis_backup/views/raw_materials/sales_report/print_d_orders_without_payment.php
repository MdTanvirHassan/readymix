                                                     ...
                                                     ?>
                                                            ...
                                                            foreach($orders as $order){ 
                                                                ...
                                                                ?> 
                                                                     ...
                                                                     <tr>
                                                                        ...
                                                                        <td style="border-left:1px solid;border-top:1px solid;border-right:1px solid;text-align:right;"><?php if(!empty($order['total_amount'])) echo $order['total_amount']; ?></td>
                                                            ...
                                                            <?php } ?>
                                                                    <tr>
                                                                        ...
                                                                        <td  style="text-align:right;border-left:1px solid;border-top:1px solid;border-bottom:1px solid;border-right:1px solid;"><?php echo $total; ?></td>
