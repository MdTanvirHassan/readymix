<div class="right_col" role="main" style="padding: 0px;">
            ...
            <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                ...
                <div class="panel-body">
                    ...
                    <div id="header_div" style="margin-top: 10px;text-align: center;" class="col-md-10 col-md-offset-1">
                        ...
                        <h4>Date : <?php if($f_date==$to_date) echo date('d-m-Y',strtotime($f_date)); else echo date('d-m-Y',strtotime($f_date)).' to '.date('d-m-Y',strtotime($to_date)) ?></h4>                   
    ...
    <script type="text/javascript">
        ...
        function submitForm(type) {
            if (type == 'print')
                var url = '<?php echo site_url(); ?>backend/sales_report/daily_statement/true';
            else
                var url = '<?php echo site_url(); ?>backend/sales_report/challanInvoiceComparisonExcel';
            $('#item-form').attr('action', url);
            $('#form-submit').click();
            $('#item-form').attr('action', '<?php echo site_url('backend/sales_report/daily_statement'); ?>');
        }
    </script>