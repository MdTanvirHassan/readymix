            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_content">
                        ...
                        <form class="form-horizontal"  action="<?php echo site_url('raw_materials/transport_companies/edit_transport_company_action/'.$customer_info[0]['id']); ?>" method="post" onsubmit="javascript: return validation()"  >
                            <div class="row">
                                    ...
                                    <div class='form-group' >
                                     ...
                                     <div class="col-sm-4 input-group">
                                           ...
                                           <select required id="transport_type" class="form-control" name="transport_type">
                                               ...
                                               <option <?php if($customer_info[0]['transport_type']=="Truck") echo 'selected'; ?> value="Truck">Truck</option>
                                               <option <?php if($customer_info[0]['transport_type']=="Ship") echo 'selected'; ?> value="Ship">Ship</option>
                                           </select>
