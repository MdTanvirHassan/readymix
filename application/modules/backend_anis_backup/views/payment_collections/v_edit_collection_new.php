                                            ...
                                            <span class="input-group-addon"><i class="fa fa-check-square"></i></span>
                                             <select  id="payment_for_id" class="form-control e1" name="payment_for_id" required >
                                                ...
                                                <?php foreach($product_categories as $product_category){ ?>
                                                    <option <?php if($collection_info[0]['payment_for_id']==$product_category['category_id']) echo 'selected'; ?> value="<?php echo $product_category['category_id'] ?>"><?php echo $product_category['category_name']; ?></option>
                                                <?php } ?>
                                             </select>        
