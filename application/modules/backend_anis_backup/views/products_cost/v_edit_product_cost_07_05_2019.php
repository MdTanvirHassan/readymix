                     ...
                     <tbody id="material_body">
                         ...
                         foreach($material_costs as $material_cost){ 
                             ...
                             ?>
                                <tr>
                                        ...
                                        <td><input required onkeyup="calculateSubtotal(<?php echo $i; ?>)" onchange="calculateSubtotal(<?php echo $i; ?>)" onblur="calculateSubtotal(<?php echo $i; ?>)"  style="width:140px;text-align:right;"  type="text"  name="quantity[]" id="quantity_<?php echo $i; ?>" class="issue" value="<?php echo $material_cost['quantity']; ?>"></td>
                                        <td><input required onkeyup="calculateSubtotal(<?php echo $i; ?>)" onchange="calculateSubtotal(<?php echo $i; ?>)" onblur="calculateSubtotal(<?php echo $i; ?>)"  style="width:140px;text-align:right;"  type="text"  name="rate[]" id="rate_<?php echo $i; ?>" class="issue" value="<?php echo $material_cost['rate']; ?>"></td>
                      ...
                      <tfoot id="foot" >
                          <tr>
                              ...
                              <td><input readonly style="width:140px;margin:0px;text-align:right;" type="text" id="total_quantity" name="total_quantity" value="<?php echo $total_qnty; ?>" /></td>
                              <td  style="text-align: right;">Total</td>
                              <td><input readonly style="width:140px;margin:0px;text-align:right;" type="text" id="total" name="total_material_cost" value="<?php echo $total; ?>" /></td>
                          </tr>
                           <tr>
                              <td colspan="4" style="text-align: right;">FOH</td>
                              <td><input onkeyup="javascript:calculateOtherExpense();" onchange="javascript:calculateOtherExpense();" onblur="javascript:calculateOtherExpense();" style="width:140px;text-align:right;" type="text" id="foh" name="foh" value="<?php if(!empty($product_other_cost[0]['foh'])) echo $product_other_cost[0]['foh'];  ?>" /></td>
                          </tr>
                           <tr>
                              <td colspan="4" style="text-align: right;">AOH</td>
                              <td><input onkeyup="javascript:calculateOtherExpense();" onchange="javascript:calculateOtherExpense();" onblur="javascript:calculateOtherExpense();" style="width:140px;text-align:right;" type="text" id="aoh" name="aoh" value="<?php if(!empty($product_other_cost[0]['aoh'])) echo $product_other_cost[0]['aoh'];  ?>" /></td>
                          </tr>
                           <tr>
                              <td colspan="4" style="text-align: right;">SOH</td>
                              <td><input onkeyup="javascript:calculateOtherExpense();" onchange="javascript:calculateOtherExpense();" onblur="javascript:calculateOtherExpense();" style="width:140px;text-align:right;" type="text" id="soh" name="soh" value="<?php if(!empty($product_other_cost[0]['soh'])) echo $product_other_cost[0]['soh'];  ?>" /></td>
                          </tr>
                           <tr>
                              <td colspan="4" style="text-align: right;">Fin. Exp</td>
                              <td><input onkeyup="javascript:calculateOtherExpense();" onchange="javascript:calculateOtherExpense();" onblur="javascript:calculateOtherExpense();" style="width:140px;text-align:right;" type="text" id="final_expense" name="final_expense" value="<?php if(!empty($product_other_cost[0]['final_expense'])) echo $product_other_cost[0]['final_expense'];  ?>" /></td>
                          ...
                          <tr>
                              ...
                              <td><input onkeyup="javascript:calculateVatAit();" onchange="javascript:calculateVatAit();" onblur="javascript:calculateVatAit();" style="width:140px;text-align:right;" type="text" id="vat" name="vat" value="<?php if(!empty($product_other_cost[0]['vat'])) echo $product_other_cost[0]['vat'];  ?>" /></td>
                          </tr>
                           <tr>
                              <td colspan="4" style="text-align: right;">AIT</td>
                              <td><input onkeyup="javascript:calculateVatAit();" onchange="javascript:calculateVatAit();" onblur="javascript:calculateVatAit();" style="width:140px;text-align:right;" type="text" id="ait" name="ait" value="<?php if(!empty($product_other_cost[0]['ait'])) echo $product_other_cost[0]['ait'];  ?>" /></td>
                  ...
                  var str='';
                   if(msg.item_list!=''){
                        $(msg.item_list).each(function(i,v){
                            ...
                            str +='<td><input required onkeyup="calculateSubtotal('+(Number(i) + 1)+')" onchange="calculateSubtotal('+(Number(i) + 1)+')" onblur="calculateSubtotal('+(Number(i) + 1)+')"  style="width:140px;text-align:right;"  type="text"  name="quantity[]" id="quantity_'+(Number(i) + 1) + '" class="issue" value="'+v.quantity+'"></td>';
                            str +='<td><input required onkeyup="calculateSubtotal('+(Number(i) + 1)+')" onchange="calculateSubtotal('+(Number(i) + 1)+')" onblur="calculateSubtotal('+(Number(i) + 1)+')"  style="width:140px;text-align:right;"  type="text"  name="rate[]" id="rate_'+(Number(i) + 1) + '" class="issue"></td>';
