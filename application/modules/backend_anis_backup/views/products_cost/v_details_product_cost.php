                          ...
                          <div class="row">
                                <div class="col-md-6">
                                    <div class='form-group row' >
                                        ...
                                        <div class="col-sm-8 col-md-8 input-group">
                                            <span class="input-group-addon"><i class="fa fa-product-hunt"></i></span>
                                            <input readonly  class="form-control" onkeyup="javascript:calculateCft()" onchange="javascript:calculateCft()"  id="casting_size_cum" name="casting_size_cum" type="text" value="<?php echo $product_quote_price[0]['casting_size_cum']; ?>">
                                        </div>
                                        <!--
                               ...
                               <div class="col-md-6">
                                    <div class='form-group row' >
                                       ...
                                       <label for="title" class="col-sm-4 col-md-4 control-label">
                                            Costing Size(In <span id="p_mu"><?php echo $product_quote_price[0]['measurement_unit']; ?></span>) <sup class="required">*</sup> :
                                        </label>
                                        <div class="col-sm-8 col-md-8 input-group">
                                            <span class="input-group-addon"><i class="fa fa-product-hunt"></i></span>
                                            <input readonly class="form-control" onkeyup="javascript:calculateCum()" onchange="javascript:calculateCum()"  id="casting_size_cft" name="casting_size_cft" type="text" value="<?php echo $product_quote_price[0]['casting_size_cft']; ?>">
                                        </div>   
                            ...
                            <table class="table table-bordered" id="myTable">
                                    ...
                                    foreach ($material_costs as $material_cost) {
                                        ...
                                        <tr>
                                            ...
                                            if($product_quote_price[0]['measurement_unit']=='MT'){
                                                ?>
                                            <td style="text-align: right;"><?php echo round($material_cost['quantity']/100),2 ?></td>
                                            <?php } ?>
                                ...
                                <tfoot id="foot" >
                                    ...
                                    <tr>
                                        <td colspan="<?php echo $colspan; ?>" style="text-align: right;">Transport Cost</td>
                                        <td style="text-align: right;"><?php if (!empty($product_other_cost[0]['transport_cost'])) echo $product_other_cost[0]['transport_cost']; ?></td>
                                    </tr>
                                    
                                    <tr>
                                        <td colspan="<?php echo $colspan; ?>" style="text-align: right;">Pumping Cost</td>
                                        <td style="text-align: right;"><?php if (!empty($product_other_cost[0]['pumping_cost'])) echo $product_other_cost[0]['pumping_cost']; ?></td>
                                    </tr>
                                    
                                    <tr>
                                        <td colspan="<?php echo $colspan; ?>" style="text-align: right;">Overhead Expense</td>
                                    ...
                                    <tr>
                                        <td colspan="<?php echo $colspan; ?>" style="text-align: right;">Sales Commission</td>
                                    ...
                                    <tr>
                                        <td colspan="<?php echo $colspan; ?>" style="text-align: right;">Administrative Expense.</td>
                                        <td style="text-align: right;"><?php if (!empty($product_other_cost[0]['admin_exp'])) echo $product_other_cost[0]['admin_exp']; ?></td>
                                    </tr>
                                    <tr>
                                        <td colspan="<?php echo $colspan; ?>" style="text-align: right;">Depreciation Expense</td>
                                        <td style="text-align: right;"><?php if (!empty($product_other_cost[0]['dep_exp'])) echo $product_other_cost[0]['dep_exp']; ?></td>
                                    </tr>
                                    <!--
                                    <tr>
                                    ...
                                    -->
                                    <tr>
                                        <td colspan="<?php echo $colspan; ?>" style="text-align: right;">Fin. Exp</td>
                                    ...
                                    <tr>
                                        <td colspan="<?php echo $colspan; ?>" style="text-align: right;">VAT</td>
                                        <td style="text-align: right;"><?php if (!empty($product_other_cost[0]['vat'])) echo $product_other_cost[0]['vat']; ?></td>
                                    </tr>
                                    <tr>
                                        <td colspan="<?php echo $colspan; ?>" style="text-align: right;">AIT</td>
                                    ...
                                    <tr>
                                        <td colspan="<?php echo $colspan+1; ?>" style="text-align: right;"></td>
                                        <td style="text-align: right;"><?php echo $total_with_other_expense_vat; ?></td>

                                    </tr>
                                    <tr>
                                        <td colspan="<?php echo $colspan; ?>" style="text-align: right;">Profit</td>
                                    ...
                                    <tr>
                                        <td colspan="<?php echo $colspan+1; ?>" style="text-align: right;"><b>Unit Price</b></td>
                                        <td style="text-align: right;"><?php if (!empty($product_quote_price[0]['quote_price'])) echo $product_quote_price[0]['quote_price']; ?></td>

                                    </tr>
                                    <tr>
                                        <td colspan="<?php echo $colspan+1; ?>" style="text-align: right;"><b>Unit Price(<?php echo $product_quote_price[0]['measurement_unit']; ?>)</b></td>
                                          <?php if($product_quote_price[0]['measurement_unit']=='MT'){ ?>
                                    <td style="text-align: right;"><label><?php echo round($product_quote_price[0]['quote_price']/2.41,2); ?></label></td>
                                    <?php }else if($product_quote_price[0]['measurement_unit']=='CFT'){?>
                                    <td style="text-align: right;"><label><?php echo round($product_quote_price[0]['quote_price']/35.31,2); ?></label></td>
                                    <?php }else{ ?>
                                    <td style="text-align: right;"><label><?php echo round($product_quote_price[0]['quote_price'],2); ?></label></td>
                                    <?php } ?>
                                    </tr>
                                </tfoot>
                            </table>
