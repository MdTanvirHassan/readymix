                                ...
                                <div class="col-md-6">
                                    <div class='form-group row' >
                                        ...
                                        <div class="col-sm-6 col-md-6 input-group">
                                            <span class="input-group-addon"><i class="fa fa-product-hunt"></i></span>
                                            <input   class="form-control" id="casting_size" name="casting_size" type="text" value="<?php echo $product_quote_price[0]['casting_size']; ?>">
                                        </div>
                                 ...
                                 //   $total_other_expense = $product_other_cost[0]['transport_cost'] + $product_other_cost[0]['overhead_expense'] + $product_other_cost[0]['sales_commission'] + $product_other_cost[0]['foh'] + $product_other_cost[0]['aoh'] + $product_other_cost[0]['soh'] + $product_other_cost[0]['final_expense'];
                                    ...
                                    foreach ($material_costs as $material_cost) {
                                        ...
                                        <tr>
                                            ...
                                            <td><input required onkeyup="calculateSubtotal(<?php echo $i; ?>)" onchange="calculateSubtotal(<?php echo $i; ?>)"   style="width:80px;text-align:right;"  type="text"  name="quantity[]" id="quantity_<?php echo $i; ?>" class="issue number" value="<?php echo $material_cost['quantity']; ?>"></td>
                                            <td><input  style="width:80px;"  type="text"  name="mu[]" id="meas_unit_<?php echo $i; ?>" class="issue" value="<?php echo $material_cost['mu']; ?>"></td>
...
<script type="text/javascript">
 ...
 function calculateConvertQnty(id){
   ...
   function calculateSubtotal(id){
       ...
       var table_row=Number(rowCount)-12;
