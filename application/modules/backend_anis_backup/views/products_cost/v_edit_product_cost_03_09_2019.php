                        ...
                        <form class="form-horizontal" action="<?php echo site_url('products_cost/edit_product_cost_action/' . $product_quote_price[0]['product_cost_id']); ?>" method="post" onsubmit="javascript: return validation()">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8 col-md-8 input-group">
                                            <span class="input-group-addon"><i class="fa fa-product-hunt"></i></span>
                                            <select  style="width:200px;" class="e1 form-control" style="width:100px;" id="product" name="product_id" >
                                            ...
                                            <span style="margin-left:10px" id="m_unit" ><?php echo 'Per ' . $product_quote_price[0]['measurement_unit']; ?></span>
                            ...
                            <table class="table table-bordered" id="myTable">
                                ...
                                <tbody id="material_body">
                                    ...
                                    foreach ($material_costs as $material_cost) {
                                        ...
                                        <tr>
                                            ...
                                            <td><input required onkeyup="calculateSubtotal(<?php echo $i; ?>)" onchange="calculateSubtotal(<?php echo $i; ?>)" onblur="calculateSubtotal(<?php echo $i; ?>)"  style="width:140px;text-align:right;"  type="text"  name="quantity[]" id="quantity_<?php echo $i; ?>" class="issue number" value="<?php echo $material_cost['quantity']; ?>"></td>
                                            <td><input required onkeyup="calculateSubtotal(<?php echo $i; ?>)" onchange="calculateSubtotal(<?php echo $i; ?>)" onblur="calculateSubtotal(<?php echo $i; ?>)"  style="width:140px;text-align:right;"  type="text"  name="rate[]" id="rate_<?php echo $i; ?>" class="issue number" value="<?php echo $material_cost['rate']; ?>"></td>
                                ...
                                <tfoot id="foot" >
                                    ...
                                    <tr>
                                        <td colspan="5" style="text-align: right;"><b>Unit Price</b></td>
                ...
                success: function (msg) {
                    ...
                    if (msg.item_list != '') {
                        ...
                        $(msg.item_list).each(function (i, v) {
                            ...
                            str += '<td><input required onkeyup="calculateSubtotal(' + (Number(i) + 1) + ')" onchange="calculateSubtotal(' + (Number(i) + 1) + ')" onblur="calculateSubtotal(' + (Number(i) + 1) + ')"  style="width:140px;text-align:right;"  type="text"  name="rate[]" id="rate_' + (Number(i) + 1) + '" class="issue number"></td>';
