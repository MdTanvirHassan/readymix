            ...
            <form class="form-horizontal" method="post" action="<?php echo site_url('production_mixing/add_production_mixing_action') ?>">
                        ...
                        <div class='form-group' >
                                    <label for="title" class="col-sm-2 control-label">
                                       Mixing Number:
                                         ...
                                         <div class="col-sm-4 input-group">
                                             ...
                                             <input class="form-control" id="schedule_no" name="pm_no" type="hidden" value="<?php if(!empty($mixing_auto_code)) echo "SD".$mixing_auto_code;  ?>">
                                            <input disabled class="form-control" id="schedule_no1" name="pm_no1" type="text" value="<?php if(!empty($mixing_auto_code)) echo "PM".$mixing_auto_code;  ?>">
                                   </div>
                                   <label for="title" class="col-sm-2 control-label">
                                       Select Product:
                                   </label> 
                                       ...
                                       <select class="form-control e1" name="schedule_d_id" id="schedule_details_id">
                                           ...
                                           <option value="">Select Product</option>
                                                    <?php foreach($details_schedule as $schedule){ ?>
                                                         <option value="<?php echo $schedule['id'] ?>"><?php echo $schedule['delivery_no'].'('.$schedule['product_name'].")"; ?></option>
                                                    <?php } ?>
                                           <?php } ?>         
                                       </select> 
                                   </div>
                         ...
                         <div class='form-group' >
                                 ...
                                 <label for="title" class="col-sm-2 control-label">
                                         Casting Size(In Cft) <sup class="required">*</sup>
                                  </label>
                                  <div class="col-sm-4 input-group">
                                         <span class="input-group-addon"><i class="fa fa-check-square"></i></span>
