                                       ...
                                       <select class="form-control e1" name="schedule_d_id" id="schedule_details_id">
                                           ...
                                           <option value="">Select Product</option>
                                                    <?php foreach($details_schedule as $schedule){ ?>
                                                         <option <?php if($mixing_info[0]['schedule_d_id']==$schedule['id']) echo 'selected'; ?> value="<?php echo $schedule['id'] ?>"><?php echo $schedule['delivery_no'].'('.$schedule['product_name'].")"; ?></option>
                                                    <?php } ?>
                                           <?php } ?>         
                                       </select> 
                                   </div>
