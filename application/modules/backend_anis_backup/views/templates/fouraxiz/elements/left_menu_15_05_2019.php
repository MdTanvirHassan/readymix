        ...
        <div class="col-md-3 left_col" style="background: darkcyan none repeat scroll 0 0;">
            <div class="left_col scroll-view">
                <div class="navbar nav_title" style="border: 0;">
                    <a href="<?php echo site_url('backend/dashboard'); ?>" class="site_title"><img id="logo_img" src='<?php echo site_url('images/wcl_logo.png'); ?>' style='width:20%;margin-top:-10px;;'/><span>&nbsp; KMIX</span></span></a>
                </div>
                          ...
                          <li <?php if ($this->menu == 'general_store') echo 'class="active"'; ?>><a><i class="fa fa-list"></i><span class="main_menu_text"> GENERAL STORE</span><span class="fa fa-chevron-down"></span></a>
                            ...
                            <li <?php if ($this->menu == 'sales') echo 'class="active"'; ?>><a><i class="fa fa-list-alt"></i><span class="main_menu_text">SALES</span><span class="fa fa-chevron-down"></span></a>
                               <ul  style="<?php if ($this->sub_menu == 'sale') echo 'display:block'; ?>" class="nav child_menu">
                                  ...
                                  <!--  <li <?php if ($this->sub_inner_menu == 'material') echo 'class="active"'; ?>><a href="<?php echo site_url('backend/materials'); ?>"><i class="fa fa-dashboard"></i><span class="main_menu_text">Material</span></a></li>-->
                                    <li <?php if ($this->sub_inner_menu == 'bank') echo 'class="active"'; ?>><a href="<?php echo site_url('backend/product_categories'); ?>"><i class="fa fa-dashboard"></i><span class="main_menu_text">Categories</span></a></li>
                                    ...
                                    <li <?php if ($this->sub_inner_menu == 'product_cost') echo 'class="active"'; ?>><a href="<?php echo site_url('backend/products_cost'); ?>"><i class="fa fa-dashboard"></i><span class="main_menu_text">Products Cost</span></a></li>
                                    <li <?php if ($this->sub_inner_menu == 'quotations') echo 'class="active"'; ?>><a href="<?php echo site_url('backend/sale_quotations'); ?>"><i class="fa fa-dashboard"></i><span class="main_menu_text">Sales Quotations</span></a></li>
                                    <li <?php if ($this->sub_inner_menu == 'sale_order') echo 'class="active"'; ?>><a href="<?php echo site_url('backend/sale_orders'); ?>"><i class="fa fa-dashboard"></i><span class="main_menu_text">Sales Orders</span></a></li>
                                    <li <?php if ($this->sub_inner_menu == 'payment_collection') echo 'class="active"'; ?>><a href="<?php echo site_url('backend/payment_collections'); ?>"><i class="fa fa-dashboard"></i><span class="main_menu_text">Payment Collections</span></a></li>
                                    <li <?php if ($this->sub_inner_menu == 'deposit_realization') echo 'class="active"'; ?>><a href="<?php echo site_url('backend/deposit_realization'); ?>"><i class="fa fa-dashboard"></i><span class="main_menu_text">Deposit & Realization</span></a></li>
                                    <li <?php if ($this->sub_inner_menu == 'delivery_order') echo 'class="active"'; ?>><a href="<?php echo site_url('backend/delivery_orders'); ?>"><i class="fa fa-dashboard"></i><span class="main_menu_text">Delivery Orders</span></a></li>
                                    <li <?php if ($this->sub_inner_menu == 'delivery_challan') echo 'class="active"'; ?>><a href="<?php echo site_url('backend/delivery_challans'); ?>"><i class="fa fa-dashboard"></i><span class="main_menu_text">Delivery Challans</span></a></li>
                                    <li <?php if ($this->sub_inner_menu == 'sale_invoice') echo 'class="active"'; ?>><a href="<?php echo site_url('backend/sale_invoices'); ?>"><i class="fa fa-dashboard"></i><span class="main_menu_text">Sales Invoices</span></a></li>
                                    <li <?php if ($this->sub_inner_menu == 'sales_report') echo 'class="active"'; ?>><a href="<?php echo site_url('backend/sales_report'); ?>"><i class="fa fa-dashboard"></i><span class="main_menu_text">Report</span></a></li>
