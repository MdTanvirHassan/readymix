        ...
        <div class="top_nav">
            ...
            <nav>
              ...
              <ul class="nav navbar-nav navbar-right">
               <li style="float:left;height: 61px;padding-right:10px;margin-left:-60px;"><p style="text-align: center;color:#81878C;margin-top:20px;font-size:16px;">Wahid Construction Ltd.</p></li>
...
<!--                  <li style="float:left;margin-left:100px;"><i class="fa fa-plus-circle" style="font-size: 27px;color: #0D47A1;margin-top: 17px;"></i></li>-->
       ...
       <li><a style="white-space: normal;" tabindex="-1" href="<?php echo site_url('dashboard/enterByComapany/'.$com['d_id'])?>"><?php echo $com['short_name']; ?></a></li>
       ...
       <?php } ?>
                ...
                <li class="">
                  <a  href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="images/logo_admin.png" alt="">Admin
                    <span class=" fa fa-angle-down"></span>
                  </a>
